...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.ILuisCruzFootballer;
...
public class LuisCruzFootballer implements ILuisCruzFootballer {
	...
	public LuisCruzFootballer(LuisCruzFootballer luisCruzFootballer)
			throws InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException,
			NoSuchMethodException, SecurityException {
		this.annotationID = luisCruzFootballer.getAnnotationID();
		for (int j = 0; j < luisCruzFootballer.getBirthPlaces().size(); j++) {
			if (luisCruzFootballer.getBirthPlaces().get(j) != null) {
				birthPlaces.add(luisCruzFootballer.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(luisCruzFootballer.getBirthPlaces().get(j).getClass())
						.newInstance(luisCruzFootballer.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (luisCruzFootballer.getBirthYear() != null)
			this.birthYear = luisCruzFootballer.getBirthYear().getClass()
					.getDeclaredConstructor(luisCruzFootballer.getBirthYear().getClass())
					.newInstance(luisCruzFootballer.getBirthYear());
		this.characterOffset = luisCruzFootballer.getCharacterOffset();
		this.characterOnset = luisCruzFootballer.getCharacterOnset();
		if (luisCruzFootballer.getPosition() != null)
			this.position = luisCruzFootballer.getPosition().getClass()
					.getDeclaredConstructor(luisCruzFootballer.getPosition().getClass())
					.newInstance(luisCruzFootballer.getPosition());
		for (int j = 0; j < luisCruzFootballer.getTeams().size(); j++) {
			if (luisCruzFootballer.getTeams().get(j) != null) {
				teams.add(luisCruzFootballer.getTeams().get(j).getClass()
						.getDeclaredConstructor(luisCruzFootballer.getTeams().get(j).getClass())
						.newInstance(luisCruzFootballer.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "LuisCruzFootballer [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear="
