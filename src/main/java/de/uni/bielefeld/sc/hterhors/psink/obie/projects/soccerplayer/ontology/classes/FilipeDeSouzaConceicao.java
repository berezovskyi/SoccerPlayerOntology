...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IFilipeDeSouzaConceicao;
...
public class FilipeDeSouzaConceicao implements IFilipeDeSouzaConceicao {
	...
	public FilipeDeSouzaConceicao(FilipeDeSouzaConceicao filipeDeSouzaConceicao)
			throws InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException,
			NoSuchMethodException, SecurityException {
		this.annotationID = filipeDeSouzaConceicao.getAnnotationID();
		for (int j = 0; j < filipeDeSouzaConceicao.getBirthPlaces().size(); j++) {
			if (filipeDeSouzaConceicao.getBirthPlaces().get(j) != null) {
				birthPlaces.add(filipeDeSouzaConceicao.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(filipeDeSouzaConceicao.getBirthPlaces().get(j).getClass())
						.newInstance(filipeDeSouzaConceicao.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (filipeDeSouzaConceicao.getBirthYear() != null)
			this.birthYear = filipeDeSouzaConceicao.getBirthYear().getClass()
					.getDeclaredConstructor(filipeDeSouzaConceicao.getBirthYear().getClass())
					.newInstance(filipeDeSouzaConceicao.getBirthYear());
		...
		if (filipeDeSouzaConceicao.getPosition() != null)
			this.position = filipeDeSouzaConceicao.getPosition().getClass()
					.getDeclaredConstructor(filipeDeSouzaConceicao.getPosition().getClass())
					.newInstance(filipeDeSouzaConceicao.getPosition());
		for (int j = 0; j < filipeDeSouzaConceicao.getTeams().size(); j++) {
			if (filipeDeSouzaConceicao.getTeams().get(j) != null) {
				teams.add(filipeDeSouzaConceicao.getTeams().get(j).getClass()
						.getDeclaredConstructor(filipeDeSouzaConceicao.getTeams().get(j).getClass())
						.newInstance(filipeDeSouzaConceicao.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "FilipeDeSouzaConceicao [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear="
