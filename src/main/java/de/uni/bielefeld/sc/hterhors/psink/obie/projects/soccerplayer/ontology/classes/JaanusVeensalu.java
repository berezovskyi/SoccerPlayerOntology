...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IJaanusVeensalu;
...
public class JaanusVeensalu implements IJaanusVeensalu {
	...
	public JaanusVeensalu(JaanusVeensalu jaanusVeensalu) throws InstantiationException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		this.annotationID = jaanusVeensalu.getAnnotationID();
		for (int j = 0; j < jaanusVeensalu.getBirthPlaces().size(); j++) {
			if (jaanusVeensalu.getBirthPlaces().get(j) != null) {
				birthPlaces.add(jaanusVeensalu.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(jaanusVeensalu.getBirthPlaces().get(j).getClass())
						.newInstance(jaanusVeensalu.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (jaanusVeensalu.getBirthYear() != null)
			this.birthYear = jaanusVeensalu.getBirthYear().getClass()
					.getDeclaredConstructor(jaanusVeensalu.getBirthYear().getClass())
					.newInstance(jaanusVeensalu.getBirthYear());
		this.characterOffset = jaanusVeensalu.getCharacterOffset();
		this.characterOnset = jaanusVeensalu.getCharacterOnset();
		if (jaanusVeensalu.getPosition() != null)
			this.position = jaanusVeensalu.getPosition().getClass()
					.getDeclaredConstructor(jaanusVeensalu.getPosition().getClass())
					.newInstance(jaanusVeensalu.getPosition());
		for (int j = 0; j < jaanusVeensalu.getTeams().size(); j++) {
			if (jaanusVeensalu.getTeams().get(j) != null) {
				teams.add(jaanusVeensalu.getTeams().get(j).getClass()
						.getDeclaredConstructor(jaanusVeensalu.getTeams().get(j).getClass())
						.newInstance(jaanusVeensalu.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "JaanusVeensalu [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear="
