...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IAbdullahMayouf;
...
public class AbdullahMayouf implements IAbdullahMayouf {
	...
	public AbdullahMayouf(AbdullahMayouf abdullahMayouf) throws InstantiationException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		this.annotationID = abdullahMayouf.getAnnotationID();
		for (int j = 0; j < abdullahMayouf.getBirthPlaces().size(); j++) {
			if (abdullahMayouf.getBirthPlaces().get(j) != null) {
				birthPlaces.add(abdullahMayouf.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(abdullahMayouf.getBirthPlaces().get(j).getClass())
						.newInstance(abdullahMayouf.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (abdullahMayouf.getBirthYear() != null)
			this.birthYear = abdullahMayouf.getBirthYear().getClass()
					.getDeclaredConstructor(abdullahMayouf.getBirthYear().getClass())
					.newInstance(abdullahMayouf.getBirthYear());
		this.characterOffset = abdullahMayouf.getCharacterOffset();
		this.characterOnset = abdullahMayouf.getCharacterOnset();
		if (abdullahMayouf.getPosition() != null)
			this.position = abdullahMayouf.getPosition().getClass()
					.getDeclaredConstructor(abdullahMayouf.getPosition().getClass())
					.newInstance(abdullahMayouf.getPosition());
		for (int j = 0; j < abdullahMayouf.getTeams().size(); j++) {
			if (abdullahMayouf.getTeams().get(j) != null) {
				teams.add(abdullahMayouf.getTeams().get(j).getClass()
						.getDeclaredConstructor(abdullahMayouf.getTeams().get(j).getClass())
						.newInstance(abdullahMayouf.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "AbdullahMayouf [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear="
