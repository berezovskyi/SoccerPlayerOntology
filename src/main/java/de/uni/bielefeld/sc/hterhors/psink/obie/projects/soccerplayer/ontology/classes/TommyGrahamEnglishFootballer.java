...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.ITommyGrahamEnglishFootballer;
...
public class TommyGrahamEnglishFootballer implements ITommyGrahamEnglishFootballer {
	...
	public TommyGrahamEnglishFootballer(TommyGrahamEnglishFootballer tommyGrahamEnglishFootballer)
			throws InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException,
			NoSuchMethodException, SecurityException {
		this.annotationID = tommyGrahamEnglishFootballer.getAnnotationID();
		for (int j = 0; j < tommyGrahamEnglishFootballer.getBirthPlaces().size(); j++) {
			if (tommyGrahamEnglishFootballer.getBirthPlaces().get(j) != null) {
				birthPlaces.add(tommyGrahamEnglishFootballer.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(tommyGrahamEnglishFootballer.getBirthPlaces().get(j).getClass())
						.newInstance(tommyGrahamEnglishFootballer.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (tommyGrahamEnglishFootballer.getBirthYear() != null)
			this.birthYear = tommyGrahamEnglishFootballer.getBirthYear().getClass()
					.getDeclaredConstructor(tommyGrahamEnglishFootballer.getBirthYear().getClass())
					.newInstance(tommyGrahamEnglishFootballer.getBirthYear());
		...
		if (tommyGrahamEnglishFootballer.getPosition() != null)
			this.position = tommyGrahamEnglishFootballer.getPosition().getClass()
					.getDeclaredConstructor(tommyGrahamEnglishFootballer.getPosition().getClass())
					.newInstance(tommyGrahamEnglishFootballer.getPosition());
		for (int j = 0; j < tommyGrahamEnglishFootballer.getTeams().size(); j++) {
			if (tommyGrahamEnglishFootballer.getTeams().get(j) != null) {
				teams.add(tommyGrahamEnglishFootballer.getTeams().get(j).getClass()
						.getDeclaredConstructor(tommyGrahamEnglishFootballer.getTeams().get(j).getClass())
						.newInstance(tommyGrahamEnglishFootballer.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "TommyGrahamEnglishFootballer [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces
