...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IOliverGustafsson;
...
public class OliverGustafsson implements IOliverGustafsson {
	...
	public OliverGustafsson(OliverGustafsson oliverGustafsson) throws InstantiationException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		this.annotationID = oliverGustafsson.getAnnotationID();
		for (int j = 0; j < oliverGustafsson.getBirthPlaces().size(); j++) {
			if (oliverGustafsson.getBirthPlaces().get(j) != null) {
				birthPlaces.add(oliverGustafsson.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(oliverGustafsson.getBirthPlaces().get(j).getClass())
						.newInstance(oliverGustafsson.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (oliverGustafsson.getBirthYear() != null)
			this.birthYear = oliverGustafsson.getBirthYear().getClass()
					.getDeclaredConstructor(oliverGustafsson.getBirthYear().getClass())
					.newInstance(oliverGustafsson.getBirthYear());
		this.characterOffset = oliverGustafsson.getCharacterOffset();
		this.characterOnset = oliverGustafsson.getCharacterOnset();
		if (oliverGustafsson.getPosition() != null)
			this.position = oliverGustafsson.getPosition().getClass()
					.getDeclaredConstructor(oliverGustafsson.getPosition().getClass())
					.newInstance(oliverGustafsson.getPosition());
		for (int j = 0; j < oliverGustafsson.getTeams().size(); j++) {
			if (oliverGustafsson.getTeams().get(j) != null) {
				teams.add(oliverGustafsson.getTeams().get(j).getClass()
						.getDeclaredConstructor(oliverGustafsson.getTeams().get(j).getClass())
						.newInstance(oliverGustafsson.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "OliverGustafsson [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear="
