...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IDanielBentley;
...
public class DanielBentley implements IDanielBentley {
	...
	public DanielBentley(DanielBentley danielBentley) throws InstantiationException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		this.annotationID = danielBentley.getAnnotationID();
		for (int j = 0; j < danielBentley.getBirthPlaces().size(); j++) {
			if (danielBentley.getBirthPlaces().get(j) != null) {
				birthPlaces.add(danielBentley.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(danielBentley.getBirthPlaces().get(j).getClass())
						.newInstance(danielBentley.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (danielBentley.getBirthYear() != null)
			this.birthYear = danielBentley.getBirthYear().getClass()
					.getDeclaredConstructor(danielBentley.getBirthYear().getClass())
					.newInstance(danielBentley.getBirthYear());
		this.characterOffset = danielBentley.getCharacterOffset();
		this.characterOnset = danielBentley.getCharacterOnset();
		if (danielBentley.getPosition() != null)
			this.position = danielBentley.getPosition().getClass()
					.getDeclaredConstructor(danielBentley.getPosition().getClass())
					.newInstance(danielBentley.getPosition());
		for (int j = 0; j < danielBentley.getTeams().size(); j++) {
			if (danielBentley.getTeams().get(j) != null) {
				teams.add(danielBentley.getTeams().get(j).getClass()
						.getDeclaredConstructor(danielBentley.getTeams().get(j).getClass())
						.newInstance(danielBentley.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "DanielBentley [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear=" + birthYear
