...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IAbdulJabarHashimHanoon;
...
public class AbdulJabarHashimHanoon implements IAbdulJabarHashimHanoon {
	...
	public AbdulJabarHashimHanoon(AbdulJabarHashimHanoon abdulJabarHashimHanoon)
			throws InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException,
			NoSuchMethodException, SecurityException {
		this.annotationID = abdulJabarHashimHanoon.getAnnotationID();
		for (int j = 0; j < abdulJabarHashimHanoon.getBirthPlaces().size(); j++) {
			if (abdulJabarHashimHanoon.getBirthPlaces().get(j) != null) {
				birthPlaces.add(abdulJabarHashimHanoon.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(abdulJabarHashimHanoon.getBirthPlaces().get(j).getClass())
						.newInstance(abdulJabarHashimHanoon.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (abdulJabarHashimHanoon.getBirthYear() != null)
			this.birthYear = abdulJabarHashimHanoon.getBirthYear().getClass()
					.getDeclaredConstructor(abdulJabarHashimHanoon.getBirthYear().getClass())
					.newInstance(abdulJabarHashimHanoon.getBirthYear());
		...
		if (abdulJabarHashimHanoon.getPosition() != null)
			this.position = abdulJabarHashimHanoon.getPosition().getClass()
					.getDeclaredConstructor(abdulJabarHashimHanoon.getPosition().getClass())
					.newInstance(abdulJabarHashimHanoon.getPosition());
		for (int j = 0; j < abdulJabarHashimHanoon.getTeams().size(); j++) {
			if (abdulJabarHashimHanoon.getTeams().get(j) != null) {
				teams.add(abdulJabarHashimHanoon.getTeams().get(j).getClass()
						.getDeclaredConstructor(abdulJabarHashimHanoon.getTeams().get(j).getClass())
						.newInstance(abdulJabarHashimHanoon.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "AbdulJabarHashimHanoon [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear="
