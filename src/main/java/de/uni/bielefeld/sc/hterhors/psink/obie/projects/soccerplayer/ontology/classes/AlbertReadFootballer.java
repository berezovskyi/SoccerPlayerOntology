...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IAlbertReadFootballer;
...
public class AlbertReadFootballer implements IAlbertReadFootballer {
	...
	public AlbertReadFootballer(AlbertReadFootballer albertReadFootballer)
			throws InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException,
			NoSuchMethodException, SecurityException {
		this.annotationID = albertReadFootballer.getAnnotationID();
		for (int j = 0; j < albertReadFootballer.getBirthPlaces().size(); j++) {
			if (albertReadFootballer.getBirthPlaces().get(j) != null) {
				birthPlaces.add(albertReadFootballer.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(albertReadFootballer.getBirthPlaces().get(j).getClass())
						.newInstance(albertReadFootballer.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (albertReadFootballer.getBirthYear() != null)
			this.birthYear = albertReadFootballer.getBirthYear().getClass()
					.getDeclaredConstructor(albertReadFootballer.getBirthYear().getClass())
					.newInstance(albertReadFootballer.getBirthYear());
		this.characterOffset = albertReadFootballer.getCharacterOffset();
		this.characterOnset = albertReadFootballer.getCharacterOnset();
		if (albertReadFootballer.getPosition() != null)
			this.position = albertReadFootballer.getPosition().getClass()
					.getDeclaredConstructor(albertReadFootballer.getPosition().getClass())
					.newInstance(albertReadFootballer.getPosition());
		for (int j = 0; j < albertReadFootballer.getTeams().size(); j++) {
			if (albertReadFootballer.getTeams().get(j) != null) {
				teams.add(albertReadFootballer.getTeams().get(j).getClass()
						.getDeclaredConstructor(albertReadFootballer.getTeams().get(j).getClass())
						.newInstance(albertReadFootballer.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "AlbertReadFootballer [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear="
