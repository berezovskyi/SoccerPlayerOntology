...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IMarkTorrance;
...
public class MarkTorrance implements IMarkTorrance {
	...
	public MarkTorrance(MarkTorrance markTorrance) throws InstantiationException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		this.annotationID = markTorrance.getAnnotationID();
		for (int j = 0; j < markTorrance.getBirthPlaces().size(); j++) {
			if (markTorrance.getBirthPlaces().get(j) != null) {
				birthPlaces.add(markTorrance.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(markTorrance.getBirthPlaces().get(j).getClass())
						.newInstance(markTorrance.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (markTorrance.getBirthYear() != null)
			this.birthYear = markTorrance.getBirthYear().getClass()
					.getDeclaredConstructor(markTorrance.getBirthYear().getClass())
					.newInstance(markTorrance.getBirthYear());
		this.characterOffset = markTorrance.getCharacterOffset();
		this.characterOnset = markTorrance.getCharacterOnset();
		if (markTorrance.getPosition() != null)
			this.position = markTorrance.getPosition().getClass()
					.getDeclaredConstructor(markTorrance.getPosition().getClass())
					.newInstance(markTorrance.getPosition());
		for (int j = 0; j < markTorrance.getTeams().size(); j++) {
			if (markTorrance.getTeams().get(j) != null) {
				teams.add(markTorrance.getTeams().get(j).getClass()
						.getDeclaredConstructor(markTorrance.getTeams().get(j).getClass())
						.newInstance(markTorrance.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "MarkTorrance [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear=" + birthYear
