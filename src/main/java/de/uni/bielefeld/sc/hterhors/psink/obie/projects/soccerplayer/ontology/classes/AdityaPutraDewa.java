...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IAdityaPutraDewa;
...
public class AdityaPutraDewa implements IAdityaPutraDewa {
	...
	public AdityaPutraDewa(AdityaPutraDewa adityaPutraDewa) throws InstantiationException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		this.annotationID = adityaPutraDewa.getAnnotationID();
		for (int j = 0; j < adityaPutraDewa.getBirthPlaces().size(); j++) {
			if (adityaPutraDewa.getBirthPlaces().get(j) != null) {
				birthPlaces.add(adityaPutraDewa.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(adityaPutraDewa.getBirthPlaces().get(j).getClass())
						.newInstance(adityaPutraDewa.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (adityaPutraDewa.getBirthYear() != null)
			this.birthYear = adityaPutraDewa.getBirthYear().getClass()
					.getDeclaredConstructor(adityaPutraDewa.getBirthYear().getClass())
					.newInstance(adityaPutraDewa.getBirthYear());
		this.characterOffset = adityaPutraDewa.getCharacterOffset();
		this.characterOnset = adityaPutraDewa.getCharacterOnset();
		if (adityaPutraDewa.getPosition() != null)
			this.position = adityaPutraDewa.getPosition().getClass()
					.getDeclaredConstructor(adityaPutraDewa.getPosition().getClass())
					.newInstance(adityaPutraDewa.getPosition());
		for (int j = 0; j < adityaPutraDewa.getTeams().size(); j++) {
			if (adityaPutraDewa.getTeams().get(j) != null) {
				teams.add(adityaPutraDewa.getTeams().get(j).getClass()
						.getDeclaredConstructor(adityaPutraDewa.getTeams().get(j).getClass())
						.newInstance(adityaPutraDewa.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "AdityaPutraDewa [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear="
