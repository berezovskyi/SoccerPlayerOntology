...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IIvayloZafirov;
...
public class IvayloZafirov implements IIvayloZafirov {
	...
	public IvayloZafirov(IvayloZafirov ivayloZafirov) throws InstantiationException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		this.annotationID = ivayloZafirov.getAnnotationID();
		for (int j = 0; j < ivayloZafirov.getBirthPlaces().size(); j++) {
			if (ivayloZafirov.getBirthPlaces().get(j) != null) {
				birthPlaces.add(ivayloZafirov.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(ivayloZafirov.getBirthPlaces().get(j).getClass())
						.newInstance(ivayloZafirov.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (ivayloZafirov.getBirthYear() != null)
			this.birthYear = ivayloZafirov.getBirthYear().getClass()
					.getDeclaredConstructor(ivayloZafirov.getBirthYear().getClass())
					.newInstance(ivayloZafirov.getBirthYear());
		this.characterOffset = ivayloZafirov.getCharacterOffset();
		this.characterOnset = ivayloZafirov.getCharacterOnset();
		if (ivayloZafirov.getPosition() != null)
			this.position = ivayloZafirov.getPosition().getClass()
					.getDeclaredConstructor(ivayloZafirov.getPosition().getClass())
					.newInstance(ivayloZafirov.getPosition());
		for (int j = 0; j < ivayloZafirov.getTeams().size(); j++) {
			if (ivayloZafirov.getTeams().get(j) != null) {
				teams.add(ivayloZafirov.getTeams().get(j).getClass()
						.getDeclaredConstructor(ivayloZafirov.getTeams().get(j).getClass())
						.newInstance(ivayloZafirov.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "IvayloZafirov [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear=" + birthYear
