...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IDenisLindsayFootballer;
...
public class DenisLindsayFootballer implements IDenisLindsayFootballer {
	...
	public DenisLindsayFootballer(DenisLindsayFootballer denisLindsayFootballer)
			throws InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException,
			NoSuchMethodException, SecurityException {
		this.annotationID = denisLindsayFootballer.getAnnotationID();
		for (int j = 0; j < denisLindsayFootballer.getBirthPlaces().size(); j++) {
			if (denisLindsayFootballer.getBirthPlaces().get(j) != null) {
				birthPlaces.add(denisLindsayFootballer.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(denisLindsayFootballer.getBirthPlaces().get(j).getClass())
						.newInstance(denisLindsayFootballer.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (denisLindsayFootballer.getBirthYear() != null)
			this.birthYear = denisLindsayFootballer.getBirthYear().getClass()
					.getDeclaredConstructor(denisLindsayFootballer.getBirthYear().getClass())
					.newInstance(denisLindsayFootballer.getBirthYear());
		...
		if (denisLindsayFootballer.getPosition() != null)
			this.position = denisLindsayFootballer.getPosition().getClass()
					.getDeclaredConstructor(denisLindsayFootballer.getPosition().getClass())
					.newInstance(denisLindsayFootballer.getPosition());
		for (int j = 0; j < denisLindsayFootballer.getTeams().size(); j++) {
			if (denisLindsayFootballer.getTeams().get(j) != null) {
				teams.add(denisLindsayFootballer.getTeams().get(j).getClass()
						.getDeclaredConstructor(denisLindsayFootballer.getTeams().get(j).getClass())
						.newInstance(denisLindsayFootballer.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "DenisLindsayFootballer [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear="
