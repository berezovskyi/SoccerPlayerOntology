...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.ITomBrooksFootballer;
...
public class TomBrooksFootballer implements ITomBrooksFootballer {
	...
	public TomBrooksFootballer(TomBrooksFootballer tomBrooksFootballer)
			throws InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException,
			NoSuchMethodException, SecurityException {
		this.annotationID = tomBrooksFootballer.getAnnotationID();
		for (int j = 0; j < tomBrooksFootballer.getBirthPlaces().size(); j++) {
			if (tomBrooksFootballer.getBirthPlaces().get(j) != null) {
				birthPlaces.add(tomBrooksFootballer.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(tomBrooksFootballer.getBirthPlaces().get(j).getClass())
						.newInstance(tomBrooksFootballer.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (tomBrooksFootballer.getBirthYear() != null)
			this.birthYear = tomBrooksFootballer.getBirthYear().getClass()
					.getDeclaredConstructor(tomBrooksFootballer.getBirthYear().getClass())
					.newInstance(tomBrooksFootballer.getBirthYear());
		this.characterOffset = tomBrooksFootballer.getCharacterOffset();
		this.characterOnset = tomBrooksFootballer.getCharacterOnset();
		if (tomBrooksFootballer.getPosition() != null)
			this.position = tomBrooksFootballer.getPosition().getClass()
					.getDeclaredConstructor(tomBrooksFootballer.getPosition().getClass())
					.newInstance(tomBrooksFootballer.getPosition());
		for (int j = 0; j < tomBrooksFootballer.getTeams().size(); j++) {
			if (tomBrooksFootballer.getTeams().get(j) != null) {
				teams.add(tomBrooksFootballer.getTeams().get(j).getClass()
						.getDeclaredConstructor(tomBrooksFootballer.getTeams().get(j).getClass())
						.newInstance(tomBrooksFootballer.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "TomBrooksFootballer [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear="
