...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IJosefMajer;
...
public class JosefMajer implements IJosefMajer {
	...
	public JosefMajer(JosefMajer josefMajer) throws InstantiationException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		this.annotationID = josefMajer.getAnnotationID();
		for (int j = 0; j < josefMajer.getBirthPlaces().size(); j++) {
			if (josefMajer.getBirthPlaces().get(j) != null) {
				birthPlaces.add(josefMajer.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(josefMajer.getBirthPlaces().get(j).getClass())
						.newInstance(josefMajer.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (josefMajer.getBirthYear() != null)
			this.birthYear = josefMajer.getBirthYear().getClass()
					.getDeclaredConstructor(josefMajer.getBirthYear().getClass())
					.newInstance(josefMajer.getBirthYear());
		this.characterOffset = josefMajer.getCharacterOffset();
		this.characterOnset = josefMajer.getCharacterOnset();
		if (josefMajer.getPosition() != null)
			this.position = josefMajer.getPosition().getClass()
					.getDeclaredConstructor(josefMajer.getPosition().getClass()).newInstance(josefMajer.getPosition());
		for (int j = 0; j < josefMajer.getTeams().size(); j++) {
			if (josefMajer.getTeams().get(j) != null) {
				teams.add(josefMajer.getTeams().get(j).getClass()
						.getDeclaredConstructor(josefMajer.getTeams().get(j).getClass())
						.newInstance(josefMajer.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "JosefMajer [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear=" + birthYear
