...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IKarlErikGrahn;
...
public class KarlErikGrahn implements IKarlErikGrahn {
	...
	public KarlErikGrahn(KarlErikGrahn karlErikGrahn) throws InstantiationException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		this.annotationID = karlErikGrahn.getAnnotationID();
		for (int j = 0; j < karlErikGrahn.getBirthPlaces().size(); j++) {
			if (karlErikGrahn.getBirthPlaces().get(j) != null) {
				birthPlaces.add(karlErikGrahn.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(karlErikGrahn.getBirthPlaces().get(j).getClass())
						.newInstance(karlErikGrahn.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (karlErikGrahn.getBirthYear() != null)
			this.birthYear = karlErikGrahn.getBirthYear().getClass()
					.getDeclaredConstructor(karlErikGrahn.getBirthYear().getClass())
					.newInstance(karlErikGrahn.getBirthYear());
		this.characterOffset = karlErikGrahn.getCharacterOffset();
		this.characterOnset = karlErikGrahn.getCharacterOnset();
		if (karlErikGrahn.getPosition() != null)
			this.position = karlErikGrahn.getPosition().getClass()
					.getDeclaredConstructor(karlErikGrahn.getPosition().getClass())
					.newInstance(karlErikGrahn.getPosition());
		for (int j = 0; j < karlErikGrahn.getTeams().size(); j++) {
			if (karlErikGrahn.getTeams().get(j) != null) {
				teams.add(karlErikGrahn.getTeams().get(j).getClass()
						.getDeclaredConstructor(karlErikGrahn.getTeams().get(j).getClass())
						.newInstance(karlErikGrahn.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "KarlErikGrahn [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear=" + birthYear
