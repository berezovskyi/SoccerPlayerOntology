...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.ITrevorHarrisFootballer;
...
public class TrevorHarrisFootballer implements ITrevorHarrisFootballer {
	...
	public TrevorHarrisFootballer(TrevorHarrisFootballer trevorHarrisFootballer)
			throws InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException,
			NoSuchMethodException, SecurityException {
		this.annotationID = trevorHarrisFootballer.getAnnotationID();
		for (int j = 0; j < trevorHarrisFootballer.getBirthPlaces().size(); j++) {
			if (trevorHarrisFootballer.getBirthPlaces().get(j) != null) {
				birthPlaces.add(trevorHarrisFootballer.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(trevorHarrisFootballer.getBirthPlaces().get(j).getClass())
						.newInstance(trevorHarrisFootballer.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (trevorHarrisFootballer.getBirthYear() != null)
			this.birthYear = trevorHarrisFootballer.getBirthYear().getClass()
					.getDeclaredConstructor(trevorHarrisFootballer.getBirthYear().getClass())
					.newInstance(trevorHarrisFootballer.getBirthYear());
		...
		if (trevorHarrisFootballer.getPosition() != null)
			this.position = trevorHarrisFootballer.getPosition().getClass()
					.getDeclaredConstructor(trevorHarrisFootballer.getPosition().getClass())
					.newInstance(trevorHarrisFootballer.getPosition());
		for (int j = 0; j < trevorHarrisFootballer.getTeams().size(); j++) {
			if (trevorHarrisFootballer.getTeams().get(j) != null) {
				teams.add(trevorHarrisFootballer.getTeams().get(j).getClass()
						.getDeclaredConstructor(trevorHarrisFootballer.getTeams().get(j).getClass())
						.newInstance(trevorHarrisFootballer.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "TrevorHarrisFootballer [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear="
