...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IHugoSeixas;
...
public class HugoSeixas implements IHugoSeixas {
	...
	public HugoSeixas(HugoSeixas hugoSeixas) throws InstantiationException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		this.annotationID = hugoSeixas.getAnnotationID();
		for (int j = 0; j < hugoSeixas.getBirthPlaces().size(); j++) {
			if (hugoSeixas.getBirthPlaces().get(j) != null) {
				birthPlaces.add(hugoSeixas.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(hugoSeixas.getBirthPlaces().get(j).getClass())
						.newInstance(hugoSeixas.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (hugoSeixas.getBirthYear() != null)
			this.birthYear = hugoSeixas.getBirthYear().getClass()
					.getDeclaredConstructor(hugoSeixas.getBirthYear().getClass())
					.newInstance(hugoSeixas.getBirthYear());
		this.characterOffset = hugoSeixas.getCharacterOffset();
		this.characterOnset = hugoSeixas.getCharacterOnset();
		if (hugoSeixas.getPosition() != null)
			this.position = hugoSeixas.getPosition().getClass()
					.getDeclaredConstructor(hugoSeixas.getPosition().getClass()).newInstance(hugoSeixas.getPosition());
		for (int j = 0; j < hugoSeixas.getTeams().size(); j++) {
			if (hugoSeixas.getTeams().get(j) != null) {
				teams.add(hugoSeixas.getTeams().get(j).getClass()
						.getDeclaredConstructor(hugoSeixas.getTeams().get(j).getClass())
						.newInstance(hugoSeixas.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "HugoSeixas [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear=" + birthYear
