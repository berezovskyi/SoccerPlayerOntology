...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IHussainAlRomaihi;
...
public class HussainAlRomaihi implements IHussainAlRomaihi {
	...
	public HussainAlRomaihi(HussainAlRomaihi hussainAlRomaihi) throws InstantiationException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		this.annotationID = hussainAlRomaihi.getAnnotationID();
		for (int j = 0; j < hussainAlRomaihi.getBirthPlaces().size(); j++) {
			if (hussainAlRomaihi.getBirthPlaces().get(j) != null) {
				birthPlaces.add(hussainAlRomaihi.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(hussainAlRomaihi.getBirthPlaces().get(j).getClass())
						.newInstance(hussainAlRomaihi.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (hussainAlRomaihi.getBirthYear() != null)
			this.birthYear = hussainAlRomaihi.getBirthYear().getClass()
					.getDeclaredConstructor(hussainAlRomaihi.getBirthYear().getClass())
					.newInstance(hussainAlRomaihi.getBirthYear());
		this.characterOffset = hussainAlRomaihi.getCharacterOffset();
		this.characterOnset = hussainAlRomaihi.getCharacterOnset();
		if (hussainAlRomaihi.getPosition() != null)
			this.position = hussainAlRomaihi.getPosition().getClass()
					.getDeclaredConstructor(hussainAlRomaihi.getPosition().getClass())
					.newInstance(hussainAlRomaihi.getPosition());
		for (int j = 0; j < hussainAlRomaihi.getTeams().size(); j++) {
			if (hussainAlRomaihi.getTeams().get(j) != null) {
				teams.add(hussainAlRomaihi.getTeams().get(j).getClass()
						.getDeclaredConstructor(hussainAlRomaihi.getTeams().get(j).getClass())
						.newInstance(hussainAlRomaihi.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "HussainAlRomaihi [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear="
