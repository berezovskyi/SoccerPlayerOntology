...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.ITysonCaiado;
...
public class TysonCaiado implements ITysonCaiado {
	...
	public TysonCaiado(TysonCaiado tysonCaiado) throws InstantiationException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		this.annotationID = tysonCaiado.getAnnotationID();
		for (int j = 0; j < tysonCaiado.getBirthPlaces().size(); j++) {
			if (tysonCaiado.getBirthPlaces().get(j) != null) {
				birthPlaces.add(tysonCaiado.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(tysonCaiado.getBirthPlaces().get(j).getClass())
						.newInstance(tysonCaiado.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (tysonCaiado.getBirthYear() != null)
			this.birthYear = tysonCaiado.getBirthYear().getClass()
					.getDeclaredConstructor(tysonCaiado.getBirthYear().getClass())
					.newInstance(tysonCaiado.getBirthYear());
		this.characterOffset = tysonCaiado.getCharacterOffset();
		this.characterOnset = tysonCaiado.getCharacterOnset();
		if (tysonCaiado.getPosition() != null)
			this.position = tysonCaiado.getPosition().getClass()
					.getDeclaredConstructor(tysonCaiado.getPosition().getClass())
					.newInstance(tysonCaiado.getPosition());
		for (int j = 0; j < tysonCaiado.getTeams().size(); j++) {
			if (tysonCaiado.getTeams().get(j) != null) {
				teams.add(tysonCaiado.getTeams().get(j).getClass()
						.getDeclaredConstructor(tysonCaiado.getTeams().get(j).getClass())
						.newInstance(tysonCaiado.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "TysonCaiado [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear=" + birthYear
