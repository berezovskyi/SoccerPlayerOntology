...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IDowlynDaly;
...
public class DowlynDaly implements IDowlynDaly {
	...
	public DowlynDaly(DowlynDaly dowlynDaly) throws InstantiationException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		this.annotationID = dowlynDaly.getAnnotationID();
		for (int j = 0; j < dowlynDaly.getBirthPlaces().size(); j++) {
			if (dowlynDaly.getBirthPlaces().get(j) != null) {
				birthPlaces.add(dowlynDaly.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(dowlynDaly.getBirthPlaces().get(j).getClass())
						.newInstance(dowlynDaly.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (dowlynDaly.getBirthYear() != null)
			this.birthYear = dowlynDaly.getBirthYear().getClass()
					.getDeclaredConstructor(dowlynDaly.getBirthYear().getClass())
					.newInstance(dowlynDaly.getBirthYear());
		this.characterOffset = dowlynDaly.getCharacterOffset();
		this.characterOnset = dowlynDaly.getCharacterOnset();
		if (dowlynDaly.getPosition() != null)
			this.position = dowlynDaly.getPosition().getClass()
					.getDeclaredConstructor(dowlynDaly.getPosition().getClass()).newInstance(dowlynDaly.getPosition());
		for (int j = 0; j < dowlynDaly.getTeams().size(); j++) {
			if (dowlynDaly.getTeams().get(j) != null) {
				teams.add(dowlynDaly.getTeams().get(j).getClass()
						.getDeclaredConstructor(dowlynDaly.getTeams().get(j).getClass())
						.newInstance(dowlynDaly.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "DowlynDaly [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear=" + birthYear
