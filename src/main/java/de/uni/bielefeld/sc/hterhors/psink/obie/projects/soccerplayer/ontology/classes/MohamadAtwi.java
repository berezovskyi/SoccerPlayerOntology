...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IMohamadAtwi;
...
public class MohamadAtwi implements IMohamadAtwi {
	...
	public MohamadAtwi(MohamadAtwi mohamadAtwi) throws InstantiationException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		this.annotationID = mohamadAtwi.getAnnotationID();
		for (int j = 0; j < mohamadAtwi.getBirthPlaces().size(); j++) {
			if (mohamadAtwi.getBirthPlaces().get(j) != null) {
				birthPlaces.add(mohamadAtwi.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(mohamadAtwi.getBirthPlaces().get(j).getClass())
						.newInstance(mohamadAtwi.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (mohamadAtwi.getBirthYear() != null)
			this.birthYear = mohamadAtwi.getBirthYear().getClass()
					.getDeclaredConstructor(mohamadAtwi.getBirthYear().getClass())
					.newInstance(mohamadAtwi.getBirthYear());
		this.characterOffset = mohamadAtwi.getCharacterOffset();
		this.characterOnset = mohamadAtwi.getCharacterOnset();
		if (mohamadAtwi.getPosition() != null)
			this.position = mohamadAtwi.getPosition().getClass()
					.getDeclaredConstructor(mohamadAtwi.getPosition().getClass())
					.newInstance(mohamadAtwi.getPosition());
		for (int j = 0; j < mohamadAtwi.getTeams().size(); j++) {
			if (mohamadAtwi.getTeams().get(j) != null) {
				teams.add(mohamadAtwi.getTeams().get(j).getClass()
						.getDeclaredConstructor(mohamadAtwi.getTeams().get(j).getClass())
						.newInstance(mohamadAtwi.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "MohamadAtwi [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear=" + birthYear
