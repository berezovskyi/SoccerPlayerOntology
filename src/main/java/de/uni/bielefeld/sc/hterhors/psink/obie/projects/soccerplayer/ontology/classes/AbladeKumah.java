...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IAbladeKumah;
...
public class AbladeKumah implements IAbladeKumah {
	...
	public AbladeKumah(AbladeKumah abladeKumah) throws InstantiationException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		this.annotationID = abladeKumah.getAnnotationID();
		for (int j = 0; j < abladeKumah.getBirthPlaces().size(); j++) {
			if (abladeKumah.getBirthPlaces().get(j) != null) {
				birthPlaces.add(abladeKumah.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(abladeKumah.getBirthPlaces().get(j).getClass())
						.newInstance(abladeKumah.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (abladeKumah.getBirthYear() != null)
			this.birthYear = abladeKumah.getBirthYear().getClass()
					.getDeclaredConstructor(abladeKumah.getBirthYear().getClass())
					.newInstance(abladeKumah.getBirthYear());
		this.characterOffset = abladeKumah.getCharacterOffset();
		this.characterOnset = abladeKumah.getCharacterOnset();
		if (abladeKumah.getPosition() != null)
			this.position = abladeKumah.getPosition().getClass()
					.getDeclaredConstructor(abladeKumah.getPosition().getClass())
					.newInstance(abladeKumah.getPosition());
		for (int j = 0; j < abladeKumah.getTeams().size(); j++) {
			if (abladeKumah.getTeams().get(j) != null) {
				teams.add(abladeKumah.getTeams().get(j).getClass()
						.getDeclaredConstructor(abladeKumah.getTeams().get(j).getClass())
						.newInstance(abladeKumah.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "AbladeKumah [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear=" + birthYear
