...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IAbdelhamidSadmi;
...
public class AbdelhamidSadmi implements IAbdelhamidSadmi {
	...
	public AbdelhamidSadmi(AbdelhamidSadmi abdelhamidSadmi) throws InstantiationException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		this.annotationID = abdelhamidSadmi.getAnnotationID();
		for (int j = 0; j < abdelhamidSadmi.getBirthPlaces().size(); j++) {
			if (abdelhamidSadmi.getBirthPlaces().get(j) != null) {
				birthPlaces.add(abdelhamidSadmi.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(abdelhamidSadmi.getBirthPlaces().get(j).getClass())
						.newInstance(abdelhamidSadmi.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (abdelhamidSadmi.getBirthYear() != null)
			this.birthYear = abdelhamidSadmi.getBirthYear().getClass()
					.getDeclaredConstructor(abdelhamidSadmi.getBirthYear().getClass())
					.newInstance(abdelhamidSadmi.getBirthYear());
		this.characterOffset = abdelhamidSadmi.getCharacterOffset();
		this.characterOnset = abdelhamidSadmi.getCharacterOnset();
		if (abdelhamidSadmi.getPosition() != null)
			this.position = abdelhamidSadmi.getPosition().getClass()
					.getDeclaredConstructor(abdelhamidSadmi.getPosition().getClass())
					.newInstance(abdelhamidSadmi.getPosition());
		for (int j = 0; j < abdelhamidSadmi.getTeams().size(); j++) {
			if (abdelhamidSadmi.getTeams().get(j) != null) {
				teams.add(abdelhamidSadmi.getTeams().get(j).getClass()
						.getDeclaredConstructor(abdelhamidSadmi.getTeams().get(j).getClass())
						.newInstance(abdelhamidSadmi.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "AbdelhamidSadmi [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear="
