...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IAugustyBartillard;
...
public class AugustyBartillard implements IAugustyBartillard {
	...
	public AugustyBartillard(AugustyBartillard augustyBartillard) throws InstantiationException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		this.annotationID = augustyBartillard.getAnnotationID();
		for (int j = 0; j < augustyBartillard.getBirthPlaces().size(); j++) {
			if (augustyBartillard.getBirthPlaces().get(j) != null) {
				birthPlaces.add(augustyBartillard.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(augustyBartillard.getBirthPlaces().get(j).getClass())
						.newInstance(augustyBartillard.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (augustyBartillard.getBirthYear() != null)
			this.birthYear = augustyBartillard.getBirthYear().getClass()
					.getDeclaredConstructor(augustyBartillard.getBirthYear().getClass())
					.newInstance(augustyBartillard.getBirthYear());
		this.characterOffset = augustyBartillard.getCharacterOffset();
		this.characterOnset = augustyBartillard.getCharacterOnset();
		if (augustyBartillard.getPosition() != null)
			this.position = augustyBartillard.getPosition().getClass()
					.getDeclaredConstructor(augustyBartillard.getPosition().getClass())
					.newInstance(augustyBartillard.getPosition());
		for (int j = 0; j < augustyBartillard.getTeams().size(); j++) {
			if (augustyBartillard.getTeams().get(j) != null) {
				teams.add(augustyBartillard.getTeams().get(j).getClass()
						.getDeclaredConstructor(augustyBartillard.getTeams().get(j).getClass())
						.newInstance(augustyBartillard.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "AugustyBartillard [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear="
