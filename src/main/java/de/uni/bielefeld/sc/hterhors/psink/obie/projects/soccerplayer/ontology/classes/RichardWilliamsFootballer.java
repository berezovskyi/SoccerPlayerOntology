...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IRichardWilliamsFootballer;
...
public class RichardWilliamsFootballer implements IRichardWilliamsFootballer {
	...
	public RichardWilliamsFootballer(RichardWilliamsFootballer richardWilliamsFootballer)
			throws InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException,
			NoSuchMethodException, SecurityException {
		this.annotationID = richardWilliamsFootballer.getAnnotationID();
		for (int j = 0; j < richardWilliamsFootballer.getBirthPlaces().size(); j++) {
			if (richardWilliamsFootballer.getBirthPlaces().get(j) != null) {
				birthPlaces.add(richardWilliamsFootballer.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(richardWilliamsFootballer.getBirthPlaces().get(j).getClass())
						.newInstance(richardWilliamsFootballer.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (richardWilliamsFootballer.getBirthYear() != null)
			this.birthYear = richardWilliamsFootballer.getBirthYear().getClass()
					.getDeclaredConstructor(richardWilliamsFootballer.getBirthYear().getClass())
					.newInstance(richardWilliamsFootballer.getBirthYear());
		...
		if (richardWilliamsFootballer.getPosition() != null)
			this.position = richardWilliamsFootballer.getPosition().getClass()
					.getDeclaredConstructor(richardWilliamsFootballer.getPosition().getClass())
					.newInstance(richardWilliamsFootballer.getPosition());
		for (int j = 0; j < richardWilliamsFootballer.getTeams().size(); j++) {
			if (richardWilliamsFootballer.getTeams().get(j) != null) {
				teams.add(richardWilliamsFootballer.getTeams().get(j).getClass()
						.getDeclaredConstructor(richardWilliamsFootballer.getTeams().get(j).getClass())
						.newInstance(richardWilliamsFootballer.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "RichardWilliamsFootballer [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear="
