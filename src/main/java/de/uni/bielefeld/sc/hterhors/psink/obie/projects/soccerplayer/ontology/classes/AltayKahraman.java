...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IAltayKahraman;
...
public class AltayKahraman implements IAltayKahraman {
	...
	public AltayKahraman(AltayKahraman altayKahraman) throws InstantiationException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		this.annotationID = altayKahraman.getAnnotationID();
		for (int j = 0; j < altayKahraman.getBirthPlaces().size(); j++) {
			if (altayKahraman.getBirthPlaces().get(j) != null) {
				birthPlaces.add(altayKahraman.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(altayKahraman.getBirthPlaces().get(j).getClass())
						.newInstance(altayKahraman.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (altayKahraman.getBirthYear() != null)
			this.birthYear = altayKahraman.getBirthYear().getClass()
					.getDeclaredConstructor(altayKahraman.getBirthYear().getClass())
					.newInstance(altayKahraman.getBirthYear());
		this.characterOffset = altayKahraman.getCharacterOffset();
		this.characterOnset = altayKahraman.getCharacterOnset();
		if (altayKahraman.getPosition() != null)
			this.position = altayKahraman.getPosition().getClass()
					.getDeclaredConstructor(altayKahraman.getPosition().getClass())
					.newInstance(altayKahraman.getPosition());
		for (int j = 0; j < altayKahraman.getTeams().size(); j++) {
			if (altayKahraman.getTeams().get(j) != null) {
				teams.add(altayKahraman.getTeams().get(j).getClass()
						.getDeclaredConstructor(altayKahraman.getTeams().get(j).getClass())
						.newInstance(altayKahraman.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "AltayKahraman [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear=" + birthYear
