...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IKeSeungWoon;
...
public class KeSeungWoon implements IKeSeungWoon {
	...
	public KeSeungWoon(KeSeungWoon keSeungWoon) throws InstantiationException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		this.annotationID = keSeungWoon.getAnnotationID();
		for (int j = 0; j < keSeungWoon.getBirthPlaces().size(); j++) {
			if (keSeungWoon.getBirthPlaces().get(j) != null) {
				birthPlaces.add(keSeungWoon.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(keSeungWoon.getBirthPlaces().get(j).getClass())
						.newInstance(keSeungWoon.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (keSeungWoon.getBirthYear() != null)
			this.birthYear = keSeungWoon.getBirthYear().getClass()
					.getDeclaredConstructor(keSeungWoon.getBirthYear().getClass())
					.newInstance(keSeungWoon.getBirthYear());
		this.characterOffset = keSeungWoon.getCharacterOffset();
		this.characterOnset = keSeungWoon.getCharacterOnset();
		if (keSeungWoon.getPosition() != null)
			this.position = keSeungWoon.getPosition().getClass()
					.getDeclaredConstructor(keSeungWoon.getPosition().getClass())
					.newInstance(keSeungWoon.getPosition());
		for (int j = 0; j < keSeungWoon.getTeams().size(); j++) {
			if (keSeungWoon.getTeams().get(j) != null) {
				teams.add(keSeungWoon.getTeams().get(j).getClass()
						.getDeclaredConstructor(keSeungWoon.getTeams().get(j).getClass())
						.newInstance(keSeungWoon.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "KeSeungWoon [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear=" + birthYear
