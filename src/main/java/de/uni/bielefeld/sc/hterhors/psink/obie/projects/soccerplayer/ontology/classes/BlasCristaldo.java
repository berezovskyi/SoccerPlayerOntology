...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IBlasCristaldo;
...
public class BlasCristaldo implements IBlasCristaldo {
	...
	public BlasCristaldo(BlasCristaldo blasCristaldo) throws InstantiationException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		this.annotationID = blasCristaldo.getAnnotationID();
		for (int j = 0; j < blasCristaldo.getBirthPlaces().size(); j++) {
			if (blasCristaldo.getBirthPlaces().get(j) != null) {
				birthPlaces.add(blasCristaldo.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(blasCristaldo.getBirthPlaces().get(j).getClass())
						.newInstance(blasCristaldo.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (blasCristaldo.getBirthYear() != null)
			this.birthYear = blasCristaldo.getBirthYear().getClass()
					.getDeclaredConstructor(blasCristaldo.getBirthYear().getClass())
					.newInstance(blasCristaldo.getBirthYear());
		this.characterOffset = blasCristaldo.getCharacterOffset();
		this.characterOnset = blasCristaldo.getCharacterOnset();
		if (blasCristaldo.getPosition() != null)
			this.position = blasCristaldo.getPosition().getClass()
					.getDeclaredConstructor(blasCristaldo.getPosition().getClass())
					.newInstance(blasCristaldo.getPosition());
		for (int j = 0; j < blasCristaldo.getTeams().size(); j++) {
			if (blasCristaldo.getTeams().get(j) != null) {
				teams.add(blasCristaldo.getTeams().get(j).getClass()
						.getDeclaredConstructor(blasCristaldo.getTeams().get(j).getClass())
						.newInstance(blasCristaldo.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "BlasCristaldo [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear=" + birthYear
