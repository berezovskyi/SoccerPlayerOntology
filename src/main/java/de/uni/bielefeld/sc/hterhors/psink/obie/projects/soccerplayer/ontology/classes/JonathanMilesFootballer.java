...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IJonathanMilesFootballer;
...
public class JonathanMilesFootballer implements IJonathanMilesFootballer {
	...
	public JonathanMilesFootballer(JonathanMilesFootballer jonathanMilesFootballer)
			throws InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException,
			NoSuchMethodException, SecurityException {
		this.annotationID = jonathanMilesFootballer.getAnnotationID();
		for (int j = 0; j < jonathanMilesFootballer.getBirthPlaces().size(); j++) {
			if (jonathanMilesFootballer.getBirthPlaces().get(j) != null) {
				birthPlaces.add(jonathanMilesFootballer.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(jonathanMilesFootballer.getBirthPlaces().get(j).getClass())
						.newInstance(jonathanMilesFootballer.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (jonathanMilesFootballer.getBirthYear() != null)
			this.birthYear = jonathanMilesFootballer.getBirthYear().getClass()
					.getDeclaredConstructor(jonathanMilesFootballer.getBirthYear().getClass())
					.newInstance(jonathanMilesFootballer.getBirthYear());
		...
		if (jonathanMilesFootballer.getPosition() != null)
			this.position = jonathanMilesFootballer.getPosition().getClass()
					.getDeclaredConstructor(jonathanMilesFootballer.getPosition().getClass())
					.newInstance(jonathanMilesFootballer.getPosition());
		for (int j = 0; j < jonathanMilesFootballer.getTeams().size(); j++) {
			if (jonathanMilesFootballer.getTeams().get(j) != null) {
				teams.add(jonathanMilesFootballer.getTeams().get(j).getClass()
						.getDeclaredConstructor(jonathanMilesFootballer.getTeams().get(j).getClass())
						.newInstance(jonathanMilesFootballer.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "JonathanMilesFootballer [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear="
