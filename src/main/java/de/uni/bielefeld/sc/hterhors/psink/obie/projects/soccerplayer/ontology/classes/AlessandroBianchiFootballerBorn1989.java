...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IAlessandroBianchiFootballerBorn1989;
...
public class AlessandroBianchiFootballerBorn1989 implements IAlessandroBianchiFootballerBorn1989 {
	...
	public AlessandroBianchiFootballerBorn1989(AlessandroBianchiFootballerBorn1989 alessandroBianchiFootballerBorn1989)
			throws InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException,
			NoSuchMethodException, SecurityException {
		this.annotationID = alessandroBianchiFootballerBorn1989.getAnnotationID();
		for (int j = 0; j < alessandroBianchiFootballerBorn1989.getBirthPlaces().size(); j++) {
			if (alessandroBianchiFootballerBorn1989.getBirthPlaces().get(j) != null) {
				birthPlaces.add(alessandroBianchiFootballerBorn1989.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(alessandroBianchiFootballerBorn1989.getBirthPlaces().get(j).getClass())
						.newInstance(alessandroBianchiFootballerBorn1989.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (alessandroBianchiFootballerBorn1989.getBirthYear() != null)
			this.birthYear = alessandroBianchiFootballerBorn1989.getBirthYear().getClass()
					.getDeclaredConstructor(alessandroBianchiFootballerBorn1989.getBirthYear().getClass())
					.newInstance(alessandroBianchiFootballerBorn1989.getBirthYear());
		...
		if (alessandroBianchiFootballerBorn1989.getPosition() != null)
			this.position = alessandroBianchiFootballerBorn1989.getPosition().getClass()
					.getDeclaredConstructor(alessandroBianchiFootballerBorn1989.getPosition().getClass())
					.newInstance(alessandroBianchiFootballerBorn1989.getPosition());
		for (int j = 0; j < alessandroBianchiFootballerBorn1989.getTeams().size(); j++) {
			if (alessandroBianchiFootballerBorn1989.getTeams().get(j) != null) {
				teams.add(alessandroBianchiFootballerBorn1989.getTeams().get(j).getClass()
						.getDeclaredConstructor(alessandroBianchiFootballerBorn1989.getTeams().get(j).getClass())
						.newInstance(alessandroBianchiFootballerBorn1989.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "AlessandroBianchiFootballerBorn1989 [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces
