...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IMohamedBenMouza;
...
public class MohamedBenMouza implements IMohamedBenMouza {
	...
	public MohamedBenMouza(MohamedBenMouza mohamedBenMouza) throws InstantiationException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		this.annotationID = mohamedBenMouza.getAnnotationID();
		for (int j = 0; j < mohamedBenMouza.getBirthPlaces().size(); j++) {
			if (mohamedBenMouza.getBirthPlaces().get(j) != null) {
				birthPlaces.add(mohamedBenMouza.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(mohamedBenMouza.getBirthPlaces().get(j).getClass())
						.newInstance(mohamedBenMouza.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (mohamedBenMouza.getBirthYear() != null)
			this.birthYear = mohamedBenMouza.getBirthYear().getClass()
					.getDeclaredConstructor(mohamedBenMouza.getBirthYear().getClass())
					.newInstance(mohamedBenMouza.getBirthYear());
		this.characterOffset = mohamedBenMouza.getCharacterOffset();
		this.characterOnset = mohamedBenMouza.getCharacterOnset();
		if (mohamedBenMouza.getPosition() != null)
			this.position = mohamedBenMouza.getPosition().getClass()
					.getDeclaredConstructor(mohamedBenMouza.getPosition().getClass())
					.newInstance(mohamedBenMouza.getPosition());
		for (int j = 0; j < mohamedBenMouza.getTeams().size(); j++) {
			if (mohamedBenMouza.getTeams().get(j) != null) {
				teams.add(mohamedBenMouza.getTeams().get(j).getClass()
						.getDeclaredConstructor(mohamedBenMouza.getTeams().get(j).getClass())
						.newInstance(mohamedBenMouza.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "MohamedBenMouza [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear="
