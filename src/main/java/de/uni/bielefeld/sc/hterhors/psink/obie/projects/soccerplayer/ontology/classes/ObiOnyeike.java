...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IObiOnyeike;
...
public class ObiOnyeike implements IObiOnyeike {
	...
	public ObiOnyeike(ObiOnyeike obiOnyeike) throws InstantiationException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		this.annotationID = obiOnyeike.getAnnotationID();
		for (int j = 0; j < obiOnyeike.getBirthPlaces().size(); j++) {
			if (obiOnyeike.getBirthPlaces().get(j) != null) {
				birthPlaces.add(obiOnyeike.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(obiOnyeike.getBirthPlaces().get(j).getClass())
						.newInstance(obiOnyeike.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (obiOnyeike.getBirthYear() != null)
			this.birthYear = obiOnyeike.getBirthYear().getClass()
					.getDeclaredConstructor(obiOnyeike.getBirthYear().getClass())
					.newInstance(obiOnyeike.getBirthYear());
		this.characterOffset = obiOnyeike.getCharacterOffset();
		this.characterOnset = obiOnyeike.getCharacterOnset();
		if (obiOnyeike.getPosition() != null)
			this.position = obiOnyeike.getPosition().getClass()
					.getDeclaredConstructor(obiOnyeike.getPosition().getClass()).newInstance(obiOnyeike.getPosition());
		for (int j = 0; j < obiOnyeike.getTeams().size(); j++) {
			if (obiOnyeike.getTeams().get(j) != null) {
				teams.add(obiOnyeike.getTeams().get(j).getClass()
						.getDeclaredConstructor(obiOnyeike.getTeams().get(j).getClass())
						.newInstance(obiOnyeike.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "ObiOnyeike [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear=" + birthYear
