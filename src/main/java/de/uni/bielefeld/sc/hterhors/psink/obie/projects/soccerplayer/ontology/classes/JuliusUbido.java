...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IJuliusUbido;
...
public class JuliusUbido implements IJuliusUbido {
	...
	public JuliusUbido(JuliusUbido juliusUbido) throws InstantiationException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		this.annotationID = juliusUbido.getAnnotationID();
		for (int j = 0; j < juliusUbido.getBirthPlaces().size(); j++) {
			if (juliusUbido.getBirthPlaces().get(j) != null) {
				birthPlaces.add(juliusUbido.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(juliusUbido.getBirthPlaces().get(j).getClass())
						.newInstance(juliusUbido.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (juliusUbido.getBirthYear() != null)
			this.birthYear = juliusUbido.getBirthYear().getClass()
					.getDeclaredConstructor(juliusUbido.getBirthYear().getClass())
					.newInstance(juliusUbido.getBirthYear());
		this.characterOffset = juliusUbido.getCharacterOffset();
		this.characterOnset = juliusUbido.getCharacterOnset();
		if (juliusUbido.getPosition() != null)
			this.position = juliusUbido.getPosition().getClass()
					.getDeclaredConstructor(juliusUbido.getPosition().getClass())
					.newInstance(juliusUbido.getPosition());
		for (int j = 0; j < juliusUbido.getTeams().size(); j++) {
			if (juliusUbido.getTeams().get(j) != null) {
				teams.add(juliusUbido.getTeams().get(j).getClass()
						.getDeclaredConstructor(juliusUbido.getTeams().get(j).getClass())
						.newInstance(juliusUbido.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "JuliusUbido [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear=" + birthYear
