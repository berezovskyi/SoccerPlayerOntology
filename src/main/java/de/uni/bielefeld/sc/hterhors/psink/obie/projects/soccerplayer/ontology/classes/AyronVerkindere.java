...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IAyronVerkindere;
...
public class AyronVerkindere implements IAyronVerkindere {
	...
	public AyronVerkindere(AyronVerkindere ayronVerkindere) throws InstantiationException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		this.annotationID = ayronVerkindere.getAnnotationID();
		for (int j = 0; j < ayronVerkindere.getBirthPlaces().size(); j++) {
			if (ayronVerkindere.getBirthPlaces().get(j) != null) {
				birthPlaces.add(ayronVerkindere.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(ayronVerkindere.getBirthPlaces().get(j).getClass())
						.newInstance(ayronVerkindere.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (ayronVerkindere.getBirthYear() != null)
			this.birthYear = ayronVerkindere.getBirthYear().getClass()
					.getDeclaredConstructor(ayronVerkindere.getBirthYear().getClass())
					.newInstance(ayronVerkindere.getBirthYear());
		this.characterOffset = ayronVerkindere.getCharacterOffset();
		this.characterOnset = ayronVerkindere.getCharacterOnset();
		if (ayronVerkindere.getPosition() != null)
			this.position = ayronVerkindere.getPosition().getClass()
					.getDeclaredConstructor(ayronVerkindere.getPosition().getClass())
					.newInstance(ayronVerkindere.getPosition());
		for (int j = 0; j < ayronVerkindere.getTeams().size(); j++) {
			if (ayronVerkindere.getTeams().get(j) != null) {
				teams.add(ayronVerkindere.getTeams().get(j).getClass()
						.getDeclaredConstructor(ayronVerkindere.getTeams().get(j).getClass())
						.newInstance(ayronVerkindere.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "AyronVerkindere [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear="
