...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IBoboiSingh;
...
public class BoboiSingh implements IBoboiSingh {
	...
	public BoboiSingh(BoboiSingh boboiSingh) throws InstantiationException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		this.annotationID = boboiSingh.getAnnotationID();
		for (int j = 0; j < boboiSingh.getBirthPlaces().size(); j++) {
			if (boboiSingh.getBirthPlaces().get(j) != null) {
				birthPlaces.add(boboiSingh.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(boboiSingh.getBirthPlaces().get(j).getClass())
						.newInstance(boboiSingh.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (boboiSingh.getBirthYear() != null)
			this.birthYear = boboiSingh.getBirthYear().getClass()
					.getDeclaredConstructor(boboiSingh.getBirthYear().getClass())
					.newInstance(boboiSingh.getBirthYear());
		this.characterOffset = boboiSingh.getCharacterOffset();
		this.characterOnset = boboiSingh.getCharacterOnset();
		if (boboiSingh.getPosition() != null)
			this.position = boboiSingh.getPosition().getClass()
					.getDeclaredConstructor(boboiSingh.getPosition().getClass()).newInstance(boboiSingh.getPosition());
		for (int j = 0; j < boboiSingh.getTeams().size(); j++) {
			if (boboiSingh.getTeams().get(j) != null) {
				teams.add(boboiSingh.getTeams().get(j).getClass()
						.getDeclaredConstructor(boboiSingh.getTeams().get(j).getClass())
						.newInstance(boboiSingh.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "BoboiSingh [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear=" + birthYear
