...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IConstantHuysmans;
...
public class ConstantHuysmans implements IConstantHuysmans {
	...
	public ConstantHuysmans(ConstantHuysmans constantHuysmans) throws InstantiationException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		this.annotationID = constantHuysmans.getAnnotationID();
		for (int j = 0; j < constantHuysmans.getBirthPlaces().size(); j++) {
			if (constantHuysmans.getBirthPlaces().get(j) != null) {
				birthPlaces.add(constantHuysmans.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(constantHuysmans.getBirthPlaces().get(j).getClass())
						.newInstance(constantHuysmans.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (constantHuysmans.getBirthYear() != null)
			this.birthYear = constantHuysmans.getBirthYear().getClass()
					.getDeclaredConstructor(constantHuysmans.getBirthYear().getClass())
					.newInstance(constantHuysmans.getBirthYear());
		this.characterOffset = constantHuysmans.getCharacterOffset();
		this.characterOnset = constantHuysmans.getCharacterOnset();
		if (constantHuysmans.getPosition() != null)
			this.position = constantHuysmans.getPosition().getClass()
					.getDeclaredConstructor(constantHuysmans.getPosition().getClass())
					.newInstance(constantHuysmans.getPosition());
		for (int j = 0; j < constantHuysmans.getTeams().size(); j++) {
			if (constantHuysmans.getTeams().get(j) != null) {
				teams.add(constantHuysmans.getTeams().get(j).getClass()
						.getDeclaredConstructor(constantHuysmans.getTeams().get(j).getClass())
						.newInstance(constantHuysmans.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "ConstantHuysmans [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear="
