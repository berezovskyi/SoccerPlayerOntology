...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IChoiYungKeun;
...
public class ChoiYungKeun implements IChoiYungKeun {
	...
	public ChoiYungKeun(ChoiYungKeun choiYungKeun) throws InstantiationException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		this.annotationID = choiYungKeun.getAnnotationID();
		for (int j = 0; j < choiYungKeun.getBirthPlaces().size(); j++) {
			if (choiYungKeun.getBirthPlaces().get(j) != null) {
				birthPlaces.add(choiYungKeun.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(choiYungKeun.getBirthPlaces().get(j).getClass())
						.newInstance(choiYungKeun.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (choiYungKeun.getBirthYear() != null)
			this.birthYear = choiYungKeun.getBirthYear().getClass()
					.getDeclaredConstructor(choiYungKeun.getBirthYear().getClass())
					.newInstance(choiYungKeun.getBirthYear());
		this.characterOffset = choiYungKeun.getCharacterOffset();
		this.characterOnset = choiYungKeun.getCharacterOnset();
		if (choiYungKeun.getPosition() != null)
			this.position = choiYungKeun.getPosition().getClass()
					.getDeclaredConstructor(choiYungKeun.getPosition().getClass())
					.newInstance(choiYungKeun.getPosition());
		for (int j = 0; j < choiYungKeun.getTeams().size(); j++) {
			if (choiYungKeun.getTeams().get(j) != null) {
				teams.add(choiYungKeun.getTeams().get(j).getClass()
						.getDeclaredConstructor(choiYungKeun.getTeams().get(j).getClass())
						.newInstance(choiYungKeun.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "ChoiYungKeun [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear=" + birthYear
