...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.ILeeJongHo;
...
public class LeeJongHo implements ILeeJongHo {
	...
	public LeeJongHo(LeeJongHo leeJongHo) throws InstantiationException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		this.annotationID = leeJongHo.getAnnotationID();
		for (int j = 0; j < leeJongHo.getBirthPlaces().size(); j++) {
			if (leeJongHo.getBirthPlaces().get(j) != null) {
				birthPlaces.add(leeJongHo.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(leeJongHo.getBirthPlaces().get(j).getClass())
						.newInstance(leeJongHo.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (leeJongHo.getBirthYear() != null)
			this.birthYear = leeJongHo.getBirthYear().getClass()
					.getDeclaredConstructor(leeJongHo.getBirthYear().getClass()).newInstance(leeJongHo.getBirthYear());
		this.characterOffset = leeJongHo.getCharacterOffset();
		this.characterOnset = leeJongHo.getCharacterOnset();
		if (leeJongHo.getPosition() != null)
			this.position = leeJongHo.getPosition().getClass()
					.getDeclaredConstructor(leeJongHo.getPosition().getClass()).newInstance(leeJongHo.getPosition());
		for (int j = 0; j < leeJongHo.getTeams().size(); j++) {
			if (leeJongHo.getTeams().get(j) != null) {
				teams.add(leeJongHo.getTeams().get(j).getClass()
						.getDeclaredConstructor(leeJongHo.getTeams().get(j).getClass())
						.newInstance(leeJongHo.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "LeeJongHo [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear=" + birthYear
