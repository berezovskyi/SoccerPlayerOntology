...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IAbdelmajidLamriss;
...
public class AbdelmajidLamriss implements IAbdelmajidLamriss {
	...
	public AbdelmajidLamriss(AbdelmajidLamriss abdelmajidLamriss) throws InstantiationException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		this.annotationID = abdelmajidLamriss.getAnnotationID();
		for (int j = 0; j < abdelmajidLamriss.getBirthPlaces().size(); j++) {
			if (abdelmajidLamriss.getBirthPlaces().get(j) != null) {
				birthPlaces.add(abdelmajidLamriss.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(abdelmajidLamriss.getBirthPlaces().get(j).getClass())
						.newInstance(abdelmajidLamriss.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (abdelmajidLamriss.getBirthYear() != null)
			this.birthYear = abdelmajidLamriss.getBirthYear().getClass()
					.getDeclaredConstructor(abdelmajidLamriss.getBirthYear().getClass())
					.newInstance(abdelmajidLamriss.getBirthYear());
		this.characterOffset = abdelmajidLamriss.getCharacterOffset();
		this.characterOnset = abdelmajidLamriss.getCharacterOnset();
		if (abdelmajidLamriss.getPosition() != null)
			this.position = abdelmajidLamriss.getPosition().getClass()
					.getDeclaredConstructor(abdelmajidLamriss.getPosition().getClass())
					.newInstance(abdelmajidLamriss.getPosition());
		for (int j = 0; j < abdelmajidLamriss.getTeams().size(); j++) {
			if (abdelmajidLamriss.getTeams().get(j) != null) {
				teams.add(abdelmajidLamriss.getTeams().get(j).getClass()
						.getDeclaredConstructor(abdelmajidLamriss.getTeams().get(j).getClass())
						.newInstance(abdelmajidLamriss.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "AbdelmajidLamriss [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear="
