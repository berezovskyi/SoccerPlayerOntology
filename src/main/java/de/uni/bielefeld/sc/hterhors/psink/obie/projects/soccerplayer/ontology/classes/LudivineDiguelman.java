...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.ILudivineDiguelman;
...
public class LudivineDiguelman implements ILudivineDiguelman {
	...
	public LudivineDiguelman(LudivineDiguelman ludivineDiguelman) throws InstantiationException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		this.annotationID = ludivineDiguelman.getAnnotationID();
		for (int j = 0; j < ludivineDiguelman.getBirthPlaces().size(); j++) {
			if (ludivineDiguelman.getBirthPlaces().get(j) != null) {
				birthPlaces.add(ludivineDiguelman.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(ludivineDiguelman.getBirthPlaces().get(j).getClass())
						.newInstance(ludivineDiguelman.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (ludivineDiguelman.getBirthYear() != null)
			this.birthYear = ludivineDiguelman.getBirthYear().getClass()
					.getDeclaredConstructor(ludivineDiguelman.getBirthYear().getClass())
					.newInstance(ludivineDiguelman.getBirthYear());
		this.characterOffset = ludivineDiguelman.getCharacterOffset();
		this.characterOnset = ludivineDiguelman.getCharacterOnset();
		if (ludivineDiguelman.getPosition() != null)
			this.position = ludivineDiguelman.getPosition().getClass()
					.getDeclaredConstructor(ludivineDiguelman.getPosition().getClass())
					.newInstance(ludivineDiguelman.getPosition());
		for (int j = 0; j < ludivineDiguelman.getTeams().size(); j++) {
			if (ludivineDiguelman.getTeams().get(j) != null) {
				teams.add(ludivineDiguelman.getTeams().get(j).getClass()
						.getDeclaredConstructor(ludivineDiguelman.getTeams().get(j).getClass())
						.newInstance(ludivineDiguelman.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "LudivineDiguelman [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear="
