...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IParwinderSingh;
...
public class ParwinderSingh implements IParwinderSingh {
	...
	public ParwinderSingh(ParwinderSingh parwinderSingh) throws InstantiationException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		this.annotationID = parwinderSingh.getAnnotationID();
		for (int j = 0; j < parwinderSingh.getBirthPlaces().size(); j++) {
			if (parwinderSingh.getBirthPlaces().get(j) != null) {
				birthPlaces.add(parwinderSingh.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(parwinderSingh.getBirthPlaces().get(j).getClass())
						.newInstance(parwinderSingh.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (parwinderSingh.getBirthYear() != null)
			this.birthYear = parwinderSingh.getBirthYear().getClass()
					.getDeclaredConstructor(parwinderSingh.getBirthYear().getClass())
					.newInstance(parwinderSingh.getBirthYear());
		this.characterOffset = parwinderSingh.getCharacterOffset();
		this.characterOnset = parwinderSingh.getCharacterOnset();
		if (parwinderSingh.getPosition() != null)
			this.position = parwinderSingh.getPosition().getClass()
					.getDeclaredConstructor(parwinderSingh.getPosition().getClass())
					.newInstance(parwinderSingh.getPosition());
		for (int j = 0; j < parwinderSingh.getTeams().size(); j++) {
			if (parwinderSingh.getTeams().get(j) != null) {
				teams.add(parwinderSingh.getTeams().get(j).getClass()
						.getDeclaredConstructor(parwinderSingh.getTeams().get(j).getClass())
						.newInstance(parwinderSingh.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "ParwinderSingh [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear="
