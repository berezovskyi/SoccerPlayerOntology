...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IAlanDunne;
...
public class AlanDunne implements IAlanDunne {
	...
	public AlanDunne(AlanDunne alanDunne) throws InstantiationException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		this.annotationID = alanDunne.getAnnotationID();
		for (int j = 0; j < alanDunne.getBirthPlaces().size(); j++) {
			if (alanDunne.getBirthPlaces().get(j) != null) {
				birthPlaces.add(alanDunne.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(alanDunne.getBirthPlaces().get(j).getClass())
						.newInstance(alanDunne.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (alanDunne.getBirthYear() != null)
			this.birthYear = alanDunne.getBirthYear().getClass()
					.getDeclaredConstructor(alanDunne.getBirthYear().getClass()).newInstance(alanDunne.getBirthYear());
		this.characterOffset = alanDunne.getCharacterOffset();
		this.characterOnset = alanDunne.getCharacterOnset();
		if (alanDunne.getPosition() != null)
			this.position = alanDunne.getPosition().getClass()
					.getDeclaredConstructor(alanDunne.getPosition().getClass()).newInstance(alanDunne.getPosition());
		for (int j = 0; j < alanDunne.getTeams().size(); j++) {
			if (alanDunne.getTeams().get(j) != null) {
				teams.add(alanDunne.getTeams().get(j).getClass()
						.getDeclaredConstructor(alanDunne.getTeams().get(j).getClass())
						.newInstance(alanDunne.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "AlanDunne [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear=" + birthYear
