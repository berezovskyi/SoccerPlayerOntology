...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IValentinGalev;
...
public class ValentinGalev implements IValentinGalev {
	...
	public ValentinGalev(ValentinGalev valentinGalev) throws InstantiationException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		this.annotationID = valentinGalev.getAnnotationID();
		for (int j = 0; j < valentinGalev.getBirthPlaces().size(); j++) {
			if (valentinGalev.getBirthPlaces().get(j) != null) {
				birthPlaces.add(valentinGalev.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(valentinGalev.getBirthPlaces().get(j).getClass())
						.newInstance(valentinGalev.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (valentinGalev.getBirthYear() != null)
			this.birthYear = valentinGalev.getBirthYear().getClass()
					.getDeclaredConstructor(valentinGalev.getBirthYear().getClass())
					.newInstance(valentinGalev.getBirthYear());
		this.characterOffset = valentinGalev.getCharacterOffset();
		this.characterOnset = valentinGalev.getCharacterOnset();
		if (valentinGalev.getPosition() != null)
			this.position = valentinGalev.getPosition().getClass()
					.getDeclaredConstructor(valentinGalev.getPosition().getClass())
					.newInstance(valentinGalev.getPosition());
		for (int j = 0; j < valentinGalev.getTeams().size(); j++) {
			if (valentinGalev.getTeams().get(j) != null) {
				teams.add(valentinGalev.getTeams().get(j).getClass()
						.getDeclaredConstructor(valentinGalev.getTeams().get(j).getClass())
						.newInstance(valentinGalev.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "ValentinGalev [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear=" + birthYear
