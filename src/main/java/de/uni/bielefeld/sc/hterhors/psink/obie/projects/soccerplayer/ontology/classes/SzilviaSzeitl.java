...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.ISzilviaSzeitl;
...
public class SzilviaSzeitl implements ISzilviaSzeitl {
	...
	public SzilviaSzeitl(SzilviaSzeitl szilviaSzeitl) throws InstantiationException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		this.annotationID = szilviaSzeitl.getAnnotationID();
		for (int j = 0; j < szilviaSzeitl.getBirthPlaces().size(); j++) {
			if (szilviaSzeitl.getBirthPlaces().get(j) != null) {
				birthPlaces.add(szilviaSzeitl.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(szilviaSzeitl.getBirthPlaces().get(j).getClass())
						.newInstance(szilviaSzeitl.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (szilviaSzeitl.getBirthYear() != null)
			this.birthYear = szilviaSzeitl.getBirthYear().getClass()
					.getDeclaredConstructor(szilviaSzeitl.getBirthYear().getClass())
					.newInstance(szilviaSzeitl.getBirthYear());
		this.characterOffset = szilviaSzeitl.getCharacterOffset();
		this.characterOnset = szilviaSzeitl.getCharacterOnset();
		if (szilviaSzeitl.getPosition() != null)
			this.position = szilviaSzeitl.getPosition().getClass()
					.getDeclaredConstructor(szilviaSzeitl.getPosition().getClass())
					.newInstance(szilviaSzeitl.getPosition());
		for (int j = 0; j < szilviaSzeitl.getTeams().size(); j++) {
			if (szilviaSzeitl.getTeams().get(j) != null) {
				teams.add(szilviaSzeitl.getTeams().get(j).getClass()
						.getDeclaredConstructor(szilviaSzeitl.getTeams().get(j).getClass())
						.newInstance(szilviaSzeitl.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "SzilviaSzeitl [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear=" + birthYear
