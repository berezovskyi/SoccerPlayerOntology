...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IArchibaldBarton;
...
public class ArchibaldBarton implements IArchibaldBarton {
	...
	public ArchibaldBarton(ArchibaldBarton archibaldBarton) throws InstantiationException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		this.annotationID = archibaldBarton.getAnnotationID();
		for (int j = 0; j < archibaldBarton.getBirthPlaces().size(); j++) {
			if (archibaldBarton.getBirthPlaces().get(j) != null) {
				birthPlaces.add(archibaldBarton.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(archibaldBarton.getBirthPlaces().get(j).getClass())
						.newInstance(archibaldBarton.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (archibaldBarton.getBirthYear() != null)
			this.birthYear = archibaldBarton.getBirthYear().getClass()
					.getDeclaredConstructor(archibaldBarton.getBirthYear().getClass())
					.newInstance(archibaldBarton.getBirthYear());
		this.characterOffset = archibaldBarton.getCharacterOffset();
		this.characterOnset = archibaldBarton.getCharacterOnset();
		if (archibaldBarton.getPosition() != null)
			this.position = archibaldBarton.getPosition().getClass()
					.getDeclaredConstructor(archibaldBarton.getPosition().getClass())
					.newInstance(archibaldBarton.getPosition());
		for (int j = 0; j < archibaldBarton.getTeams().size(); j++) {
			if (archibaldBarton.getTeams().get(j) != null) {
				teams.add(archibaldBarton.getTeams().get(j).getClass()
						.getDeclaredConstructor(archibaldBarton.getTeams().get(j).getClass())
						.newInstance(archibaldBarton.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "ArchibaldBarton [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear="
