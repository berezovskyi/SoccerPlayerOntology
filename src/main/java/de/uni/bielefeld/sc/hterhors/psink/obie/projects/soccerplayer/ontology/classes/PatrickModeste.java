...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IPatrickModeste;
...
public class PatrickModeste implements IPatrickModeste {
	...
	public PatrickModeste(PatrickModeste patrickModeste) throws InstantiationException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		this.annotationID = patrickModeste.getAnnotationID();
		for (int j = 0; j < patrickModeste.getBirthPlaces().size(); j++) {
			if (patrickModeste.getBirthPlaces().get(j) != null) {
				birthPlaces.add(patrickModeste.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(patrickModeste.getBirthPlaces().get(j).getClass())
						.newInstance(patrickModeste.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (patrickModeste.getBirthYear() != null)
			this.birthYear = patrickModeste.getBirthYear().getClass()
					.getDeclaredConstructor(patrickModeste.getBirthYear().getClass())
					.newInstance(patrickModeste.getBirthYear());
		this.characterOffset = patrickModeste.getCharacterOffset();
		this.characterOnset = patrickModeste.getCharacterOnset();
		if (patrickModeste.getPosition() != null)
			this.position = patrickModeste.getPosition().getClass()
					.getDeclaredConstructor(patrickModeste.getPosition().getClass())
					.newInstance(patrickModeste.getPosition());
		for (int j = 0; j < patrickModeste.getTeams().size(); j++) {
			if (patrickModeste.getTeams().get(j) != null) {
				teams.add(patrickModeste.getTeams().get(j).getClass()
						.getDeclaredConstructor(patrickModeste.getTeams().get(j).getClass())
						.newInstance(patrickModeste.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "PatrickModeste [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear="
