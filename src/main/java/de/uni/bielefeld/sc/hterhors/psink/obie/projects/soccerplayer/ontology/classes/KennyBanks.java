...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IKennyBanks;
...
public class KennyBanks implements IKennyBanks {
	...
	public KennyBanks(KennyBanks kennyBanks) throws InstantiationException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		this.annotationID = kennyBanks.getAnnotationID();
		for (int j = 0; j < kennyBanks.getBirthPlaces().size(); j++) {
			if (kennyBanks.getBirthPlaces().get(j) != null) {
				birthPlaces.add(kennyBanks.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(kennyBanks.getBirthPlaces().get(j).getClass())
						.newInstance(kennyBanks.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (kennyBanks.getBirthYear() != null)
			this.birthYear = kennyBanks.getBirthYear().getClass()
					.getDeclaredConstructor(kennyBanks.getBirthYear().getClass())
					.newInstance(kennyBanks.getBirthYear());
		this.characterOffset = kennyBanks.getCharacterOffset();
		this.characterOnset = kennyBanks.getCharacterOnset();
		if (kennyBanks.getPosition() != null)
			this.position = kennyBanks.getPosition().getClass()
					.getDeclaredConstructor(kennyBanks.getPosition().getClass()).newInstance(kennyBanks.getPosition());
		for (int j = 0; j < kennyBanks.getTeams().size(); j++) {
			if (kennyBanks.getTeams().get(j) != null) {
				teams.add(kennyBanks.getTeams().get(j).getClass()
						.getDeclaredConstructor(kennyBanks.getTeams().get(j).getClass())
						.newInstance(kennyBanks.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "KennyBanks [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear=" + birthYear
