...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IZhuCongFootballer;
...
public class ZhuCongFootballer implements IZhuCongFootballer {
	...
	public ZhuCongFootballer(ZhuCongFootballer zhuCongFootballer) throws InstantiationException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		this.annotationID = zhuCongFootballer.getAnnotationID();
		for (int j = 0; j < zhuCongFootballer.getBirthPlaces().size(); j++) {
			if (zhuCongFootballer.getBirthPlaces().get(j) != null) {
				birthPlaces.add(zhuCongFootballer.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(zhuCongFootballer.getBirthPlaces().get(j).getClass())
						.newInstance(zhuCongFootballer.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (zhuCongFootballer.getBirthYear() != null)
			this.birthYear = zhuCongFootballer.getBirthYear().getClass()
					.getDeclaredConstructor(zhuCongFootballer.getBirthYear().getClass())
					.newInstance(zhuCongFootballer.getBirthYear());
		this.characterOffset = zhuCongFootballer.getCharacterOffset();
		this.characterOnset = zhuCongFootballer.getCharacterOnset();
		if (zhuCongFootballer.getPosition() != null)
			this.position = zhuCongFootballer.getPosition().getClass()
					.getDeclaredConstructor(zhuCongFootballer.getPosition().getClass())
					.newInstance(zhuCongFootballer.getPosition());
		for (int j = 0; j < zhuCongFootballer.getTeams().size(); j++) {
			if (zhuCongFootballer.getTeams().get(j) != null) {
				teams.add(zhuCongFootballer.getTeams().get(j).getClass()
						.getDeclaredConstructor(zhuCongFootballer.getTeams().get(j).getClass())
						.newInstance(zhuCongFootballer.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "ZhuCongFootballer [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear="
