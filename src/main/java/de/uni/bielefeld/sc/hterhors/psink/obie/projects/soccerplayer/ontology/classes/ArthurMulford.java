...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IArthurMulford;
...
public class ArthurMulford implements IArthurMulford {
	...
	public ArthurMulford(ArthurMulford arthurMulford) throws InstantiationException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		this.annotationID = arthurMulford.getAnnotationID();
		for (int j = 0; j < arthurMulford.getBirthPlaces().size(); j++) {
			if (arthurMulford.getBirthPlaces().get(j) != null) {
				birthPlaces.add(arthurMulford.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(arthurMulford.getBirthPlaces().get(j).getClass())
						.newInstance(arthurMulford.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (arthurMulford.getBirthYear() != null)
			this.birthYear = arthurMulford.getBirthYear().getClass()
					.getDeclaredConstructor(arthurMulford.getBirthYear().getClass())
					.newInstance(arthurMulford.getBirthYear());
		this.characterOffset = arthurMulford.getCharacterOffset();
		this.characterOnset = arthurMulford.getCharacterOnset();
		if (arthurMulford.getPosition() != null)
			this.position = arthurMulford.getPosition().getClass()
					.getDeclaredConstructor(arthurMulford.getPosition().getClass())
					.newInstance(arthurMulford.getPosition());
		for (int j = 0; j < arthurMulford.getTeams().size(); j++) {
			if (arthurMulford.getTeams().get(j) != null) {
				teams.add(arthurMulford.getTeams().get(j).getClass()
						.getDeclaredConstructor(arthurMulford.getTeams().get(j).getClass())
						.newInstance(arthurMulford.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "ArthurMulford [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear=" + birthYear
