...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IIvanOKonnelBronin;
...
public class IvanOKonnelBronin implements IIvanOKonnelBronin {
	...
	public IvanOKonnelBronin(IvanOKonnelBronin ivanOKonnelBronin) throws InstantiationException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		this.annotationID = ivanOKonnelBronin.getAnnotationID();
		for (int j = 0; j < ivanOKonnelBronin.getBirthPlaces().size(); j++) {
			if (ivanOKonnelBronin.getBirthPlaces().get(j) != null) {
				birthPlaces.add(ivanOKonnelBronin.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(ivanOKonnelBronin.getBirthPlaces().get(j).getClass())
						.newInstance(ivanOKonnelBronin.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (ivanOKonnelBronin.getBirthYear() != null)
			this.birthYear = ivanOKonnelBronin.getBirthYear().getClass()
					.getDeclaredConstructor(ivanOKonnelBronin.getBirthYear().getClass())
					.newInstance(ivanOKonnelBronin.getBirthYear());
		this.characterOffset = ivanOKonnelBronin.getCharacterOffset();
		this.characterOnset = ivanOKonnelBronin.getCharacterOnset();
		if (ivanOKonnelBronin.getPosition() != null)
			this.position = ivanOKonnelBronin.getPosition().getClass()
					.getDeclaredConstructor(ivanOKonnelBronin.getPosition().getClass())
					.newInstance(ivanOKonnelBronin.getPosition());
		for (int j = 0; j < ivanOKonnelBronin.getTeams().size(); j++) {
			if (ivanOKonnelBronin.getTeams().get(j) != null) {
				teams.add(ivanOKonnelBronin.getTeams().get(j).getClass()
						.getDeclaredConstructor(ivanOKonnelBronin.getTeams().get(j).getClass())
						.newInstance(ivanOKonnelBronin.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "IvanOKonnelBronin [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear="
