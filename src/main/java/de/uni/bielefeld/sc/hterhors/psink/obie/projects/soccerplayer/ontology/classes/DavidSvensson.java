...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IDavidSvensson;
...
public class DavidSvensson implements IDavidSvensson {
	...
	public DavidSvensson(DavidSvensson davidSvensson) throws InstantiationException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		this.annotationID = davidSvensson.getAnnotationID();
		for (int j = 0; j < davidSvensson.getBirthPlaces().size(); j++) {
			if (davidSvensson.getBirthPlaces().get(j) != null) {
				birthPlaces.add(davidSvensson.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(davidSvensson.getBirthPlaces().get(j).getClass())
						.newInstance(davidSvensson.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (davidSvensson.getBirthYear() != null)
			this.birthYear = davidSvensson.getBirthYear().getClass()
					.getDeclaredConstructor(davidSvensson.getBirthYear().getClass())
					.newInstance(davidSvensson.getBirthYear());
		this.characterOffset = davidSvensson.getCharacterOffset();
		this.characterOnset = davidSvensson.getCharacterOnset();
		if (davidSvensson.getPosition() != null)
			this.position = davidSvensson.getPosition().getClass()
					.getDeclaredConstructor(davidSvensson.getPosition().getClass())
					.newInstance(davidSvensson.getPosition());
		for (int j = 0; j < davidSvensson.getTeams().size(); j++) {
			if (davidSvensson.getTeams().get(j) != null) {
				teams.add(davidSvensson.getTeams().get(j).getClass()
						.getDeclaredConstructor(davidSvensson.getTeams().get(j).getClass())
						.newInstance(davidSvensson.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "DavidSvensson [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear=" + birthYear
