...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IJohnBainesFootballer;
...
public class JohnBainesFootballer implements IJohnBainesFootballer {
	...
	public JohnBainesFootballer(JohnBainesFootballer johnBainesFootballer)
			throws InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException,
			NoSuchMethodException, SecurityException {
		this.annotationID = johnBainesFootballer.getAnnotationID();
		for (int j = 0; j < johnBainesFootballer.getBirthPlaces().size(); j++) {
			if (johnBainesFootballer.getBirthPlaces().get(j) != null) {
				birthPlaces.add(johnBainesFootballer.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(johnBainesFootballer.getBirthPlaces().get(j).getClass())
						.newInstance(johnBainesFootballer.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (johnBainesFootballer.getBirthYear() != null)
			this.birthYear = johnBainesFootballer.getBirthYear().getClass()
					.getDeclaredConstructor(johnBainesFootballer.getBirthYear().getClass())
					.newInstance(johnBainesFootballer.getBirthYear());
		this.characterOffset = johnBainesFootballer.getCharacterOffset();
		this.characterOnset = johnBainesFootballer.getCharacterOnset();
		if (johnBainesFootballer.getPosition() != null)
			this.position = johnBainesFootballer.getPosition().getClass()
					.getDeclaredConstructor(johnBainesFootballer.getPosition().getClass())
					.newInstance(johnBainesFootballer.getPosition());
		for (int j = 0; j < johnBainesFootballer.getTeams().size(); j++) {
			if (johnBainesFootballer.getTeams().get(j) != null) {
				teams.add(johnBainesFootballer.getTeams().get(j).getClass()
						.getDeclaredConstructor(johnBainesFootballer.getTeams().get(j).getClass())
						.newInstance(johnBainesFootballer.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "JohnBainesFootballer [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear="
