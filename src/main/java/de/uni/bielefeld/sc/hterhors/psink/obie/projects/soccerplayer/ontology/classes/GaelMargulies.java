...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IGaelMargulies;
...
public class GaelMargulies implements IGaelMargulies {
	...
	public GaelMargulies(GaelMargulies gaelMargulies) throws InstantiationException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		this.annotationID = gaelMargulies.getAnnotationID();
		for (int j = 0; j < gaelMargulies.getBirthPlaces().size(); j++) {
			if (gaelMargulies.getBirthPlaces().get(j) != null) {
				birthPlaces.add(gaelMargulies.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(gaelMargulies.getBirthPlaces().get(j).getClass())
						.newInstance(gaelMargulies.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (gaelMargulies.getBirthYear() != null)
			this.birthYear = gaelMargulies.getBirthYear().getClass()
					.getDeclaredConstructor(gaelMargulies.getBirthYear().getClass())
					.newInstance(gaelMargulies.getBirthYear());
		this.characterOffset = gaelMargulies.getCharacterOffset();
		this.characterOnset = gaelMargulies.getCharacterOnset();
		if (gaelMargulies.getPosition() != null)
			this.position = gaelMargulies.getPosition().getClass()
					.getDeclaredConstructor(gaelMargulies.getPosition().getClass())
					.newInstance(gaelMargulies.getPosition());
		for (int j = 0; j < gaelMargulies.getTeams().size(); j++) {
			if (gaelMargulies.getTeams().get(j) != null) {
				teams.add(gaelMargulies.getTeams().get(j).getClass()
						.getDeclaredConstructor(gaelMargulies.getTeams().get(j).getClass())
						.newInstance(gaelMargulies.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "GaelMargulies [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear=" + birthYear
