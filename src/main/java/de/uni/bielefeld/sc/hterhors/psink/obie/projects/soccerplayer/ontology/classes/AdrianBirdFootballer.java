...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IAdrianBirdFootballer;
...
public class AdrianBirdFootballer implements IAdrianBirdFootballer {
	...
	public AdrianBirdFootballer(AdrianBirdFootballer adrianBirdFootballer)
			throws InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException,
			NoSuchMethodException, SecurityException {
		this.annotationID = adrianBirdFootballer.getAnnotationID();
		for (int j = 0; j < adrianBirdFootballer.getBirthPlaces().size(); j++) {
			if (adrianBirdFootballer.getBirthPlaces().get(j) != null) {
				birthPlaces.add(adrianBirdFootballer.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(adrianBirdFootballer.getBirthPlaces().get(j).getClass())
						.newInstance(adrianBirdFootballer.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (adrianBirdFootballer.getBirthYear() != null)
			this.birthYear = adrianBirdFootballer.getBirthYear().getClass()
					.getDeclaredConstructor(adrianBirdFootballer.getBirthYear().getClass())
					.newInstance(adrianBirdFootballer.getBirthYear());
		this.characterOffset = adrianBirdFootballer.getCharacterOffset();
		this.characterOnset = adrianBirdFootballer.getCharacterOnset();
		if (adrianBirdFootballer.getPosition() != null)
			this.position = adrianBirdFootballer.getPosition().getClass()
					.getDeclaredConstructor(adrianBirdFootballer.getPosition().getClass())
					.newInstance(adrianBirdFootballer.getPosition());
		for (int j = 0; j < adrianBirdFootballer.getTeams().size(); j++) {
			if (adrianBirdFootballer.getTeams().get(j) != null) {
				teams.add(adrianBirdFootballer.getTeams().get(j).getClass()
						.getDeclaredConstructor(adrianBirdFootballer.getTeams().get(j).getClass())
						.newInstance(adrianBirdFootballer.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "AdrianBirdFootballer [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear="
