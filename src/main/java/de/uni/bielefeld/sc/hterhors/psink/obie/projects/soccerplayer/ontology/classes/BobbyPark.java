...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IBobbyPark;
...
public class BobbyPark implements IBobbyPark {
	...
	public BobbyPark(BobbyPark bobbyPark) throws InstantiationException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		this.annotationID = bobbyPark.getAnnotationID();
		for (int j = 0; j < bobbyPark.getBirthPlaces().size(); j++) {
			if (bobbyPark.getBirthPlaces().get(j) != null) {
				birthPlaces.add(bobbyPark.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(bobbyPark.getBirthPlaces().get(j).getClass())
						.newInstance(bobbyPark.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (bobbyPark.getBirthYear() != null)
			this.birthYear = bobbyPark.getBirthYear().getClass()
					.getDeclaredConstructor(bobbyPark.getBirthYear().getClass()).newInstance(bobbyPark.getBirthYear());
		this.characterOffset = bobbyPark.getCharacterOffset();
		this.characterOnset = bobbyPark.getCharacterOnset();
		if (bobbyPark.getPosition() != null)
			this.position = bobbyPark.getPosition().getClass()
					.getDeclaredConstructor(bobbyPark.getPosition().getClass()).newInstance(bobbyPark.getPosition());
		for (int j = 0; j < bobbyPark.getTeams().size(); j++) {
			if (bobbyPark.getTeams().get(j) != null) {
				teams.add(bobbyPark.getTeams().get(j).getClass()
						.getDeclaredConstructor(bobbyPark.getTeams().get(j).getClass())
						.newInstance(bobbyPark.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "BobbyPark [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear=" + birthYear
