...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IMuayadAlHaddad;
...
public class MuayadAlHaddad implements IMuayadAlHaddad {
	...
	public MuayadAlHaddad(MuayadAlHaddad muayadAlHaddad) throws InstantiationException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		this.annotationID = muayadAlHaddad.getAnnotationID();
		for (int j = 0; j < muayadAlHaddad.getBirthPlaces().size(); j++) {
			if (muayadAlHaddad.getBirthPlaces().get(j) != null) {
				birthPlaces.add(muayadAlHaddad.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(muayadAlHaddad.getBirthPlaces().get(j).getClass())
						.newInstance(muayadAlHaddad.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (muayadAlHaddad.getBirthYear() != null)
			this.birthYear = muayadAlHaddad.getBirthYear().getClass()
					.getDeclaredConstructor(muayadAlHaddad.getBirthYear().getClass())
					.newInstance(muayadAlHaddad.getBirthYear());
		this.characterOffset = muayadAlHaddad.getCharacterOffset();
		this.characterOnset = muayadAlHaddad.getCharacterOnset();
		if (muayadAlHaddad.getPosition() != null)
			this.position = muayadAlHaddad.getPosition().getClass()
					.getDeclaredConstructor(muayadAlHaddad.getPosition().getClass())
					.newInstance(muayadAlHaddad.getPosition());
		for (int j = 0; j < muayadAlHaddad.getTeams().size(); j++) {
			if (muayadAlHaddad.getTeams().get(j) != null) {
				teams.add(muayadAlHaddad.getTeams().get(j).getClass()
						.getDeclaredConstructor(muayadAlHaddad.getTeams().get(j).getClass())
						.newInstance(muayadAlHaddad.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "MuayadAlHaddad [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear="
