...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IJosephKamga;
...
public class JosephKamga implements IJosephKamga {
	...
	public JosephKamga(JosephKamga josephKamga) throws InstantiationException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		this.annotationID = josephKamga.getAnnotationID();
		for (int j = 0; j < josephKamga.getBirthPlaces().size(); j++) {
			if (josephKamga.getBirthPlaces().get(j) != null) {
				birthPlaces.add(josephKamga.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(josephKamga.getBirthPlaces().get(j).getClass())
						.newInstance(josephKamga.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (josephKamga.getBirthYear() != null)
			this.birthYear = josephKamga.getBirthYear().getClass()
					.getDeclaredConstructor(josephKamga.getBirthYear().getClass())
					.newInstance(josephKamga.getBirthYear());
		this.characterOffset = josephKamga.getCharacterOffset();
		this.characterOnset = josephKamga.getCharacterOnset();
		if (josephKamga.getPosition() != null)
			this.position = josephKamga.getPosition().getClass()
					.getDeclaredConstructor(josephKamga.getPosition().getClass())
					.newInstance(josephKamga.getPosition());
		for (int j = 0; j < josephKamga.getTeams().size(); j++) {
			if (josephKamga.getTeams().get(j) != null) {
				teams.add(josephKamga.getTeams().get(j).getClass()
						.getDeclaredConstructor(josephKamga.getTeams().get(j).getClass())
						.newInstance(josephKamga.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "JosephKamga [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear=" + birthYear
