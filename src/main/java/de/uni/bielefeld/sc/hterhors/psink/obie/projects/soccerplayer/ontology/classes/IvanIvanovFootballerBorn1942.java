...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IIvanIvanovFootballerBorn1942;
...
public class IvanIvanovFootballerBorn1942 implements IIvanIvanovFootballerBorn1942 {
	...
	public IvanIvanovFootballerBorn1942(IvanIvanovFootballerBorn1942 ivanIvanovFootballerBorn1942)
			throws InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException,
			NoSuchMethodException, SecurityException {
		this.annotationID = ivanIvanovFootballerBorn1942.getAnnotationID();
		for (int j = 0; j < ivanIvanovFootballerBorn1942.getBirthPlaces().size(); j++) {
			if (ivanIvanovFootballerBorn1942.getBirthPlaces().get(j) != null) {
				birthPlaces.add(ivanIvanovFootballerBorn1942.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(ivanIvanovFootballerBorn1942.getBirthPlaces().get(j).getClass())
						.newInstance(ivanIvanovFootballerBorn1942.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (ivanIvanovFootballerBorn1942.getBirthYear() != null)
			this.birthYear = ivanIvanovFootballerBorn1942.getBirthYear().getClass()
					.getDeclaredConstructor(ivanIvanovFootballerBorn1942.getBirthYear().getClass())
					.newInstance(ivanIvanovFootballerBorn1942.getBirthYear());
		...
		if (ivanIvanovFootballerBorn1942.getPosition() != null)
			this.position = ivanIvanovFootballerBorn1942.getPosition().getClass()
					.getDeclaredConstructor(ivanIvanovFootballerBorn1942.getPosition().getClass())
					.newInstance(ivanIvanovFootballerBorn1942.getPosition());
		for (int j = 0; j < ivanIvanovFootballerBorn1942.getTeams().size(); j++) {
			if (ivanIvanovFootballerBorn1942.getTeams().get(j) != null) {
				teams.add(ivanIvanovFootballerBorn1942.getTeams().get(j).getClass()
						.getDeclaredConstructor(ivanIvanovFootballerBorn1942.getTeams().get(j).getClass())
						.newInstance(ivanIvanovFootballerBorn1942.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "IvanIvanovFootballerBorn1942 [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces
