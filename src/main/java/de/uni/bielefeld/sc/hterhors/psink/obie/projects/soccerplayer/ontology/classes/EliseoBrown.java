...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IEliseoBrown;
...
public class EliseoBrown implements IEliseoBrown {
	...
	public EliseoBrown(EliseoBrown eliseoBrown) throws InstantiationException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		this.annotationID = eliseoBrown.getAnnotationID();
		for (int j = 0; j < eliseoBrown.getBirthPlaces().size(); j++) {
			if (eliseoBrown.getBirthPlaces().get(j) != null) {
				birthPlaces.add(eliseoBrown.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(eliseoBrown.getBirthPlaces().get(j).getClass())
						.newInstance(eliseoBrown.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (eliseoBrown.getBirthYear() != null)
			this.birthYear = eliseoBrown.getBirthYear().getClass()
					.getDeclaredConstructor(eliseoBrown.getBirthYear().getClass())
					.newInstance(eliseoBrown.getBirthYear());
		this.characterOffset = eliseoBrown.getCharacterOffset();
		this.characterOnset = eliseoBrown.getCharacterOnset();
		if (eliseoBrown.getPosition() != null)
			this.position = eliseoBrown.getPosition().getClass()
					.getDeclaredConstructor(eliseoBrown.getPosition().getClass())
					.newInstance(eliseoBrown.getPosition());
		for (int j = 0; j < eliseoBrown.getTeams().size(); j++) {
			if (eliseoBrown.getTeams().get(j) != null) {
				teams.add(eliseoBrown.getTeams().get(j).getClass()
						.getDeclaredConstructor(eliseoBrown.getTeams().get(j).getClass())
						.newInstance(eliseoBrown.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "EliseoBrown [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear=" + birthYear
