...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.ILuisMiguelValle;
...
public class LuisMiguelValle implements ILuisMiguelValle {
	...
	public LuisMiguelValle(LuisMiguelValle luisMiguelValle) throws InstantiationException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		this.annotationID = luisMiguelValle.getAnnotationID();
		for (int j = 0; j < luisMiguelValle.getBirthPlaces().size(); j++) {
			if (luisMiguelValle.getBirthPlaces().get(j) != null) {
				birthPlaces.add(luisMiguelValle.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(luisMiguelValle.getBirthPlaces().get(j).getClass())
						.newInstance(luisMiguelValle.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (luisMiguelValle.getBirthYear() != null)
			this.birthYear = luisMiguelValle.getBirthYear().getClass()
					.getDeclaredConstructor(luisMiguelValle.getBirthYear().getClass())
					.newInstance(luisMiguelValle.getBirthYear());
		this.characterOffset = luisMiguelValle.getCharacterOffset();
		this.characterOnset = luisMiguelValle.getCharacterOnset();
		if (luisMiguelValle.getPosition() != null)
			this.position = luisMiguelValle.getPosition().getClass()
					.getDeclaredConstructor(luisMiguelValle.getPosition().getClass())
					.newInstance(luisMiguelValle.getPosition());
		for (int j = 0; j < luisMiguelValle.getTeams().size(); j++) {
			if (luisMiguelValle.getTeams().get(j) != null) {
				teams.add(luisMiguelValle.getTeams().get(j).getClass()
						.getDeclaredConstructor(luisMiguelValle.getTeams().get(j).getClass())
						.newInstance(luisMiguelValle.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "LuisMiguelValle [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear="
