...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IRaafatAttia;
...
public class RaafatAttia implements IRaafatAttia {
	...
	public RaafatAttia(RaafatAttia raafatAttia) throws InstantiationException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		this.annotationID = raafatAttia.getAnnotationID();
		for (int j = 0; j < raafatAttia.getBirthPlaces().size(); j++) {
			if (raafatAttia.getBirthPlaces().get(j) != null) {
				birthPlaces.add(raafatAttia.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(raafatAttia.getBirthPlaces().get(j).getClass())
						.newInstance(raafatAttia.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (raafatAttia.getBirthYear() != null)
			this.birthYear = raafatAttia.getBirthYear().getClass()
					.getDeclaredConstructor(raafatAttia.getBirthYear().getClass())
					.newInstance(raafatAttia.getBirthYear());
		this.characterOffset = raafatAttia.getCharacterOffset();
		this.characterOnset = raafatAttia.getCharacterOnset();
		if (raafatAttia.getPosition() != null)
			this.position = raafatAttia.getPosition().getClass()
					.getDeclaredConstructor(raafatAttia.getPosition().getClass())
					.newInstance(raafatAttia.getPosition());
		for (int j = 0; j < raafatAttia.getTeams().size(); j++) {
			if (raafatAttia.getTeams().get(j) != null) {
				teams.add(raafatAttia.getTeams().get(j).getClass()
						.getDeclaredConstructor(raafatAttia.getTeams().get(j).getClass())
						.newInstance(raafatAttia.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "RaafatAttia [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear=" + birthYear
