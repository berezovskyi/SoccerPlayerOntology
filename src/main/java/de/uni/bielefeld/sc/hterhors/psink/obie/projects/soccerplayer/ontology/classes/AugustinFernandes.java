...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IAugustinFernandes;
...
public class AugustinFernandes implements IAugustinFernandes {
	...
	public AugustinFernandes(AugustinFernandes augustinFernandes) throws InstantiationException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		this.annotationID = augustinFernandes.getAnnotationID();
		for (int j = 0; j < augustinFernandes.getBirthPlaces().size(); j++) {
			if (augustinFernandes.getBirthPlaces().get(j) != null) {
				birthPlaces.add(augustinFernandes.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(augustinFernandes.getBirthPlaces().get(j).getClass())
						.newInstance(augustinFernandes.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (augustinFernandes.getBirthYear() != null)
			this.birthYear = augustinFernandes.getBirthYear().getClass()
					.getDeclaredConstructor(augustinFernandes.getBirthYear().getClass())
					.newInstance(augustinFernandes.getBirthYear());
		this.characterOffset = augustinFernandes.getCharacterOffset();
		this.characterOnset = augustinFernandes.getCharacterOnset();
		if (augustinFernandes.getPosition() != null)
			this.position = augustinFernandes.getPosition().getClass()
					.getDeclaredConstructor(augustinFernandes.getPosition().getClass())
					.newInstance(augustinFernandes.getPosition());
		for (int j = 0; j < augustinFernandes.getTeams().size(); j++) {
			if (augustinFernandes.getTeams().get(j) != null) {
				teams.add(augustinFernandes.getTeams().get(j).getClass()
						.getDeclaredConstructor(augustinFernandes.getTeams().get(j).getClass())
						.newInstance(augustinFernandes.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "AugustinFernandes [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear="
