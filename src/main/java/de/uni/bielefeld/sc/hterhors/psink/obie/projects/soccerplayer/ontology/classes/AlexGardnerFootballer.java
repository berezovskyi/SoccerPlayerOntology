...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IAlexGardnerFootballer;
...
public class AlexGardnerFootballer implements IAlexGardnerFootballer {
	...
	public AlexGardnerFootballer(AlexGardnerFootballer alexGardnerFootballer)
			throws InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException,
			NoSuchMethodException, SecurityException {
		this.annotationID = alexGardnerFootballer.getAnnotationID();
		for (int j = 0; j < alexGardnerFootballer.getBirthPlaces().size(); j++) {
			if (alexGardnerFootballer.getBirthPlaces().get(j) != null) {
				birthPlaces.add(alexGardnerFootballer.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(alexGardnerFootballer.getBirthPlaces().get(j).getClass())
						.newInstance(alexGardnerFootballer.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (alexGardnerFootballer.getBirthYear() != null)
			this.birthYear = alexGardnerFootballer.getBirthYear().getClass()
					.getDeclaredConstructor(alexGardnerFootballer.getBirthYear().getClass())
					.newInstance(alexGardnerFootballer.getBirthYear());
		this.characterOffset = alexGardnerFootballer.getCharacterOffset();
		this.characterOnset = alexGardnerFootballer.getCharacterOnset();
		if (alexGardnerFootballer.getPosition() != null)
			this.position = alexGardnerFootballer.getPosition().getClass()
					.getDeclaredConstructor(alexGardnerFootballer.getPosition().getClass())
					.newInstance(alexGardnerFootballer.getPosition());
		for (int j = 0; j < alexGardnerFootballer.getTeams().size(); j++) {
			if (alexGardnerFootballer.getTeams().get(j) != null) {
				teams.add(alexGardnerFootballer.getTeams().get(j).getClass()
						.getDeclaredConstructor(alexGardnerFootballer.getTeams().get(j).getClass())
						.newInstance(alexGardnerFootballer.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "AlexGardnerFootballer [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear="
