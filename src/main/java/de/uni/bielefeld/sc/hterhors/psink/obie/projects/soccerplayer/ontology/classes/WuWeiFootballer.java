...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IWuWeiFootballer;
...
public class WuWeiFootballer implements IWuWeiFootballer {
	...
	public WuWeiFootballer(WuWeiFootballer wuWeiFootballer) throws InstantiationException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		this.annotationID = wuWeiFootballer.getAnnotationID();
		for (int j = 0; j < wuWeiFootballer.getBirthPlaces().size(); j++) {
			if (wuWeiFootballer.getBirthPlaces().get(j) != null) {
				birthPlaces.add(wuWeiFootballer.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(wuWeiFootballer.getBirthPlaces().get(j).getClass())
						.newInstance(wuWeiFootballer.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (wuWeiFootballer.getBirthYear() != null)
			this.birthYear = wuWeiFootballer.getBirthYear().getClass()
					.getDeclaredConstructor(wuWeiFootballer.getBirthYear().getClass())
					.newInstance(wuWeiFootballer.getBirthYear());
		this.characterOffset = wuWeiFootballer.getCharacterOffset();
		this.characterOnset = wuWeiFootballer.getCharacterOnset();
		if (wuWeiFootballer.getPosition() != null)
			this.position = wuWeiFootballer.getPosition().getClass()
					.getDeclaredConstructor(wuWeiFootballer.getPosition().getClass())
					.newInstance(wuWeiFootballer.getPosition());
		for (int j = 0; j < wuWeiFootballer.getTeams().size(); j++) {
			if (wuWeiFootballer.getTeams().get(j) != null) {
				teams.add(wuWeiFootballer.getTeams().get(j).getClass()
						.getDeclaredConstructor(wuWeiFootballer.getTeams().get(j).getClass())
						.newInstance(wuWeiFootballer.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "WuWeiFootballer [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear="
