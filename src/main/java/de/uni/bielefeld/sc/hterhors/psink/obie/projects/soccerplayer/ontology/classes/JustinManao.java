...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IJustinManao;
...
public class JustinManao implements IJustinManao {
	...
	public JustinManao(JustinManao justinManao) throws InstantiationException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		this.annotationID = justinManao.getAnnotationID();
		for (int j = 0; j < justinManao.getBirthPlaces().size(); j++) {
			if (justinManao.getBirthPlaces().get(j) != null) {
				birthPlaces.add(justinManao.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(justinManao.getBirthPlaces().get(j).getClass())
						.newInstance(justinManao.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (justinManao.getBirthYear() != null)
			this.birthYear = justinManao.getBirthYear().getClass()
					.getDeclaredConstructor(justinManao.getBirthYear().getClass())
					.newInstance(justinManao.getBirthYear());
		this.characterOffset = justinManao.getCharacterOffset();
		this.characterOnset = justinManao.getCharacterOnset();
		if (justinManao.getPosition() != null)
			this.position = justinManao.getPosition().getClass()
					.getDeclaredConstructor(justinManao.getPosition().getClass())
					.newInstance(justinManao.getPosition());
		for (int j = 0; j < justinManao.getTeams().size(); j++) {
			if (justinManao.getTeams().get(j) != null) {
				teams.add(justinManao.getTeams().get(j).getClass()
						.getDeclaredConstructor(justinManao.getTeams().get(j).getClass())
						.newInstance(justinManao.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "JustinManao [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear=" + birthYear
