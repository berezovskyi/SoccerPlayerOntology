...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IPaulDennyFootballer;
...
public class PaulDennyFootballer implements IPaulDennyFootballer {
	...
	public PaulDennyFootballer(PaulDennyFootballer paulDennyFootballer)
			throws InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException,
			NoSuchMethodException, SecurityException {
		this.annotationID = paulDennyFootballer.getAnnotationID();
		for (int j = 0; j < paulDennyFootballer.getBirthPlaces().size(); j++) {
			if (paulDennyFootballer.getBirthPlaces().get(j) != null) {
				birthPlaces.add(paulDennyFootballer.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(paulDennyFootballer.getBirthPlaces().get(j).getClass())
						.newInstance(paulDennyFootballer.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (paulDennyFootballer.getBirthYear() != null)
			this.birthYear = paulDennyFootballer.getBirthYear().getClass()
					.getDeclaredConstructor(paulDennyFootballer.getBirthYear().getClass())
					.newInstance(paulDennyFootballer.getBirthYear());
		this.characterOffset = paulDennyFootballer.getCharacterOffset();
		this.characterOnset = paulDennyFootballer.getCharacterOnset();
		if (paulDennyFootballer.getPosition() != null)
			this.position = paulDennyFootballer.getPosition().getClass()
					.getDeclaredConstructor(paulDennyFootballer.getPosition().getClass())
					.newInstance(paulDennyFootballer.getPosition());
		for (int j = 0; j < paulDennyFootballer.getTeams().size(); j++) {
			if (paulDennyFootballer.getTeams().get(j) != null) {
				teams.add(paulDennyFootballer.getTeams().get(j).getClass()
						.getDeclaredConstructor(paulDennyFootballer.getTeams().get(j).getClass())
						.newInstance(paulDennyFootballer.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "PaulDennyFootballer [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear="
