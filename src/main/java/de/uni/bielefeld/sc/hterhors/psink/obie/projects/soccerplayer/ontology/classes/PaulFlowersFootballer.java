...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IPaulFlowersFootballer;
...
public class PaulFlowersFootballer implements IPaulFlowersFootballer {
	...
	public PaulFlowersFootballer(PaulFlowersFootballer paulFlowersFootballer)
			throws InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException,
			NoSuchMethodException, SecurityException {
		this.annotationID = paulFlowersFootballer.getAnnotationID();
		for (int j = 0; j < paulFlowersFootballer.getBirthPlaces().size(); j++) {
			if (paulFlowersFootballer.getBirthPlaces().get(j) != null) {
				birthPlaces.add(paulFlowersFootballer.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(paulFlowersFootballer.getBirthPlaces().get(j).getClass())
						.newInstance(paulFlowersFootballer.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (paulFlowersFootballer.getBirthYear() != null)
			this.birthYear = paulFlowersFootballer.getBirthYear().getClass()
					.getDeclaredConstructor(paulFlowersFootballer.getBirthYear().getClass())
					.newInstance(paulFlowersFootballer.getBirthYear());
		this.characterOffset = paulFlowersFootballer.getCharacterOffset();
		this.characterOnset = paulFlowersFootballer.getCharacterOnset();
		if (paulFlowersFootballer.getPosition() != null)
			this.position = paulFlowersFootballer.getPosition().getClass()
					.getDeclaredConstructor(paulFlowersFootballer.getPosition().getClass())
					.newInstance(paulFlowersFootballer.getPosition());
		for (int j = 0; j < paulFlowersFootballer.getTeams().size(); j++) {
			if (paulFlowersFootballer.getTeams().get(j) != null) {
				teams.add(paulFlowersFootballer.getTeams().get(j).getClass()
						.getDeclaredConstructor(paulFlowersFootballer.getTeams().get(j).getClass())
						.newInstance(paulFlowersFootballer.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "PaulFlowersFootballer [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear="
