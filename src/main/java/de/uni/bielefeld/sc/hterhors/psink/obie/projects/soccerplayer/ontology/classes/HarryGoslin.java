...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IHarryGoslin;
...
public class HarryGoslin implements IHarryGoslin {
	...
	public HarryGoslin(HarryGoslin harryGoslin) throws InstantiationException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		this.annotationID = harryGoslin.getAnnotationID();
		for (int j = 0; j < harryGoslin.getBirthPlaces().size(); j++) {
			if (harryGoslin.getBirthPlaces().get(j) != null) {
				birthPlaces.add(harryGoslin.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(harryGoslin.getBirthPlaces().get(j).getClass())
						.newInstance(harryGoslin.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (harryGoslin.getBirthYear() != null)
			this.birthYear = harryGoslin.getBirthYear().getClass()
					.getDeclaredConstructor(harryGoslin.getBirthYear().getClass())
					.newInstance(harryGoslin.getBirthYear());
		this.characterOffset = harryGoslin.getCharacterOffset();
		this.characterOnset = harryGoslin.getCharacterOnset();
		if (harryGoslin.getPosition() != null)
			this.position = harryGoslin.getPosition().getClass()
					.getDeclaredConstructor(harryGoslin.getPosition().getClass())
					.newInstance(harryGoslin.getPosition());
		for (int j = 0; j < harryGoslin.getTeams().size(); j++) {
			if (harryGoslin.getTeams().get(j) != null) {
				teams.add(harryGoslin.getTeams().get(j).getClass()
						.getDeclaredConstructor(harryGoslin.getTeams().get(j).getClass())
						.newInstance(harryGoslin.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "HarryGoslin [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear=" + birthYear
