...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IPiotrRobakowski;
...
public class PiotrRobakowski implements IPiotrRobakowski {
	...
	public PiotrRobakowski(PiotrRobakowski piotrRobakowski) throws InstantiationException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		this.annotationID = piotrRobakowski.getAnnotationID();
		for (int j = 0; j < piotrRobakowski.getBirthPlaces().size(); j++) {
			if (piotrRobakowski.getBirthPlaces().get(j) != null) {
				birthPlaces.add(piotrRobakowski.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(piotrRobakowski.getBirthPlaces().get(j).getClass())
						.newInstance(piotrRobakowski.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (piotrRobakowski.getBirthYear() != null)
			this.birthYear = piotrRobakowski.getBirthYear().getClass()
					.getDeclaredConstructor(piotrRobakowski.getBirthYear().getClass())
					.newInstance(piotrRobakowski.getBirthYear());
		this.characterOffset = piotrRobakowski.getCharacterOffset();
		this.characterOnset = piotrRobakowski.getCharacterOnset();
		if (piotrRobakowski.getPosition() != null)
			this.position = piotrRobakowski.getPosition().getClass()
					.getDeclaredConstructor(piotrRobakowski.getPosition().getClass())
					.newInstance(piotrRobakowski.getPosition());
		for (int j = 0; j < piotrRobakowski.getTeams().size(); j++) {
			if (piotrRobakowski.getTeams().get(j) != null) {
				teams.add(piotrRobakowski.getTeams().get(j).getClass()
						.getDeclaredConstructor(piotrRobakowski.getTeams().get(j).getClass())
						.newInstance(piotrRobakowski.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "PiotrRobakowski [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear="
