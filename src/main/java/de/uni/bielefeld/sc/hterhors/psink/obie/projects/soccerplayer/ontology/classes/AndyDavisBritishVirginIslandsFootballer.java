...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IAndyDavisBritishVirginIslandsFootballer;
...
public class AndyDavisBritishVirginIslandsFootballer implements IAndyDavisBritishVirginIslandsFootballer {
	...
	public AndyDavisBritishVirginIslandsFootballer(
			AndyDavisBritishVirginIslandsFootballer andyDavisBritishVirginIslandsFootballer)
			throws InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException,
			NoSuchMethodException, SecurityException {
		this.annotationID = andyDavisBritishVirginIslandsFootballer.getAnnotationID();
		for (int j = 0; j < andyDavisBritishVirginIslandsFootballer.getBirthPlaces().size(); j++) {
			if (andyDavisBritishVirginIslandsFootballer.getBirthPlaces().get(j) != null) {
				birthPlaces.add(andyDavisBritishVirginIslandsFootballer.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(
								andyDavisBritishVirginIslandsFootballer.getBirthPlaces().get(j).getClass())
						.newInstance(andyDavisBritishVirginIslandsFootballer.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (andyDavisBritishVirginIslandsFootballer.getBirthYear() != null)
			this.birthYear = andyDavisBritishVirginIslandsFootballer.getBirthYear().getClass()
					.getDeclaredConstructor(andyDavisBritishVirginIslandsFootballer.getBirthYear().getClass())
					.newInstance(andyDavisBritishVirginIslandsFootballer.getBirthYear());
		...
		if (andyDavisBritishVirginIslandsFootballer.getPosition() != null)
			this.position = andyDavisBritishVirginIslandsFootballer.getPosition().getClass()
					.getDeclaredConstructor(andyDavisBritishVirginIslandsFootballer.getPosition().getClass())
					.newInstance(andyDavisBritishVirginIslandsFootballer.getPosition());
		for (int j = 0; j < andyDavisBritishVirginIslandsFootballer.getTeams().size(); j++) {
			if (andyDavisBritishVirginIslandsFootballer.getTeams().get(j) != null) {
				teams.add(andyDavisBritishVirginIslandsFootballer.getTeams().get(j).getClass()
						.getDeclaredConstructor(andyDavisBritishVirginIslandsFootballer.getTeams().get(j).getClass())
						.newInstance(andyDavisBritishVirginIslandsFootballer.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "AndyDavisBritishVirginIslandsFootballer [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces
				+ ",birthYear=" + birthYear + ",characterOffset=" + characterOffset + ",characterOnset="
				+ characterOnset + ",position=" + position + ",serialVersionUID=" + serialVersionUID + ",teams=" + teams
