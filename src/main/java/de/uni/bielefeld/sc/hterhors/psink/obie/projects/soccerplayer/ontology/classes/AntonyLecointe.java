...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IAntonyLecointe;
...
public class AntonyLecointe implements IAntonyLecointe {
	...
	public AntonyLecointe(AntonyLecointe antonyLecointe) throws InstantiationException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		this.annotationID = antonyLecointe.getAnnotationID();
		for (int j = 0; j < antonyLecointe.getBirthPlaces().size(); j++) {
			if (antonyLecointe.getBirthPlaces().get(j) != null) {
				birthPlaces.add(antonyLecointe.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(antonyLecointe.getBirthPlaces().get(j).getClass())
						.newInstance(antonyLecointe.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (antonyLecointe.getBirthYear() != null)
			this.birthYear = antonyLecointe.getBirthYear().getClass()
					.getDeclaredConstructor(antonyLecointe.getBirthYear().getClass())
					.newInstance(antonyLecointe.getBirthYear());
		this.characterOffset = antonyLecointe.getCharacterOffset();
		this.characterOnset = antonyLecointe.getCharacterOnset();
		if (antonyLecointe.getPosition() != null)
			this.position = antonyLecointe.getPosition().getClass()
					.getDeclaredConstructor(antonyLecointe.getPosition().getClass())
					.newInstance(antonyLecointe.getPosition());
		for (int j = 0; j < antonyLecointe.getTeams().size(); j++) {
			if (antonyLecointe.getTeams().get(j) != null) {
				teams.add(antonyLecointe.getTeams().get(j).getClass()
						.getDeclaredConstructor(antonyLecointe.getTeams().get(j).getClass())
						.newInstance(antonyLecointe.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "AntonyLecointe [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear="
