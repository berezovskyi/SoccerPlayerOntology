...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IYorickAntheunis;
...
public class YorickAntheunis implements IYorickAntheunis {
	...
	public YorickAntheunis(YorickAntheunis yorickAntheunis) throws InstantiationException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		this.annotationID = yorickAntheunis.getAnnotationID();
		for (int j = 0; j < yorickAntheunis.getBirthPlaces().size(); j++) {
			if (yorickAntheunis.getBirthPlaces().get(j) != null) {
				birthPlaces.add(yorickAntheunis.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(yorickAntheunis.getBirthPlaces().get(j).getClass())
						.newInstance(yorickAntheunis.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (yorickAntheunis.getBirthYear() != null)
			this.birthYear = yorickAntheunis.getBirthYear().getClass()
					.getDeclaredConstructor(yorickAntheunis.getBirthYear().getClass())
					.newInstance(yorickAntheunis.getBirthYear());
		this.characterOffset = yorickAntheunis.getCharacterOffset();
		this.characterOnset = yorickAntheunis.getCharacterOnset();
		if (yorickAntheunis.getPosition() != null)
			this.position = yorickAntheunis.getPosition().getClass()
					.getDeclaredConstructor(yorickAntheunis.getPosition().getClass())
					.newInstance(yorickAntheunis.getPosition());
		for (int j = 0; j < yorickAntheunis.getTeams().size(); j++) {
			if (yorickAntheunis.getTeams().get(j) != null) {
				teams.add(yorickAntheunis.getTeams().get(j).getClass()
						.getDeclaredConstructor(yorickAntheunis.getTeams().get(j).getClass())
						.newInstance(yorickAntheunis.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "YorickAntheunis [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear="
