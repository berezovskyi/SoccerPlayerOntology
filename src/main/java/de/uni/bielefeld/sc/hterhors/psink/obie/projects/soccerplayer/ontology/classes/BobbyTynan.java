...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IBobbyTynan;
...
public class BobbyTynan implements IBobbyTynan {
	...
	public BobbyTynan(BobbyTynan bobbyTynan) throws InstantiationException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		this.annotationID = bobbyTynan.getAnnotationID();
		for (int j = 0; j < bobbyTynan.getBirthPlaces().size(); j++) {
			if (bobbyTynan.getBirthPlaces().get(j) != null) {
				birthPlaces.add(bobbyTynan.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(bobbyTynan.getBirthPlaces().get(j).getClass())
						.newInstance(bobbyTynan.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (bobbyTynan.getBirthYear() != null)
			this.birthYear = bobbyTynan.getBirthYear().getClass()
					.getDeclaredConstructor(bobbyTynan.getBirthYear().getClass())
					.newInstance(bobbyTynan.getBirthYear());
		this.characterOffset = bobbyTynan.getCharacterOffset();
		this.characterOnset = bobbyTynan.getCharacterOnset();
		if (bobbyTynan.getPosition() != null)
			this.position = bobbyTynan.getPosition().getClass()
					.getDeclaredConstructor(bobbyTynan.getPosition().getClass()).newInstance(bobbyTynan.getPosition());
		for (int j = 0; j < bobbyTynan.getTeams().size(); j++) {
			if (bobbyTynan.getTeams().get(j) != null) {
				teams.add(bobbyTynan.getTeams().get(j).getClass()
						.getDeclaredConstructor(bobbyTynan.getTeams().get(j).getClass())
						.newInstance(bobbyTynan.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "BobbyTynan [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear=" + birthYear
