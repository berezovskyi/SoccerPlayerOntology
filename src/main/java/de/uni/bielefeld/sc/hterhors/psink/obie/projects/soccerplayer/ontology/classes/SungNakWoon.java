...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.ISungNakWoon;
...
public class SungNakWoon implements ISungNakWoon {
	...
	public SungNakWoon(SungNakWoon sungNakWoon) throws InstantiationException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		this.annotationID = sungNakWoon.getAnnotationID();
		for (int j = 0; j < sungNakWoon.getBirthPlaces().size(); j++) {
			if (sungNakWoon.getBirthPlaces().get(j) != null) {
				birthPlaces.add(sungNakWoon.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(sungNakWoon.getBirthPlaces().get(j).getClass())
						.newInstance(sungNakWoon.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (sungNakWoon.getBirthYear() != null)
			this.birthYear = sungNakWoon.getBirthYear().getClass()
					.getDeclaredConstructor(sungNakWoon.getBirthYear().getClass())
					.newInstance(sungNakWoon.getBirthYear());
		this.characterOffset = sungNakWoon.getCharacterOffset();
		this.characterOnset = sungNakWoon.getCharacterOnset();
		if (sungNakWoon.getPosition() != null)
			this.position = sungNakWoon.getPosition().getClass()
					.getDeclaredConstructor(sungNakWoon.getPosition().getClass())
					.newInstance(sungNakWoon.getPosition());
		for (int j = 0; j < sungNakWoon.getTeams().size(); j++) {
			if (sungNakWoon.getTeams().get(j) != null) {
				teams.add(sungNakWoon.getTeams().get(j).getClass()
						.getDeclaredConstructor(sungNakWoon.getTeams().get(j).getClass())
						.newInstance(sungNakWoon.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "SungNakWoon [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear=" + birthYear
