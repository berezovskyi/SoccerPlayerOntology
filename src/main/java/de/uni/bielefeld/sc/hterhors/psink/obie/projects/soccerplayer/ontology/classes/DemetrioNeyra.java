...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IDemetrioNeyra;
...
public class DemetrioNeyra implements IDemetrioNeyra {
	...
	public DemetrioNeyra(DemetrioNeyra demetrioNeyra) throws InstantiationException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		this.annotationID = demetrioNeyra.getAnnotationID();
		for (int j = 0; j < demetrioNeyra.getBirthPlaces().size(); j++) {
			if (demetrioNeyra.getBirthPlaces().get(j) != null) {
				birthPlaces.add(demetrioNeyra.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(demetrioNeyra.getBirthPlaces().get(j).getClass())
						.newInstance(demetrioNeyra.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (demetrioNeyra.getBirthYear() != null)
			this.birthYear = demetrioNeyra.getBirthYear().getClass()
					.getDeclaredConstructor(demetrioNeyra.getBirthYear().getClass())
					.newInstance(demetrioNeyra.getBirthYear());
		this.characterOffset = demetrioNeyra.getCharacterOffset();
		this.characterOnset = demetrioNeyra.getCharacterOnset();
		if (demetrioNeyra.getPosition() != null)
			this.position = demetrioNeyra.getPosition().getClass()
					.getDeclaredConstructor(demetrioNeyra.getPosition().getClass())
					.newInstance(demetrioNeyra.getPosition());
		for (int j = 0; j < demetrioNeyra.getTeams().size(); j++) {
			if (demetrioNeyra.getTeams().get(j) != null) {
				teams.add(demetrioNeyra.getTeams().get(j).getClass()
						.getDeclaredConstructor(demetrioNeyra.getTeams().get(j).getClass())
						.newInstance(demetrioNeyra.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "DemetrioNeyra [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear=" + birthYear
