...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IHarryMooreFootballer;
...
public class HarryMooreFootballer implements IHarryMooreFootballer {
	...
	public HarryMooreFootballer(HarryMooreFootballer harryMooreFootballer)
			throws InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException,
			NoSuchMethodException, SecurityException {
		this.annotationID = harryMooreFootballer.getAnnotationID();
		for (int j = 0; j < harryMooreFootballer.getBirthPlaces().size(); j++) {
			if (harryMooreFootballer.getBirthPlaces().get(j) != null) {
				birthPlaces.add(harryMooreFootballer.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(harryMooreFootballer.getBirthPlaces().get(j).getClass())
						.newInstance(harryMooreFootballer.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (harryMooreFootballer.getBirthYear() != null)
			this.birthYear = harryMooreFootballer.getBirthYear().getClass()
					.getDeclaredConstructor(harryMooreFootballer.getBirthYear().getClass())
					.newInstance(harryMooreFootballer.getBirthYear());
		this.characterOffset = harryMooreFootballer.getCharacterOffset();
		this.characterOnset = harryMooreFootballer.getCharacterOnset();
		if (harryMooreFootballer.getPosition() != null)
			this.position = harryMooreFootballer.getPosition().getClass()
					.getDeclaredConstructor(harryMooreFootballer.getPosition().getClass())
					.newInstance(harryMooreFootballer.getPosition());
		for (int j = 0; j < harryMooreFootballer.getTeams().size(); j++) {
			if (harryMooreFootballer.getTeams().get(j) != null) {
				teams.add(harryMooreFootballer.getTeams().get(j).getClass()
						.getDeclaredConstructor(harryMooreFootballer.getTeams().get(j).getClass())
						.newInstance(harryMooreFootballer.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "HarryMooreFootballer [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear="
