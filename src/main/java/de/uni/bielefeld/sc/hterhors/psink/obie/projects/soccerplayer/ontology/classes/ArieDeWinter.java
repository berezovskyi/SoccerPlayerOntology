...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IArieDeWinter;
...
public class ArieDeWinter implements IArieDeWinter {
	...
	public ArieDeWinter(ArieDeWinter arieDeWinter) throws InstantiationException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		this.annotationID = arieDeWinter.getAnnotationID();
		for (int j = 0; j < arieDeWinter.getBirthPlaces().size(); j++) {
			if (arieDeWinter.getBirthPlaces().get(j) != null) {
				birthPlaces.add(arieDeWinter.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(arieDeWinter.getBirthPlaces().get(j).getClass())
						.newInstance(arieDeWinter.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (arieDeWinter.getBirthYear() != null)
			this.birthYear = arieDeWinter.getBirthYear().getClass()
					.getDeclaredConstructor(arieDeWinter.getBirthYear().getClass())
					.newInstance(arieDeWinter.getBirthYear());
		this.characterOffset = arieDeWinter.getCharacterOffset();
		this.characterOnset = arieDeWinter.getCharacterOnset();
		if (arieDeWinter.getPosition() != null)
			this.position = arieDeWinter.getPosition().getClass()
					.getDeclaredConstructor(arieDeWinter.getPosition().getClass())
					.newInstance(arieDeWinter.getPosition());
		for (int j = 0; j < arieDeWinter.getTeams().size(); j++) {
			if (arieDeWinter.getTeams().get(j) != null) {
				teams.add(arieDeWinter.getTeams().get(j).getClass()
						.getDeclaredConstructor(arieDeWinter.getTeams().get(j).getClass())
						.newInstance(arieDeWinter.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "ArieDeWinter [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear=" + birthYear
