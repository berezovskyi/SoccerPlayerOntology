...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IAlanDennis;
...
public class AlanDennis implements IAlanDennis {
	...
	public AlanDennis(AlanDennis alanDennis) throws InstantiationException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		this.annotationID = alanDennis.getAnnotationID();
		for (int j = 0; j < alanDennis.getBirthPlaces().size(); j++) {
			if (alanDennis.getBirthPlaces().get(j) != null) {
				birthPlaces.add(alanDennis.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(alanDennis.getBirthPlaces().get(j).getClass())
						.newInstance(alanDennis.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (alanDennis.getBirthYear() != null)
			this.birthYear = alanDennis.getBirthYear().getClass()
					.getDeclaredConstructor(alanDennis.getBirthYear().getClass())
					.newInstance(alanDennis.getBirthYear());
		this.characterOffset = alanDennis.getCharacterOffset();
		this.characterOnset = alanDennis.getCharacterOnset();
		if (alanDennis.getPosition() != null)
			this.position = alanDennis.getPosition().getClass()
					.getDeclaredConstructor(alanDennis.getPosition().getClass()).newInstance(alanDennis.getPosition());
		for (int j = 0; j < alanDennis.getTeams().size(); j++) {
			if (alanDennis.getTeams().get(j) != null) {
				teams.add(alanDennis.getTeams().get(j).getClass()
						.getDeclaredConstructor(alanDennis.getTeams().get(j).getClass())
						.newInstance(alanDennis.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "AlanDennis [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear=" + birthYear
