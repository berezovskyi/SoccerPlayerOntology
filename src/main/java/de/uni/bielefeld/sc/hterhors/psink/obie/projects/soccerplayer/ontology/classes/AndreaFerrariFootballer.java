...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IAndreaFerrariFootballer;
...
public class AndreaFerrariFootballer implements IAndreaFerrariFootballer {
	...
	public AndreaFerrariFootballer(AndreaFerrariFootballer andreaFerrariFootballer)
			throws InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException,
			NoSuchMethodException, SecurityException {
		this.annotationID = andreaFerrariFootballer.getAnnotationID();
		for (int j = 0; j < andreaFerrariFootballer.getBirthPlaces().size(); j++) {
			if (andreaFerrariFootballer.getBirthPlaces().get(j) != null) {
				birthPlaces.add(andreaFerrariFootballer.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(andreaFerrariFootballer.getBirthPlaces().get(j).getClass())
						.newInstance(andreaFerrariFootballer.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (andreaFerrariFootballer.getBirthYear() != null)
			this.birthYear = andreaFerrariFootballer.getBirthYear().getClass()
					.getDeclaredConstructor(andreaFerrariFootballer.getBirthYear().getClass())
					.newInstance(andreaFerrariFootballer.getBirthYear());
		...
		if (andreaFerrariFootballer.getPosition() != null)
			this.position = andreaFerrariFootballer.getPosition().getClass()
					.getDeclaredConstructor(andreaFerrariFootballer.getPosition().getClass())
					.newInstance(andreaFerrariFootballer.getPosition());
		for (int j = 0; j < andreaFerrariFootballer.getTeams().size(); j++) {
			if (andreaFerrariFootballer.getTeams().get(j) != null) {
				teams.add(andreaFerrariFootballer.getTeams().get(j).getClass()
						.getDeclaredConstructor(andreaFerrariFootballer.getTeams().get(j).getClass())
						.newInstance(andreaFerrariFootballer.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "AndreaFerrariFootballer [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear="
