...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IJoBackaert;
...
public class JoBackaert implements IJoBackaert {
	...
	public JoBackaert(JoBackaert joBackaert) throws InstantiationException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		this.annotationID = joBackaert.getAnnotationID();
		for (int j = 0; j < joBackaert.getBirthPlaces().size(); j++) {
			if (joBackaert.getBirthPlaces().get(j) != null) {
				birthPlaces.add(joBackaert.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(joBackaert.getBirthPlaces().get(j).getClass())
						.newInstance(joBackaert.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (joBackaert.getBirthYear() != null)
			this.birthYear = joBackaert.getBirthYear().getClass()
					.getDeclaredConstructor(joBackaert.getBirthYear().getClass())
					.newInstance(joBackaert.getBirthYear());
		this.characterOffset = joBackaert.getCharacterOffset();
		this.characterOnset = joBackaert.getCharacterOnset();
		if (joBackaert.getPosition() != null)
			this.position = joBackaert.getPosition().getClass()
					.getDeclaredConstructor(joBackaert.getPosition().getClass()).newInstance(joBackaert.getPosition());
		for (int j = 0; j < joBackaert.getTeams().size(); j++) {
			if (joBackaert.getTeams().get(j) != null) {
				teams.add(joBackaert.getTeams().get(j).getClass()
						.getDeclaredConstructor(joBackaert.getTeams().get(j).getClass())
						.newInstance(joBackaert.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "JoBackaert [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear=" + birthYear
