...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IDavidBuckFootballer;
...
public class DavidBuckFootballer implements IDavidBuckFootballer {
	...
	public DavidBuckFootballer(DavidBuckFootballer davidBuckFootballer)
			throws InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException,
			NoSuchMethodException, SecurityException {
		this.annotationID = davidBuckFootballer.getAnnotationID();
		for (int j = 0; j < davidBuckFootballer.getBirthPlaces().size(); j++) {
			if (davidBuckFootballer.getBirthPlaces().get(j) != null) {
				birthPlaces.add(davidBuckFootballer.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(davidBuckFootballer.getBirthPlaces().get(j).getClass())
						.newInstance(davidBuckFootballer.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (davidBuckFootballer.getBirthYear() != null)
			this.birthYear = davidBuckFootballer.getBirthYear().getClass()
					.getDeclaredConstructor(davidBuckFootballer.getBirthYear().getClass())
					.newInstance(davidBuckFootballer.getBirthYear());
		this.characterOffset = davidBuckFootballer.getCharacterOffset();
		this.characterOnset = davidBuckFootballer.getCharacterOnset();
		if (davidBuckFootballer.getPosition() != null)
			this.position = davidBuckFootballer.getPosition().getClass()
					.getDeclaredConstructor(davidBuckFootballer.getPosition().getClass())
					.newInstance(davidBuckFootballer.getPosition());
		for (int j = 0; j < davidBuckFootballer.getTeams().size(); j++) {
			if (davidBuckFootballer.getTeams().get(j) != null) {
				teams.add(davidBuckFootballer.getTeams().get(j).getClass()
						.getDeclaredConstructor(davidBuckFootballer.getTeams().get(j).getClass())
						.newInstance(davidBuckFootballer.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "DavidBuckFootballer [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear="
