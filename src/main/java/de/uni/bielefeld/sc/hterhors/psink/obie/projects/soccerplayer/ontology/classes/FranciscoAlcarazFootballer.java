...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IFranciscoAlcarazFootballer;
...
public class FranciscoAlcarazFootballer implements IFranciscoAlcarazFootballer {
	...
	public FranciscoAlcarazFootballer(FranciscoAlcarazFootballer franciscoAlcarazFootballer)
			throws InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException,
			NoSuchMethodException, SecurityException {
		this.annotationID = franciscoAlcarazFootballer.getAnnotationID();
		for (int j = 0; j < franciscoAlcarazFootballer.getBirthPlaces().size(); j++) {
			if (franciscoAlcarazFootballer.getBirthPlaces().get(j) != null) {
				birthPlaces.add(franciscoAlcarazFootballer.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(franciscoAlcarazFootballer.getBirthPlaces().get(j).getClass())
						.newInstance(franciscoAlcarazFootballer.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (franciscoAlcarazFootballer.getBirthYear() != null)
			this.birthYear = franciscoAlcarazFootballer.getBirthYear().getClass()
					.getDeclaredConstructor(franciscoAlcarazFootballer.getBirthYear().getClass())
					.newInstance(franciscoAlcarazFootballer.getBirthYear());
		...
		if (franciscoAlcarazFootballer.getPosition() != null)
			this.position = franciscoAlcarazFootballer.getPosition().getClass()
					.getDeclaredConstructor(franciscoAlcarazFootballer.getPosition().getClass())
					.newInstance(franciscoAlcarazFootballer.getPosition());
		for (int j = 0; j < franciscoAlcarazFootballer.getTeams().size(); j++) {
			if (franciscoAlcarazFootballer.getTeams().get(j) != null) {
				teams.add(franciscoAlcarazFootballer.getTeams().get(j).getClass()
						.getDeclaredConstructor(franciscoAlcarazFootballer.getTeams().get(j).getClass())
						.newInstance(franciscoAlcarazFootballer.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "FranciscoAlcarazFootballer [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces
