...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IRayWhiteFootballer;
...
public class RayWhiteFootballer implements IRayWhiteFootballer {
	...
	public RayWhiteFootballer(RayWhiteFootballer rayWhiteFootballer)
			throws InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException,
			NoSuchMethodException, SecurityException {
		this.annotationID = rayWhiteFootballer.getAnnotationID();
		for (int j = 0; j < rayWhiteFootballer.getBirthPlaces().size(); j++) {
			if (rayWhiteFootballer.getBirthPlaces().get(j) != null) {
				birthPlaces.add(rayWhiteFootballer.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(rayWhiteFootballer.getBirthPlaces().get(j).getClass())
						.newInstance(rayWhiteFootballer.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (rayWhiteFootballer.getBirthYear() != null)
			this.birthYear = rayWhiteFootballer.getBirthYear().getClass()
					.getDeclaredConstructor(rayWhiteFootballer.getBirthYear().getClass())
					.newInstance(rayWhiteFootballer.getBirthYear());
		this.characterOffset = rayWhiteFootballer.getCharacterOffset();
		this.characterOnset = rayWhiteFootballer.getCharacterOnset();
		if (rayWhiteFootballer.getPosition() != null)
			this.position = rayWhiteFootballer.getPosition().getClass()
					.getDeclaredConstructor(rayWhiteFootballer.getPosition().getClass())
					.newInstance(rayWhiteFootballer.getPosition());
		for (int j = 0; j < rayWhiteFootballer.getTeams().size(); j++) {
			if (rayWhiteFootballer.getTeams().get(j) != null) {
				teams.add(rayWhiteFootballer.getTeams().get(j).getClass()
						.getDeclaredConstructor(rayWhiteFootballer.getTeams().get(j).getClass())
						.newInstance(rayWhiteFootballer.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "RayWhiteFootballer [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear="
