...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IThandokuhleMkhonza;
...
public class ThandokuhleMkhonza implements IThandokuhleMkhonza {
	...
	public ThandokuhleMkhonza(ThandokuhleMkhonza thandokuhleMkhonza)
			throws InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException,
			NoSuchMethodException, SecurityException {
		this.annotationID = thandokuhleMkhonza.getAnnotationID();
		for (int j = 0; j < thandokuhleMkhonza.getBirthPlaces().size(); j++) {
			if (thandokuhleMkhonza.getBirthPlaces().get(j) != null) {
				birthPlaces.add(thandokuhleMkhonza.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(thandokuhleMkhonza.getBirthPlaces().get(j).getClass())
						.newInstance(thandokuhleMkhonza.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (thandokuhleMkhonza.getBirthYear() != null)
			this.birthYear = thandokuhleMkhonza.getBirthYear().getClass()
					.getDeclaredConstructor(thandokuhleMkhonza.getBirthYear().getClass())
					.newInstance(thandokuhleMkhonza.getBirthYear());
		this.characterOffset = thandokuhleMkhonza.getCharacterOffset();
		this.characterOnset = thandokuhleMkhonza.getCharacterOnset();
		if (thandokuhleMkhonza.getPosition() != null)
			this.position = thandokuhleMkhonza.getPosition().getClass()
					.getDeclaredConstructor(thandokuhleMkhonza.getPosition().getClass())
					.newInstance(thandokuhleMkhonza.getPosition());
		for (int j = 0; j < thandokuhleMkhonza.getTeams().size(); j++) {
			if (thandokuhleMkhonza.getTeams().get(j) != null) {
				teams.add(thandokuhleMkhonza.getTeams().get(j).getClass()
						.getDeclaredConstructor(thandokuhleMkhonza.getTeams().get(j).getClass())
						.newInstance(thandokuhleMkhonza.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "ThandokuhleMkhonza [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear="
