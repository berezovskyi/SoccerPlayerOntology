...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IBruceCrawfordFootballer;
...
public class BruceCrawfordFootballer implements IBruceCrawfordFootballer {
	...
	public BruceCrawfordFootballer(BruceCrawfordFootballer bruceCrawfordFootballer)
			throws InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException,
			NoSuchMethodException, SecurityException {
		this.annotationID = bruceCrawfordFootballer.getAnnotationID();
		for (int j = 0; j < bruceCrawfordFootballer.getBirthPlaces().size(); j++) {
			if (bruceCrawfordFootballer.getBirthPlaces().get(j) != null) {
				birthPlaces.add(bruceCrawfordFootballer.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(bruceCrawfordFootballer.getBirthPlaces().get(j).getClass())
						.newInstance(bruceCrawfordFootballer.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (bruceCrawfordFootballer.getBirthYear() != null)
			this.birthYear = bruceCrawfordFootballer.getBirthYear().getClass()
					.getDeclaredConstructor(bruceCrawfordFootballer.getBirthYear().getClass())
					.newInstance(bruceCrawfordFootballer.getBirthYear());
		...
		if (bruceCrawfordFootballer.getPosition() != null)
			this.position = bruceCrawfordFootballer.getPosition().getClass()
					.getDeclaredConstructor(bruceCrawfordFootballer.getPosition().getClass())
					.newInstance(bruceCrawfordFootballer.getPosition());
		for (int j = 0; j < bruceCrawfordFootballer.getTeams().size(); j++) {
			if (bruceCrawfordFootballer.getTeams().get(j) != null) {
				teams.add(bruceCrawfordFootballer.getTeams().get(j).getClass()
						.getDeclaredConstructor(bruceCrawfordFootballer.getTeams().get(j).getClass())
						.newInstance(bruceCrawfordFootballer.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "BruceCrawfordFootballer [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear="
