...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IDarrenHoldenFootballer;
...
public class DarrenHoldenFootballer implements IDarrenHoldenFootballer {
	...
	public DarrenHoldenFootballer(DarrenHoldenFootballer darrenHoldenFootballer)
			throws InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException,
			NoSuchMethodException, SecurityException {
		this.annotationID = darrenHoldenFootballer.getAnnotationID();
		for (int j = 0; j < darrenHoldenFootballer.getBirthPlaces().size(); j++) {
			if (darrenHoldenFootballer.getBirthPlaces().get(j) != null) {
				birthPlaces.add(darrenHoldenFootballer.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(darrenHoldenFootballer.getBirthPlaces().get(j).getClass())
						.newInstance(darrenHoldenFootballer.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (darrenHoldenFootballer.getBirthYear() != null)
			this.birthYear = darrenHoldenFootballer.getBirthYear().getClass()
					.getDeclaredConstructor(darrenHoldenFootballer.getBirthYear().getClass())
					.newInstance(darrenHoldenFootballer.getBirthYear());
		...
		if (darrenHoldenFootballer.getPosition() != null)
			this.position = darrenHoldenFootballer.getPosition().getClass()
					.getDeclaredConstructor(darrenHoldenFootballer.getPosition().getClass())
					.newInstance(darrenHoldenFootballer.getPosition());
		for (int j = 0; j < darrenHoldenFootballer.getTeams().size(); j++) {
			if (darrenHoldenFootballer.getTeams().get(j) != null) {
				teams.add(darrenHoldenFootballer.getTeams().get(j).getClass()
						.getDeclaredConstructor(darrenHoldenFootballer.getTeams().get(j).getClass())
						.newInstance(darrenHoldenFootballer.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "DarrenHoldenFootballer [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear="
