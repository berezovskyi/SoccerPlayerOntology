...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IOleChristofferHeierenHansen;
...
public class OleChristofferHeierenHansen implements IOleChristofferHeierenHansen {
	...
	public OleChristofferHeierenHansen(OleChristofferHeierenHansen oleChristofferHeierenHansen)
			throws InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException,
			NoSuchMethodException, SecurityException {
		this.annotationID = oleChristofferHeierenHansen.getAnnotationID();
		for (int j = 0; j < oleChristofferHeierenHansen.getBirthPlaces().size(); j++) {
			if (oleChristofferHeierenHansen.getBirthPlaces().get(j) != null) {
				birthPlaces.add(oleChristofferHeierenHansen.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(oleChristofferHeierenHansen.getBirthPlaces().get(j).getClass())
						.newInstance(oleChristofferHeierenHansen.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (oleChristofferHeierenHansen.getBirthYear() != null)
			this.birthYear = oleChristofferHeierenHansen.getBirthYear().getClass()
					.getDeclaredConstructor(oleChristofferHeierenHansen.getBirthYear().getClass())
					.newInstance(oleChristofferHeierenHansen.getBirthYear());
		...
		if (oleChristofferHeierenHansen.getPosition() != null)
			this.position = oleChristofferHeierenHansen.getPosition().getClass()
					.getDeclaredConstructor(oleChristofferHeierenHansen.getPosition().getClass())
					.newInstance(oleChristofferHeierenHansen.getPosition());
		for (int j = 0; j < oleChristofferHeierenHansen.getTeams().size(); j++) {
			if (oleChristofferHeierenHansen.getTeams().get(j) != null) {
				teams.add(oleChristofferHeierenHansen.getTeams().get(j).getClass()
						.getDeclaredConstructor(oleChristofferHeierenHansen.getTeams().get(j).getClass())
						.newInstance(oleChristofferHeierenHansen.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "OleChristofferHeierenHansen [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces
