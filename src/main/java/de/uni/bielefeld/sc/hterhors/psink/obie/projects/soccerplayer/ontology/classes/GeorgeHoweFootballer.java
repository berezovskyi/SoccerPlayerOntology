...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IGeorgeHoweFootballer;
...
public class GeorgeHoweFootballer implements IGeorgeHoweFootballer {
	...
	public GeorgeHoweFootballer(GeorgeHoweFootballer georgeHoweFootballer)
			throws InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException,
			NoSuchMethodException, SecurityException {
		this.annotationID = georgeHoweFootballer.getAnnotationID();
		for (int j = 0; j < georgeHoweFootballer.getBirthPlaces().size(); j++) {
			if (georgeHoweFootballer.getBirthPlaces().get(j) != null) {
				birthPlaces.add(georgeHoweFootballer.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(georgeHoweFootballer.getBirthPlaces().get(j).getClass())
						.newInstance(georgeHoweFootballer.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (georgeHoweFootballer.getBirthYear() != null)
			this.birthYear = georgeHoweFootballer.getBirthYear().getClass()
					.getDeclaredConstructor(georgeHoweFootballer.getBirthYear().getClass())
					.newInstance(georgeHoweFootballer.getBirthYear());
		this.characterOffset = georgeHoweFootballer.getCharacterOffset();
		this.characterOnset = georgeHoweFootballer.getCharacterOnset();
		if (georgeHoweFootballer.getPosition() != null)
			this.position = georgeHoweFootballer.getPosition().getClass()
					.getDeclaredConstructor(georgeHoweFootballer.getPosition().getClass())
					.newInstance(georgeHoweFootballer.getPosition());
		for (int j = 0; j < georgeHoweFootballer.getTeams().size(); j++) {
			if (georgeHoweFootballer.getTeams().get(j) != null) {
				teams.add(georgeHoweFootballer.getTeams().get(j).getClass()
						.getDeclaredConstructor(georgeHoweFootballer.getTeams().get(j).getClass())
						.newInstance(georgeHoweFootballer.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "GeorgeHoweFootballer [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear="
