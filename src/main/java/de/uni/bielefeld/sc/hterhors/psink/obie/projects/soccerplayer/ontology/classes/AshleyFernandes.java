...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IAshleyFernandes;
...
public class AshleyFernandes implements IAshleyFernandes {
	...
	public AshleyFernandes(AshleyFernandes ashleyFernandes) throws InstantiationException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		this.annotationID = ashleyFernandes.getAnnotationID();
		for (int j = 0; j < ashleyFernandes.getBirthPlaces().size(); j++) {
			if (ashleyFernandes.getBirthPlaces().get(j) != null) {
				birthPlaces.add(ashleyFernandes.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(ashleyFernandes.getBirthPlaces().get(j).getClass())
						.newInstance(ashleyFernandes.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (ashleyFernandes.getBirthYear() != null)
			this.birthYear = ashleyFernandes.getBirthYear().getClass()
					.getDeclaredConstructor(ashleyFernandes.getBirthYear().getClass())
					.newInstance(ashleyFernandes.getBirthYear());
		this.characterOffset = ashleyFernandes.getCharacterOffset();
		this.characterOnset = ashleyFernandes.getCharacterOnset();
		if (ashleyFernandes.getPosition() != null)
			this.position = ashleyFernandes.getPosition().getClass()
					.getDeclaredConstructor(ashleyFernandes.getPosition().getClass())
					.newInstance(ashleyFernandes.getPosition());
		for (int j = 0; j < ashleyFernandes.getTeams().size(); j++) {
			if (ashleyFernandes.getTeams().get(j) != null) {
				teams.add(ashleyFernandes.getTeams().get(j).getClass()
						.getDeclaredConstructor(ashleyFernandes.getTeams().get(j).getClass())
						.newInstance(ashleyFernandes.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "AshleyFernandes [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear="
