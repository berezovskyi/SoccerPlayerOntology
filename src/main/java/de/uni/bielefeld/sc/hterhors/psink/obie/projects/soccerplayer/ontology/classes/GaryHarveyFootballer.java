...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IGaryHarveyFootballer;
...
public class GaryHarveyFootballer implements IGaryHarveyFootballer {
	...
	public GaryHarveyFootballer(GaryHarveyFootballer garyHarveyFootballer)
			throws InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException,
			NoSuchMethodException, SecurityException {
		this.annotationID = garyHarveyFootballer.getAnnotationID();
		for (int j = 0; j < garyHarveyFootballer.getBirthPlaces().size(); j++) {
			if (garyHarveyFootballer.getBirthPlaces().get(j) != null) {
				birthPlaces.add(garyHarveyFootballer.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(garyHarveyFootballer.getBirthPlaces().get(j).getClass())
						.newInstance(garyHarveyFootballer.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (garyHarveyFootballer.getBirthYear() != null)
			this.birthYear = garyHarveyFootballer.getBirthYear().getClass()
					.getDeclaredConstructor(garyHarveyFootballer.getBirthYear().getClass())
					.newInstance(garyHarveyFootballer.getBirthYear());
		this.characterOffset = garyHarveyFootballer.getCharacterOffset();
		this.characterOnset = garyHarveyFootballer.getCharacterOnset();
		if (garyHarveyFootballer.getPosition() != null)
			this.position = garyHarveyFootballer.getPosition().getClass()
					.getDeclaredConstructor(garyHarveyFootballer.getPosition().getClass())
					.newInstance(garyHarveyFootballer.getPosition());
		for (int j = 0; j < garyHarveyFootballer.getTeams().size(); j++) {
			if (garyHarveyFootballer.getTeams().get(j) != null) {
				teams.add(garyHarveyFootballer.getTeams().get(j).getClass()
						.getDeclaredConstructor(garyHarveyFootballer.getTeams().get(j).getClass())
						.newInstance(garyHarveyFootballer.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "GaryHarveyFootballer [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear="
