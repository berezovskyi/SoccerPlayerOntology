...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IAlfredDobson;
...
public class AlfredDobson implements IAlfredDobson {
	...
	public AlfredDobson(AlfredDobson alfredDobson) throws InstantiationException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		this.annotationID = alfredDobson.getAnnotationID();
		for (int j = 0; j < alfredDobson.getBirthPlaces().size(); j++) {
			if (alfredDobson.getBirthPlaces().get(j) != null) {
				birthPlaces.add(alfredDobson.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(alfredDobson.getBirthPlaces().get(j).getClass())
						.newInstance(alfredDobson.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (alfredDobson.getBirthYear() != null)
			this.birthYear = alfredDobson.getBirthYear().getClass()
					.getDeclaredConstructor(alfredDobson.getBirthYear().getClass())
					.newInstance(alfredDobson.getBirthYear());
		this.characterOffset = alfredDobson.getCharacterOffset();
		this.characterOnset = alfredDobson.getCharacterOnset();
		if (alfredDobson.getPosition() != null)
			this.position = alfredDobson.getPosition().getClass()
					.getDeclaredConstructor(alfredDobson.getPosition().getClass())
					.newInstance(alfredDobson.getPosition());
		for (int j = 0; j < alfredDobson.getTeams().size(); j++) {
			if (alfredDobson.getTeams().get(j) != null) {
				teams.add(alfredDobson.getTeams().get(j).getClass()
						.getDeclaredConstructor(alfredDobson.getTeams().get(j).getClass())
						.newInstance(alfredDobson.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "AlfredDobson [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear=" + birthYear
