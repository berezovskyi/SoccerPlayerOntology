...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IReidarOlsen;
...
public class ReidarOlsen implements IReidarOlsen {
	...
	public ReidarOlsen(ReidarOlsen reidarOlsen) throws InstantiationException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		this.annotationID = reidarOlsen.getAnnotationID();
		for (int j = 0; j < reidarOlsen.getBirthPlaces().size(); j++) {
			if (reidarOlsen.getBirthPlaces().get(j) != null) {
				birthPlaces.add(reidarOlsen.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(reidarOlsen.getBirthPlaces().get(j).getClass())
						.newInstance(reidarOlsen.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (reidarOlsen.getBirthYear() != null)
			this.birthYear = reidarOlsen.getBirthYear().getClass()
					.getDeclaredConstructor(reidarOlsen.getBirthYear().getClass())
					.newInstance(reidarOlsen.getBirthYear());
		this.characterOffset = reidarOlsen.getCharacterOffset();
		this.characterOnset = reidarOlsen.getCharacterOnset();
		if (reidarOlsen.getPosition() != null)
			this.position = reidarOlsen.getPosition().getClass()
					.getDeclaredConstructor(reidarOlsen.getPosition().getClass())
					.newInstance(reidarOlsen.getPosition());
		for (int j = 0; j < reidarOlsen.getTeams().size(); j++) {
			if (reidarOlsen.getTeams().get(j) != null) {
				teams.add(reidarOlsen.getTeams().get(j).getClass()
						.getDeclaredConstructor(reidarOlsen.getTeams().get(j).getClass())
						.newInstance(reidarOlsen.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "ReidarOlsen [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear=" + birthYear
