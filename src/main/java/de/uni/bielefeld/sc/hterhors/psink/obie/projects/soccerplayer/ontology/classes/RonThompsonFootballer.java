...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IRonThompsonFootballer;
...
public class RonThompsonFootballer implements IRonThompsonFootballer {
	...
	public RonThompsonFootballer(RonThompsonFootballer ronThompsonFootballer)
			throws InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException,
			NoSuchMethodException, SecurityException {
		this.annotationID = ronThompsonFootballer.getAnnotationID();
		for (int j = 0; j < ronThompsonFootballer.getBirthPlaces().size(); j++) {
			if (ronThompsonFootballer.getBirthPlaces().get(j) != null) {
				birthPlaces.add(ronThompsonFootballer.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(ronThompsonFootballer.getBirthPlaces().get(j).getClass())
						.newInstance(ronThompsonFootballer.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (ronThompsonFootballer.getBirthYear() != null)
			this.birthYear = ronThompsonFootballer.getBirthYear().getClass()
					.getDeclaredConstructor(ronThompsonFootballer.getBirthYear().getClass())
					.newInstance(ronThompsonFootballer.getBirthYear());
		this.characterOffset = ronThompsonFootballer.getCharacterOffset();
		this.characterOnset = ronThompsonFootballer.getCharacterOnset();
		if (ronThompsonFootballer.getPosition() != null)
			this.position = ronThompsonFootballer.getPosition().getClass()
					.getDeclaredConstructor(ronThompsonFootballer.getPosition().getClass())
					.newInstance(ronThompsonFootballer.getPosition());
		for (int j = 0; j < ronThompsonFootballer.getTeams().size(); j++) {
			if (ronThompsonFootballer.getTeams().get(j) != null) {
				teams.add(ronThompsonFootballer.getTeams().get(j).getClass()
						.getDeclaredConstructor(ronThompsonFootballer.getTeams().get(j).getClass())
						.newInstance(ronThompsonFootballer.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "RonThompsonFootballer [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear="
