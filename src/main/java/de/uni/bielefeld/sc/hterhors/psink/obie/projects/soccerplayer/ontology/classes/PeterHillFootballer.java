...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IPeterHillFootballer;
...
public class PeterHillFootballer implements IPeterHillFootballer {
	...
	public PeterHillFootballer(PeterHillFootballer peterHillFootballer)
			throws InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException,
			NoSuchMethodException, SecurityException {
		this.annotationID = peterHillFootballer.getAnnotationID();
		for (int j = 0; j < peterHillFootballer.getBirthPlaces().size(); j++) {
			if (peterHillFootballer.getBirthPlaces().get(j) != null) {
				birthPlaces.add(peterHillFootballer.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(peterHillFootballer.getBirthPlaces().get(j).getClass())
						.newInstance(peterHillFootballer.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (peterHillFootballer.getBirthYear() != null)
			this.birthYear = peterHillFootballer.getBirthYear().getClass()
					.getDeclaredConstructor(peterHillFootballer.getBirthYear().getClass())
					.newInstance(peterHillFootballer.getBirthYear());
		this.characterOffset = peterHillFootballer.getCharacterOffset();
		this.characterOnset = peterHillFootballer.getCharacterOnset();
		if (peterHillFootballer.getPosition() != null)
			this.position = peterHillFootballer.getPosition().getClass()
					.getDeclaredConstructor(peterHillFootballer.getPosition().getClass())
					.newInstance(peterHillFootballer.getPosition());
		for (int j = 0; j < peterHillFootballer.getTeams().size(); j++) {
			if (peterHillFootballer.getTeams().get(j) != null) {
				teams.add(peterHillFootballer.getTeams().get(j).getClass()
						.getDeclaredConstructor(peterHillFootballer.getTeams().get(j).getClass())
						.newInstance(peterHillFootballer.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "PeterHillFootballer [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear="
