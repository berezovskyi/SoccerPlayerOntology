...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IDavidBueso;
...
public class DavidBueso implements IDavidBueso {
	...
	public DavidBueso(DavidBueso davidBueso) throws InstantiationException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		this.annotationID = davidBueso.getAnnotationID();
		for (int j = 0; j < davidBueso.getBirthPlaces().size(); j++) {
			if (davidBueso.getBirthPlaces().get(j) != null) {
				birthPlaces.add(davidBueso.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(davidBueso.getBirthPlaces().get(j).getClass())
						.newInstance(davidBueso.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (davidBueso.getBirthYear() != null)
			this.birthYear = davidBueso.getBirthYear().getClass()
					.getDeclaredConstructor(davidBueso.getBirthYear().getClass())
					.newInstance(davidBueso.getBirthYear());
		this.characterOffset = davidBueso.getCharacterOffset();
		this.characterOnset = davidBueso.getCharacterOnset();
		if (davidBueso.getPosition() != null)
			this.position = davidBueso.getPosition().getClass()
					.getDeclaredConstructor(davidBueso.getPosition().getClass()).newInstance(davidBueso.getPosition());
		for (int j = 0; j < davidBueso.getTeams().size(); j++) {
			if (davidBueso.getTeams().get(j) != null) {
				teams.add(davidBueso.getTeams().get(j).getClass()
						.getDeclaredConstructor(davidBueso.getTeams().get(j).getClass())
						.newInstance(davidBueso.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "DavidBueso [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear=" + birthYear
