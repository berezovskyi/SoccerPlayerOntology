...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IGunnarOlssonFootballer;
...
public class GunnarOlssonFootballer implements IGunnarOlssonFootballer {
	...
	public GunnarOlssonFootballer(GunnarOlssonFootballer gunnarOlssonFootballer)
			throws InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException,
			NoSuchMethodException, SecurityException {
		this.annotationID = gunnarOlssonFootballer.getAnnotationID();
		for (int j = 0; j < gunnarOlssonFootballer.getBirthPlaces().size(); j++) {
			if (gunnarOlssonFootballer.getBirthPlaces().get(j) != null) {
				birthPlaces.add(gunnarOlssonFootballer.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(gunnarOlssonFootballer.getBirthPlaces().get(j).getClass())
						.newInstance(gunnarOlssonFootballer.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (gunnarOlssonFootballer.getBirthYear() != null)
			this.birthYear = gunnarOlssonFootballer.getBirthYear().getClass()
					.getDeclaredConstructor(gunnarOlssonFootballer.getBirthYear().getClass())
					.newInstance(gunnarOlssonFootballer.getBirthYear());
		...
		if (gunnarOlssonFootballer.getPosition() != null)
			this.position = gunnarOlssonFootballer.getPosition().getClass()
					.getDeclaredConstructor(gunnarOlssonFootballer.getPosition().getClass())
					.newInstance(gunnarOlssonFootballer.getPosition());
		for (int j = 0; j < gunnarOlssonFootballer.getTeams().size(); j++) {
			if (gunnarOlssonFootballer.getTeams().get(j) != null) {
				teams.add(gunnarOlssonFootballer.getTeams().get(j).getClass()
						.getDeclaredConstructor(gunnarOlssonFootballer.getTeams().get(j).getClass())
						.newInstance(gunnarOlssonFootballer.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "GunnarOlssonFootballer [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear="
