...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IDmytroZaderetskyi;
...
public class DmytroZaderetskyi implements IDmytroZaderetskyi {
	...
	public DmytroZaderetskyi(DmytroZaderetskyi dmytroZaderetskyi) throws InstantiationException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		this.annotationID = dmytroZaderetskyi.getAnnotationID();
		for (int j = 0; j < dmytroZaderetskyi.getBirthPlaces().size(); j++) {
			if (dmytroZaderetskyi.getBirthPlaces().get(j) != null) {
				birthPlaces.add(dmytroZaderetskyi.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(dmytroZaderetskyi.getBirthPlaces().get(j).getClass())
						.newInstance(dmytroZaderetskyi.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (dmytroZaderetskyi.getBirthYear() != null)
			this.birthYear = dmytroZaderetskyi.getBirthYear().getClass()
					.getDeclaredConstructor(dmytroZaderetskyi.getBirthYear().getClass())
					.newInstance(dmytroZaderetskyi.getBirthYear());
		this.characterOffset = dmytroZaderetskyi.getCharacterOffset();
		this.characterOnset = dmytroZaderetskyi.getCharacterOnset();
		if (dmytroZaderetskyi.getPosition() != null)
			this.position = dmytroZaderetskyi.getPosition().getClass()
					.getDeclaredConstructor(dmytroZaderetskyi.getPosition().getClass())
					.newInstance(dmytroZaderetskyi.getPosition());
		for (int j = 0; j < dmytroZaderetskyi.getTeams().size(); j++) {
			if (dmytroZaderetskyi.getTeams().get(j) != null) {
				teams.add(dmytroZaderetskyi.getTeams().get(j).getClass()
						.getDeclaredConstructor(dmytroZaderetskyi.getTeams().get(j).getClass())
						.newInstance(dmytroZaderetskyi.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "DmytroZaderetskyi [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear="
