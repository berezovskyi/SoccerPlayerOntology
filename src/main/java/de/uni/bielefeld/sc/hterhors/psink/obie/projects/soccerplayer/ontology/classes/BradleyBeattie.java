...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IBradleyBeattie;
...
public class BradleyBeattie implements IBradleyBeattie {
	...
	public BradleyBeattie(BradleyBeattie bradleyBeattie) throws InstantiationException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		this.annotationID = bradleyBeattie.getAnnotationID();
		for (int j = 0; j < bradleyBeattie.getBirthPlaces().size(); j++) {
			if (bradleyBeattie.getBirthPlaces().get(j) != null) {
				birthPlaces.add(bradleyBeattie.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(bradleyBeattie.getBirthPlaces().get(j).getClass())
						.newInstance(bradleyBeattie.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (bradleyBeattie.getBirthYear() != null)
			this.birthYear = bradleyBeattie.getBirthYear().getClass()
					.getDeclaredConstructor(bradleyBeattie.getBirthYear().getClass())
					.newInstance(bradleyBeattie.getBirthYear());
		this.characterOffset = bradleyBeattie.getCharacterOffset();
		this.characterOnset = bradleyBeattie.getCharacterOnset();
		if (bradleyBeattie.getPosition() != null)
			this.position = bradleyBeattie.getPosition().getClass()
					.getDeclaredConstructor(bradleyBeattie.getPosition().getClass())
					.newInstance(bradleyBeattie.getPosition());
		for (int j = 0; j < bradleyBeattie.getTeams().size(); j++) {
			if (bradleyBeattie.getTeams().get(j) != null) {
				teams.add(bradleyBeattie.getTeams().get(j).getClass()
						.getDeclaredConstructor(bradleyBeattie.getTeams().get(j).getClass())
						.newInstance(bradleyBeattie.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "BradleyBeattie [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear="
