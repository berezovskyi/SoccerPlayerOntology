...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IJosephGryzik;
...
public class JosephGryzik implements IJosephGryzik {
	...
	public JosephGryzik(JosephGryzik josephGryzik) throws InstantiationException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		this.annotationID = josephGryzik.getAnnotationID();
		for (int j = 0; j < josephGryzik.getBirthPlaces().size(); j++) {
			if (josephGryzik.getBirthPlaces().get(j) != null) {
				birthPlaces.add(josephGryzik.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(josephGryzik.getBirthPlaces().get(j).getClass())
						.newInstance(josephGryzik.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (josephGryzik.getBirthYear() != null)
			this.birthYear = josephGryzik.getBirthYear().getClass()
					.getDeclaredConstructor(josephGryzik.getBirthYear().getClass())
					.newInstance(josephGryzik.getBirthYear());
		this.characterOffset = josephGryzik.getCharacterOffset();
		this.characterOnset = josephGryzik.getCharacterOnset();
		if (josephGryzik.getPosition() != null)
			this.position = josephGryzik.getPosition().getClass()
					.getDeclaredConstructor(josephGryzik.getPosition().getClass())
					.newInstance(josephGryzik.getPosition());
		for (int j = 0; j < josephGryzik.getTeams().size(); j++) {
			if (josephGryzik.getTeams().get(j) != null) {
				teams.add(josephGryzik.getTeams().get(j).getClass()
						.getDeclaredConstructor(josephGryzik.getTeams().get(j).getClass())
						.newInstance(josephGryzik.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "JosephGryzik [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear=" + birthYear
