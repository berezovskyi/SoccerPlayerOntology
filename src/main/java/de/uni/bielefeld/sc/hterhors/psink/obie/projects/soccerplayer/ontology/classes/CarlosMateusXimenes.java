...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.ICarlosMateusXimenes;
...
public class CarlosMateusXimenes implements ICarlosMateusXimenes {
	...
	public CarlosMateusXimenes(CarlosMateusXimenes carlosMateusXimenes)
			throws InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException,
			NoSuchMethodException, SecurityException {
		this.annotationID = carlosMateusXimenes.getAnnotationID();
		for (int j = 0; j < carlosMateusXimenes.getBirthPlaces().size(); j++) {
			if (carlosMateusXimenes.getBirthPlaces().get(j) != null) {
				birthPlaces.add(carlosMateusXimenes.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(carlosMateusXimenes.getBirthPlaces().get(j).getClass())
						.newInstance(carlosMateusXimenes.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (carlosMateusXimenes.getBirthYear() != null)
			this.birthYear = carlosMateusXimenes.getBirthYear().getClass()
					.getDeclaredConstructor(carlosMateusXimenes.getBirthYear().getClass())
					.newInstance(carlosMateusXimenes.getBirthYear());
		this.characterOffset = carlosMateusXimenes.getCharacterOffset();
		this.characterOnset = carlosMateusXimenes.getCharacterOnset();
		if (carlosMateusXimenes.getPosition() != null)
			this.position = carlosMateusXimenes.getPosition().getClass()
					.getDeclaredConstructor(carlosMateusXimenes.getPosition().getClass())
					.newInstance(carlosMateusXimenes.getPosition());
		for (int j = 0; j < carlosMateusXimenes.getTeams().size(); j++) {
			if (carlosMateusXimenes.getTeams().get(j) != null) {
				teams.add(carlosMateusXimenes.getTeams().get(j).getClass()
						.getDeclaredConstructor(carlosMateusXimenes.getTeams().get(j).getClass())
						.newInstance(carlosMateusXimenes.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "CarlosMateusXimenes [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear="
