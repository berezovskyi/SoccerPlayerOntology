...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.ICharlesGeertsFootballer;
...
public class CharlesGeertsFootballer implements ICharlesGeertsFootballer {
	...
	public CharlesGeertsFootballer(CharlesGeertsFootballer charlesGeertsFootballer)
			throws InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException,
			NoSuchMethodException, SecurityException {
		this.annotationID = charlesGeertsFootballer.getAnnotationID();
		for (int j = 0; j < charlesGeertsFootballer.getBirthPlaces().size(); j++) {
			if (charlesGeertsFootballer.getBirthPlaces().get(j) != null) {
				birthPlaces.add(charlesGeertsFootballer.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(charlesGeertsFootballer.getBirthPlaces().get(j).getClass())
						.newInstance(charlesGeertsFootballer.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (charlesGeertsFootballer.getBirthYear() != null)
			this.birthYear = charlesGeertsFootballer.getBirthYear().getClass()
					.getDeclaredConstructor(charlesGeertsFootballer.getBirthYear().getClass())
					.newInstance(charlesGeertsFootballer.getBirthYear());
		...
		if (charlesGeertsFootballer.getPosition() != null)
			this.position = charlesGeertsFootballer.getPosition().getClass()
					.getDeclaredConstructor(charlesGeertsFootballer.getPosition().getClass())
					.newInstance(charlesGeertsFootballer.getPosition());
		for (int j = 0; j < charlesGeertsFootballer.getTeams().size(); j++) {
			if (charlesGeertsFootballer.getTeams().get(j) != null) {
				teams.add(charlesGeertsFootballer.getTeams().get(j).getClass()
						.getDeclaredConstructor(charlesGeertsFootballer.getTeams().get(j).getClass())
						.newInstance(charlesGeertsFootballer.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "CharlesGeertsFootballer [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear="
