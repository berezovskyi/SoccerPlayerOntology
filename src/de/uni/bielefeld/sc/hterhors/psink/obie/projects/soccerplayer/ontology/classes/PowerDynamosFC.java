...
@NamedIndividual public class PowerDynamosFC implements IPowerDynamosFC{
...
final private String textMention;
	...
	public PowerDynamosFC(PowerDynamosFC powerDynamosFC)throws InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException,NoSuchMethodException, SecurityException{
...
return "PowerDynamosFC [annotationID="+annotationID+",characterOffset="+characterOffset+",characterOnset="+characterOnset+",serialVersionUID="+serialVersionUID+",textMention="+textMention+"]";}
