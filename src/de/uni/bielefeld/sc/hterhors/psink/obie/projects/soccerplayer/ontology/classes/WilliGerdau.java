...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IWilliGerdau;
...
public class WilliGerdau implements IWilliGerdau {
	...
	public WilliGerdau(WilliGerdau williGerdau) throws InstantiationException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		this.annotationID = williGerdau.getAnnotationID();
		for (int j = 0; j < williGerdau.getBirthPlaces().size(); j++) {
			if (williGerdau.getBirthPlaces().get(j) != null) {
				birthPlaces.add(williGerdau.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(williGerdau.getBirthPlaces().get(j).getClass())
						.newInstance(williGerdau.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (williGerdau.getBirthYear() != null)
			this.birthYear = williGerdau.getBirthYear().getClass()
					.getDeclaredConstructor(williGerdau.getBirthYear().getClass())
					.newInstance(williGerdau.getBirthYear());
		this.characterOffset = williGerdau.getCharacterOffset();
		this.characterOnset = williGerdau.getCharacterOnset();
		if (williGerdau.getPosition() != null)
			this.position = williGerdau.getPosition().getClass()
					.getDeclaredConstructor(williGerdau.getPosition().getClass())
					.newInstance(williGerdau.getPosition());
		for (int j = 0; j < williGerdau.getTeams().size(); j++) {
			if (williGerdau.getTeams().get(j) != null) {
				teams.add(williGerdau.getTeams().get(j).getClass()
						.getDeclaredConstructor(williGerdau.getTeams().get(j).getClass())
						.newInstance(williGerdau.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "WilliGerdau [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear=" + birthYear
