...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IBrianAbrey;
...
public class BrianAbrey implements IBrianAbrey {
	...
	public BrianAbrey(BrianAbrey brianAbrey) throws InstantiationException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		this.annotationID = brianAbrey.getAnnotationID();
		for (int j = 0; j < brianAbrey.getBirthPlaces().size(); j++) {
			if (brianAbrey.getBirthPlaces().get(j) != null) {
				birthPlaces.add(brianAbrey.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(brianAbrey.getBirthPlaces().get(j).getClass())
						.newInstance(brianAbrey.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (brianAbrey.getBirthYear() != null)
			this.birthYear = brianAbrey.getBirthYear().getClass()
					.getDeclaredConstructor(brianAbrey.getBirthYear().getClass())
					.newInstance(brianAbrey.getBirthYear());
		this.characterOffset = brianAbrey.getCharacterOffset();
		this.characterOnset = brianAbrey.getCharacterOnset();
		if (brianAbrey.getPosition() != null)
			this.position = brianAbrey.getPosition().getClass()
					.getDeclaredConstructor(brianAbrey.getPosition().getClass()).newInstance(brianAbrey.getPosition());
		for (int j = 0; j < brianAbrey.getTeams().size(); j++) {
			if (brianAbrey.getTeams().get(j) != null) {
				teams.add(brianAbrey.getTeams().get(j).getClass()
						.getDeclaredConstructor(brianAbrey.getTeams().get(j).getClass())
						.newInstance(brianAbrey.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "BrianAbrey [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear=" + birthYear
