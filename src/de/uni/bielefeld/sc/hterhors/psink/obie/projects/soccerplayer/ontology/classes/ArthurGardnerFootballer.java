...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IArthurGardnerFootballer;
...
public class ArthurGardnerFootballer implements IArthurGardnerFootballer {
	...
	public ArthurGardnerFootballer(ArthurGardnerFootballer arthurGardnerFootballer)
			throws InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException,
			NoSuchMethodException, SecurityException {
		this.annotationID = arthurGardnerFootballer.getAnnotationID();
		for (int j = 0; j < arthurGardnerFootballer.getBirthPlaces().size(); j++) {
			if (arthurGardnerFootballer.getBirthPlaces().get(j) != null) {
				birthPlaces.add(arthurGardnerFootballer.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(arthurGardnerFootballer.getBirthPlaces().get(j).getClass())
						.newInstance(arthurGardnerFootballer.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (arthurGardnerFootballer.getBirthYear() != null)
			this.birthYear = arthurGardnerFootballer.getBirthYear().getClass()
					.getDeclaredConstructor(arthurGardnerFootballer.getBirthYear().getClass())
					.newInstance(arthurGardnerFootballer.getBirthYear());
		...
		if (arthurGardnerFootballer.getPosition() != null)
			this.position = arthurGardnerFootballer.getPosition().getClass()
					.getDeclaredConstructor(arthurGardnerFootballer.getPosition().getClass())
					.newInstance(arthurGardnerFootballer.getPosition());
		for (int j = 0; j < arthurGardnerFootballer.getTeams().size(); j++) {
			if (arthurGardnerFootballer.getTeams().get(j) != null) {
				teams.add(arthurGardnerFootballer.getTeams().get(j).getClass()
						.getDeclaredConstructor(arthurGardnerFootballer.getTeams().get(j).getClass())
						.newInstance(arthurGardnerFootballer.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "ArthurGardnerFootballer [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear="
