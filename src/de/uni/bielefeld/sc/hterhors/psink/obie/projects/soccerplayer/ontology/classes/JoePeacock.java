...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IJoePeacock;
...
public class JoePeacock implements IJoePeacock {
	...
	public JoePeacock(JoePeacock joePeacock) throws InstantiationException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		this.annotationID = joePeacock.getAnnotationID();
		for (int j = 0; j < joePeacock.getBirthPlaces().size(); j++) {
			if (joePeacock.getBirthPlaces().get(j) != null) {
				birthPlaces.add(joePeacock.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(joePeacock.getBirthPlaces().get(j).getClass())
						.newInstance(joePeacock.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (joePeacock.getBirthYear() != null)
			this.birthYear = joePeacock.getBirthYear().getClass()
					.getDeclaredConstructor(joePeacock.getBirthYear().getClass())
					.newInstance(joePeacock.getBirthYear());
		this.characterOffset = joePeacock.getCharacterOffset();
		this.characterOnset = joePeacock.getCharacterOnset();
		if (joePeacock.getPosition() != null)
			this.position = joePeacock.getPosition().getClass()
					.getDeclaredConstructor(joePeacock.getPosition().getClass()).newInstance(joePeacock.getPosition());
		for (int j = 0; j < joePeacock.getTeams().size(); j++) {
			if (joePeacock.getTeams().get(j) != null) {
				teams.add(joePeacock.getTeams().get(j).getClass()
						.getDeclaredConstructor(joePeacock.getTeams().get(j).getClass())
						.newInstance(joePeacock.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "JoePeacock [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear=" + birthYear
