...
@NamedIndividual public class VagonulArad implements IVagonulArad{
...
this.textMention = textMention;
	...
	public VagonulArad(VagonulArad vagonulArad)throws InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException,NoSuchMethodException, SecurityException{
...
return "VagonulArad [annotationID="+annotationID+",characterOffset="+characterOffset+",characterOnset="+characterOnset+",serialVersionUID="+serialVersionUID+",textMention="+textMention+"]";}
