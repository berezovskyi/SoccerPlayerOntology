...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IPeterMooneyFootballer;
...
public class PeterMooneyFootballer implements IPeterMooneyFootballer {
	...
	public PeterMooneyFootballer(PeterMooneyFootballer peterMooneyFootballer)
			throws InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException,
			NoSuchMethodException, SecurityException {
		this.annotationID = peterMooneyFootballer.getAnnotationID();
		for (int j = 0; j < peterMooneyFootballer.getBirthPlaces().size(); j++) {
			if (peterMooneyFootballer.getBirthPlaces().get(j) != null) {
				birthPlaces.add(peterMooneyFootballer.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(peterMooneyFootballer.getBirthPlaces().get(j).getClass())
						.newInstance(peterMooneyFootballer.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (peterMooneyFootballer.getBirthYear() != null)
			this.birthYear = peterMooneyFootballer.getBirthYear().getClass()
					.getDeclaredConstructor(peterMooneyFootballer.getBirthYear().getClass())
					.newInstance(peterMooneyFootballer.getBirthYear());
		this.characterOffset = peterMooneyFootballer.getCharacterOffset();
		this.characterOnset = peterMooneyFootballer.getCharacterOnset();
		if (peterMooneyFootballer.getPosition() != null)
			this.position = peterMooneyFootballer.getPosition().getClass()
					.getDeclaredConstructor(peterMooneyFootballer.getPosition().getClass())
					.newInstance(peterMooneyFootballer.getPosition());
		for (int j = 0; j < peterMooneyFootballer.getTeams().size(); j++) {
			if (peterMooneyFootballer.getTeams().get(j) != null) {
				teams.add(peterMooneyFootballer.getTeams().get(j).getClass()
						.getDeclaredConstructor(peterMooneyFootballer.getTeams().get(j).getClass())
						.newInstance(peterMooneyFootballer.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "PeterMooneyFootballer [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear="
