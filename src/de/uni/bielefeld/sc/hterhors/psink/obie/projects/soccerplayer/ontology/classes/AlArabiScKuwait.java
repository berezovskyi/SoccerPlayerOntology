...
@NamedIndividual public class AlArabiScKuwait implements IAlArabiScKuwait{
...
this.textMention = textMention;
	...
	public AlArabiScKuwait(AlArabiScKuwait alArabiScKuwait)throws InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException,NoSuchMethodException, SecurityException{
...
return "AlArabiScKuwait [annotationID="+annotationID+",characterOffset="+characterOffset+",characterOnset="+characterOnset+",serialVersionUID="+serialVersionUID+",textMention="+textMention+"]";}
