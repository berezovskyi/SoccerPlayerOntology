...
@NamedIndividual public class ParefSouthridgeSchool implements IParefSouthridgeSchool{
...
this.textMention = null;
	...
	public ParefSouthridgeSchool(ParefSouthridgeSchool parefSouthridgeSchool)throws InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException,NoSuchMethodException, SecurityException{
...
return "ParefSouthridgeSchool [annotationID="+annotationID+",characterOffset="+characterOffset+",characterOnset="+characterOnset+",serialVersionUID="+serialVersionUID+",textMention="+textMention+"]";}
