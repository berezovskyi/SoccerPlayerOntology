...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.ILucasDawson;
...
public class LucasDawson implements ILucasDawson {
	...
	public LucasDawson(LucasDawson lucasDawson) throws InstantiationException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		this.annotationID = lucasDawson.getAnnotationID();
		for (int j = 0; j < lucasDawson.getBirthPlaces().size(); j++) {
			if (lucasDawson.getBirthPlaces().get(j) != null) {
				birthPlaces.add(lucasDawson.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(lucasDawson.getBirthPlaces().get(j).getClass())
						.newInstance(lucasDawson.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (lucasDawson.getBirthYear() != null)
			this.birthYear = lucasDawson.getBirthYear().getClass()
					.getDeclaredConstructor(lucasDawson.getBirthYear().getClass())
					.newInstance(lucasDawson.getBirthYear());
		this.characterOffset = lucasDawson.getCharacterOffset();
		this.characterOnset = lucasDawson.getCharacterOnset();
		if (lucasDawson.getPosition() != null)
			this.position = lucasDawson.getPosition().getClass()
					.getDeclaredConstructor(lucasDawson.getPosition().getClass())
					.newInstance(lucasDawson.getPosition());
		for (int j = 0; j < lucasDawson.getTeams().size(); j++) {
			if (lucasDawson.getTeams().get(j) != null) {
				teams.add(lucasDawson.getTeams().get(j).getClass()
						.getDeclaredConstructor(lucasDawson.getTeams().get(j).getClass())
						.newInstance(lucasDawson.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "LucasDawson [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear=" + birthYear
