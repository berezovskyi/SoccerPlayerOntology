...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IWayneSobers;
...
public class WayneSobers implements IWayneSobers {
	...
	public WayneSobers(WayneSobers wayneSobers) throws InstantiationException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		this.annotationID = wayneSobers.getAnnotationID();
		for (int j = 0; j < wayneSobers.getBirthPlaces().size(); j++) {
			if (wayneSobers.getBirthPlaces().get(j) != null) {
				birthPlaces.add(wayneSobers.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(wayneSobers.getBirthPlaces().get(j).getClass())
						.newInstance(wayneSobers.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (wayneSobers.getBirthYear() != null)
			this.birthYear = wayneSobers.getBirthYear().getClass()
					.getDeclaredConstructor(wayneSobers.getBirthYear().getClass())
					.newInstance(wayneSobers.getBirthYear());
		this.characterOffset = wayneSobers.getCharacterOffset();
		this.characterOnset = wayneSobers.getCharacterOnset();
		if (wayneSobers.getPosition() != null)
			this.position = wayneSobers.getPosition().getClass()
					.getDeclaredConstructor(wayneSobers.getPosition().getClass())
					.newInstance(wayneSobers.getPosition());
		for (int j = 0; j < wayneSobers.getTeams().size(); j++) {
			if (wayneSobers.getTeams().get(j) != null) {
				teams.add(wayneSobers.getTeams().get(j).getClass()
						.getDeclaredConstructor(wayneSobers.getTeams().get(j).getClass())
						.newInstance(wayneSobers.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "WayneSobers [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear=" + birthYear
