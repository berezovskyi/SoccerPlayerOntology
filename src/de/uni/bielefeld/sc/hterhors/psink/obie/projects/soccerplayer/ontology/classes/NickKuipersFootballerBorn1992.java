...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.INickKuipersFootballerBorn1992;
...
public class NickKuipersFootballerBorn1992 implements INickKuipersFootballerBorn1992 {
	...
	public NickKuipersFootballerBorn1992(NickKuipersFootballerBorn1992 nickKuipersFootballerBorn1992)
			throws InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException,
			NoSuchMethodException, SecurityException {
		this.annotationID = nickKuipersFootballerBorn1992.getAnnotationID();
		for (int j = 0; j < nickKuipersFootballerBorn1992.getBirthPlaces().size(); j++) {
			if (nickKuipersFootballerBorn1992.getBirthPlaces().get(j) != null) {
				birthPlaces.add(nickKuipersFootballerBorn1992.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(nickKuipersFootballerBorn1992.getBirthPlaces().get(j).getClass())
						.newInstance(nickKuipersFootballerBorn1992.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (nickKuipersFootballerBorn1992.getBirthYear() != null)
			this.birthYear = nickKuipersFootballerBorn1992.getBirthYear().getClass()
					.getDeclaredConstructor(nickKuipersFootballerBorn1992.getBirthYear().getClass())
					.newInstance(nickKuipersFootballerBorn1992.getBirthYear());
		...
		if (nickKuipersFootballerBorn1992.getPosition() != null)
			this.position = nickKuipersFootballerBorn1992.getPosition().getClass()
					.getDeclaredConstructor(nickKuipersFootballerBorn1992.getPosition().getClass())
					.newInstance(nickKuipersFootballerBorn1992.getPosition());
		for (int j = 0; j < nickKuipersFootballerBorn1992.getTeams().size(); j++) {
			if (nickKuipersFootballerBorn1992.getTeams().get(j) != null) {
				teams.add(nickKuipersFootballerBorn1992.getTeams().get(j).getClass()
						.getDeclaredConstructor(nickKuipersFootballerBorn1992.getTeams().get(j).getClass())
						.newInstance(nickKuipersFootballerBorn1992.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "NickKuipersFootballerBorn1992 [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces
