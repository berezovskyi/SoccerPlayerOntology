...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IDimitrisMachairas;
...
public class DimitrisMachairas implements IDimitrisMachairas {
	...
	public DimitrisMachairas(DimitrisMachairas dimitrisMachairas) throws InstantiationException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		this.annotationID = dimitrisMachairas.getAnnotationID();
		for (int j = 0; j < dimitrisMachairas.getBirthPlaces().size(); j++) {
			if (dimitrisMachairas.getBirthPlaces().get(j) != null) {
				birthPlaces.add(dimitrisMachairas.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(dimitrisMachairas.getBirthPlaces().get(j).getClass())
						.newInstance(dimitrisMachairas.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (dimitrisMachairas.getBirthYear() != null)
			this.birthYear = dimitrisMachairas.getBirthYear().getClass()
					.getDeclaredConstructor(dimitrisMachairas.getBirthYear().getClass())
					.newInstance(dimitrisMachairas.getBirthYear());
		this.characterOffset = dimitrisMachairas.getCharacterOffset();
		this.characterOnset = dimitrisMachairas.getCharacterOnset();
		if (dimitrisMachairas.getPosition() != null)
			this.position = dimitrisMachairas.getPosition().getClass()
					.getDeclaredConstructor(dimitrisMachairas.getPosition().getClass())
					.newInstance(dimitrisMachairas.getPosition());
		for (int j = 0; j < dimitrisMachairas.getTeams().size(); j++) {
			if (dimitrisMachairas.getTeams().get(j) != null) {
				teams.add(dimitrisMachairas.getTeams().get(j).getClass()
						.getDeclaredConstructor(dimitrisMachairas.getTeams().get(j).getClass())
						.newInstance(dimitrisMachairas.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "DimitrisMachairas [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear="
