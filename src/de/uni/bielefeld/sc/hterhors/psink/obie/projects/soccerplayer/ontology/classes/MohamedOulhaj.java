...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IMohamedOulhaj;
...
public class MohamedOulhaj implements IMohamedOulhaj {
	...
	public MohamedOulhaj(MohamedOulhaj mohamedOulhaj) throws InstantiationException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		this.annotationID = mohamedOulhaj.getAnnotationID();
		for (int j = 0; j < mohamedOulhaj.getBirthPlaces().size(); j++) {
			if (mohamedOulhaj.getBirthPlaces().get(j) != null) {
				birthPlaces.add(mohamedOulhaj.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(mohamedOulhaj.getBirthPlaces().get(j).getClass())
						.newInstance(mohamedOulhaj.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (mohamedOulhaj.getBirthYear() != null)
			this.birthYear = mohamedOulhaj.getBirthYear().getClass()
					.getDeclaredConstructor(mohamedOulhaj.getBirthYear().getClass())
					.newInstance(mohamedOulhaj.getBirthYear());
		this.characterOffset = mohamedOulhaj.getCharacterOffset();
		this.characterOnset = mohamedOulhaj.getCharacterOnset();
		if (mohamedOulhaj.getPosition() != null)
			this.position = mohamedOulhaj.getPosition().getClass()
					.getDeclaredConstructor(mohamedOulhaj.getPosition().getClass())
					.newInstance(mohamedOulhaj.getPosition());
		for (int j = 0; j < mohamedOulhaj.getTeams().size(); j++) {
			if (mohamedOulhaj.getTeams().get(j) != null) {
				teams.add(mohamedOulhaj.getTeams().get(j).getClass()
						.getDeclaredConstructor(mohamedOulhaj.getTeams().get(j).getClass())
						.newInstance(mohamedOulhaj.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "MohamedOulhaj [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear=" + birthYear
