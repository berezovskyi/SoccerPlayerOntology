...
@NamedIndividual public class GombakUnitedFc implements IGombakUnitedFc{
...
this.textMention = null;
	...
	public GombakUnitedFc(GombakUnitedFc gombakUnitedFc)throws InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException,NoSuchMethodException, SecurityException{
...
return "GombakUnitedFc [annotationID="+annotationID+",characterOffset="+characterOffset+",characterOnset="+characterOnset+",serialVersionUID="+serialVersionUID+",textMention="+textMention+"]";}
