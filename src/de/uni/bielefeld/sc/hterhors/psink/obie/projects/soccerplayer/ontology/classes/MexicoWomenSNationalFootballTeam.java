...
this.textMention = textMention;
	...
	public MexicoWomenSNationalFootballTeam(MexicoWomenSNationalFootballTeam mexicoWomenSNationalFootballTeam)throws InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException,NoSuchMethodException, SecurityException{
...
return "MexicoWomenSNationalFootballTeam [annotationID="+annotationID+",characterOffset="+characterOffset+",characterOnset="+characterOnset+",serialVersionUID="+serialVersionUID+",textMention="+textMention+"]";}
