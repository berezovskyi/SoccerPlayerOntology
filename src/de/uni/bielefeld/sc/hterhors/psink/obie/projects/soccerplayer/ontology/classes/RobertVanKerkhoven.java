...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IRobertVanKerkhoven;
...
public class RobertVanKerkhoven implements IRobertVanKerkhoven {
	...
	public RobertVanKerkhoven(RobertVanKerkhoven robertVanKerkhoven)
			throws InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException,
			NoSuchMethodException, SecurityException {
		this.annotationID = robertVanKerkhoven.getAnnotationID();
		for (int j = 0; j < robertVanKerkhoven.getBirthPlaces().size(); j++) {
			if (robertVanKerkhoven.getBirthPlaces().get(j) != null) {
				birthPlaces.add(robertVanKerkhoven.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(robertVanKerkhoven.getBirthPlaces().get(j).getClass())
						.newInstance(robertVanKerkhoven.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (robertVanKerkhoven.getBirthYear() != null)
			this.birthYear = robertVanKerkhoven.getBirthYear().getClass()
					.getDeclaredConstructor(robertVanKerkhoven.getBirthYear().getClass())
					.newInstance(robertVanKerkhoven.getBirthYear());
		this.characterOffset = robertVanKerkhoven.getCharacterOffset();
		this.characterOnset = robertVanKerkhoven.getCharacterOnset();
		if (robertVanKerkhoven.getPosition() != null)
			this.position = robertVanKerkhoven.getPosition().getClass()
					.getDeclaredConstructor(robertVanKerkhoven.getPosition().getClass())
					.newInstance(robertVanKerkhoven.getPosition());
		for (int j = 0; j < robertVanKerkhoven.getTeams().size(); j++) {
			if (robertVanKerkhoven.getTeams().get(j) != null) {
				teams.add(robertVanKerkhoven.getTeams().get(j).getClass()
						.getDeclaredConstructor(robertVanKerkhoven.getTeams().get(j).getClass())
						.newInstance(robertVanKerkhoven.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "RobertVanKerkhoven [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear="
