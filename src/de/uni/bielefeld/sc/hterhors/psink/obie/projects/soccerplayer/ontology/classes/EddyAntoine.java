...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IEddyAntoine;
...
public class EddyAntoine implements IEddyAntoine {
	...
	public EddyAntoine(EddyAntoine eddyAntoine) throws InstantiationException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		this.annotationID = eddyAntoine.getAnnotationID();
		for (int j = 0; j < eddyAntoine.getBirthPlaces().size(); j++) {
			if (eddyAntoine.getBirthPlaces().get(j) != null) {
				birthPlaces.add(eddyAntoine.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(eddyAntoine.getBirthPlaces().get(j).getClass())
						.newInstance(eddyAntoine.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (eddyAntoine.getBirthYear() != null)
			this.birthYear = eddyAntoine.getBirthYear().getClass()
					.getDeclaredConstructor(eddyAntoine.getBirthYear().getClass())
					.newInstance(eddyAntoine.getBirthYear());
		this.characterOffset = eddyAntoine.getCharacterOffset();
		this.characterOnset = eddyAntoine.getCharacterOnset();
		if (eddyAntoine.getPosition() != null)
			this.position = eddyAntoine.getPosition().getClass()
					.getDeclaredConstructor(eddyAntoine.getPosition().getClass())
					.newInstance(eddyAntoine.getPosition());
		for (int j = 0; j < eddyAntoine.getTeams().size(); j++) {
			if (eddyAntoine.getTeams().get(j) != null) {
				teams.add(eddyAntoine.getTeams().get(j).getClass()
						.getDeclaredConstructor(eddyAntoine.getTeams().get(j).getClass())
						.newInstance(eddyAntoine.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "EddyAntoine [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear=" + birthYear
