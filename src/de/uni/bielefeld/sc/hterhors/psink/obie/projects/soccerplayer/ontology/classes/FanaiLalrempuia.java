...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IFanaiLalrempuia;
...
public class FanaiLalrempuia implements IFanaiLalrempuia {
	...
	public FanaiLalrempuia(FanaiLalrempuia fanaiLalrempuia) throws InstantiationException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		this.annotationID = fanaiLalrempuia.getAnnotationID();
		for (int j = 0; j < fanaiLalrempuia.getBirthPlaces().size(); j++) {
			if (fanaiLalrempuia.getBirthPlaces().get(j) != null) {
				birthPlaces.add(fanaiLalrempuia.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(fanaiLalrempuia.getBirthPlaces().get(j).getClass())
						.newInstance(fanaiLalrempuia.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (fanaiLalrempuia.getBirthYear() != null)
			this.birthYear = fanaiLalrempuia.getBirthYear().getClass()
					.getDeclaredConstructor(fanaiLalrempuia.getBirthYear().getClass())
					.newInstance(fanaiLalrempuia.getBirthYear());
		this.characterOffset = fanaiLalrempuia.getCharacterOffset();
		this.characterOnset = fanaiLalrempuia.getCharacterOnset();
		if (fanaiLalrempuia.getPosition() != null)
			this.position = fanaiLalrempuia.getPosition().getClass()
					.getDeclaredConstructor(fanaiLalrempuia.getPosition().getClass())
					.newInstance(fanaiLalrempuia.getPosition());
		for (int j = 0; j < fanaiLalrempuia.getTeams().size(); j++) {
			if (fanaiLalrempuia.getTeams().get(j) != null) {
				teams.add(fanaiLalrempuia.getTeams().get(j).getClass()
						.getDeclaredConstructor(fanaiLalrempuia.getTeams().get(j).getClass())
						.newInstance(fanaiLalrempuia.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "FanaiLalrempuia [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear="
