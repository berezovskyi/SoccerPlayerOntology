...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IFredBarronFootballer;
...
public class FredBarronFootballer implements IFredBarronFootballer {
	...
	public FredBarronFootballer(FredBarronFootballer fredBarronFootballer)
			throws InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException,
			NoSuchMethodException, SecurityException {
		this.annotationID = fredBarronFootballer.getAnnotationID();
		for (int j = 0; j < fredBarronFootballer.getBirthPlaces().size(); j++) {
			if (fredBarronFootballer.getBirthPlaces().get(j) != null) {
				birthPlaces.add(fredBarronFootballer.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(fredBarronFootballer.getBirthPlaces().get(j).getClass())
						.newInstance(fredBarronFootballer.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (fredBarronFootballer.getBirthYear() != null)
			this.birthYear = fredBarronFootballer.getBirthYear().getClass()
					.getDeclaredConstructor(fredBarronFootballer.getBirthYear().getClass())
					.newInstance(fredBarronFootballer.getBirthYear());
		this.characterOffset = fredBarronFootballer.getCharacterOffset();
		this.characterOnset = fredBarronFootballer.getCharacterOnset();
		if (fredBarronFootballer.getPosition() != null)
			this.position = fredBarronFootballer.getPosition().getClass()
					.getDeclaredConstructor(fredBarronFootballer.getPosition().getClass())
					.newInstance(fredBarronFootballer.getPosition());
		for (int j = 0; j < fredBarronFootballer.getTeams().size(); j++) {
			if (fredBarronFootballer.getTeams().get(j) != null) {
				teams.add(fredBarronFootballer.getTeams().get(j).getClass()
						.getDeclaredConstructor(fredBarronFootballer.getTeams().get(j).getClass())
						.newInstance(fredBarronFootballer.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "FredBarronFootballer [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear="
