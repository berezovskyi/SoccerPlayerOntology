...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IBernardSmithFootballer;
...
public class BernardSmithFootballer implements IBernardSmithFootballer {
	...
	public BernardSmithFootballer(BernardSmithFootballer bernardSmithFootballer)
			throws InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException,
			NoSuchMethodException, SecurityException {
		this.annotationID = bernardSmithFootballer.getAnnotationID();
		for (int j = 0; j < bernardSmithFootballer.getBirthPlaces().size(); j++) {
			if (bernardSmithFootballer.getBirthPlaces().get(j) != null) {
				birthPlaces.add(bernardSmithFootballer.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(bernardSmithFootballer.getBirthPlaces().get(j).getClass())
						.newInstance(bernardSmithFootballer.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (bernardSmithFootballer.getBirthYear() != null)
			this.birthYear = bernardSmithFootballer.getBirthYear().getClass()
					.getDeclaredConstructor(bernardSmithFootballer.getBirthYear().getClass())
					.newInstance(bernardSmithFootballer.getBirthYear());
		...
		if (bernardSmithFootballer.getPosition() != null)
			this.position = bernardSmithFootballer.getPosition().getClass()
					.getDeclaredConstructor(bernardSmithFootballer.getPosition().getClass())
					.newInstance(bernardSmithFootballer.getPosition());
		for (int j = 0; j < bernardSmithFootballer.getTeams().size(); j++) {
			if (bernardSmithFootballer.getTeams().get(j) != null) {
				teams.add(bernardSmithFootballer.getTeams().get(j).getClass()
						.getDeclaredConstructor(bernardSmithFootballer.getTeams().get(j).getClass())
						.newInstance(bernardSmithFootballer.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "BernardSmithFootballer [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear="
