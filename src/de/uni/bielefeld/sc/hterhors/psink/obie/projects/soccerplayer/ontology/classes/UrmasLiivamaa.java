...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IUrmasLiivamaa;
...
public class UrmasLiivamaa implements IUrmasLiivamaa {
	...
	public UrmasLiivamaa(UrmasLiivamaa urmasLiivamaa) throws InstantiationException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		this.annotationID = urmasLiivamaa.getAnnotationID();
		for (int j = 0; j < urmasLiivamaa.getBirthPlaces().size(); j++) {
			if (urmasLiivamaa.getBirthPlaces().get(j) != null) {
				birthPlaces.add(urmasLiivamaa.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(urmasLiivamaa.getBirthPlaces().get(j).getClass())
						.newInstance(urmasLiivamaa.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (urmasLiivamaa.getBirthYear() != null)
			this.birthYear = urmasLiivamaa.getBirthYear().getClass()
					.getDeclaredConstructor(urmasLiivamaa.getBirthYear().getClass())
					.newInstance(urmasLiivamaa.getBirthYear());
		this.characterOffset = urmasLiivamaa.getCharacterOffset();
		this.characterOnset = urmasLiivamaa.getCharacterOnset();
		if (urmasLiivamaa.getPosition() != null)
			this.position = urmasLiivamaa.getPosition().getClass()
					.getDeclaredConstructor(urmasLiivamaa.getPosition().getClass())
					.newInstance(urmasLiivamaa.getPosition());
		for (int j = 0; j < urmasLiivamaa.getTeams().size(); j++) {
			if (urmasLiivamaa.getTeams().get(j) != null) {
				teams.add(urmasLiivamaa.getTeams().get(j).getClass()
						.getDeclaredConstructor(urmasLiivamaa.getTeams().get(j).getClass())
						.newInstance(urmasLiivamaa.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "UrmasLiivamaa [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear=" + birthYear
