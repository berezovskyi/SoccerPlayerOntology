...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IWilliamBerryFootballer;
...
public class WilliamBerryFootballer implements IWilliamBerryFootballer {
	...
	public WilliamBerryFootballer(WilliamBerryFootballer williamBerryFootballer)
			throws InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException,
			NoSuchMethodException, SecurityException {
		this.annotationID = williamBerryFootballer.getAnnotationID();
		for (int j = 0; j < williamBerryFootballer.getBirthPlaces().size(); j++) {
			if (williamBerryFootballer.getBirthPlaces().get(j) != null) {
				birthPlaces.add(williamBerryFootballer.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(williamBerryFootballer.getBirthPlaces().get(j).getClass())
						.newInstance(williamBerryFootballer.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (williamBerryFootballer.getBirthYear() != null)
			this.birthYear = williamBerryFootballer.getBirthYear().getClass()
					.getDeclaredConstructor(williamBerryFootballer.getBirthYear().getClass())
					.newInstance(williamBerryFootballer.getBirthYear());
		...
		if (williamBerryFootballer.getPosition() != null)
			this.position = williamBerryFootballer.getPosition().getClass()
					.getDeclaredConstructor(williamBerryFootballer.getPosition().getClass())
					.newInstance(williamBerryFootballer.getPosition());
		for (int j = 0; j < williamBerryFootballer.getTeams().size(); j++) {
			if (williamBerryFootballer.getTeams().get(j) != null) {
				teams.add(williamBerryFootballer.getTeams().get(j).getClass()
						.getDeclaredConstructor(williamBerryFootballer.getTeams().get(j).getClass())
						.newInstance(williamBerryFootballer.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "WilliamBerryFootballer [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear="
