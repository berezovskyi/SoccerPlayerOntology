...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IRalphODonnell;
...
public class RalphODonnell implements IRalphODonnell {
	...
	public RalphODonnell(RalphODonnell ralphODonnell) throws InstantiationException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		this.annotationID = ralphODonnell.getAnnotationID();
		for (int j = 0; j < ralphODonnell.getBirthPlaces().size(); j++) {
			if (ralphODonnell.getBirthPlaces().get(j) != null) {
				birthPlaces.add(ralphODonnell.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(ralphODonnell.getBirthPlaces().get(j).getClass())
						.newInstance(ralphODonnell.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (ralphODonnell.getBirthYear() != null)
			this.birthYear = ralphODonnell.getBirthYear().getClass()
					.getDeclaredConstructor(ralphODonnell.getBirthYear().getClass())
					.newInstance(ralphODonnell.getBirthYear());
		this.characterOffset = ralphODonnell.getCharacterOffset();
		this.characterOnset = ralphODonnell.getCharacterOnset();
		if (ralphODonnell.getPosition() != null)
			this.position = ralphODonnell.getPosition().getClass()
					.getDeclaredConstructor(ralphODonnell.getPosition().getClass())
					.newInstance(ralphODonnell.getPosition());
		for (int j = 0; j < ralphODonnell.getTeams().size(); j++) {
			if (ralphODonnell.getTeams().get(j) != null) {
				teams.add(ralphODonnell.getTeams().get(j).getClass()
						.getDeclaredConstructor(ralphODonnell.getTeams().get(j).getClass())
						.newInstance(ralphODonnell.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "RalphODonnell [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear=" + birthYear
