...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IDavidLetham;
...
public class DavidLetham implements IDavidLetham {
	...
	public DavidLetham(DavidLetham davidLetham) throws InstantiationException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		this.annotationID = davidLetham.getAnnotationID();
		for (int j = 0; j < davidLetham.getBirthPlaces().size(); j++) {
			if (davidLetham.getBirthPlaces().get(j) != null) {
				birthPlaces.add(davidLetham.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(davidLetham.getBirthPlaces().get(j).getClass())
						.newInstance(davidLetham.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (davidLetham.getBirthYear() != null)
			this.birthYear = davidLetham.getBirthYear().getClass()
					.getDeclaredConstructor(davidLetham.getBirthYear().getClass())
					.newInstance(davidLetham.getBirthYear());
		this.characterOffset = davidLetham.getCharacterOffset();
		this.characterOnset = davidLetham.getCharacterOnset();
		if (davidLetham.getPosition() != null)
			this.position = davidLetham.getPosition().getClass()
					.getDeclaredConstructor(davidLetham.getPosition().getClass())
					.newInstance(davidLetham.getPosition());
		for (int j = 0; j < davidLetham.getTeams().size(); j++) {
			if (davidLetham.getTeams().get(j) != null) {
				teams.add(davidLetham.getTeams().get(j).getClass()
						.getDeclaredConstructor(davidLetham.getTeams().get(j).getClass())
						.newInstance(davidLetham.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "DavidLetham [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear=" + birthYear
