...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IEmmanuelOgoli;
...
public class EmmanuelOgoli implements IEmmanuelOgoli {
	...
	public EmmanuelOgoli(EmmanuelOgoli emmanuelOgoli) throws InstantiationException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		this.annotationID = emmanuelOgoli.getAnnotationID();
		for (int j = 0; j < emmanuelOgoli.getBirthPlaces().size(); j++) {
			if (emmanuelOgoli.getBirthPlaces().get(j) != null) {
				birthPlaces.add(emmanuelOgoli.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(emmanuelOgoli.getBirthPlaces().get(j).getClass())
						.newInstance(emmanuelOgoli.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (emmanuelOgoli.getBirthYear() != null)
			this.birthYear = emmanuelOgoli.getBirthYear().getClass()
					.getDeclaredConstructor(emmanuelOgoli.getBirthYear().getClass())
					.newInstance(emmanuelOgoli.getBirthYear());
		this.characterOffset = emmanuelOgoli.getCharacterOffset();
		this.characterOnset = emmanuelOgoli.getCharacterOnset();
		if (emmanuelOgoli.getPosition() != null)
			this.position = emmanuelOgoli.getPosition().getClass()
					.getDeclaredConstructor(emmanuelOgoli.getPosition().getClass())
					.newInstance(emmanuelOgoli.getPosition());
		for (int j = 0; j < emmanuelOgoli.getTeams().size(); j++) {
			if (emmanuelOgoli.getTeams().get(j) != null) {
				teams.add(emmanuelOgoli.getTeams().get(j).getClass()
						.getDeclaredConstructor(emmanuelOgoli.getTeams().get(j).getClass())
						.newInstance(emmanuelOgoli.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "EmmanuelOgoli [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear=" + birthYear
