...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IGyulaPrassler;
...
public class GyulaPrassler implements IGyulaPrassler {
	...
	public GyulaPrassler(GyulaPrassler gyulaPrassler) throws InstantiationException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		this.annotationID = gyulaPrassler.getAnnotationID();
		for (int j = 0; j < gyulaPrassler.getBirthPlaces().size(); j++) {
			if (gyulaPrassler.getBirthPlaces().get(j) != null) {
				birthPlaces.add(gyulaPrassler.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(gyulaPrassler.getBirthPlaces().get(j).getClass())
						.newInstance(gyulaPrassler.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (gyulaPrassler.getBirthYear() != null)
			this.birthYear = gyulaPrassler.getBirthYear().getClass()
					.getDeclaredConstructor(gyulaPrassler.getBirthYear().getClass())
					.newInstance(gyulaPrassler.getBirthYear());
		this.characterOffset = gyulaPrassler.getCharacterOffset();
		this.characterOnset = gyulaPrassler.getCharacterOnset();
		if (gyulaPrassler.getPosition() != null)
			this.position = gyulaPrassler.getPosition().getClass()
					.getDeclaredConstructor(gyulaPrassler.getPosition().getClass())
					.newInstance(gyulaPrassler.getPosition());
		for (int j = 0; j < gyulaPrassler.getTeams().size(); j++) {
			if (gyulaPrassler.getTeams().get(j) != null) {
				teams.add(gyulaPrassler.getTeams().get(j).getClass()
						.getDeclaredConstructor(gyulaPrassler.getTeams().get(j).getClass())
						.newInstance(gyulaPrassler.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "GyulaPrassler [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear=" + birthYear
