...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IDanyMaury;
...
public class DanyMaury implements IDanyMaury {
	...
	public DanyMaury(DanyMaury danyMaury) throws InstantiationException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		this.annotationID = danyMaury.getAnnotationID();
		for (int j = 0; j < danyMaury.getBirthPlaces().size(); j++) {
			if (danyMaury.getBirthPlaces().get(j) != null) {
				birthPlaces.add(danyMaury.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(danyMaury.getBirthPlaces().get(j).getClass())
						.newInstance(danyMaury.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (danyMaury.getBirthYear() != null)
			this.birthYear = danyMaury.getBirthYear().getClass()
					.getDeclaredConstructor(danyMaury.getBirthYear().getClass()).newInstance(danyMaury.getBirthYear());
		this.characterOffset = danyMaury.getCharacterOffset();
		this.characterOnset = danyMaury.getCharacterOnset();
		if (danyMaury.getPosition() != null)
			this.position = danyMaury.getPosition().getClass()
					.getDeclaredConstructor(danyMaury.getPosition().getClass()).newInstance(danyMaury.getPosition());
		for (int j = 0; j < danyMaury.getTeams().size(); j++) {
			if (danyMaury.getTeams().get(j) != null) {
				teams.add(danyMaury.getTeams().get(j).getClass()
						.getDeclaredConstructor(danyMaury.getTeams().get(j).getClass())
						.newInstance(danyMaury.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "DanyMaury [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear=" + birthYear
