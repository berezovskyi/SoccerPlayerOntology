...
@NamedIndividual public class Colchester implements IColchester{
...
this.textMention = textMention;
	...
	public Colchester(Colchester colchester)throws InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException,NoSuchMethodException, SecurityException{
...
return "Colchester [annotationID="+annotationID+",characterOffset="+characterOffset+",characterOnset="+characterOnset+",serialVersionUID="+serialVersionUID+",textMention="+textMention+"]";}
