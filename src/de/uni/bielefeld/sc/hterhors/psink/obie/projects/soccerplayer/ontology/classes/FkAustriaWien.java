...
@NamedIndividual public class FkAustriaWien implements IFkAustriaWien{
...
this.textMention = null;
	...
	public FkAustriaWien(FkAustriaWien fkAustriaWien)throws InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException,NoSuchMethodException, SecurityException{
...
return "FkAustriaWien [annotationID="+annotationID+",characterOffset="+characterOffset+",characterOnset="+characterOnset+",serialVersionUID="+serialVersionUID+",textMention="+textMention+"]";}
