...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.ISadokSassi;
...
public class SadokSassi implements ISadokSassi {
	...
	public SadokSassi(SadokSassi sadokSassi) throws InstantiationException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		this.annotationID = sadokSassi.getAnnotationID();
		for (int j = 0; j < sadokSassi.getBirthPlaces().size(); j++) {
			if (sadokSassi.getBirthPlaces().get(j) != null) {
				birthPlaces.add(sadokSassi.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(sadokSassi.getBirthPlaces().get(j).getClass())
						.newInstance(sadokSassi.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (sadokSassi.getBirthYear() != null)
			this.birthYear = sadokSassi.getBirthYear().getClass()
					.getDeclaredConstructor(sadokSassi.getBirthYear().getClass())
					.newInstance(sadokSassi.getBirthYear());
		this.characterOffset = sadokSassi.getCharacterOffset();
		this.characterOnset = sadokSassi.getCharacterOnset();
		if (sadokSassi.getPosition() != null)
			this.position = sadokSassi.getPosition().getClass()
					.getDeclaredConstructor(sadokSassi.getPosition().getClass()).newInstance(sadokSassi.getPosition());
		for (int j = 0; j < sadokSassi.getTeams().size(); j++) {
			if (sadokSassi.getTeams().get(j) != null) {
				teams.add(sadokSassi.getTeams().get(j).getClass()
						.getDeclaredConstructor(sadokSassi.getTeams().get(j).getClass())
						.newInstance(sadokSassi.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "SadokSassi [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear=" + birthYear
