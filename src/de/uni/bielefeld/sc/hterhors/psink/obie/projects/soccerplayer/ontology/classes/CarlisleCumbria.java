...
@NamedIndividual public class CarlisleCumbria implements ICarlisleCumbria{
...
this.textMention = textMention;
	...
	public CarlisleCumbria(CarlisleCumbria carlisleCumbria)throws InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException,NoSuchMethodException, SecurityException{
...
return "CarlisleCumbria [annotationID="+annotationID+",characterOffset="+characterOffset+",characterOnset="+characterOnset+",serialVersionUID="+serialVersionUID+",textMention="+textMention+"]";}
