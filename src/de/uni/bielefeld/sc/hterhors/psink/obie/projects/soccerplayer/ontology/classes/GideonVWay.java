...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IGideonVWay;
...
public class GideonVWay implements IGideonVWay {
	...
	public GideonVWay(GideonVWay gideonVWay) throws InstantiationException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		this.annotationID = gideonVWay.getAnnotationID();
		for (int j = 0; j < gideonVWay.getBirthPlaces().size(); j++) {
			if (gideonVWay.getBirthPlaces().get(j) != null) {
				birthPlaces.add(gideonVWay.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(gideonVWay.getBirthPlaces().get(j).getClass())
						.newInstance(gideonVWay.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (gideonVWay.getBirthYear() != null)
			this.birthYear = gideonVWay.getBirthYear().getClass()
					.getDeclaredConstructor(gideonVWay.getBirthYear().getClass())
					.newInstance(gideonVWay.getBirthYear());
		this.characterOffset = gideonVWay.getCharacterOffset();
		this.characterOnset = gideonVWay.getCharacterOnset();
		if (gideonVWay.getPosition() != null)
			this.position = gideonVWay.getPosition().getClass()
					.getDeclaredConstructor(gideonVWay.getPosition().getClass()).newInstance(gideonVWay.getPosition());
		for (int j = 0; j < gideonVWay.getTeams().size(); j++) {
			if (gideonVWay.getTeams().get(j) != null) {
				teams.add(gideonVWay.getTeams().get(j).getClass()
						.getDeclaredConstructor(gideonVWay.getTeams().get(j).getClass())
						.newInstance(gideonVWay.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "GideonVWay [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear=" + birthYear
