...
this.textMention = textMention;
	...
	public HungaryWomenSNationalFootballTeam(HungaryWomenSNationalFootballTeam hungaryWomenSNationalFootballTeam)throws InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException,NoSuchMethodException, SecurityException{
...
return "HungaryWomenSNationalFootballTeam [annotationID="+annotationID+",characterOffset="+characterOffset+",characterOnset="+characterOnset+",serialVersionUID="+serialVersionUID+",textMention="+textMention+"]";}
