...
@NamedIndividual public class DalianShideFC implements IDalianShideFC{
...
this.textMention = textMention;
	...
	public DalianShideFC(DalianShideFC dalianShideFC)throws InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException,NoSuchMethodException, SecurityException{
...
return "DalianShideFC [annotationID="+annotationID+",characterOffset="+characterOffset+",characterOnset="+characterOnset+",serialVersionUID="+serialVersionUID+",textMention="+textMention+"]";}
