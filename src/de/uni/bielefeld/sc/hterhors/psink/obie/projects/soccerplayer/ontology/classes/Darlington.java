...
@NamedIndividual public class Darlington implements IDarlington{
...
this.textMention = textMention;
	...
	public Darlington(Darlington darlington)throws InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException,NoSuchMethodException, SecurityException{
...
return "Darlington [annotationID="+annotationID+",characterOffset="+characterOffset+",characterOnset="+characterOnset+",serialVersionUID="+serialVersionUID+",textMention="+textMention+"]";}
