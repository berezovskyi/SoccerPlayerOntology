...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IDumitruStajila;
...
public class DumitruStajila implements IDumitruStajila {
	...
	public DumitruStajila(DumitruStajila dumitruStajila) throws InstantiationException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		this.annotationID = dumitruStajila.getAnnotationID();
		for (int j = 0; j < dumitruStajila.getBirthPlaces().size(); j++) {
			if (dumitruStajila.getBirthPlaces().get(j) != null) {
				birthPlaces.add(dumitruStajila.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(dumitruStajila.getBirthPlaces().get(j).getClass())
						.newInstance(dumitruStajila.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (dumitruStajila.getBirthYear() != null)
			this.birthYear = dumitruStajila.getBirthYear().getClass()
					.getDeclaredConstructor(dumitruStajila.getBirthYear().getClass())
					.newInstance(dumitruStajila.getBirthYear());
		this.characterOffset = dumitruStajila.getCharacterOffset();
		this.characterOnset = dumitruStajila.getCharacterOnset();
		if (dumitruStajila.getPosition() != null)
			this.position = dumitruStajila.getPosition().getClass()
					.getDeclaredConstructor(dumitruStajila.getPosition().getClass())
					.newInstance(dumitruStajila.getPosition());
		for (int j = 0; j < dumitruStajila.getTeams().size(); j++) {
			if (dumitruStajila.getTeams().get(j) != null) {
				teams.add(dumitruStajila.getTeams().get(j).getClass()
						.getDeclaredConstructor(dumitruStajila.getTeams().get(j).getClass())
						.newInstance(dumitruStajila.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "DumitruStajila [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear="
