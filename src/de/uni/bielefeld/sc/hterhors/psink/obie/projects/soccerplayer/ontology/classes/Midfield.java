...
@DirectInterface(get=IMidfield.class)

@NamedIndividual
@AssignableSubClasses(get={})

@SuperRootClasses(get={Position.class, })
 public class Midfield implements IMidfield{

	final static public String ONTOLOGY_NAME = "http://psink.de/scio/Midfield";
...
final private String textMention;
	...
	public Midfield(Midfield midfield)throws InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException,NoSuchMethodException, SecurityException{
this.annotationID = midfield.getAnnotationID();
this.characterOffset = midfield.getCharacterOffset();
this.characterOnset = midfield.getCharacterOnset();
this.textMention = midfield.getTextMention();
}
	public Midfield(String annotationID, String textMention){
...
return "Midfield [annotationID="+annotationID+",characterOffset="+characterOffset+",characterOnset="+characterOnset+",serialVersionUID="+serialVersionUID+",textMention="+textMention+"]";}
