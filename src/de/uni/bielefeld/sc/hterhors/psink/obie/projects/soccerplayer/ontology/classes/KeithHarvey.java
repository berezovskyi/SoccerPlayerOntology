...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IKeithHarvey;
...
public class KeithHarvey implements IKeithHarvey {
	...
	public KeithHarvey(KeithHarvey keithHarvey) throws InstantiationException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		this.annotationID = keithHarvey.getAnnotationID();
		for (int j = 0; j < keithHarvey.getBirthPlaces().size(); j++) {
			if (keithHarvey.getBirthPlaces().get(j) != null) {
				birthPlaces.add(keithHarvey.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(keithHarvey.getBirthPlaces().get(j).getClass())
						.newInstance(keithHarvey.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (keithHarvey.getBirthYear() != null)
			this.birthYear = keithHarvey.getBirthYear().getClass()
					.getDeclaredConstructor(keithHarvey.getBirthYear().getClass())
					.newInstance(keithHarvey.getBirthYear());
		this.characterOffset = keithHarvey.getCharacterOffset();
		this.characterOnset = keithHarvey.getCharacterOnset();
		if (keithHarvey.getPosition() != null)
			this.position = keithHarvey.getPosition().getClass()
					.getDeclaredConstructor(keithHarvey.getPosition().getClass())
					.newInstance(keithHarvey.getPosition());
		for (int j = 0; j < keithHarvey.getTeams().size(); j++) {
			if (keithHarvey.getTeams().get(j) != null) {
				teams.add(keithHarvey.getTeams().get(j).getClass()
						.getDeclaredConstructor(keithHarvey.getTeams().get(j).getClass())
						.newInstance(keithHarvey.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "KeithHarvey [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear=" + birthYear
