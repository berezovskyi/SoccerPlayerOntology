...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IHerbieWilliams;
...
public class HerbieWilliams implements IHerbieWilliams {
	...
	public HerbieWilliams(HerbieWilliams herbieWilliams) throws InstantiationException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		this.annotationID = herbieWilliams.getAnnotationID();
		for (int j = 0; j < herbieWilliams.getBirthPlaces().size(); j++) {
			if (herbieWilliams.getBirthPlaces().get(j) != null) {
				birthPlaces.add(herbieWilliams.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(herbieWilliams.getBirthPlaces().get(j).getClass())
						.newInstance(herbieWilliams.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (herbieWilliams.getBirthYear() != null)
			this.birthYear = herbieWilliams.getBirthYear().getClass()
					.getDeclaredConstructor(herbieWilliams.getBirthYear().getClass())
					.newInstance(herbieWilliams.getBirthYear());
		this.characterOffset = herbieWilliams.getCharacterOffset();
		this.characterOnset = herbieWilliams.getCharacterOnset();
		if (herbieWilliams.getPosition() != null)
			this.position = herbieWilliams.getPosition().getClass()
					.getDeclaredConstructor(herbieWilliams.getPosition().getClass())
					.newInstance(herbieWilliams.getPosition());
		for (int j = 0; j < herbieWilliams.getTeams().size(); j++) {
			if (herbieWilliams.getTeams().get(j) != null) {
				teams.add(herbieWilliams.getTeams().get(j).getClass()
						.getDeclaredConstructor(herbieWilliams.getTeams().get(j).getClass())
						.newInstance(herbieWilliams.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "HerbieWilliams [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear="
