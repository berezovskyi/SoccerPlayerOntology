...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.ILennardRemy;
...
public class LennardRemy implements ILennardRemy {
	...
	public LennardRemy(LennardRemy lennardRemy) throws InstantiationException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		this.annotationID = lennardRemy.getAnnotationID();
		for (int j = 0; j < lennardRemy.getBirthPlaces().size(); j++) {
			if (lennardRemy.getBirthPlaces().get(j) != null) {
				birthPlaces.add(lennardRemy.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(lennardRemy.getBirthPlaces().get(j).getClass())
						.newInstance(lennardRemy.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (lennardRemy.getBirthYear() != null)
			this.birthYear = lennardRemy.getBirthYear().getClass()
					.getDeclaredConstructor(lennardRemy.getBirthYear().getClass())
					.newInstance(lennardRemy.getBirthYear());
		this.characterOffset = lennardRemy.getCharacterOffset();
		this.characterOnset = lennardRemy.getCharacterOnset();
		if (lennardRemy.getPosition() != null)
			this.position = lennardRemy.getPosition().getClass()
					.getDeclaredConstructor(lennardRemy.getPosition().getClass())
					.newInstance(lennardRemy.getPosition());
		for (int j = 0; j < lennardRemy.getTeams().size(); j++) {
			if (lennardRemy.getTeams().get(j) != null) {
				teams.add(lennardRemy.getTeams().get(j).getClass()
						.getDeclaredConstructor(lennardRemy.getTeams().get(j).getClass())
						.newInstance(lennardRemy.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "LennardRemy [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear=" + birthYear
