...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IKyleBenedictus;
...
public class KyleBenedictus implements IKyleBenedictus {
	...
	public KyleBenedictus(KyleBenedictus kyleBenedictus) throws InstantiationException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		this.annotationID = kyleBenedictus.getAnnotationID();
		for (int j = 0; j < kyleBenedictus.getBirthPlaces().size(); j++) {
			if (kyleBenedictus.getBirthPlaces().get(j) != null) {
				birthPlaces.add(kyleBenedictus.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(kyleBenedictus.getBirthPlaces().get(j).getClass())
						.newInstance(kyleBenedictus.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (kyleBenedictus.getBirthYear() != null)
			this.birthYear = kyleBenedictus.getBirthYear().getClass()
					.getDeclaredConstructor(kyleBenedictus.getBirthYear().getClass())
					.newInstance(kyleBenedictus.getBirthYear());
		this.characterOffset = kyleBenedictus.getCharacterOffset();
		this.characterOnset = kyleBenedictus.getCharacterOnset();
		if (kyleBenedictus.getPosition() != null)
			this.position = kyleBenedictus.getPosition().getClass()
					.getDeclaredConstructor(kyleBenedictus.getPosition().getClass())
					.newInstance(kyleBenedictus.getPosition());
		for (int j = 0; j < kyleBenedictus.getTeams().size(); j++) {
			if (kyleBenedictus.getTeams().get(j) != null) {
				teams.add(kyleBenedictus.getTeams().get(j).getClass()
						.getDeclaredConstructor(kyleBenedictus.getTeams().get(j).getClass())
						.newInstance(kyleBenedictus.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "KyleBenedictus [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear="
