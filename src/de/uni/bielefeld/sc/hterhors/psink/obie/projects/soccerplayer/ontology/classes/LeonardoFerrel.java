...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.ILeonardoFerrel;
...
public class LeonardoFerrel implements ILeonardoFerrel {
	...
	public LeonardoFerrel(LeonardoFerrel leonardoFerrel) throws InstantiationException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		this.annotationID = leonardoFerrel.getAnnotationID();
		for (int j = 0; j < leonardoFerrel.getBirthPlaces().size(); j++) {
			if (leonardoFerrel.getBirthPlaces().get(j) != null) {
				birthPlaces.add(leonardoFerrel.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(leonardoFerrel.getBirthPlaces().get(j).getClass())
						.newInstance(leonardoFerrel.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (leonardoFerrel.getBirthYear() != null)
			this.birthYear = leonardoFerrel.getBirthYear().getClass()
					.getDeclaredConstructor(leonardoFerrel.getBirthYear().getClass())
					.newInstance(leonardoFerrel.getBirthYear());
		this.characterOffset = leonardoFerrel.getCharacterOffset();
		this.characterOnset = leonardoFerrel.getCharacterOnset();
		if (leonardoFerrel.getPosition() != null)
			this.position = leonardoFerrel.getPosition().getClass()
					.getDeclaredConstructor(leonardoFerrel.getPosition().getClass())
					.newInstance(leonardoFerrel.getPosition());
		for (int j = 0; j < leonardoFerrel.getTeams().size(); j++) {
			if (leonardoFerrel.getTeams().get(j) != null) {
				teams.add(leonardoFerrel.getTeams().get(j).getClass()
						.getDeclaredConstructor(leonardoFerrel.getTeams().get(j).getClass())
						.newInstance(leonardoFerrel.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "LeonardoFerrel [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear="
