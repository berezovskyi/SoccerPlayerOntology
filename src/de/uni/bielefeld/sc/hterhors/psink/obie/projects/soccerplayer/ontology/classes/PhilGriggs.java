...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IPhilGriggs;
...
public class PhilGriggs implements IPhilGriggs {
	...
	public PhilGriggs(PhilGriggs philGriggs) throws InstantiationException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		this.annotationID = philGriggs.getAnnotationID();
		for (int j = 0; j < philGriggs.getBirthPlaces().size(); j++) {
			if (philGriggs.getBirthPlaces().get(j) != null) {
				birthPlaces.add(philGriggs.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(philGriggs.getBirthPlaces().get(j).getClass())
						.newInstance(philGriggs.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (philGriggs.getBirthYear() != null)
			this.birthYear = philGriggs.getBirthYear().getClass()
					.getDeclaredConstructor(philGriggs.getBirthYear().getClass())
					.newInstance(philGriggs.getBirthYear());
		this.characterOffset = philGriggs.getCharacterOffset();
		this.characterOnset = philGriggs.getCharacterOnset();
		if (philGriggs.getPosition() != null)
			this.position = philGriggs.getPosition().getClass()
					.getDeclaredConstructor(philGriggs.getPosition().getClass()).newInstance(philGriggs.getPosition());
		for (int j = 0; j < philGriggs.getTeams().size(); j++) {
			if (philGriggs.getTeams().get(j) != null) {
				teams.add(philGriggs.getTeams().get(j).getClass()
						.getDeclaredConstructor(philGriggs.getTeams().get(j).getClass())
						.newInstance(philGriggs.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "PhilGriggs [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear=" + birthYear
