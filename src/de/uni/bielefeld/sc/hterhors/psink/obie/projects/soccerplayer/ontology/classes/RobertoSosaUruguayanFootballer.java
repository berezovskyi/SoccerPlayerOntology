...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IRobertoSosaUruguayanFootballer;
...
public class RobertoSosaUruguayanFootballer implements IRobertoSosaUruguayanFootballer {
	...
	public RobertoSosaUruguayanFootballer(RobertoSosaUruguayanFootballer robertoSosaUruguayanFootballer)
			throws InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException,
			NoSuchMethodException, SecurityException {
		this.annotationID = robertoSosaUruguayanFootballer.getAnnotationID();
		for (int j = 0; j < robertoSosaUruguayanFootballer.getBirthPlaces().size(); j++) {
			if (robertoSosaUruguayanFootballer.getBirthPlaces().get(j) != null) {
				birthPlaces.add(robertoSosaUruguayanFootballer.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(robertoSosaUruguayanFootballer.getBirthPlaces().get(j).getClass())
						.newInstance(robertoSosaUruguayanFootballer.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (robertoSosaUruguayanFootballer.getBirthYear() != null)
			this.birthYear = robertoSosaUruguayanFootballer.getBirthYear().getClass()
					.getDeclaredConstructor(robertoSosaUruguayanFootballer.getBirthYear().getClass())
					.newInstance(robertoSosaUruguayanFootballer.getBirthYear());
		...
		if (robertoSosaUruguayanFootballer.getPosition() != null)
			this.position = robertoSosaUruguayanFootballer.getPosition().getClass()
					.getDeclaredConstructor(robertoSosaUruguayanFootballer.getPosition().getClass())
					.newInstance(robertoSosaUruguayanFootballer.getPosition());
		for (int j = 0; j < robertoSosaUruguayanFootballer.getTeams().size(); j++) {
			if (robertoSosaUruguayanFootballer.getTeams().get(j) != null) {
				teams.add(robertoSosaUruguayanFootballer.getTeams().get(j).getClass()
						.getDeclaredConstructor(robertoSosaUruguayanFootballer.getTeams().get(j).getClass())
						.newInstance(robertoSosaUruguayanFootballer.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "RobertoSosaUruguayanFootballer [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces
