...
@NamedIndividual public class FalkenbergsFf implements IFalkenbergsFf{
...
final private String textMention;
	...
	public FalkenbergsFf(FalkenbergsFf falkenbergsFf)throws InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException,NoSuchMethodException, SecurityException{
...
return "FalkenbergsFf [annotationID="+annotationID+",characterOffset="+characterOffset+",characterOnset="+characterOnset+",serialVersionUID="+serialVersionUID+",textMention="+textMention+"]";}
