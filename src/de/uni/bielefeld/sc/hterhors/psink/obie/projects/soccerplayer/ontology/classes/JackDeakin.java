...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IJackDeakin;
...
public class JackDeakin implements IJackDeakin {
	...
	public JackDeakin(JackDeakin jackDeakin) throws InstantiationException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		this.annotationID = jackDeakin.getAnnotationID();
		for (int j = 0; j < jackDeakin.getBirthPlaces().size(); j++) {
			if (jackDeakin.getBirthPlaces().get(j) != null) {
				birthPlaces.add(jackDeakin.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(jackDeakin.getBirthPlaces().get(j).getClass())
						.newInstance(jackDeakin.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (jackDeakin.getBirthYear() != null)
			this.birthYear = jackDeakin.getBirthYear().getClass()
					.getDeclaredConstructor(jackDeakin.getBirthYear().getClass())
					.newInstance(jackDeakin.getBirthYear());
		this.characterOffset = jackDeakin.getCharacterOffset();
		this.characterOnset = jackDeakin.getCharacterOnset();
		if (jackDeakin.getPosition() != null)
			this.position = jackDeakin.getPosition().getClass()
					.getDeclaredConstructor(jackDeakin.getPosition().getClass()).newInstance(jackDeakin.getPosition());
		for (int j = 0; j < jackDeakin.getTeams().size(); j++) {
			if (jackDeakin.getTeams().get(j) != null) {
				teams.add(jackDeakin.getTeams().get(j).getClass()
						.getDeclaredConstructor(jackDeakin.getTeams().get(j).getClass())
						.newInstance(jackDeakin.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "JackDeakin [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear=" + birthYear
