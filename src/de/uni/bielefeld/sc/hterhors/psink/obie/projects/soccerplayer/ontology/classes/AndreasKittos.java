...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IAndreasKittos;
...
public class AndreasKittos implements IAndreasKittos {
	...
	public AndreasKittos(AndreasKittos andreasKittos) throws InstantiationException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		this.annotationID = andreasKittos.getAnnotationID();
		for (int j = 0; j < andreasKittos.getBirthPlaces().size(); j++) {
			if (andreasKittos.getBirthPlaces().get(j) != null) {
				birthPlaces.add(andreasKittos.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(andreasKittos.getBirthPlaces().get(j).getClass())
						.newInstance(andreasKittos.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (andreasKittos.getBirthYear() != null)
			this.birthYear = andreasKittos.getBirthYear().getClass()
					.getDeclaredConstructor(andreasKittos.getBirthYear().getClass())
					.newInstance(andreasKittos.getBirthYear());
		this.characterOffset = andreasKittos.getCharacterOffset();
		this.characterOnset = andreasKittos.getCharacterOnset();
		if (andreasKittos.getPosition() != null)
			this.position = andreasKittos.getPosition().getClass()
					.getDeclaredConstructor(andreasKittos.getPosition().getClass())
					.newInstance(andreasKittos.getPosition());
		for (int j = 0; j < andreasKittos.getTeams().size(); j++) {
			if (andreasKittos.getTeams().get(j) != null) {
				teams.add(andreasKittos.getTeams().get(j).getClass()
						.getDeclaredConstructor(andreasKittos.getTeams().get(j).getClass())
						.newInstance(andreasKittos.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "AndreasKittos [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear=" + birthYear
