...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.ICLallawmzuala;
...
public class CLallawmzuala implements ICLallawmzuala {
	...
	public CLallawmzuala(CLallawmzuala cLallawmzuala) throws InstantiationException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		this.annotationID = cLallawmzuala.getAnnotationID();
		for (int j = 0; j < cLallawmzuala.getBirthPlaces().size(); j++) {
			if (cLallawmzuala.getBirthPlaces().get(j) != null) {
				birthPlaces.add(cLallawmzuala.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(cLallawmzuala.getBirthPlaces().get(j).getClass())
						.newInstance(cLallawmzuala.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (cLallawmzuala.getBirthYear() != null)
			this.birthYear = cLallawmzuala.getBirthYear().getClass()
					.getDeclaredConstructor(cLallawmzuala.getBirthYear().getClass())
					.newInstance(cLallawmzuala.getBirthYear());
		this.characterOffset = cLallawmzuala.getCharacterOffset();
		this.characterOnset = cLallawmzuala.getCharacterOnset();
		if (cLallawmzuala.getPosition() != null)
			this.position = cLallawmzuala.getPosition().getClass()
					.getDeclaredConstructor(cLallawmzuala.getPosition().getClass())
					.newInstance(cLallawmzuala.getPosition());
		for (int j = 0; j < cLallawmzuala.getTeams().size(); j++) {
			if (cLallawmzuala.getTeams().get(j) != null) {
				teams.add(cLallawmzuala.getTeams().get(j).getClass()
						.getDeclaredConstructor(cLallawmzuala.getTeams().get(j).getClass())
						.newInstance(cLallawmzuala.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "CLallawmzuala [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear=" + birthYear
