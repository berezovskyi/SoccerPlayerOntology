...
@NamedIndividual public class PofcBotevVratsa implements IPofcBotevVratsa{
...
final private String textMention;
	...
	public PofcBotevVratsa(PofcBotevVratsa pofcBotevVratsa)throws InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException,NoSuchMethodException, SecurityException{
...
return "PofcBotevVratsa [annotationID="+annotationID+",characterOffset="+characterOffset+",characterOnset="+characterOnset+",serialVersionUID="+serialVersionUID+",textMention="+textMention+"]";}
