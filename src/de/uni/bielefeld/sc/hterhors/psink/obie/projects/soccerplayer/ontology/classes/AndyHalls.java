...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IAndyHalls;
...
public class AndyHalls implements IAndyHalls {
	...
	public AndyHalls(AndyHalls andyHalls) throws InstantiationException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		this.annotationID = andyHalls.getAnnotationID();
		for (int j = 0; j < andyHalls.getBirthPlaces().size(); j++) {
			if (andyHalls.getBirthPlaces().get(j) != null) {
				birthPlaces.add(andyHalls.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(andyHalls.getBirthPlaces().get(j).getClass())
						.newInstance(andyHalls.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (andyHalls.getBirthYear() != null)
			this.birthYear = andyHalls.getBirthYear().getClass()
					.getDeclaredConstructor(andyHalls.getBirthYear().getClass()).newInstance(andyHalls.getBirthYear());
		this.characterOffset = andyHalls.getCharacterOffset();
		this.characterOnset = andyHalls.getCharacterOnset();
		if (andyHalls.getPosition() != null)
			this.position = andyHalls.getPosition().getClass()
					.getDeclaredConstructor(andyHalls.getPosition().getClass()).newInstance(andyHalls.getPosition());
		for (int j = 0; j < andyHalls.getTeams().size(); j++) {
			if (andyHalls.getTeams().get(j) != null) {
				teams.add(andyHalls.getTeams().get(j).getClass()
						.getDeclaredConstructor(andyHalls.getTeams().get(j).getClass())
						.newInstance(andyHalls.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "AndyHalls [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear=" + birthYear
