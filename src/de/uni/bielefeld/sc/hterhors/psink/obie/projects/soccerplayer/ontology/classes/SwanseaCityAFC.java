...
@NamedIndividual public class SwanseaCityAFC implements ISwanseaCityAFC{
...
this.textMention = null;
	...
	public SwanseaCityAFC(SwanseaCityAFC swanseaCityAFC)throws InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException,NoSuchMethodException, SecurityException{
...
return "SwanseaCityAFC [annotationID="+annotationID+",characterOffset="+characterOffset+",characterOnset="+characterOnset+",serialVersionUID="+serialVersionUID+",textMention="+textMention+"]";}
