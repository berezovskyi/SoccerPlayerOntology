...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IEvansKangwa;
...
public class EvansKangwa implements IEvansKangwa {
	...
	public EvansKangwa(EvansKangwa evansKangwa) throws InstantiationException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		this.annotationID = evansKangwa.getAnnotationID();
		for (int j = 0; j < evansKangwa.getBirthPlaces().size(); j++) {
			if (evansKangwa.getBirthPlaces().get(j) != null) {
				birthPlaces.add(evansKangwa.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(evansKangwa.getBirthPlaces().get(j).getClass())
						.newInstance(evansKangwa.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (evansKangwa.getBirthYear() != null)
			this.birthYear = evansKangwa.getBirthYear().getClass()
					.getDeclaredConstructor(evansKangwa.getBirthYear().getClass())
					.newInstance(evansKangwa.getBirthYear());
		this.characterOffset = evansKangwa.getCharacterOffset();
		this.characterOnset = evansKangwa.getCharacterOnset();
		if (evansKangwa.getPosition() != null)
			this.position = evansKangwa.getPosition().getClass()
					.getDeclaredConstructor(evansKangwa.getPosition().getClass())
					.newInstance(evansKangwa.getPosition());
		for (int j = 0; j < evansKangwa.getTeams().size(); j++) {
			if (evansKangwa.getTeams().get(j) != null) {
				teams.add(evansKangwa.getTeams().get(j).getClass()
						.getDeclaredConstructor(evansKangwa.getTeams().get(j).getClass())
						.newInstance(evansKangwa.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "EvansKangwa [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear=" + birthYear
