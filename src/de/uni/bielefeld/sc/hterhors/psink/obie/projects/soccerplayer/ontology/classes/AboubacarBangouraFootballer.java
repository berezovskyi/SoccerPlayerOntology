...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IAboubacarBangouraFootballer;
...
public class AboubacarBangouraFootballer implements IAboubacarBangouraFootballer {
	...
	public AboubacarBangouraFootballer(AboubacarBangouraFootballer aboubacarBangouraFootballer)
			throws InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException,
			NoSuchMethodException, SecurityException {
		this.annotationID = aboubacarBangouraFootballer.getAnnotationID();
		for (int j = 0; j < aboubacarBangouraFootballer.getBirthPlaces().size(); j++) {
			if (aboubacarBangouraFootballer.getBirthPlaces().get(j) != null) {
				birthPlaces.add(aboubacarBangouraFootballer.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(aboubacarBangouraFootballer.getBirthPlaces().get(j).getClass())
						.newInstance(aboubacarBangouraFootballer.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (aboubacarBangouraFootballer.getBirthYear() != null)
			this.birthYear = aboubacarBangouraFootballer.getBirthYear().getClass()
					.getDeclaredConstructor(aboubacarBangouraFootballer.getBirthYear().getClass())
					.newInstance(aboubacarBangouraFootballer.getBirthYear());
		...
		if (aboubacarBangouraFootballer.getPosition() != null)
			this.position = aboubacarBangouraFootballer.getPosition().getClass()
					.getDeclaredConstructor(aboubacarBangouraFootballer.getPosition().getClass())
					.newInstance(aboubacarBangouraFootballer.getPosition());
		for (int j = 0; j < aboubacarBangouraFootballer.getTeams().size(); j++) {
			if (aboubacarBangouraFootballer.getTeams().get(j) != null) {
				teams.add(aboubacarBangouraFootballer.getTeams().get(j).getClass()
						.getDeclaredConstructor(aboubacarBangouraFootballer.getTeams().get(j).getClass())
						.newInstance(aboubacarBangouraFootballer.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "AboubacarBangouraFootballer [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces
