...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IAlexGilbey;
...
public class AlexGilbey implements IAlexGilbey {
	...
	public AlexGilbey(AlexGilbey alexGilbey) throws InstantiationException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		this.annotationID = alexGilbey.getAnnotationID();
		for (int j = 0; j < alexGilbey.getBirthPlaces().size(); j++) {
			if (alexGilbey.getBirthPlaces().get(j) != null) {
				birthPlaces.add(alexGilbey.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(alexGilbey.getBirthPlaces().get(j).getClass())
						.newInstance(alexGilbey.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (alexGilbey.getBirthYear() != null)
			this.birthYear = alexGilbey.getBirthYear().getClass()
					.getDeclaredConstructor(alexGilbey.getBirthYear().getClass())
					.newInstance(alexGilbey.getBirthYear());
		this.characterOffset = alexGilbey.getCharacterOffset();
		this.characterOnset = alexGilbey.getCharacterOnset();
		if (alexGilbey.getPosition() != null)
			this.position = alexGilbey.getPosition().getClass()
					.getDeclaredConstructor(alexGilbey.getPosition().getClass()).newInstance(alexGilbey.getPosition());
		for (int j = 0; j < alexGilbey.getTeams().size(); j++) {
			if (alexGilbey.getTeams().get(j) != null) {
				teams.add(alexGilbey.getTeams().get(j).getClass()
						.getDeclaredConstructor(alexGilbey.getTeams().get(j).getClass())
						.newInstance(alexGilbey.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "AlexGilbey [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear=" + birthYear
