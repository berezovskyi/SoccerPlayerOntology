...
@DirectInterface(get=IWingHalf.class)

@SuperRootClasses(get={Position.class, })

@NamedIndividual
@AssignableSubClasses(get={})
 public class WingHalf implements IWingHalf{

	final static public String ONTOLOGY_NAME = "http://psink.de/scio/WingHalf";
...
this.textMention = null;
	...
	public WingHalf(String annotationID, String textMention){
this.annotationID = annotationID;
this.textMention = textMention;
}
	public WingHalf(WingHalf wingHalf)throws InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException,NoSuchMethodException, SecurityException{
this.annotationID = wingHalf.getAnnotationID();
this.characterOffset = wingHalf.getCharacterOffset();
this.characterOnset = wingHalf.getCharacterOnset();
this.textMention = wingHalf.getTextMention();
}
...
return "WingHalf [annotationID="+annotationID+",characterOffset="+characterOffset+",characterOnset="+characterOnset+",serialVersionUID="+serialVersionUID+",textMention="+textMention+"]";}
