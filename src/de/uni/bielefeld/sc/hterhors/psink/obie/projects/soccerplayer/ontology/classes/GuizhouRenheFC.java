...
@NamedIndividual public class GuizhouRenheFC implements IGuizhouRenheFC{
...
final private String textMention;
	...
	public GuizhouRenheFC(GuizhouRenheFC guizhouRenheFC)throws InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException,NoSuchMethodException, SecurityException{
...
return "GuizhouRenheFC [annotationID="+annotationID+",characterOffset="+characterOffset+",characterOnset="+characterOnset+",serialVersionUID="+serialVersionUID+",textMention="+textMention+"]";}
