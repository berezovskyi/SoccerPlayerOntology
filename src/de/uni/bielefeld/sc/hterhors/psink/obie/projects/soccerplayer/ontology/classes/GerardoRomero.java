...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IGerardoRomero;
...
public class GerardoRomero implements IGerardoRomero {
	...
	public GerardoRomero(GerardoRomero gerardoRomero) throws InstantiationException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		this.annotationID = gerardoRomero.getAnnotationID();
		for (int j = 0; j < gerardoRomero.getBirthPlaces().size(); j++) {
			if (gerardoRomero.getBirthPlaces().get(j) != null) {
				birthPlaces.add(gerardoRomero.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(gerardoRomero.getBirthPlaces().get(j).getClass())
						.newInstance(gerardoRomero.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (gerardoRomero.getBirthYear() != null)
			this.birthYear = gerardoRomero.getBirthYear().getClass()
					.getDeclaredConstructor(gerardoRomero.getBirthYear().getClass())
					.newInstance(gerardoRomero.getBirthYear());
		this.characterOffset = gerardoRomero.getCharacterOffset();
		this.characterOnset = gerardoRomero.getCharacterOnset();
		if (gerardoRomero.getPosition() != null)
			this.position = gerardoRomero.getPosition().getClass()
					.getDeclaredConstructor(gerardoRomero.getPosition().getClass())
					.newInstance(gerardoRomero.getPosition());
		for (int j = 0; j < gerardoRomero.getTeams().size(); j++) {
			if (gerardoRomero.getTeams().get(j) != null) {
				teams.add(gerardoRomero.getTeams().get(j).getClass()
						.getDeclaredConstructor(gerardoRomero.getTeams().get(j).getClass())
						.newInstance(gerardoRomero.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "GerardoRomero [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear=" + birthYear
