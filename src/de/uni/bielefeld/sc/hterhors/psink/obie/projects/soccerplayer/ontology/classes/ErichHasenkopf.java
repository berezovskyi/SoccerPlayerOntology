...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IErichHasenkopf;
...
public class ErichHasenkopf implements IErichHasenkopf {
	...
	public ErichHasenkopf(ErichHasenkopf erichHasenkopf) throws InstantiationException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		this.annotationID = erichHasenkopf.getAnnotationID();
		for (int j = 0; j < erichHasenkopf.getBirthPlaces().size(); j++) {
			if (erichHasenkopf.getBirthPlaces().get(j) != null) {
				birthPlaces.add(erichHasenkopf.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(erichHasenkopf.getBirthPlaces().get(j).getClass())
						.newInstance(erichHasenkopf.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (erichHasenkopf.getBirthYear() != null)
			this.birthYear = erichHasenkopf.getBirthYear().getClass()
					.getDeclaredConstructor(erichHasenkopf.getBirthYear().getClass())
					.newInstance(erichHasenkopf.getBirthYear());
		this.characterOffset = erichHasenkopf.getCharacterOffset();
		this.characterOnset = erichHasenkopf.getCharacterOnset();
		if (erichHasenkopf.getPosition() != null)
			this.position = erichHasenkopf.getPosition().getClass()
					.getDeclaredConstructor(erichHasenkopf.getPosition().getClass())
					.newInstance(erichHasenkopf.getPosition());
		for (int j = 0; j < erichHasenkopf.getTeams().size(); j++) {
			if (erichHasenkopf.getTeams().get(j) != null) {
				teams.add(erichHasenkopf.getTeams().get(j).getClass()
						.getDeclaredConstructor(erichHasenkopf.getTeams().get(j).getClass())
						.newInstance(erichHasenkopf.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "ErichHasenkopf [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear="
