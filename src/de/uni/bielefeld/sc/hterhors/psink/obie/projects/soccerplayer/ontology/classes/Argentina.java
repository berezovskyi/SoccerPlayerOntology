...
@NamedIndividual public class Argentina implements IArgentina{
...
this.textMention = textMention;
	...
	public Argentina(Argentina argentina)throws InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException,NoSuchMethodException, SecurityException{
...
return "Argentina [annotationID="+annotationID+",characterOffset="+characterOffset+",characterOnset="+characterOnset+",serialVersionUID="+serialVersionUID+",textMention="+textMention+"]";}
