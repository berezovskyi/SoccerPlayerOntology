...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IDanielOliveiraCosta;
...
public class DanielOliveiraCosta implements IDanielOliveiraCosta {
	...
	public DanielOliveiraCosta(DanielOliveiraCosta danielOliveiraCosta)
			throws InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException,
			NoSuchMethodException, SecurityException {
		this.annotationID = danielOliveiraCosta.getAnnotationID();
		for (int j = 0; j < danielOliveiraCosta.getBirthPlaces().size(); j++) {
			if (danielOliveiraCosta.getBirthPlaces().get(j) != null) {
				birthPlaces.add(danielOliveiraCosta.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(danielOliveiraCosta.getBirthPlaces().get(j).getClass())
						.newInstance(danielOliveiraCosta.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (danielOliveiraCosta.getBirthYear() != null)
			this.birthYear = danielOliveiraCosta.getBirthYear().getClass()
					.getDeclaredConstructor(danielOliveiraCosta.getBirthYear().getClass())
					.newInstance(danielOliveiraCosta.getBirthYear());
		this.characterOffset = danielOliveiraCosta.getCharacterOffset();
		this.characterOnset = danielOliveiraCosta.getCharacterOnset();
		if (danielOliveiraCosta.getPosition() != null)
			this.position = danielOliveiraCosta.getPosition().getClass()
					.getDeclaredConstructor(danielOliveiraCosta.getPosition().getClass())
					.newInstance(danielOliveiraCosta.getPosition());
		for (int j = 0; j < danielOliveiraCosta.getTeams().size(); j++) {
			if (danielOliveiraCosta.getTeams().get(j) != null) {
				teams.add(danielOliveiraCosta.getTeams().get(j).getClass()
						.getDeclaredConstructor(danielOliveiraCosta.getTeams().get(j).getClass())
						.newInstance(danielOliveiraCosta.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "DanielOliveiraCosta [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear="
