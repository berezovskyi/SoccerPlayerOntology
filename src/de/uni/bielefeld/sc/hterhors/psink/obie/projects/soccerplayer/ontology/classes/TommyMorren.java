...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.ITommyMorren;
...
public class TommyMorren implements ITommyMorren {
	...
	public TommyMorren(TommyMorren tommyMorren) throws InstantiationException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		this.annotationID = tommyMorren.getAnnotationID();
		for (int j = 0; j < tommyMorren.getBirthPlaces().size(); j++) {
			if (tommyMorren.getBirthPlaces().get(j) != null) {
				birthPlaces.add(tommyMorren.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(tommyMorren.getBirthPlaces().get(j).getClass())
						.newInstance(tommyMorren.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (tommyMorren.getBirthYear() != null)
			this.birthYear = tommyMorren.getBirthYear().getClass()
					.getDeclaredConstructor(tommyMorren.getBirthYear().getClass())
					.newInstance(tommyMorren.getBirthYear());
		this.characterOffset = tommyMorren.getCharacterOffset();
		this.characterOnset = tommyMorren.getCharacterOnset();
		if (tommyMorren.getPosition() != null)
			this.position = tommyMorren.getPosition().getClass()
					.getDeclaredConstructor(tommyMorren.getPosition().getClass())
					.newInstance(tommyMorren.getPosition());
		for (int j = 0; j < tommyMorren.getTeams().size(); j++) {
			if (tommyMorren.getTeams().get(j) != null) {
				teams.add(tommyMorren.getTeams().get(j).getClass()
						.getDeclaredConstructor(tommyMorren.getTeams().get(j).getClass())
						.newInstance(tommyMorren.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "TommyMorren [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear=" + birthYear
