...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.ISheldonGovier;
...
public class SheldonGovier implements ISheldonGovier {
	...
	public SheldonGovier(SheldonGovier sheldonGovier) throws InstantiationException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		this.annotationID = sheldonGovier.getAnnotationID();
		for (int j = 0; j < sheldonGovier.getBirthPlaces().size(); j++) {
			if (sheldonGovier.getBirthPlaces().get(j) != null) {
				birthPlaces.add(sheldonGovier.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(sheldonGovier.getBirthPlaces().get(j).getClass())
						.newInstance(sheldonGovier.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (sheldonGovier.getBirthYear() != null)
			this.birthYear = sheldonGovier.getBirthYear().getClass()
					.getDeclaredConstructor(sheldonGovier.getBirthYear().getClass())
					.newInstance(sheldonGovier.getBirthYear());
		this.characterOffset = sheldonGovier.getCharacterOffset();
		this.characterOnset = sheldonGovier.getCharacterOnset();
		if (sheldonGovier.getPosition() != null)
			this.position = sheldonGovier.getPosition().getClass()
					.getDeclaredConstructor(sheldonGovier.getPosition().getClass())
					.newInstance(sheldonGovier.getPosition());
		for (int j = 0; j < sheldonGovier.getTeams().size(); j++) {
			if (sheldonGovier.getTeams().get(j) != null) {
				teams.add(sheldonGovier.getTeams().get(j).getClass()
						.getDeclaredConstructor(sheldonGovier.getTeams().get(j).getClass())
						.newInstance(sheldonGovier.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "SheldonGovier [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear=" + birthYear
