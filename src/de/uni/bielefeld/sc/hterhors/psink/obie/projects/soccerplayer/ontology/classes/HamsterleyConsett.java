...
@NamedIndividual public class HamsterleyConsett implements IHamsterleyConsett{
...
this.textMention = textMention;
	...
	public HamsterleyConsett(HamsterleyConsett hamsterleyConsett)throws InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException,NoSuchMethodException, SecurityException{
...
return "HamsterleyConsett [annotationID="+annotationID+",characterOffset="+characterOffset+",characterOnset="+characterOnset+",serialVersionUID="+serialVersionUID+",textMention="+textMention+"]";}
