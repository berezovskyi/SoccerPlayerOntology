...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IAdenCharmakeh;
...
public class AdenCharmakeh implements IAdenCharmakeh {
	...
	public AdenCharmakeh(AdenCharmakeh adenCharmakeh) throws InstantiationException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		this.annotationID = adenCharmakeh.getAnnotationID();
		for (int j = 0; j < adenCharmakeh.getBirthPlaces().size(); j++) {
			if (adenCharmakeh.getBirthPlaces().get(j) != null) {
				birthPlaces.add(adenCharmakeh.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(adenCharmakeh.getBirthPlaces().get(j).getClass())
						.newInstance(adenCharmakeh.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (adenCharmakeh.getBirthYear() != null)
			this.birthYear = adenCharmakeh.getBirthYear().getClass()
					.getDeclaredConstructor(adenCharmakeh.getBirthYear().getClass())
					.newInstance(adenCharmakeh.getBirthYear());
		this.characterOffset = adenCharmakeh.getCharacterOffset();
		this.characterOnset = adenCharmakeh.getCharacterOnset();
		if (adenCharmakeh.getPosition() != null)
			this.position = adenCharmakeh.getPosition().getClass()
					.getDeclaredConstructor(adenCharmakeh.getPosition().getClass())
					.newInstance(adenCharmakeh.getPosition());
		for (int j = 0; j < adenCharmakeh.getTeams().size(); j++) {
			if (adenCharmakeh.getTeams().get(j) != null) {
				teams.add(adenCharmakeh.getTeams().get(j).getClass()
						.getDeclaredConstructor(adenCharmakeh.getTeams().get(j).getClass())
						.newInstance(adenCharmakeh.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "AdenCharmakeh [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear=" + birthYear
