...
@NamedIndividual public class StockportCountyFC implements IStockportCountyFC{
...
this.textMention = null;
	...
	public StockportCountyFC(StockportCountyFC stockportCountyFC)throws InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException,NoSuchMethodException, SecurityException{
...
return "StockportCountyFC [annotationID="+annotationID+",characterOffset="+characterOffset+",characterOnset="+characterOnset+",serialVersionUID="+serialVersionUID+",textMention="+textMention+"]";}
