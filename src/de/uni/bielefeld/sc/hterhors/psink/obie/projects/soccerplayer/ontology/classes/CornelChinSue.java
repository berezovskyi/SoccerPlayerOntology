...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.ICornelChinSue;
...
public class CornelChinSue implements ICornelChinSue {
	...
	public CornelChinSue(CornelChinSue cornelChinSue) throws InstantiationException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		this.annotationID = cornelChinSue.getAnnotationID();
		for (int j = 0; j < cornelChinSue.getBirthPlaces().size(); j++) {
			if (cornelChinSue.getBirthPlaces().get(j) != null) {
				birthPlaces.add(cornelChinSue.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(cornelChinSue.getBirthPlaces().get(j).getClass())
						.newInstance(cornelChinSue.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (cornelChinSue.getBirthYear() != null)
			this.birthYear = cornelChinSue.getBirthYear().getClass()
					.getDeclaredConstructor(cornelChinSue.getBirthYear().getClass())
					.newInstance(cornelChinSue.getBirthYear());
		this.characterOffset = cornelChinSue.getCharacterOffset();
		this.characterOnset = cornelChinSue.getCharacterOnset();
		if (cornelChinSue.getPosition() != null)
			this.position = cornelChinSue.getPosition().getClass()
					.getDeclaredConstructor(cornelChinSue.getPosition().getClass())
					.newInstance(cornelChinSue.getPosition());
		for (int j = 0; j < cornelChinSue.getTeams().size(); j++) {
			if (cornelChinSue.getTeams().get(j) != null) {
				teams.add(cornelChinSue.getTeams().get(j).getClass()
						.getDeclaredConstructor(cornelChinSue.getTeams().get(j).getClass())
						.newInstance(cornelChinSue.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "CornelChinSue [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear=" + birthYear
