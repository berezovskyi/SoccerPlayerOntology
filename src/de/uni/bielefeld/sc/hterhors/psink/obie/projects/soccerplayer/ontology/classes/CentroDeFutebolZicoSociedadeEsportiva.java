...
final private String textMention;
	...
	public CentroDeFutebolZicoSociedadeEsportiva(CentroDeFutebolZicoSociedadeEsportiva centroDeFutebolZicoSociedadeEsportiva)throws InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException,NoSuchMethodException, SecurityException{
...
return "CentroDeFutebolZicoSociedadeEsportiva [annotationID="+annotationID+",characterOffset="+characterOffset+",characterOnset="+characterOnset+",serialVersionUID="+serialVersionUID+",textMention="+textMention+"]";}
