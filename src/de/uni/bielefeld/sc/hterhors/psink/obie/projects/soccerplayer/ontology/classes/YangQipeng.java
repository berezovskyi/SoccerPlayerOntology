...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IYangQipeng;
...
public class YangQipeng implements IYangQipeng {
	...
	public YangQipeng(YangQipeng yangQipeng) throws InstantiationException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		this.annotationID = yangQipeng.getAnnotationID();
		for (int j = 0; j < yangQipeng.getBirthPlaces().size(); j++) {
			if (yangQipeng.getBirthPlaces().get(j) != null) {
				birthPlaces.add(yangQipeng.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(yangQipeng.getBirthPlaces().get(j).getClass())
						.newInstance(yangQipeng.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (yangQipeng.getBirthYear() != null)
			this.birthYear = yangQipeng.getBirthYear().getClass()
					.getDeclaredConstructor(yangQipeng.getBirthYear().getClass())
					.newInstance(yangQipeng.getBirthYear());
		this.characterOffset = yangQipeng.getCharacterOffset();
		this.characterOnset = yangQipeng.getCharacterOnset();
		if (yangQipeng.getPosition() != null)
			this.position = yangQipeng.getPosition().getClass()
					.getDeclaredConstructor(yangQipeng.getPosition().getClass()).newInstance(yangQipeng.getPosition());
		for (int j = 0; j < yangQipeng.getTeams().size(); j++) {
			if (yangQipeng.getTeams().get(j) != null) {
				teams.add(yangQipeng.getTeams().get(j).getClass()
						.getDeclaredConstructor(yangQipeng.getTeams().get(j).getClass())
						.newInstance(yangQipeng.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "YangQipeng [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear=" + birthYear
