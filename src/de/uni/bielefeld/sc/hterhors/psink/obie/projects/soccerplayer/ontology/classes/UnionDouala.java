...
@NamedIndividual public class UnionDouala implements IUnionDouala{
...
this.textMention = null;
	...
	public UnionDouala(UnionDouala unionDouala)throws InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException,NoSuchMethodException, SecurityException{
...
return "UnionDouala [annotationID="+annotationID+",characterOffset="+characterOffset+",characterOnset="+characterOnset+",serialVersionUID="+serialVersionUID+",textMention="+textMention+"]";}
