...
@NamedIndividual public class HarlandAndWolff implements IHarlandAndWolff{
...
this.textMention = null;
	...
	public HarlandAndWolff(HarlandAndWolff harlandAndWolff)throws InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException,NoSuchMethodException, SecurityException{
...
return "HarlandAndWolff [annotationID="+annotationID+",characterOffset="+characterOffset+",characterOnset="+characterOnset+",serialVersionUID="+serialVersionUID+",textMention="+textMention+"]";}
