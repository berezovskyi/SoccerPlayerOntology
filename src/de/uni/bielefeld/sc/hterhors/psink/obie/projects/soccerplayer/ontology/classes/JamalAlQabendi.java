...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IJamalAlQabendi;
...
public class JamalAlQabendi implements IJamalAlQabendi {
	...
	public JamalAlQabendi(JamalAlQabendi jamalAlQabendi) throws InstantiationException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		this.annotationID = jamalAlQabendi.getAnnotationID();
		for (int j = 0; j < jamalAlQabendi.getBirthPlaces().size(); j++) {
			if (jamalAlQabendi.getBirthPlaces().get(j) != null) {
				birthPlaces.add(jamalAlQabendi.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(jamalAlQabendi.getBirthPlaces().get(j).getClass())
						.newInstance(jamalAlQabendi.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (jamalAlQabendi.getBirthYear() != null)
			this.birthYear = jamalAlQabendi.getBirthYear().getClass()
					.getDeclaredConstructor(jamalAlQabendi.getBirthYear().getClass())
					.newInstance(jamalAlQabendi.getBirthYear());
		this.characterOffset = jamalAlQabendi.getCharacterOffset();
		this.characterOnset = jamalAlQabendi.getCharacterOnset();
		if (jamalAlQabendi.getPosition() != null)
			this.position = jamalAlQabendi.getPosition().getClass()
					.getDeclaredConstructor(jamalAlQabendi.getPosition().getClass())
					.newInstance(jamalAlQabendi.getPosition());
		for (int j = 0; j < jamalAlQabendi.getTeams().size(); j++) {
			if (jamalAlQabendi.getTeams().get(j) != null) {
				teams.add(jamalAlQabendi.getTeams().get(j).getClass()
						.getDeclaredConstructor(jamalAlQabendi.getTeams().get(j).getClass())
						.newInstance(jamalAlQabendi.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "JamalAlQabendi [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear="
