...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.ITomPerryFootballer;
...
public class TomPerryFootballer implements ITomPerryFootballer {
	...
	public TomPerryFootballer(TomPerryFootballer tomPerryFootballer)
			throws InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException,
			NoSuchMethodException, SecurityException {
		this.annotationID = tomPerryFootballer.getAnnotationID();
		for (int j = 0; j < tomPerryFootballer.getBirthPlaces().size(); j++) {
			if (tomPerryFootballer.getBirthPlaces().get(j) != null) {
				birthPlaces.add(tomPerryFootballer.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(tomPerryFootballer.getBirthPlaces().get(j).getClass())
						.newInstance(tomPerryFootballer.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (tomPerryFootballer.getBirthYear() != null)
			this.birthYear = tomPerryFootballer.getBirthYear().getClass()
					.getDeclaredConstructor(tomPerryFootballer.getBirthYear().getClass())
					.newInstance(tomPerryFootballer.getBirthYear());
		this.characterOffset = tomPerryFootballer.getCharacterOffset();
		this.characterOnset = tomPerryFootballer.getCharacterOnset();
		if (tomPerryFootballer.getPosition() != null)
			this.position = tomPerryFootballer.getPosition().getClass()
					.getDeclaredConstructor(tomPerryFootballer.getPosition().getClass())
					.newInstance(tomPerryFootballer.getPosition());
		for (int j = 0; j < tomPerryFootballer.getTeams().size(); j++) {
			if (tomPerryFootballer.getTeams().get(j) != null) {
				teams.add(tomPerryFootballer.getTeams().get(j).getClass()
						.getDeclaredConstructor(tomPerryFootballer.getTeams().get(j).getClass())
						.newInstance(tomPerryFootballer.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "TomPerryFootballer [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear="
