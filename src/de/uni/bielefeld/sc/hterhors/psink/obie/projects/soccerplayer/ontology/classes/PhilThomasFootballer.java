...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IPhilThomasFootballer;
...
public class PhilThomasFootballer implements IPhilThomasFootballer {
	...
	public PhilThomasFootballer(PhilThomasFootballer philThomasFootballer)
			throws InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException,
			NoSuchMethodException, SecurityException {
		this.annotationID = philThomasFootballer.getAnnotationID();
		for (int j = 0; j < philThomasFootballer.getBirthPlaces().size(); j++) {
			if (philThomasFootballer.getBirthPlaces().get(j) != null) {
				birthPlaces.add(philThomasFootballer.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(philThomasFootballer.getBirthPlaces().get(j).getClass())
						.newInstance(philThomasFootballer.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (philThomasFootballer.getBirthYear() != null)
			this.birthYear = philThomasFootballer.getBirthYear().getClass()
					.getDeclaredConstructor(philThomasFootballer.getBirthYear().getClass())
					.newInstance(philThomasFootballer.getBirthYear());
		this.characterOffset = philThomasFootballer.getCharacterOffset();
		this.characterOnset = philThomasFootballer.getCharacterOnset();
		if (philThomasFootballer.getPosition() != null)
			this.position = philThomasFootballer.getPosition().getClass()
					.getDeclaredConstructor(philThomasFootballer.getPosition().getClass())
					.newInstance(philThomasFootballer.getPosition());
		for (int j = 0; j < philThomasFootballer.getTeams().size(); j++) {
			if (philThomasFootballer.getTeams().get(j) != null) {
				teams.add(philThomasFootballer.getTeams().get(j).getClass()
						.getDeclaredConstructor(philThomasFootballer.getTeams().get(j).getClass())
						.newInstance(philThomasFootballer.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "PhilThomasFootballer [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear="
