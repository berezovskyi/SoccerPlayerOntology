...
@NamedIndividual public class ArisThessalonikiFCWomen implements IArisThessalonikiFCWomen{
...
this.textMention = null;
	...
	public ArisThessalonikiFCWomen(ArisThessalonikiFCWomen arisThessalonikiFCWomen)throws InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException,NoSuchMethodException, SecurityException{
...
return "ArisThessalonikiFCWomen [annotationID="+annotationID+",characterOffset="+characterOffset+",characterOnset="+characterOnset+",serialVersionUID="+serialVersionUID+",textMention="+textMention+"]";}
