...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.ICedricBadjeck;
...
public class CedricBadjeck implements ICedricBadjeck {
	...
	public CedricBadjeck(CedricBadjeck cedricBadjeck) throws InstantiationException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		this.annotationID = cedricBadjeck.getAnnotationID();
		for (int j = 0; j < cedricBadjeck.getBirthPlaces().size(); j++) {
			if (cedricBadjeck.getBirthPlaces().get(j) != null) {
				birthPlaces.add(cedricBadjeck.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(cedricBadjeck.getBirthPlaces().get(j).getClass())
						.newInstance(cedricBadjeck.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (cedricBadjeck.getBirthYear() != null)
			this.birthYear = cedricBadjeck.getBirthYear().getClass()
					.getDeclaredConstructor(cedricBadjeck.getBirthYear().getClass())
					.newInstance(cedricBadjeck.getBirthYear());
		this.characterOffset = cedricBadjeck.getCharacterOffset();
		this.characterOnset = cedricBadjeck.getCharacterOnset();
		if (cedricBadjeck.getPosition() != null)
			this.position = cedricBadjeck.getPosition().getClass()
					.getDeclaredConstructor(cedricBadjeck.getPosition().getClass())
					.newInstance(cedricBadjeck.getPosition());
		for (int j = 0; j < cedricBadjeck.getTeams().size(); j++) {
			if (cedricBadjeck.getTeams().get(j) != null) {
				teams.add(cedricBadjeck.getTeams().get(j).getClass()
						.getDeclaredConstructor(cedricBadjeck.getTeams().get(j).getClass())
						.newInstance(cedricBadjeck.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "CedricBadjeck [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear=" + birthYear
