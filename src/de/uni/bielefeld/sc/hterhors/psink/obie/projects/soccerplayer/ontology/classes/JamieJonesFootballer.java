...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IJamieJonesFootballer;
...
public class JamieJonesFootballer implements IJamieJonesFootballer {
	...
	public JamieJonesFootballer(JamieJonesFootballer jamieJonesFootballer)
			throws InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException,
			NoSuchMethodException, SecurityException {
		this.annotationID = jamieJonesFootballer.getAnnotationID();
		for (int j = 0; j < jamieJonesFootballer.getBirthPlaces().size(); j++) {
			if (jamieJonesFootballer.getBirthPlaces().get(j) != null) {
				birthPlaces.add(jamieJonesFootballer.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(jamieJonesFootballer.getBirthPlaces().get(j).getClass())
						.newInstance(jamieJonesFootballer.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (jamieJonesFootballer.getBirthYear() != null)
			this.birthYear = jamieJonesFootballer.getBirthYear().getClass()
					.getDeclaredConstructor(jamieJonesFootballer.getBirthYear().getClass())
					.newInstance(jamieJonesFootballer.getBirthYear());
		this.characterOffset = jamieJonesFootballer.getCharacterOffset();
		this.characterOnset = jamieJonesFootballer.getCharacterOnset();
		if (jamieJonesFootballer.getPosition() != null)
			this.position = jamieJonesFootballer.getPosition().getClass()
					.getDeclaredConstructor(jamieJonesFootballer.getPosition().getClass())
					.newInstance(jamieJonesFootballer.getPosition());
		for (int j = 0; j < jamieJonesFootballer.getTeams().size(); j++) {
			if (jamieJonesFootballer.getTeams().get(j) != null) {
				teams.add(jamieJonesFootballer.getTeams().get(j).getClass()
						.getDeclaredConstructor(jamieJonesFootballer.getTeams().get(j).getClass())
						.newInstance(jamieJonesFootballer.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "JamieJonesFootballer [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear="
