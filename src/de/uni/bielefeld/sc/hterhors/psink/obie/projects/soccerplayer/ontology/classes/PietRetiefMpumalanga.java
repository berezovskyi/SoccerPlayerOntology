...
@NamedIndividual public class PietRetiefMpumalanga implements IPietRetiefMpumalanga{
...
this.textMention = textMention;
	...
	public PietRetiefMpumalanga(PietRetiefMpumalanga pietRetiefMpumalanga)throws InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException,NoSuchMethodException, SecurityException{
...
return "PietRetiefMpumalanga [annotationID="+annotationID+",characterOffset="+characterOffset+",characterOnset="+characterOnset+",serialVersionUID="+serialVersionUID+",textMention="+textMention+"]";}
