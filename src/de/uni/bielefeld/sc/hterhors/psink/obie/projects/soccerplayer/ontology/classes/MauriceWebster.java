...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IMauriceWebster;
...
public class MauriceWebster implements IMauriceWebster {
	...
	public MauriceWebster(MauriceWebster mauriceWebster) throws InstantiationException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		this.annotationID = mauriceWebster.getAnnotationID();
		for (int j = 0; j < mauriceWebster.getBirthPlaces().size(); j++) {
			if (mauriceWebster.getBirthPlaces().get(j) != null) {
				birthPlaces.add(mauriceWebster.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(mauriceWebster.getBirthPlaces().get(j).getClass())
						.newInstance(mauriceWebster.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (mauriceWebster.getBirthYear() != null)
			this.birthYear = mauriceWebster.getBirthYear().getClass()
					.getDeclaredConstructor(mauriceWebster.getBirthYear().getClass())
					.newInstance(mauriceWebster.getBirthYear());
		this.characterOffset = mauriceWebster.getCharacterOffset();
		this.characterOnset = mauriceWebster.getCharacterOnset();
		if (mauriceWebster.getPosition() != null)
			this.position = mauriceWebster.getPosition().getClass()
					.getDeclaredConstructor(mauriceWebster.getPosition().getClass())
					.newInstance(mauriceWebster.getPosition());
		for (int j = 0; j < mauriceWebster.getTeams().size(); j++) {
			if (mauriceWebster.getTeams().get(j) != null) {
				teams.add(mauriceWebster.getTeams().get(j).getClass()
						.getDeclaredConstructor(mauriceWebster.getTeams().get(j).getClass())
						.newInstance(mauriceWebster.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "MauriceWebster [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear="
