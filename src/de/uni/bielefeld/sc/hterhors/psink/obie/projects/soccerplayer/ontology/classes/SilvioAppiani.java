...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.ISilvioAppiani;
...
public class SilvioAppiani implements ISilvioAppiani {
	...
	public SilvioAppiani(SilvioAppiani silvioAppiani) throws InstantiationException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		this.annotationID = silvioAppiani.getAnnotationID();
		for (int j = 0; j < silvioAppiani.getBirthPlaces().size(); j++) {
			if (silvioAppiani.getBirthPlaces().get(j) != null) {
				birthPlaces.add(silvioAppiani.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(silvioAppiani.getBirthPlaces().get(j).getClass())
						.newInstance(silvioAppiani.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (silvioAppiani.getBirthYear() != null)
			this.birthYear = silvioAppiani.getBirthYear().getClass()
					.getDeclaredConstructor(silvioAppiani.getBirthYear().getClass())
					.newInstance(silvioAppiani.getBirthYear());
		this.characterOffset = silvioAppiani.getCharacterOffset();
		this.characterOnset = silvioAppiani.getCharacterOnset();
		if (silvioAppiani.getPosition() != null)
			this.position = silvioAppiani.getPosition().getClass()
					.getDeclaredConstructor(silvioAppiani.getPosition().getClass())
					.newInstance(silvioAppiani.getPosition());
		for (int j = 0; j < silvioAppiani.getTeams().size(); j++) {
			if (silvioAppiani.getTeams().get(j) != null) {
				teams.add(silvioAppiani.getTeams().get(j).getClass()
						.getDeclaredConstructor(silvioAppiani.getTeams().get(j).getClass())
						.newInstance(silvioAppiani.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "SilvioAppiani [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear=" + birthYear
