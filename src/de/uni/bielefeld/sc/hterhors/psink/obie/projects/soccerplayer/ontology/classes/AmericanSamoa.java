...
@NamedIndividual public class AmericanSamoa implements IAmericanSamoa{
...
this.textMention = textMention;
	...
	public AmericanSamoa(AmericanSamoa americanSamoa)throws InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException,NoSuchMethodException, SecurityException{
...
return "AmericanSamoa [annotationID="+annotationID+",characterOffset="+characterOffset+",characterOnset="+characterOnset+",serialVersionUID="+serialVersionUID+",textMention="+textMention+"]";}
