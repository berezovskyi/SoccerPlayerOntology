...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IJamesLamontFootballer;
...
public class JamesLamontFootballer implements IJamesLamontFootballer {
	...
	public JamesLamontFootballer(JamesLamontFootballer jamesLamontFootballer)
			throws InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException,
			NoSuchMethodException, SecurityException {
		this.annotationID = jamesLamontFootballer.getAnnotationID();
		for (int j = 0; j < jamesLamontFootballer.getBirthPlaces().size(); j++) {
			if (jamesLamontFootballer.getBirthPlaces().get(j) != null) {
				birthPlaces.add(jamesLamontFootballer.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(jamesLamontFootballer.getBirthPlaces().get(j).getClass())
						.newInstance(jamesLamontFootballer.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (jamesLamontFootballer.getBirthYear() != null)
			this.birthYear = jamesLamontFootballer.getBirthYear().getClass()
					.getDeclaredConstructor(jamesLamontFootballer.getBirthYear().getClass())
					.newInstance(jamesLamontFootballer.getBirthYear());
		this.characterOffset = jamesLamontFootballer.getCharacterOffset();
		this.characterOnset = jamesLamontFootballer.getCharacterOnset();
		if (jamesLamontFootballer.getPosition() != null)
			this.position = jamesLamontFootballer.getPosition().getClass()
					.getDeclaredConstructor(jamesLamontFootballer.getPosition().getClass())
					.newInstance(jamesLamontFootballer.getPosition());
		for (int j = 0; j < jamesLamontFootballer.getTeams().size(); j++) {
			if (jamesLamontFootballer.getTeams().get(j) != null) {
				teams.add(jamesLamontFootballer.getTeams().get(j).getClass()
						.getDeclaredConstructor(jamesLamontFootballer.getTeams().get(j).getClass())
						.newInstance(jamesLamontFootballer.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "JamesLamontFootballer [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear="
