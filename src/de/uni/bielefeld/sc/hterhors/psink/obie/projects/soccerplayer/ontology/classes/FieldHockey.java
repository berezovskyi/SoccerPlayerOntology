...
@NamedIndividual
@DirectInterface(get=IFieldHockey.class)
...
@DirectSiblings(get={GoalkeeperAssociationFootball.class, FieldHockey.class, ForwardAssociationFootball.class, InsideForward.class, Midfielder.class, WingHalf.class, DefenderAssociationFootball.class, Midfield.class, })
 public class FieldHockey implements IFieldHockey{

	final static public String ONTOLOGY_NAME = "http://psink.de/scio/FieldHockey";
...
final private String textMention;
	...
	public FieldHockey(String annotationID, String textMention){
this.annotationID = annotationID;
this.textMention = textMention;
}
	public FieldHockey(FieldHockey fieldHockey)throws InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException,NoSuchMethodException, SecurityException{
this.annotationID = fieldHockey.getAnnotationID();
this.characterOffset = fieldHockey.getCharacterOffset();
this.characterOnset = fieldHockey.getCharacterOnset();
this.textMention = fieldHockey.getTextMention();
}
	public FieldHockey(){
...
return false;
FieldHockey other = (FieldHockey) obj;
...
return "FieldHockey [annotationID="+annotationID+",characterOffset="+characterOffset+",characterOnset="+characterOnset+",serialVersionUID="+serialVersionUID+",textMention="+textMention+"]";}
