...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IGianpieroCombi;
...
public class GianpieroCombi implements IGianpieroCombi {
	...
	public GianpieroCombi(GianpieroCombi gianpieroCombi) throws InstantiationException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		this.annotationID = gianpieroCombi.getAnnotationID();
		for (int j = 0; j < gianpieroCombi.getBirthPlaces().size(); j++) {
			if (gianpieroCombi.getBirthPlaces().get(j) != null) {
				birthPlaces.add(gianpieroCombi.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(gianpieroCombi.getBirthPlaces().get(j).getClass())
						.newInstance(gianpieroCombi.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (gianpieroCombi.getBirthYear() != null)
			this.birthYear = gianpieroCombi.getBirthYear().getClass()
					.getDeclaredConstructor(gianpieroCombi.getBirthYear().getClass())
					.newInstance(gianpieroCombi.getBirthYear());
		this.characterOffset = gianpieroCombi.getCharacterOffset();
		this.characterOnset = gianpieroCombi.getCharacterOnset();
		if (gianpieroCombi.getPosition() != null)
			this.position = gianpieroCombi.getPosition().getClass()
					.getDeclaredConstructor(gianpieroCombi.getPosition().getClass())
					.newInstance(gianpieroCombi.getPosition());
		for (int j = 0; j < gianpieroCombi.getTeams().size(); j++) {
			if (gianpieroCombi.getTeams().get(j) != null) {
				teams.add(gianpieroCombi.getTeams().get(j).getClass()
						.getDeclaredConstructor(gianpieroCombi.getTeams().get(j).getClass())
						.newInstance(gianpieroCombi.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "GianpieroCombi [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear="
