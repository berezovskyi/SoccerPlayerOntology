...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IKimBongHwan;
...
public class KimBongHwan implements IKimBongHwan {
	...
	public KimBongHwan(KimBongHwan kimBongHwan) throws InstantiationException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		this.annotationID = kimBongHwan.getAnnotationID();
		for (int j = 0; j < kimBongHwan.getBirthPlaces().size(); j++) {
			if (kimBongHwan.getBirthPlaces().get(j) != null) {
				birthPlaces.add(kimBongHwan.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(kimBongHwan.getBirthPlaces().get(j).getClass())
						.newInstance(kimBongHwan.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (kimBongHwan.getBirthYear() != null)
			this.birthYear = kimBongHwan.getBirthYear().getClass()
					.getDeclaredConstructor(kimBongHwan.getBirthYear().getClass())
					.newInstance(kimBongHwan.getBirthYear());
		this.characterOffset = kimBongHwan.getCharacterOffset();
		this.characterOnset = kimBongHwan.getCharacterOnset();
		if (kimBongHwan.getPosition() != null)
			this.position = kimBongHwan.getPosition().getClass()
					.getDeclaredConstructor(kimBongHwan.getPosition().getClass())
					.newInstance(kimBongHwan.getPosition());
		for (int j = 0; j < kimBongHwan.getTeams().size(); j++) {
			if (kimBongHwan.getTeams().get(j) != null) {
				teams.add(kimBongHwan.getTeams().get(j).getClass()
						.getDeclaredConstructor(kimBongHwan.getTeams().get(j).getClass())
						.newInstance(kimBongHwan.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "KimBongHwan [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear=" + birthYear
