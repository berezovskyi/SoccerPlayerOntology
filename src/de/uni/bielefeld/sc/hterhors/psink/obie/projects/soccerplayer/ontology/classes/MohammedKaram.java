...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IMohammedKaram;
...
public class MohammedKaram implements IMohammedKaram {
	...
	public MohammedKaram(MohammedKaram mohammedKaram) throws InstantiationException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		this.annotationID = mohammedKaram.getAnnotationID();
		for (int j = 0; j < mohammedKaram.getBirthPlaces().size(); j++) {
			if (mohammedKaram.getBirthPlaces().get(j) != null) {
				birthPlaces.add(mohammedKaram.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(mohammedKaram.getBirthPlaces().get(j).getClass())
						.newInstance(mohammedKaram.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (mohammedKaram.getBirthYear() != null)
			this.birthYear = mohammedKaram.getBirthYear().getClass()
					.getDeclaredConstructor(mohammedKaram.getBirthYear().getClass())
					.newInstance(mohammedKaram.getBirthYear());
		this.characterOffset = mohammedKaram.getCharacterOffset();
		this.characterOnset = mohammedKaram.getCharacterOnset();
		if (mohammedKaram.getPosition() != null)
			this.position = mohammedKaram.getPosition().getClass()
					.getDeclaredConstructor(mohammedKaram.getPosition().getClass())
					.newInstance(mohammedKaram.getPosition());
		for (int j = 0; j < mohammedKaram.getTeams().size(); j++) {
			if (mohammedKaram.getTeams().get(j) != null) {
				teams.add(mohammedKaram.getTeams().get(j).getClass()
						.getDeclaredConstructor(mohammedKaram.getTeams().get(j).getClass())
						.newInstance(mohammedKaram.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "MohammedKaram [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear=" + birthYear
