...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IHanChangWha;
...
public class HanChangWha implements IHanChangWha {
	...
	public HanChangWha(HanChangWha hanChangWha) throws InstantiationException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		this.annotationID = hanChangWha.getAnnotationID();
		for (int j = 0; j < hanChangWha.getBirthPlaces().size(); j++) {
			if (hanChangWha.getBirthPlaces().get(j) != null) {
				birthPlaces.add(hanChangWha.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(hanChangWha.getBirthPlaces().get(j).getClass())
						.newInstance(hanChangWha.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (hanChangWha.getBirthYear() != null)
			this.birthYear = hanChangWha.getBirthYear().getClass()
					.getDeclaredConstructor(hanChangWha.getBirthYear().getClass())
					.newInstance(hanChangWha.getBirthYear());
		this.characterOffset = hanChangWha.getCharacterOffset();
		this.characterOnset = hanChangWha.getCharacterOnset();
		if (hanChangWha.getPosition() != null)
			this.position = hanChangWha.getPosition().getClass()
					.getDeclaredConstructor(hanChangWha.getPosition().getClass())
					.newInstance(hanChangWha.getPosition());
		for (int j = 0; j < hanChangWha.getTeams().size(); j++) {
			if (hanChangWha.getTeams().get(j) != null) {
				teams.add(hanChangWha.getTeams().get(j).getClass()
						.getDeclaredConstructor(hanChangWha.getTeams().get(j).getClass())
						.newInstance(hanChangWha.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "HanChangWha [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear=" + birthYear
