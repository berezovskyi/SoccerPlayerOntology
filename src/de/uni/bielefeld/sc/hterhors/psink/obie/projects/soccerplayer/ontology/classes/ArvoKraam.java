...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IArvoKraam;
...
public class ArvoKraam implements IArvoKraam {
	...
	public ArvoKraam(ArvoKraam arvoKraam) throws InstantiationException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		this.annotationID = arvoKraam.getAnnotationID();
		for (int j = 0; j < arvoKraam.getBirthPlaces().size(); j++) {
			if (arvoKraam.getBirthPlaces().get(j) != null) {
				birthPlaces.add(arvoKraam.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(arvoKraam.getBirthPlaces().get(j).getClass())
						.newInstance(arvoKraam.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (arvoKraam.getBirthYear() != null)
			this.birthYear = arvoKraam.getBirthYear().getClass()
					.getDeclaredConstructor(arvoKraam.getBirthYear().getClass()).newInstance(arvoKraam.getBirthYear());
		this.characterOffset = arvoKraam.getCharacterOffset();
		this.characterOnset = arvoKraam.getCharacterOnset();
		if (arvoKraam.getPosition() != null)
			this.position = arvoKraam.getPosition().getClass()
					.getDeclaredConstructor(arvoKraam.getPosition().getClass()).newInstance(arvoKraam.getPosition());
		for (int j = 0; j < arvoKraam.getTeams().size(); j++) {
			if (arvoKraam.getTeams().get(j) != null) {
				teams.add(arvoKraam.getTeams().get(j).getClass()
						.getDeclaredConstructor(arvoKraam.getTeams().get(j).getClass())
						.newInstance(arvoKraam.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "ArvoKraam [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear=" + birthYear
