...
@NamedIndividual public class SogndalFotball implements ISogndalFotball{
...
this.textMention = textMention;
	...
	public SogndalFotball(SogndalFotball sogndalFotball)throws InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException,NoSuchMethodException, SecurityException{
...
return "SogndalFotball [annotationID="+annotationID+",characterOffset="+characterOffset+",characterOnset="+characterOnset+",serialVersionUID="+serialVersionUID+",textMention="+textMention+"]";}
