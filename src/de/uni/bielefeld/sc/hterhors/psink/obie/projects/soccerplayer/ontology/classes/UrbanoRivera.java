...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IUrbanoRivera;
...
public class UrbanoRivera implements IUrbanoRivera {
	...
	public UrbanoRivera(UrbanoRivera urbanoRivera) throws InstantiationException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		this.annotationID = urbanoRivera.getAnnotationID();
		for (int j = 0; j < urbanoRivera.getBirthPlaces().size(); j++) {
			if (urbanoRivera.getBirthPlaces().get(j) != null) {
				birthPlaces.add(urbanoRivera.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(urbanoRivera.getBirthPlaces().get(j).getClass())
						.newInstance(urbanoRivera.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (urbanoRivera.getBirthYear() != null)
			this.birthYear = urbanoRivera.getBirthYear().getClass()
					.getDeclaredConstructor(urbanoRivera.getBirthYear().getClass())
					.newInstance(urbanoRivera.getBirthYear());
		this.characterOffset = urbanoRivera.getCharacterOffset();
		this.characterOnset = urbanoRivera.getCharacterOnset();
		if (urbanoRivera.getPosition() != null)
			this.position = urbanoRivera.getPosition().getClass()
					.getDeclaredConstructor(urbanoRivera.getPosition().getClass())
					.newInstance(urbanoRivera.getPosition());
		for (int j = 0; j < urbanoRivera.getTeams().size(); j++) {
			if (urbanoRivera.getTeams().get(j) != null) {
				teams.add(urbanoRivera.getTeams().get(j).getClass()
						.getDeclaredConstructor(urbanoRivera.getTeams().get(j).getClass())
						.newInstance(urbanoRivera.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "UrbanoRivera [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear=" + birthYear
