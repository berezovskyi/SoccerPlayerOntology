...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IValeriyBoychenko;
...
public class ValeriyBoychenko implements IValeriyBoychenko {
	...
	public ValeriyBoychenko(ValeriyBoychenko valeriyBoychenko) throws InstantiationException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		this.annotationID = valeriyBoychenko.getAnnotationID();
		for (int j = 0; j < valeriyBoychenko.getBirthPlaces().size(); j++) {
			if (valeriyBoychenko.getBirthPlaces().get(j) != null) {
				birthPlaces.add(valeriyBoychenko.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(valeriyBoychenko.getBirthPlaces().get(j).getClass())
						.newInstance(valeriyBoychenko.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (valeriyBoychenko.getBirthYear() != null)
			this.birthYear = valeriyBoychenko.getBirthYear().getClass()
					.getDeclaredConstructor(valeriyBoychenko.getBirthYear().getClass())
					.newInstance(valeriyBoychenko.getBirthYear());
		this.characterOffset = valeriyBoychenko.getCharacterOffset();
		this.characterOnset = valeriyBoychenko.getCharacterOnset();
		if (valeriyBoychenko.getPosition() != null)
			this.position = valeriyBoychenko.getPosition().getClass()
					.getDeclaredConstructor(valeriyBoychenko.getPosition().getClass())
					.newInstance(valeriyBoychenko.getPosition());
		for (int j = 0; j < valeriyBoychenko.getTeams().size(); j++) {
			if (valeriyBoychenko.getTeams().get(j) != null) {
				teams.add(valeriyBoychenko.getTeams().get(j).getClass()
						.getDeclaredConstructor(valeriyBoychenko.getTeams().get(j).getClass())
						.newInstance(valeriyBoychenko.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "ValeriyBoychenko [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear="
