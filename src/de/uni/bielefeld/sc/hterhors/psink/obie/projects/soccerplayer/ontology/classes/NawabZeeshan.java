...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.INawabZeeshan;
...
public class NawabZeeshan implements INawabZeeshan {
	...
	public NawabZeeshan(NawabZeeshan nawabZeeshan) throws InstantiationException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		this.annotationID = nawabZeeshan.getAnnotationID();
		for (int j = 0; j < nawabZeeshan.getBirthPlaces().size(); j++) {
			if (nawabZeeshan.getBirthPlaces().get(j) != null) {
				birthPlaces.add(nawabZeeshan.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(nawabZeeshan.getBirthPlaces().get(j).getClass())
						.newInstance(nawabZeeshan.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (nawabZeeshan.getBirthYear() != null)
			this.birthYear = nawabZeeshan.getBirthYear().getClass()
					.getDeclaredConstructor(nawabZeeshan.getBirthYear().getClass())
					.newInstance(nawabZeeshan.getBirthYear());
		this.characterOffset = nawabZeeshan.getCharacterOffset();
		this.characterOnset = nawabZeeshan.getCharacterOnset();
		if (nawabZeeshan.getPosition() != null)
			this.position = nawabZeeshan.getPosition().getClass()
					.getDeclaredConstructor(nawabZeeshan.getPosition().getClass())
					.newInstance(nawabZeeshan.getPosition());
		for (int j = 0; j < nawabZeeshan.getTeams().size(); j++) {
			if (nawabZeeshan.getTeams().get(j) != null) {
				teams.add(nawabZeeshan.getTeams().get(j).getClass()
						.getDeclaredConstructor(nawabZeeshan.getTeams().get(j).getClass())
						.newInstance(nawabZeeshan.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "NawabZeeshan [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear=" + birthYear
