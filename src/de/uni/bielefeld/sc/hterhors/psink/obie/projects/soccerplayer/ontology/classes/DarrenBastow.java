...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IDarrenBastow;
...
public class DarrenBastow implements IDarrenBastow {
	...
	public DarrenBastow(DarrenBastow darrenBastow) throws InstantiationException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		this.annotationID = darrenBastow.getAnnotationID();
		for (int j = 0; j < darrenBastow.getBirthPlaces().size(); j++) {
			if (darrenBastow.getBirthPlaces().get(j) != null) {
				birthPlaces.add(darrenBastow.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(darrenBastow.getBirthPlaces().get(j).getClass())
						.newInstance(darrenBastow.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (darrenBastow.getBirthYear() != null)
			this.birthYear = darrenBastow.getBirthYear().getClass()
					.getDeclaredConstructor(darrenBastow.getBirthYear().getClass())
					.newInstance(darrenBastow.getBirthYear());
		this.characterOffset = darrenBastow.getCharacterOffset();
		this.characterOnset = darrenBastow.getCharacterOnset();
		if (darrenBastow.getPosition() != null)
			this.position = darrenBastow.getPosition().getClass()
					.getDeclaredConstructor(darrenBastow.getPosition().getClass())
					.newInstance(darrenBastow.getPosition());
		for (int j = 0; j < darrenBastow.getTeams().size(); j++) {
			if (darrenBastow.getTeams().get(j) != null) {
				teams.add(darrenBastow.getTeams().get(j).getClass()
						.getDeclaredConstructor(darrenBastow.getTeams().get(j).getClass())
						.newInstance(darrenBastow.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "DarrenBastow [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear=" + birthYear
