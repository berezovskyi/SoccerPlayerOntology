...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IOliverGill;
...
public class OliverGill implements IOliverGill {
	...
	public OliverGill(OliverGill oliverGill) throws InstantiationException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		this.annotationID = oliverGill.getAnnotationID();
		for (int j = 0; j < oliverGill.getBirthPlaces().size(); j++) {
			if (oliverGill.getBirthPlaces().get(j) != null) {
				birthPlaces.add(oliverGill.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(oliverGill.getBirthPlaces().get(j).getClass())
						.newInstance(oliverGill.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (oliverGill.getBirthYear() != null)
			this.birthYear = oliverGill.getBirthYear().getClass()
					.getDeclaredConstructor(oliverGill.getBirthYear().getClass())
					.newInstance(oliverGill.getBirthYear());
		this.characterOffset = oliverGill.getCharacterOffset();
		this.characterOnset = oliverGill.getCharacterOnset();
		if (oliverGill.getPosition() != null)
			this.position = oliverGill.getPosition().getClass()
					.getDeclaredConstructor(oliverGill.getPosition().getClass()).newInstance(oliverGill.getPosition());
		for (int j = 0; j < oliverGill.getTeams().size(); j++) {
			if (oliverGill.getTeams().get(j) != null) {
				teams.add(oliverGill.getTeams().get(j).getClass()
						.getDeclaredConstructor(oliverGill.getTeams().get(j).getClass())
						.newInstance(oliverGill.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "OliverGill [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear=" + birthYear
