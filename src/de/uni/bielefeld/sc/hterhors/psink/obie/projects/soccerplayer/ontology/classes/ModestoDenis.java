...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IModestoDenis;
...
public class ModestoDenis implements IModestoDenis {
	...
	public ModestoDenis(ModestoDenis modestoDenis) throws InstantiationException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		this.annotationID = modestoDenis.getAnnotationID();
		for (int j = 0; j < modestoDenis.getBirthPlaces().size(); j++) {
			if (modestoDenis.getBirthPlaces().get(j) != null) {
				birthPlaces.add(modestoDenis.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(modestoDenis.getBirthPlaces().get(j).getClass())
						.newInstance(modestoDenis.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (modestoDenis.getBirthYear() != null)
			this.birthYear = modestoDenis.getBirthYear().getClass()
					.getDeclaredConstructor(modestoDenis.getBirthYear().getClass())
					.newInstance(modestoDenis.getBirthYear());
		this.characterOffset = modestoDenis.getCharacterOffset();
		this.characterOnset = modestoDenis.getCharacterOnset();
		if (modestoDenis.getPosition() != null)
			this.position = modestoDenis.getPosition().getClass()
					.getDeclaredConstructor(modestoDenis.getPosition().getClass())
					.newInstance(modestoDenis.getPosition());
		for (int j = 0; j < modestoDenis.getTeams().size(); j++) {
			if (modestoDenis.getTeams().get(j) != null) {
				teams.add(modestoDenis.getTeams().get(j).getClass()
						.getDeclaredConstructor(modestoDenis.getTeams().get(j).getClass())
						.newInstance(modestoDenis.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "ModestoDenis [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear=" + birthYear
