...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IRomanNykytyuk;
...
public class RomanNykytyuk implements IRomanNykytyuk {
	...
	public RomanNykytyuk(RomanNykytyuk romanNykytyuk) throws InstantiationException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		this.annotationID = romanNykytyuk.getAnnotationID();
		for (int j = 0; j < romanNykytyuk.getBirthPlaces().size(); j++) {
			if (romanNykytyuk.getBirthPlaces().get(j) != null) {
				birthPlaces.add(romanNykytyuk.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(romanNykytyuk.getBirthPlaces().get(j).getClass())
						.newInstance(romanNykytyuk.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (romanNykytyuk.getBirthYear() != null)
			this.birthYear = romanNykytyuk.getBirthYear().getClass()
					.getDeclaredConstructor(romanNykytyuk.getBirthYear().getClass())
					.newInstance(romanNykytyuk.getBirthYear());
		this.characterOffset = romanNykytyuk.getCharacterOffset();
		this.characterOnset = romanNykytyuk.getCharacterOnset();
		if (romanNykytyuk.getPosition() != null)
			this.position = romanNykytyuk.getPosition().getClass()
					.getDeclaredConstructor(romanNykytyuk.getPosition().getClass())
					.newInstance(romanNykytyuk.getPosition());
		for (int j = 0; j < romanNykytyuk.getTeams().size(); j++) {
			if (romanNykytyuk.getTeams().get(j) != null) {
				teams.add(romanNykytyuk.getTeams().get(j).getClass()
						.getDeclaredConstructor(romanNykytyuk.getTeams().get(j).getClass())
						.newInstance(romanNykytyuk.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "RomanNykytyuk [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear=" + birthYear
