...
@ImplementationClass(get = BirthPlace.class)
...
@AssignableSubInterfaces(get = { IMalta.class, IHorsens.class, ICrediton.class, IStaffordshire.class,
		...
		IChester.class, ISenegal.class, IAmsterdam.class, IBradford.class, IAshtonUnderLyne.class, IMeasham.class,
		IBoulogneSurMer.class, ISovietUnion.class, IOman.class, IMealhada.class, IFarnham.class, ISliema.class,
		IMarketDrayton.class, INorthernIreland.class, IMontpellier.class, ITunisia.class, ISingapore.class,
		IManganIndia.class, IJamaica.class, ITeignmouth.class, ILondon.class, INorthKorea.class, IPoland.class,
		INigeria.class, IBulgaria.class, IKiryatMotzkin.class, IPietRetiefMpumalanga.class, IOtley.class,
...
public interface IBirthPlace extends IPlace {
