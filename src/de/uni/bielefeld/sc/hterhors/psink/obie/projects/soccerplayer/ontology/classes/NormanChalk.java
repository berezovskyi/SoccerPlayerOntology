...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.INormanChalk;
...
public class NormanChalk implements INormanChalk {
	...
	public NormanChalk(NormanChalk normanChalk) throws InstantiationException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		this.annotationID = normanChalk.getAnnotationID();
		for (int j = 0; j < normanChalk.getBirthPlaces().size(); j++) {
			if (normanChalk.getBirthPlaces().get(j) != null) {
				birthPlaces.add(normanChalk.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(normanChalk.getBirthPlaces().get(j).getClass())
						.newInstance(normanChalk.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (normanChalk.getBirthYear() != null)
			this.birthYear = normanChalk.getBirthYear().getClass()
					.getDeclaredConstructor(normanChalk.getBirthYear().getClass())
					.newInstance(normanChalk.getBirthYear());
		this.characterOffset = normanChalk.getCharacterOffset();
		this.characterOnset = normanChalk.getCharacterOnset();
		if (normanChalk.getPosition() != null)
			this.position = normanChalk.getPosition().getClass()
					.getDeclaredConstructor(normanChalk.getPosition().getClass())
					.newInstance(normanChalk.getPosition());
		for (int j = 0; j < normanChalk.getTeams().size(); j++) {
			if (normanChalk.getTeams().get(j) != null) {
				teams.add(normanChalk.getTeams().get(j).getClass()
						.getDeclaredConstructor(normanChalk.getTeams().get(j).getClass())
						.newInstance(normanChalk.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "NormanChalk [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear=" + birthYear
