...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IZhaoXuebin;
...
public class ZhaoXuebin implements IZhaoXuebin {
	...
	public ZhaoXuebin(ZhaoXuebin zhaoXuebin) throws InstantiationException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		this.annotationID = zhaoXuebin.getAnnotationID();
		for (int j = 0; j < zhaoXuebin.getBirthPlaces().size(); j++) {
			if (zhaoXuebin.getBirthPlaces().get(j) != null) {
				birthPlaces.add(zhaoXuebin.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(zhaoXuebin.getBirthPlaces().get(j).getClass())
						.newInstance(zhaoXuebin.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (zhaoXuebin.getBirthYear() != null)
			this.birthYear = zhaoXuebin.getBirthYear().getClass()
					.getDeclaredConstructor(zhaoXuebin.getBirthYear().getClass())
					.newInstance(zhaoXuebin.getBirthYear());
		this.characterOffset = zhaoXuebin.getCharacterOffset();
		this.characterOnset = zhaoXuebin.getCharacterOnset();
		if (zhaoXuebin.getPosition() != null)
			this.position = zhaoXuebin.getPosition().getClass()
					.getDeclaredConstructor(zhaoXuebin.getPosition().getClass()).newInstance(zhaoXuebin.getPosition());
		for (int j = 0; j < zhaoXuebin.getTeams().size(); j++) {
			if (zhaoXuebin.getTeams().get(j) != null) {
				teams.add(zhaoXuebin.getTeams().get(j).getClass()
						.getDeclaredConstructor(zhaoXuebin.getTeams().get(j).getClass())
						.newInstance(zhaoXuebin.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "ZhaoXuebin [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear=" + birthYear
