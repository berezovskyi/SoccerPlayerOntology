...
@NamedIndividual public class ClydebankFC implements IClydebankFC{
...
this.textMention = textMention;
	...
	public ClydebankFC(ClydebankFC clydebankFC)throws InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException,NoSuchMethodException, SecurityException{
...
return "ClydebankFC [annotationID="+annotationID+",characterOffset="+characterOffset+",characterOnset="+characterOnset+",serialVersionUID="+serialVersionUID+",textMention="+textMention+"]";}
