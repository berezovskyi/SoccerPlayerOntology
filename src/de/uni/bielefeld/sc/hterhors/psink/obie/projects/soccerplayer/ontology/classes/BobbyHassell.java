...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IBobbyHassell;
...
public class BobbyHassell implements IBobbyHassell {
	...
	public BobbyHassell(BobbyHassell bobbyHassell) throws InstantiationException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		this.annotationID = bobbyHassell.getAnnotationID();
		for (int j = 0; j < bobbyHassell.getBirthPlaces().size(); j++) {
			if (bobbyHassell.getBirthPlaces().get(j) != null) {
				birthPlaces.add(bobbyHassell.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(bobbyHassell.getBirthPlaces().get(j).getClass())
						.newInstance(bobbyHassell.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (bobbyHassell.getBirthYear() != null)
			this.birthYear = bobbyHassell.getBirthYear().getClass()
					.getDeclaredConstructor(bobbyHassell.getBirthYear().getClass())
					.newInstance(bobbyHassell.getBirthYear());
		this.characterOffset = bobbyHassell.getCharacterOffset();
		this.characterOnset = bobbyHassell.getCharacterOnset();
		if (bobbyHassell.getPosition() != null)
			this.position = bobbyHassell.getPosition().getClass()
					.getDeclaredConstructor(bobbyHassell.getPosition().getClass())
					.newInstance(bobbyHassell.getPosition());
		for (int j = 0; j < bobbyHassell.getTeams().size(); j++) {
			if (bobbyHassell.getTeams().get(j) != null) {
				teams.add(bobbyHassell.getTeams().get(j).getClass()
						.getDeclaredConstructor(bobbyHassell.getTeams().get(j).getClass())
						.newInstance(bobbyHassell.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "BobbyHassell [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear=" + birthYear
