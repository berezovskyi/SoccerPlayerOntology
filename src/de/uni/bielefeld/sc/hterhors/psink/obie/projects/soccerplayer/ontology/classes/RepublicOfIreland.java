...
@NamedIndividual public class RepublicOfIreland implements IRepublicOfIreland{
...
this.textMention = null;
	...
	public RepublicOfIreland(RepublicOfIreland republicOfIreland)throws InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException,NoSuchMethodException, SecurityException{
...
return "RepublicOfIreland [annotationID="+annotationID+",characterOffset="+characterOffset+",characterOnset="+characterOnset+",serialVersionUID="+serialVersionUID+",textMention="+textMention+"]";}
