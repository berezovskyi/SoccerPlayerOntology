...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IMahmoodAbdulla;
...
public class MahmoodAbdulla implements IMahmoodAbdulla {
	...
	public MahmoodAbdulla(MahmoodAbdulla mahmoodAbdulla) throws InstantiationException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		this.annotationID = mahmoodAbdulla.getAnnotationID();
		for (int j = 0; j < mahmoodAbdulla.getBirthPlaces().size(); j++) {
			if (mahmoodAbdulla.getBirthPlaces().get(j) != null) {
				birthPlaces.add(mahmoodAbdulla.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(mahmoodAbdulla.getBirthPlaces().get(j).getClass())
						.newInstance(mahmoodAbdulla.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (mahmoodAbdulla.getBirthYear() != null)
			this.birthYear = mahmoodAbdulla.getBirthYear().getClass()
					.getDeclaredConstructor(mahmoodAbdulla.getBirthYear().getClass())
					.newInstance(mahmoodAbdulla.getBirthYear());
		this.characterOffset = mahmoodAbdulla.getCharacterOffset();
		this.characterOnset = mahmoodAbdulla.getCharacterOnset();
		if (mahmoodAbdulla.getPosition() != null)
			this.position = mahmoodAbdulla.getPosition().getClass()
					.getDeclaredConstructor(mahmoodAbdulla.getPosition().getClass())
					.newInstance(mahmoodAbdulla.getPosition());
		for (int j = 0; j < mahmoodAbdulla.getTeams().size(); j++) {
			if (mahmoodAbdulla.getTeams().get(j) != null) {
				teams.add(mahmoodAbdulla.getTeams().get(j).getClass()
						.getDeclaredConstructor(mahmoodAbdulla.getTeams().get(j).getClass())
						.newInstance(mahmoodAbdulla.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "MahmoodAbdulla [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear="
