...
@NamedIndividual public class VeteransBviFootball implements IVeteransBviFootball{
...
this.textMention = textMention;
	...
	public VeteransBviFootball(VeteransBviFootball veteransBviFootball)throws InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException,NoSuchMethodException, SecurityException{
...
return "VeteransBviFootball [annotationID="+annotationID+",characterOffset="+characterOffset+",characterOnset="+characterOnset+",serialVersionUID="+serialVersionUID+",textMention="+textMention+"]";}
