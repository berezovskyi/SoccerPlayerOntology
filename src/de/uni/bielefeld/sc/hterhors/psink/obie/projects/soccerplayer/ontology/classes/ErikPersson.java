...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IErikPersson;
...
@DirectInterface(get = IErikPersson.class)

@AssignableSubClasses(get = {})
public class ErikPersson implements IErikPersson {

	final static public String ONTOLOGY_NAME = "http://psink.de/scio/ErikPersson";
	...
	public ErikPersson(String annotationID, String textMention) {
	...
	public ErikPersson(ErikPersson erikPersson) throws InstantiationException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		this.annotationID = erikPersson.getAnnotationID();
		for (int j = 0; j < erikPersson.getBirthPlaces().size(); j++) {
			if (erikPersson.getBirthPlaces().get(j) != null) {
				birthPlaces.add(erikPersson.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(erikPersson.getBirthPlaces().get(j).getClass())
						.newInstance(erikPersson.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (erikPersson.getBirthYear() != null)
			this.birthYear = erikPersson.getBirthYear().getClass()
					.getDeclaredConstructor(erikPersson.getBirthYear().getClass())
					.newInstance(erikPersson.getBirthYear());
		this.characterOffset = erikPersson.getCharacterOffset();
		this.characterOnset = erikPersson.getCharacterOnset();
		if (erikPersson.getPosition() != null)
			this.position = erikPersson.getPosition().getClass()
					.getDeclaredConstructor(erikPersson.getPosition().getClass())
					.newInstance(erikPersson.getPosition());
		for (int j = 0; j < erikPersson.getTeams().size(); j++) {
			if (erikPersson.getTeams().get(j) != null) {
				teams.add(erikPersson.getTeams().get(j).getClass()
						.getDeclaredConstructor(erikPersson.getTeams().get(j).getClass())
						.newInstance(erikPersson.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
		this.textMention = erikPersson.getTextMention();
	}

	/***/
	@Override
	public ErikPersson addBirthPlace(IBirthPlace birthPlace) {
	...
	/***/
	@Override
	public ErikPersson addTeam(ITeam team) {
		this.teams.add(team);
		return this;
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		ErikPersson other = (ErikPersson) obj;
	...
	/***/
	@Override
	public ErikPersson setBirthPlaces(List<IBirthPlace> birthPlaces) {
		if (birthPlaces == null) {
	...
	/***/
	@Override
	public ErikPersson setBirthYear(IBirthYear birthYear) {
	...
	/***/
	@Override
	public ErikPersson setPosition(IPosition position) {
	...
	/***/
	@Override
	public ErikPersson setTeams(List<ITeam> teams) {
		if (teams == null) {
			throw new IllegalArgumentException("Can not set list objects to null.");
		}
		this.teams = teams;
	...
	public String toString() {
		return "ErikPersson [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear=" + birthYear
