...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.ICarlosContrerasFootballer;
...
public class CarlosContrerasFootballer implements ICarlosContrerasFootballer {
	...
	public CarlosContrerasFootballer(CarlosContrerasFootballer carlosContrerasFootballer)
			throws InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException,
			NoSuchMethodException, SecurityException {
		this.annotationID = carlosContrerasFootballer.getAnnotationID();
		for (int j = 0; j < carlosContrerasFootballer.getBirthPlaces().size(); j++) {
			if (carlosContrerasFootballer.getBirthPlaces().get(j) != null) {
				birthPlaces.add(carlosContrerasFootballer.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(carlosContrerasFootballer.getBirthPlaces().get(j).getClass())
						.newInstance(carlosContrerasFootballer.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (carlosContrerasFootballer.getBirthYear() != null)
			this.birthYear = carlosContrerasFootballer.getBirthYear().getClass()
					.getDeclaredConstructor(carlosContrerasFootballer.getBirthYear().getClass())
					.newInstance(carlosContrerasFootballer.getBirthYear());
		...
		if (carlosContrerasFootballer.getPosition() != null)
			this.position = carlosContrerasFootballer.getPosition().getClass()
					.getDeclaredConstructor(carlosContrerasFootballer.getPosition().getClass())
					.newInstance(carlosContrerasFootballer.getPosition());
		for (int j = 0; j < carlosContrerasFootballer.getTeams().size(); j++) {
			if (carlosContrerasFootballer.getTeams().get(j) != null) {
				teams.add(carlosContrerasFootballer.getTeams().get(j).getClass()
						.getDeclaredConstructor(carlosContrerasFootballer.getTeams().get(j).getClass())
						.newInstance(carlosContrerasFootballer.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "CarlosContrerasFootballer [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear="
				+ birthYear + ",characterOffset=" + characterOffset + ",characterOnset=" + characterOnset + ",position="
				+ position + ",serialVersionUID=" + serialVersionUID + ",teams=" + teams + ",textMention=" + textMention
				+ "]";
	}
