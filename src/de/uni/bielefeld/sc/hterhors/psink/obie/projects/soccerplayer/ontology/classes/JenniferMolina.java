...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IJenniferMolina;
...
public class JenniferMolina implements IJenniferMolina {
	...
	public JenniferMolina(JenniferMolina jenniferMolina) throws InstantiationException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		this.annotationID = jenniferMolina.getAnnotationID();
		for (int j = 0; j < jenniferMolina.getBirthPlaces().size(); j++) {
			if (jenniferMolina.getBirthPlaces().get(j) != null) {
				birthPlaces.add(jenniferMolina.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(jenniferMolina.getBirthPlaces().get(j).getClass())
						.newInstance(jenniferMolina.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (jenniferMolina.getBirthYear() != null)
			this.birthYear = jenniferMolina.getBirthYear().getClass()
					.getDeclaredConstructor(jenniferMolina.getBirthYear().getClass())
					.newInstance(jenniferMolina.getBirthYear());
		this.characterOffset = jenniferMolina.getCharacterOffset();
		this.characterOnset = jenniferMolina.getCharacterOnset();
		if (jenniferMolina.getPosition() != null)
			this.position = jenniferMolina.getPosition().getClass()
					.getDeclaredConstructor(jenniferMolina.getPosition().getClass())
					.newInstance(jenniferMolina.getPosition());
		for (int j = 0; j < jenniferMolina.getTeams().size(); j++) {
			if (jenniferMolina.getTeams().get(j) != null) {
				teams.add(jenniferMolina.getTeams().get(j).getClass()
						.getDeclaredConstructor(jenniferMolina.getTeams().get(j).getClass())
						.newInstance(jenniferMolina.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "JenniferMolina [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear="
