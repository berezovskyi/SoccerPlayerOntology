...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.ISelwynWhalley;
...
public class SelwynWhalley implements ISelwynWhalley {
	...
	public SelwynWhalley(SelwynWhalley selwynWhalley) throws InstantiationException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		this.annotationID = selwynWhalley.getAnnotationID();
		for (int j = 0; j < selwynWhalley.getBirthPlaces().size(); j++) {
			if (selwynWhalley.getBirthPlaces().get(j) != null) {
				birthPlaces.add(selwynWhalley.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(selwynWhalley.getBirthPlaces().get(j).getClass())
						.newInstance(selwynWhalley.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (selwynWhalley.getBirthYear() != null)
			this.birthYear = selwynWhalley.getBirthYear().getClass()
					.getDeclaredConstructor(selwynWhalley.getBirthYear().getClass())
					.newInstance(selwynWhalley.getBirthYear());
		this.characterOffset = selwynWhalley.getCharacterOffset();
		this.characterOnset = selwynWhalley.getCharacterOnset();
		if (selwynWhalley.getPosition() != null)
			this.position = selwynWhalley.getPosition().getClass()
					.getDeclaredConstructor(selwynWhalley.getPosition().getClass())
					.newInstance(selwynWhalley.getPosition());
		for (int j = 0; j < selwynWhalley.getTeams().size(); j++) {
			if (selwynWhalley.getTeams().get(j) != null) {
				teams.add(selwynWhalley.getTeams().get(j).getClass()
						.getDeclaredConstructor(selwynWhalley.getTeams().get(j).getClass())
						.newInstance(selwynWhalley.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "SelwynWhalley [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear=" + birthYear
