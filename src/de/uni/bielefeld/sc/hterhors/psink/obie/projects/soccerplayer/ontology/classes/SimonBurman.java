...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.ISimonBurman;
...
public class SimonBurman implements ISimonBurman {
	...
	public SimonBurman(SimonBurman simonBurman) throws InstantiationException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		this.annotationID = simonBurman.getAnnotationID();
		for (int j = 0; j < simonBurman.getBirthPlaces().size(); j++) {
			if (simonBurman.getBirthPlaces().get(j) != null) {
				birthPlaces.add(simonBurman.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(simonBurman.getBirthPlaces().get(j).getClass())
						.newInstance(simonBurman.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (simonBurman.getBirthYear() != null)
			this.birthYear = simonBurman.getBirthYear().getClass()
					.getDeclaredConstructor(simonBurman.getBirthYear().getClass())
					.newInstance(simonBurman.getBirthYear());
		this.characterOffset = simonBurman.getCharacterOffset();
		this.characterOnset = simonBurman.getCharacterOnset();
		if (simonBurman.getPosition() != null)
			this.position = simonBurman.getPosition().getClass()
					.getDeclaredConstructor(simonBurman.getPosition().getClass())
					.newInstance(simonBurman.getPosition());
		for (int j = 0; j < simonBurman.getTeams().size(); j++) {
			if (simonBurman.getTeams().get(j) != null) {
				teams.add(simonBurman.getTeams().get(j).getClass()
						.getDeclaredConstructor(simonBurman.getTeams().get(j).getClass())
						.newInstance(simonBurman.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "SimonBurman [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear=" + birthYear
