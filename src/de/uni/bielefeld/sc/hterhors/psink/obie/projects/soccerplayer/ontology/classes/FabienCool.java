...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IFabienCool;
...
public class FabienCool implements IFabienCool {
	...
	public FabienCool(FabienCool fabienCool) throws InstantiationException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		this.annotationID = fabienCool.getAnnotationID();
		for (int j = 0; j < fabienCool.getBirthPlaces().size(); j++) {
			if (fabienCool.getBirthPlaces().get(j) != null) {
				birthPlaces.add(fabienCool.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(fabienCool.getBirthPlaces().get(j).getClass())
						.newInstance(fabienCool.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (fabienCool.getBirthYear() != null)
			this.birthYear = fabienCool.getBirthYear().getClass()
					.getDeclaredConstructor(fabienCool.getBirthYear().getClass())
					.newInstance(fabienCool.getBirthYear());
		this.characterOffset = fabienCool.getCharacterOffset();
		this.characterOnset = fabienCool.getCharacterOnset();
		if (fabienCool.getPosition() != null)
			this.position = fabienCool.getPosition().getClass()
					.getDeclaredConstructor(fabienCool.getPosition().getClass()).newInstance(fabienCool.getPosition());
		for (int j = 0; j < fabienCool.getTeams().size(); j++) {
			if (fabienCool.getTeams().get(j) != null) {
				teams.add(fabienCool.getTeams().get(j).getClass()
						.getDeclaredConstructor(fabienCool.getTeams().get(j).getClass())
						.newInstance(fabienCool.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "FabienCool [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear=" + birthYear
