...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.ILuisReyna;
...
public class LuisReyna implements ILuisReyna {
	...
	public LuisReyna(LuisReyna luisReyna) throws InstantiationException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		this.annotationID = luisReyna.getAnnotationID();
		for (int j = 0; j < luisReyna.getBirthPlaces().size(); j++) {
			if (luisReyna.getBirthPlaces().get(j) != null) {
				birthPlaces.add(luisReyna.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(luisReyna.getBirthPlaces().get(j).getClass())
						.newInstance(luisReyna.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (luisReyna.getBirthYear() != null)
			this.birthYear = luisReyna.getBirthYear().getClass()
					.getDeclaredConstructor(luisReyna.getBirthYear().getClass()).newInstance(luisReyna.getBirthYear());
		this.characterOffset = luisReyna.getCharacterOffset();
		this.characterOnset = luisReyna.getCharacterOnset();
		if (luisReyna.getPosition() != null)
			this.position = luisReyna.getPosition().getClass()
					.getDeclaredConstructor(luisReyna.getPosition().getClass()).newInstance(luisReyna.getPosition());
		for (int j = 0; j < luisReyna.getTeams().size(); j++) {
			if (luisReyna.getTeams().get(j) != null) {
				teams.add(luisReyna.getTeams().get(j).getClass()
						.getDeclaredConstructor(luisReyna.getTeams().get(j).getClass())
						.newInstance(luisReyna.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "LuisReyna [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear=" + birthYear
