...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IYangSeungKook;
...
public class YangSeungKook implements IYangSeungKook {
	...
	public YangSeungKook(YangSeungKook yangSeungKook) throws InstantiationException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		this.annotationID = yangSeungKook.getAnnotationID();
		for (int j = 0; j < yangSeungKook.getBirthPlaces().size(); j++) {
			if (yangSeungKook.getBirthPlaces().get(j) != null) {
				birthPlaces.add(yangSeungKook.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(yangSeungKook.getBirthPlaces().get(j).getClass())
						.newInstance(yangSeungKook.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (yangSeungKook.getBirthYear() != null)
			this.birthYear = yangSeungKook.getBirthYear().getClass()
					.getDeclaredConstructor(yangSeungKook.getBirthYear().getClass())
					.newInstance(yangSeungKook.getBirthYear());
		this.characterOffset = yangSeungKook.getCharacterOffset();
		this.characterOnset = yangSeungKook.getCharacterOnset();
		if (yangSeungKook.getPosition() != null)
			this.position = yangSeungKook.getPosition().getClass()
					.getDeclaredConstructor(yangSeungKook.getPosition().getClass())
					.newInstance(yangSeungKook.getPosition());
		for (int j = 0; j < yangSeungKook.getTeams().size(); j++) {
			if (yangSeungKook.getTeams().get(j) != null) {
				teams.add(yangSeungKook.getTeams().get(j).getClass()
						.getDeclaredConstructor(yangSeungKook.getTeams().get(j).getClass())
						.newInstance(yangSeungKook.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "YangSeungKook [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear=" + birthYear
