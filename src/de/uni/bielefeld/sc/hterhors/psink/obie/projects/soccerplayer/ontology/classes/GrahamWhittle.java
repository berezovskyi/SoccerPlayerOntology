...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IGrahamWhittle;
...
public class GrahamWhittle implements IGrahamWhittle {
	...
	public GrahamWhittle(GrahamWhittle grahamWhittle) throws InstantiationException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		this.annotationID = grahamWhittle.getAnnotationID();
		for (int j = 0; j < grahamWhittle.getBirthPlaces().size(); j++) {
			if (grahamWhittle.getBirthPlaces().get(j) != null) {
				birthPlaces.add(grahamWhittle.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(grahamWhittle.getBirthPlaces().get(j).getClass())
						.newInstance(grahamWhittle.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (grahamWhittle.getBirthYear() != null)
			this.birthYear = grahamWhittle.getBirthYear().getClass()
					.getDeclaredConstructor(grahamWhittle.getBirthYear().getClass())
					.newInstance(grahamWhittle.getBirthYear());
		this.characterOffset = grahamWhittle.getCharacterOffset();
		this.characterOnset = grahamWhittle.getCharacterOnset();
		if (grahamWhittle.getPosition() != null)
			this.position = grahamWhittle.getPosition().getClass()
					.getDeclaredConstructor(grahamWhittle.getPosition().getClass())
					.newInstance(grahamWhittle.getPosition());
		for (int j = 0; j < grahamWhittle.getTeams().size(); j++) {
			if (grahamWhittle.getTeams().get(j) != null) {
				teams.add(grahamWhittle.getTeams().get(j).getClass()
						.getDeclaredConstructor(grahamWhittle.getTeams().get(j).getClass())
						.newInstance(grahamWhittle.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "GrahamWhittle [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear=" + birthYear
