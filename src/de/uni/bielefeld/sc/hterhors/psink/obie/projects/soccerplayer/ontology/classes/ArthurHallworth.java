...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IArthurHallworth;
...
public class ArthurHallworth implements IArthurHallworth {
	...
	public ArthurHallworth(ArthurHallworth arthurHallworth) throws InstantiationException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		this.annotationID = arthurHallworth.getAnnotationID();
		for (int j = 0; j < arthurHallworth.getBirthPlaces().size(); j++) {
			if (arthurHallworth.getBirthPlaces().get(j) != null) {
				birthPlaces.add(arthurHallworth.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(arthurHallworth.getBirthPlaces().get(j).getClass())
						.newInstance(arthurHallworth.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (arthurHallworth.getBirthYear() != null)
			this.birthYear = arthurHallworth.getBirthYear().getClass()
					.getDeclaredConstructor(arthurHallworth.getBirthYear().getClass())
					.newInstance(arthurHallworth.getBirthYear());
		this.characterOffset = arthurHallworth.getCharacterOffset();
		this.characterOnset = arthurHallworth.getCharacterOnset();
		if (arthurHallworth.getPosition() != null)
			this.position = arthurHallworth.getPosition().getClass()
					.getDeclaredConstructor(arthurHallworth.getPosition().getClass())
					.newInstance(arthurHallworth.getPosition());
		for (int j = 0; j < arthurHallworth.getTeams().size(); j++) {
			if (arthurHallworth.getTeams().get(j) != null) {
				teams.add(arthurHallworth.getTeams().get(j).getClass()
						.getDeclaredConstructor(arthurHallworth.getTeams().get(j).getClass())
						.newInstance(arthurHallworth.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "ArthurHallworth [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear="
