...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IArthurNineham;
...
public class ArthurNineham implements IArthurNineham {
	...
	public ArthurNineham(ArthurNineham arthurNineham) throws InstantiationException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		this.annotationID = arthurNineham.getAnnotationID();
		for (int j = 0; j < arthurNineham.getBirthPlaces().size(); j++) {
			if (arthurNineham.getBirthPlaces().get(j) != null) {
				birthPlaces.add(arthurNineham.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(arthurNineham.getBirthPlaces().get(j).getClass())
						.newInstance(arthurNineham.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (arthurNineham.getBirthYear() != null)
			this.birthYear = arthurNineham.getBirthYear().getClass()
					.getDeclaredConstructor(arthurNineham.getBirthYear().getClass())
					.newInstance(arthurNineham.getBirthYear());
		this.characterOffset = arthurNineham.getCharacterOffset();
		this.characterOnset = arthurNineham.getCharacterOnset();
		if (arthurNineham.getPosition() != null)
			this.position = arthurNineham.getPosition().getClass()
					.getDeclaredConstructor(arthurNineham.getPosition().getClass())
					.newInstance(arthurNineham.getPosition());
		for (int j = 0; j < arthurNineham.getTeams().size(); j++) {
			if (arthurNineham.getTeams().get(j) != null) {
				teams.add(arthurNineham.getTeams().get(j).getClass()
						.getDeclaredConstructor(arthurNineham.getTeams().get(j).getClass())
						.newInstance(arthurNineham.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "ArthurNineham [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear=" + birthYear
