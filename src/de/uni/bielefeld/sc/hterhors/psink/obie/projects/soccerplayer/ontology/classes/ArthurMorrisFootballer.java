...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IArthurMorrisFootballer;
...
public class ArthurMorrisFootballer implements IArthurMorrisFootballer {
	...
	public ArthurMorrisFootballer(ArthurMorrisFootballer arthurMorrisFootballer)
			throws InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException,
			NoSuchMethodException, SecurityException {
		this.annotationID = arthurMorrisFootballer.getAnnotationID();
		for (int j = 0; j < arthurMorrisFootballer.getBirthPlaces().size(); j++) {
			if (arthurMorrisFootballer.getBirthPlaces().get(j) != null) {
				birthPlaces.add(arthurMorrisFootballer.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(arthurMorrisFootballer.getBirthPlaces().get(j).getClass())
						.newInstance(arthurMorrisFootballer.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (arthurMorrisFootballer.getBirthYear() != null)
			this.birthYear = arthurMorrisFootballer.getBirthYear().getClass()
					.getDeclaredConstructor(arthurMorrisFootballer.getBirthYear().getClass())
					.newInstance(arthurMorrisFootballer.getBirthYear());
		...
		if (arthurMorrisFootballer.getPosition() != null)
			this.position = arthurMorrisFootballer.getPosition().getClass()
					.getDeclaredConstructor(arthurMorrisFootballer.getPosition().getClass())
					.newInstance(arthurMorrisFootballer.getPosition());
		for (int j = 0; j < arthurMorrisFootballer.getTeams().size(); j++) {
			if (arthurMorrisFootballer.getTeams().get(j) != null) {
				teams.add(arthurMorrisFootballer.getTeams().get(j).getClass()
						.getDeclaredConstructor(arthurMorrisFootballer.getTeams().get(j).getClass())
						.newInstance(arthurMorrisFootballer.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "ArthurMorrisFootballer [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear="
