...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.ILahcenOuadani;
...
public class LahcenOuadani implements ILahcenOuadani {
	...
	public LahcenOuadani(LahcenOuadani lahcenOuadani) throws InstantiationException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		this.annotationID = lahcenOuadani.getAnnotationID();
		for (int j = 0; j < lahcenOuadani.getBirthPlaces().size(); j++) {
			if (lahcenOuadani.getBirthPlaces().get(j) != null) {
				birthPlaces.add(lahcenOuadani.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(lahcenOuadani.getBirthPlaces().get(j).getClass())
						.newInstance(lahcenOuadani.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (lahcenOuadani.getBirthYear() != null)
			this.birthYear = lahcenOuadani.getBirthYear().getClass()
					.getDeclaredConstructor(lahcenOuadani.getBirthYear().getClass())
					.newInstance(lahcenOuadani.getBirthYear());
		this.characterOffset = lahcenOuadani.getCharacterOffset();
		this.characterOnset = lahcenOuadani.getCharacterOnset();
		if (lahcenOuadani.getPosition() != null)
			this.position = lahcenOuadani.getPosition().getClass()
					.getDeclaredConstructor(lahcenOuadani.getPosition().getClass())
					.newInstance(lahcenOuadani.getPosition());
		for (int j = 0; j < lahcenOuadani.getTeams().size(); j++) {
			if (lahcenOuadani.getTeams().get(j) != null) {
				teams.add(lahcenOuadani.getTeams().get(j).getClass()
						.getDeclaredConstructor(lahcenOuadani.getTeams().get(j).getClass())
						.newInstance(lahcenOuadani.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "LahcenOuadani [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear=" + birthYear
