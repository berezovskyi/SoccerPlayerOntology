...
@NamedIndividual public class AlArabiScQatar implements IAlArabiScQatar{
...
this.textMention = textMention;
	...
	public AlArabiScQatar(AlArabiScQatar alArabiScQatar)throws InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException,NoSuchMethodException, SecurityException{
...
return "AlArabiScQatar [annotationID="+annotationID+",characterOffset="+characterOffset+",characterOnset="+characterOnset+",serialVersionUID="+serialVersionUID+",textMention="+textMention+"]";}
