...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IAlfredoBrown;
...
public class AlfredoBrown implements IAlfredoBrown {
	...
	public AlfredoBrown(AlfredoBrown alfredoBrown) throws InstantiationException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		this.annotationID = alfredoBrown.getAnnotationID();
		for (int j = 0; j < alfredoBrown.getBirthPlaces().size(); j++) {
			if (alfredoBrown.getBirthPlaces().get(j) != null) {
				birthPlaces.add(alfredoBrown.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(alfredoBrown.getBirthPlaces().get(j).getClass())
						.newInstance(alfredoBrown.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (alfredoBrown.getBirthYear() != null)
			this.birthYear = alfredoBrown.getBirthYear().getClass()
					.getDeclaredConstructor(alfredoBrown.getBirthYear().getClass())
					.newInstance(alfredoBrown.getBirthYear());
		this.characterOffset = alfredoBrown.getCharacterOffset();
		this.characterOnset = alfredoBrown.getCharacterOnset();
		if (alfredoBrown.getPosition() != null)
			this.position = alfredoBrown.getPosition().getClass()
					.getDeclaredConstructor(alfredoBrown.getPosition().getClass())
					.newInstance(alfredoBrown.getPosition());
		for (int j = 0; j < alfredoBrown.getTeams().size(); j++) {
			if (alfredoBrown.getTeams().get(j) != null) {
				teams.add(alfredoBrown.getTeams().get(j).getClass()
						.getDeclaredConstructor(alfredoBrown.getTeams().get(j).getClass())
						.newInstance(alfredoBrown.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "AlfredoBrown [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear=" + birthYear
