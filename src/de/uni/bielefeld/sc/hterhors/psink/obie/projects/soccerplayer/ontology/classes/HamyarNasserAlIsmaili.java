...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IHamyarNasserAlIsmaili;
...
public class HamyarNasserAlIsmaili implements IHamyarNasserAlIsmaili {
	...
	public HamyarNasserAlIsmaili(HamyarNasserAlIsmaili hamyarNasserAlIsmaili)
			throws InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException,
			NoSuchMethodException, SecurityException {
		this.annotationID = hamyarNasserAlIsmaili.getAnnotationID();
		for (int j = 0; j < hamyarNasserAlIsmaili.getBirthPlaces().size(); j++) {
			if (hamyarNasserAlIsmaili.getBirthPlaces().get(j) != null) {
				birthPlaces.add(hamyarNasserAlIsmaili.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(hamyarNasserAlIsmaili.getBirthPlaces().get(j).getClass())
						.newInstance(hamyarNasserAlIsmaili.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (hamyarNasserAlIsmaili.getBirthYear() != null)
			this.birthYear = hamyarNasserAlIsmaili.getBirthYear().getClass()
					.getDeclaredConstructor(hamyarNasserAlIsmaili.getBirthYear().getClass())
					.newInstance(hamyarNasserAlIsmaili.getBirthYear());
		this.characterOffset = hamyarNasserAlIsmaili.getCharacterOffset();
		this.characterOnset = hamyarNasserAlIsmaili.getCharacterOnset();
		if (hamyarNasserAlIsmaili.getPosition() != null)
			this.position = hamyarNasserAlIsmaili.getPosition().getClass()
					.getDeclaredConstructor(hamyarNasserAlIsmaili.getPosition().getClass())
					.newInstance(hamyarNasserAlIsmaili.getPosition());
		for (int j = 0; j < hamyarNasserAlIsmaili.getTeams().size(); j++) {
			if (hamyarNasserAlIsmaili.getTeams().get(j) != null) {
				teams.add(hamyarNasserAlIsmaili.getTeams().get(j).getClass()
						.getDeclaredConstructor(hamyarNasserAlIsmaili.getTeams().get(j).getClass())
						.newInstance(hamyarNasserAlIsmaili.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "HamyarNasserAlIsmaili [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear="
