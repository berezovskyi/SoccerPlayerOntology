...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IJoeAshley;
...
public class JoeAshley implements IJoeAshley {
	...
	public JoeAshley(JoeAshley joeAshley) throws InstantiationException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		this.annotationID = joeAshley.getAnnotationID();
		for (int j = 0; j < joeAshley.getBirthPlaces().size(); j++) {
			if (joeAshley.getBirthPlaces().get(j) != null) {
				birthPlaces.add(joeAshley.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(joeAshley.getBirthPlaces().get(j).getClass())
						.newInstance(joeAshley.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (joeAshley.getBirthYear() != null)
			this.birthYear = joeAshley.getBirthYear().getClass()
					.getDeclaredConstructor(joeAshley.getBirthYear().getClass()).newInstance(joeAshley.getBirthYear());
		this.characterOffset = joeAshley.getCharacterOffset();
		this.characterOnset = joeAshley.getCharacterOnset();
		if (joeAshley.getPosition() != null)
			this.position = joeAshley.getPosition().getClass()
					.getDeclaredConstructor(joeAshley.getPosition().getClass()).newInstance(joeAshley.getPosition());
		for (int j = 0; j < joeAshley.getTeams().size(); j++) {
			if (joeAshley.getTeams().get(j) != null) {
				teams.add(joeAshley.getTeams().get(j).getClass()
						.getDeclaredConstructor(joeAshley.getTeams().get(j).getClass())
						.newInstance(joeAshley.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "JoeAshley [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear=" + birthYear
