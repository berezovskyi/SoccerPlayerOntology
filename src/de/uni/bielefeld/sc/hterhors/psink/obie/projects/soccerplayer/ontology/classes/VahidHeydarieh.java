...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IVahidHeydarieh;
...
public class VahidHeydarieh implements IVahidHeydarieh {
	...
	public VahidHeydarieh(VahidHeydarieh vahidHeydarieh) throws InstantiationException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		this.annotationID = vahidHeydarieh.getAnnotationID();
		for (int j = 0; j < vahidHeydarieh.getBirthPlaces().size(); j++) {
			if (vahidHeydarieh.getBirthPlaces().get(j) != null) {
				birthPlaces.add(vahidHeydarieh.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(vahidHeydarieh.getBirthPlaces().get(j).getClass())
						.newInstance(vahidHeydarieh.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (vahidHeydarieh.getBirthYear() != null)
			this.birthYear = vahidHeydarieh.getBirthYear().getClass()
					.getDeclaredConstructor(vahidHeydarieh.getBirthYear().getClass())
					.newInstance(vahidHeydarieh.getBirthYear());
		this.characterOffset = vahidHeydarieh.getCharacterOffset();
		this.characterOnset = vahidHeydarieh.getCharacterOnset();
		if (vahidHeydarieh.getPosition() != null)
			this.position = vahidHeydarieh.getPosition().getClass()
					.getDeclaredConstructor(vahidHeydarieh.getPosition().getClass())
					.newInstance(vahidHeydarieh.getPosition());
		for (int j = 0; j < vahidHeydarieh.getTeams().size(); j++) {
			if (vahidHeydarieh.getTeams().get(j) != null) {
				teams.add(vahidHeydarieh.getTeams().get(j).getClass()
						.getDeclaredConstructor(vahidHeydarieh.getTeams().get(j).getClass())
						.newInstance(vahidHeydarieh.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "VahidHeydarieh [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear="
