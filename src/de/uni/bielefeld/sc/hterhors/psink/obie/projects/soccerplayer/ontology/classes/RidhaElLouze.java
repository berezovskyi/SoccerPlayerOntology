...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IRidhaElLouze;
...
public class RidhaElLouze implements IRidhaElLouze {
	...
	public RidhaElLouze(RidhaElLouze ridhaElLouze) throws InstantiationException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		this.annotationID = ridhaElLouze.getAnnotationID();
		for (int j = 0; j < ridhaElLouze.getBirthPlaces().size(); j++) {
			if (ridhaElLouze.getBirthPlaces().get(j) != null) {
				birthPlaces.add(ridhaElLouze.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(ridhaElLouze.getBirthPlaces().get(j).getClass())
						.newInstance(ridhaElLouze.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (ridhaElLouze.getBirthYear() != null)
			this.birthYear = ridhaElLouze.getBirthYear().getClass()
					.getDeclaredConstructor(ridhaElLouze.getBirthYear().getClass())
					.newInstance(ridhaElLouze.getBirthYear());
		this.characterOffset = ridhaElLouze.getCharacterOffset();
		this.characterOnset = ridhaElLouze.getCharacterOnset();
		if (ridhaElLouze.getPosition() != null)
			this.position = ridhaElLouze.getPosition().getClass()
					.getDeclaredConstructor(ridhaElLouze.getPosition().getClass())
					.newInstance(ridhaElLouze.getPosition());
		for (int j = 0; j < ridhaElLouze.getTeams().size(); j++) {
			if (ridhaElLouze.getTeams().get(j) != null) {
				teams.add(ridhaElLouze.getTeams().get(j).getClass()
						.getDeclaredConstructor(ridhaElLouze.getTeams().get(j).getClass())
						.newInstance(ridhaElLouze.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "RidhaElLouze [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear=" + birthYear
