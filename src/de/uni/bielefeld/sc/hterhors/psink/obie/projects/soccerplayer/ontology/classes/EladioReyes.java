...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IEladioReyes;
...
public class EladioReyes implements IEladioReyes {
	...
	public EladioReyes(EladioReyes eladioReyes) throws InstantiationException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		this.annotationID = eladioReyes.getAnnotationID();
		for (int j = 0; j < eladioReyes.getBirthPlaces().size(); j++) {
			if (eladioReyes.getBirthPlaces().get(j) != null) {
				birthPlaces.add(eladioReyes.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(eladioReyes.getBirthPlaces().get(j).getClass())
						.newInstance(eladioReyes.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (eladioReyes.getBirthYear() != null)
			this.birthYear = eladioReyes.getBirthYear().getClass()
					.getDeclaredConstructor(eladioReyes.getBirthYear().getClass())
					.newInstance(eladioReyes.getBirthYear());
		this.characterOffset = eladioReyes.getCharacterOffset();
		this.characterOnset = eladioReyes.getCharacterOnset();
		if (eladioReyes.getPosition() != null)
			this.position = eladioReyes.getPosition().getClass()
					.getDeclaredConstructor(eladioReyes.getPosition().getClass())
					.newInstance(eladioReyes.getPosition());
		for (int j = 0; j < eladioReyes.getTeams().size(); j++) {
			if (eladioReyes.getTeams().get(j) != null) {
				teams.add(eladioReyes.getTeams().get(j).getClass()
						.getDeclaredConstructor(eladioReyes.getTeams().get(j).getClass())
						.newInstance(eladioReyes.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "EladioReyes [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear=" + birthYear
