...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.ISalahdineHmied;
...
public class SalahdineHmied implements ISalahdineHmied {
	...
	public SalahdineHmied(SalahdineHmied salahdineHmied) throws InstantiationException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		this.annotationID = salahdineHmied.getAnnotationID();
		for (int j = 0; j < salahdineHmied.getBirthPlaces().size(); j++) {
			if (salahdineHmied.getBirthPlaces().get(j) != null) {
				birthPlaces.add(salahdineHmied.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(salahdineHmied.getBirthPlaces().get(j).getClass())
						.newInstance(salahdineHmied.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (salahdineHmied.getBirthYear() != null)
			this.birthYear = salahdineHmied.getBirthYear().getClass()
					.getDeclaredConstructor(salahdineHmied.getBirthYear().getClass())
					.newInstance(salahdineHmied.getBirthYear());
		this.characterOffset = salahdineHmied.getCharacterOffset();
		this.characterOnset = salahdineHmied.getCharacterOnset();
		if (salahdineHmied.getPosition() != null)
			this.position = salahdineHmied.getPosition().getClass()
					.getDeclaredConstructor(salahdineHmied.getPosition().getClass())
					.newInstance(salahdineHmied.getPosition());
		for (int j = 0; j < salahdineHmied.getTeams().size(); j++) {
			if (salahdineHmied.getTeams().get(j) != null) {
				teams.add(salahdineHmied.getTeams().get(j).getClass()
						.getDeclaredConstructor(salahdineHmied.getTeams().get(j).getClass())
						.newInstance(salahdineHmied.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "SalahdineHmied [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear="
