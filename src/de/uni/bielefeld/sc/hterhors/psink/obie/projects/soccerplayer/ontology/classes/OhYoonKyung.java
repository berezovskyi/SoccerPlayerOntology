...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IOhYoonKyung;
...
public class OhYoonKyung implements IOhYoonKyung {
	...
	public OhYoonKyung(OhYoonKyung ohYoonKyung) throws InstantiationException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		this.annotationID = ohYoonKyung.getAnnotationID();
		for (int j = 0; j < ohYoonKyung.getBirthPlaces().size(); j++) {
			if (ohYoonKyung.getBirthPlaces().get(j) != null) {
				birthPlaces.add(ohYoonKyung.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(ohYoonKyung.getBirthPlaces().get(j).getClass())
						.newInstance(ohYoonKyung.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (ohYoonKyung.getBirthYear() != null)
			this.birthYear = ohYoonKyung.getBirthYear().getClass()
					.getDeclaredConstructor(ohYoonKyung.getBirthYear().getClass())
					.newInstance(ohYoonKyung.getBirthYear());
		this.characterOffset = ohYoonKyung.getCharacterOffset();
		this.characterOnset = ohYoonKyung.getCharacterOnset();
		if (ohYoonKyung.getPosition() != null)
			this.position = ohYoonKyung.getPosition().getClass()
					.getDeclaredConstructor(ohYoonKyung.getPosition().getClass())
					.newInstance(ohYoonKyung.getPosition());
		for (int j = 0; j < ohYoonKyung.getTeams().size(); j++) {
			if (ohYoonKyung.getTeams().get(j) != null) {
				teams.add(ohYoonKyung.getTeams().get(j).getClass()
						.getDeclaredConstructor(ohYoonKyung.getTeams().get(j).getClass())
						.newInstance(ohYoonKyung.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "OhYoonKyung [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear=" + birthYear
