...
@NamedIndividual public class Yugoslavia implements IYugoslavia{
...
final private String textMention;
	...
	public Yugoslavia(Yugoslavia yugoslavia)throws InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException,NoSuchMethodException, SecurityException{
...
return "Yugoslavia [annotationID="+annotationID+",characterOffset="+characterOffset+",characterOnset="+characterOnset+",serialVersionUID="+serialVersionUID+",textMention="+textMention+"]";}
