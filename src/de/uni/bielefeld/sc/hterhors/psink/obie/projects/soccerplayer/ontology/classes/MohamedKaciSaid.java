...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IMohamedKaciSaid;
...
public class MohamedKaciSaid implements IMohamedKaciSaid {
	...
	public MohamedKaciSaid(MohamedKaciSaid mohamedKaciSaid) throws InstantiationException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		this.annotationID = mohamedKaciSaid.getAnnotationID();
		for (int j = 0; j < mohamedKaciSaid.getBirthPlaces().size(); j++) {
			if (mohamedKaciSaid.getBirthPlaces().get(j) != null) {
				birthPlaces.add(mohamedKaciSaid.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(mohamedKaciSaid.getBirthPlaces().get(j).getClass())
						.newInstance(mohamedKaciSaid.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (mohamedKaciSaid.getBirthYear() != null)
			this.birthYear = mohamedKaciSaid.getBirthYear().getClass()
					.getDeclaredConstructor(mohamedKaciSaid.getBirthYear().getClass())
					.newInstance(mohamedKaciSaid.getBirthYear());
		this.characterOffset = mohamedKaciSaid.getCharacterOffset();
		this.characterOnset = mohamedKaciSaid.getCharacterOnset();
		if (mohamedKaciSaid.getPosition() != null)
			this.position = mohamedKaciSaid.getPosition().getClass()
					.getDeclaredConstructor(mohamedKaciSaid.getPosition().getClass())
					.newInstance(mohamedKaciSaid.getPosition());
		for (int j = 0; j < mohamedKaciSaid.getTeams().size(); j++) {
			if (mohamedKaciSaid.getTeams().get(j) != null) {
				teams.add(mohamedKaciSaid.getTeams().get(j).getClass()
						.getDeclaredConstructor(mohamedKaciSaid.getTeams().get(j).getClass())
						.newInstance(mohamedKaciSaid.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "MohamedKaciSaid [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear="
