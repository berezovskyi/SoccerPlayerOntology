...
@NamedIndividual public class KirklandWashington implements IKirklandWashington{
...
this.textMention = textMention;
	...
	public KirklandWashington(KirklandWashington kirklandWashington)throws InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException,NoSuchMethodException, SecurityException{
...
return "KirklandWashington [annotationID="+annotationID+",characterOffset="+characterOffset+",characterOnset="+characterOnset+",serialVersionUID="+serialVersionUID+",textMention="+textMention+"]";}
