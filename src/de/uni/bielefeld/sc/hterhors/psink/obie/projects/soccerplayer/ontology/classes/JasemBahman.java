...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IJasemBahman;
...
public class JasemBahman implements IJasemBahman {
	...
	public JasemBahman(JasemBahman jasemBahman) throws InstantiationException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		this.annotationID = jasemBahman.getAnnotationID();
		for (int j = 0; j < jasemBahman.getBirthPlaces().size(); j++) {
			if (jasemBahman.getBirthPlaces().get(j) != null) {
				birthPlaces.add(jasemBahman.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(jasemBahman.getBirthPlaces().get(j).getClass())
						.newInstance(jasemBahman.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (jasemBahman.getBirthYear() != null)
			this.birthYear = jasemBahman.getBirthYear().getClass()
					.getDeclaredConstructor(jasemBahman.getBirthYear().getClass())
					.newInstance(jasemBahman.getBirthYear());
		this.characterOffset = jasemBahman.getCharacterOffset();
		this.characterOnset = jasemBahman.getCharacterOnset();
		if (jasemBahman.getPosition() != null)
			this.position = jasemBahman.getPosition().getClass()
					.getDeclaredConstructor(jasemBahman.getPosition().getClass())
					.newInstance(jasemBahman.getPosition());
		for (int j = 0; j < jasemBahman.getTeams().size(); j++) {
			if (jasemBahman.getTeams().get(j) != null) {
				teams.add(jasemBahman.getTeams().get(j).getClass()
						.getDeclaredConstructor(jasemBahman.getTeams().get(j).getClass())
						.newInstance(jasemBahman.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "JasemBahman [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear=" + birthYear
