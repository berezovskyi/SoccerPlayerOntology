...
@NamedIndividual public class AnambraState implements IAnambraState{
...
this.textMention = null;
	...
	public AnambraState(AnambraState anambraState)throws InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException,NoSuchMethodException, SecurityException{
...
return "AnambraState [annotationID="+annotationID+",characterOffset="+characterOffset+",characterOnset="+characterOnset+",serialVersionUID="+serialVersionUID+",textMention="+textMention+"]";}
