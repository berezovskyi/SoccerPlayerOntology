...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IMiguelMba;
...
public class MiguelMba implements IMiguelMba {
	...
	public MiguelMba(MiguelMba miguelMba) throws InstantiationException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		this.annotationID = miguelMba.getAnnotationID();
		for (int j = 0; j < miguelMba.getBirthPlaces().size(); j++) {
			if (miguelMba.getBirthPlaces().get(j) != null) {
				birthPlaces.add(miguelMba.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(miguelMba.getBirthPlaces().get(j).getClass())
						.newInstance(miguelMba.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (miguelMba.getBirthYear() != null)
			this.birthYear = miguelMba.getBirthYear().getClass()
					.getDeclaredConstructor(miguelMba.getBirthYear().getClass()).newInstance(miguelMba.getBirthYear());
		this.characterOffset = miguelMba.getCharacterOffset();
		this.characterOnset = miguelMba.getCharacterOnset();
		if (miguelMba.getPosition() != null)
			this.position = miguelMba.getPosition().getClass()
					.getDeclaredConstructor(miguelMba.getPosition().getClass()).newInstance(miguelMba.getPosition());
		for (int j = 0; j < miguelMba.getTeams().size(); j++) {
			if (miguelMba.getTeams().get(j) != null) {
				teams.add(miguelMba.getTeams().get(j).getClass()
						.getDeclaredConstructor(miguelMba.getTeams().get(j).getClass())
						.newInstance(miguelMba.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "MiguelMba [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear=" + birthYear
