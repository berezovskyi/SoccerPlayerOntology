...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IMartinVanLeeuwen;
...
public class MartinVanLeeuwen implements IMartinVanLeeuwen {
	...
	public MartinVanLeeuwen(MartinVanLeeuwen martinVanLeeuwen) throws InstantiationException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		this.annotationID = martinVanLeeuwen.getAnnotationID();
		for (int j = 0; j < martinVanLeeuwen.getBirthPlaces().size(); j++) {
			if (martinVanLeeuwen.getBirthPlaces().get(j) != null) {
				birthPlaces.add(martinVanLeeuwen.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(martinVanLeeuwen.getBirthPlaces().get(j).getClass())
						.newInstance(martinVanLeeuwen.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (martinVanLeeuwen.getBirthYear() != null)
			this.birthYear = martinVanLeeuwen.getBirthYear().getClass()
					.getDeclaredConstructor(martinVanLeeuwen.getBirthYear().getClass())
					.newInstance(martinVanLeeuwen.getBirthYear());
		this.characterOffset = martinVanLeeuwen.getCharacterOffset();
		this.characterOnset = martinVanLeeuwen.getCharacterOnset();
		if (martinVanLeeuwen.getPosition() != null)
			this.position = martinVanLeeuwen.getPosition().getClass()
					.getDeclaredConstructor(martinVanLeeuwen.getPosition().getClass())
					.newInstance(martinVanLeeuwen.getPosition());
		for (int j = 0; j < martinVanLeeuwen.getTeams().size(); j++) {
			if (martinVanLeeuwen.getTeams().get(j) != null) {
				teams.add(martinVanLeeuwen.getTeams().get(j).getClass()
						.getDeclaredConstructor(martinVanLeeuwen.getTeams().get(j).getClass())
						.newInstance(martinVanLeeuwen.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "MartinVanLeeuwen [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear="
