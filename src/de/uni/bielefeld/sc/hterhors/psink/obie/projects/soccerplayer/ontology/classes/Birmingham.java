...
@NamedIndividual public class Birmingham implements IBirmingham{
...
this.textMention = textMention;
	...
	public Birmingham(Birmingham birmingham)throws InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException,NoSuchMethodException, SecurityException{
...
return "Birmingham [annotationID="+annotationID+",characterOffset="+characterOffset+",characterOnset="+characterOnset+",serialVersionUID="+serialVersionUID+",textMention="+textMention+"]";}
