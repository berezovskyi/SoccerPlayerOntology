...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IIoannisStefas;
...
public class IoannisStefas implements IIoannisStefas {
	...
	public IoannisStefas(IoannisStefas ioannisStefas) throws InstantiationException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		this.annotationID = ioannisStefas.getAnnotationID();
		for (int j = 0; j < ioannisStefas.getBirthPlaces().size(); j++) {
			if (ioannisStefas.getBirthPlaces().get(j) != null) {
				birthPlaces.add(ioannisStefas.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(ioannisStefas.getBirthPlaces().get(j).getClass())
						.newInstance(ioannisStefas.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (ioannisStefas.getBirthYear() != null)
			this.birthYear = ioannisStefas.getBirthYear().getClass()
					.getDeclaredConstructor(ioannisStefas.getBirthYear().getClass())
					.newInstance(ioannisStefas.getBirthYear());
		this.characterOffset = ioannisStefas.getCharacterOffset();
		this.characterOnset = ioannisStefas.getCharacterOnset();
		if (ioannisStefas.getPosition() != null)
			this.position = ioannisStefas.getPosition().getClass()
					.getDeclaredConstructor(ioannisStefas.getPosition().getClass())
					.newInstance(ioannisStefas.getPosition());
		for (int j = 0; j < ioannisStefas.getTeams().size(); j++) {
			if (ioannisStefas.getTeams().get(j) != null) {
				teams.add(ioannisStefas.getTeams().get(j).getClass()
						.getDeclaredConstructor(ioannisStefas.getTeams().get(j).getClass())
						.newInstance(ioannisStefas.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "IoannisStefas [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear=" + birthYear
