...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IErnestoBrown;
...
public class ErnestoBrown implements IErnestoBrown {
	...
	public ErnestoBrown(ErnestoBrown ernestoBrown) throws InstantiationException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		this.annotationID = ernestoBrown.getAnnotationID();
		for (int j = 0; j < ernestoBrown.getBirthPlaces().size(); j++) {
			if (ernestoBrown.getBirthPlaces().get(j) != null) {
				birthPlaces.add(ernestoBrown.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(ernestoBrown.getBirthPlaces().get(j).getClass())
						.newInstance(ernestoBrown.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (ernestoBrown.getBirthYear() != null)
			this.birthYear = ernestoBrown.getBirthYear().getClass()
					.getDeclaredConstructor(ernestoBrown.getBirthYear().getClass())
					.newInstance(ernestoBrown.getBirthYear());
		this.characterOffset = ernestoBrown.getCharacterOffset();
		this.characterOnset = ernestoBrown.getCharacterOnset();
		if (ernestoBrown.getPosition() != null)
			this.position = ernestoBrown.getPosition().getClass()
					.getDeclaredConstructor(ernestoBrown.getPosition().getClass())
					.newInstance(ernestoBrown.getPosition());
		for (int j = 0; j < ernestoBrown.getTeams().size(); j++) {
			if (ernestoBrown.getTeams().get(j) != null) {
				teams.add(ernestoBrown.getTeams().get(j).getClass()
						.getDeclaredConstructor(ernestoBrown.getTeams().get(j).getClass())
						.newInstance(ernestoBrown.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "ErnestoBrown [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear=" + birthYear
