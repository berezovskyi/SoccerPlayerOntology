...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IFikriElma;
...
public class FikriElma implements IFikriElma {
	...
	public FikriElma(FikriElma fikriElma) throws InstantiationException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		this.annotationID = fikriElma.getAnnotationID();
		for (int j = 0; j < fikriElma.getBirthPlaces().size(); j++) {
			if (fikriElma.getBirthPlaces().get(j) != null) {
				birthPlaces.add(fikriElma.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(fikriElma.getBirthPlaces().get(j).getClass())
						.newInstance(fikriElma.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (fikriElma.getBirthYear() != null)
			this.birthYear = fikriElma.getBirthYear().getClass()
					.getDeclaredConstructor(fikriElma.getBirthYear().getClass()).newInstance(fikriElma.getBirthYear());
		this.characterOffset = fikriElma.getCharacterOffset();
		this.characterOnset = fikriElma.getCharacterOnset();
		if (fikriElma.getPosition() != null)
			this.position = fikriElma.getPosition().getClass()
					.getDeclaredConstructor(fikriElma.getPosition().getClass()).newInstance(fikriElma.getPosition());
		for (int j = 0; j < fikriElma.getTeams().size(); j++) {
			if (fikriElma.getTeams().get(j) != null) {
				teams.add(fikriElma.getTeams().get(j).getClass()
						.getDeclaredConstructor(fikriElma.getTeams().get(j).getClass())
						.newInstance(fikriElma.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "FikriElma [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear=" + birthYear
