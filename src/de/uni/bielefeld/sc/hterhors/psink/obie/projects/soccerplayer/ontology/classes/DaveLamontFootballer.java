...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IDaveLamontFootballer;
...
public class DaveLamontFootballer implements IDaveLamontFootballer {
	...
	public DaveLamontFootballer(DaveLamontFootballer daveLamontFootballer)
			throws InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException,
			NoSuchMethodException, SecurityException {
		this.annotationID = daveLamontFootballer.getAnnotationID();
		for (int j = 0; j < daveLamontFootballer.getBirthPlaces().size(); j++) {
			if (daveLamontFootballer.getBirthPlaces().get(j) != null) {
				birthPlaces.add(daveLamontFootballer.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(daveLamontFootballer.getBirthPlaces().get(j).getClass())
						.newInstance(daveLamontFootballer.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (daveLamontFootballer.getBirthYear() != null)
			this.birthYear = daveLamontFootballer.getBirthYear().getClass()
					.getDeclaredConstructor(daveLamontFootballer.getBirthYear().getClass())
					.newInstance(daveLamontFootballer.getBirthYear());
		this.characterOffset = daveLamontFootballer.getCharacterOffset();
		this.characterOnset = daveLamontFootballer.getCharacterOnset();
		if (daveLamontFootballer.getPosition() != null)
			this.position = daveLamontFootballer.getPosition().getClass()
					.getDeclaredConstructor(daveLamontFootballer.getPosition().getClass())
					.newInstance(daveLamontFootballer.getPosition());
		for (int j = 0; j < daveLamontFootballer.getTeams().size(); j++) {
			if (daveLamontFootballer.getTeams().get(j) != null) {
				teams.add(daveLamontFootballer.getTeams().get(j).getClass()
						.getDeclaredConstructor(daveLamontFootballer.getTeams().get(j).getClass())
						.newInstance(daveLamontFootballer.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "DaveLamontFootballer [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear="
