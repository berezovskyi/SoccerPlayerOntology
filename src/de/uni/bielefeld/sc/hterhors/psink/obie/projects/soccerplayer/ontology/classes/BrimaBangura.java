...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IBrimaBangura;
...
public class BrimaBangura implements IBrimaBangura {
	...
	public BrimaBangura(BrimaBangura brimaBangura) throws InstantiationException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		this.annotationID = brimaBangura.getAnnotationID();
		for (int j = 0; j < brimaBangura.getBirthPlaces().size(); j++) {
			if (brimaBangura.getBirthPlaces().get(j) != null) {
				birthPlaces.add(brimaBangura.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(brimaBangura.getBirthPlaces().get(j).getClass())
						.newInstance(brimaBangura.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (brimaBangura.getBirthYear() != null)
			this.birthYear = brimaBangura.getBirthYear().getClass()
					.getDeclaredConstructor(brimaBangura.getBirthYear().getClass())
					.newInstance(brimaBangura.getBirthYear());
		this.characterOffset = brimaBangura.getCharacterOffset();
		this.characterOnset = brimaBangura.getCharacterOnset();
		if (brimaBangura.getPosition() != null)
			this.position = brimaBangura.getPosition().getClass()
					.getDeclaredConstructor(brimaBangura.getPosition().getClass())
					.newInstance(brimaBangura.getPosition());
		for (int j = 0; j < brimaBangura.getTeams().size(); j++) {
			if (brimaBangura.getTeams().get(j) != null) {
				teams.add(brimaBangura.getTeams().get(j).getClass()
						.getDeclaredConstructor(brimaBangura.getTeams().get(j).getClass())
						.newInstance(brimaBangura.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "BrimaBangura [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear=" + birthYear
