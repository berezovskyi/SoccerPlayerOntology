...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IStefanVelichkov;
...
public class StefanVelichkov implements IStefanVelichkov {
	...
	public StefanVelichkov(StefanVelichkov stefanVelichkov) throws InstantiationException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		this.annotationID = stefanVelichkov.getAnnotationID();
		for (int j = 0; j < stefanVelichkov.getBirthPlaces().size(); j++) {
			if (stefanVelichkov.getBirthPlaces().get(j) != null) {
				birthPlaces.add(stefanVelichkov.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(stefanVelichkov.getBirthPlaces().get(j).getClass())
						.newInstance(stefanVelichkov.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (stefanVelichkov.getBirthYear() != null)
			this.birthYear = stefanVelichkov.getBirthYear().getClass()
					.getDeclaredConstructor(stefanVelichkov.getBirthYear().getClass())
					.newInstance(stefanVelichkov.getBirthYear());
		this.characterOffset = stefanVelichkov.getCharacterOffset();
		this.characterOnset = stefanVelichkov.getCharacterOnset();
		if (stefanVelichkov.getPosition() != null)
			this.position = stefanVelichkov.getPosition().getClass()
					.getDeclaredConstructor(stefanVelichkov.getPosition().getClass())
					.newInstance(stefanVelichkov.getPosition());
		for (int j = 0; j < stefanVelichkov.getTeams().size(); j++) {
			if (stefanVelichkov.getTeams().get(j) != null) {
				teams.add(stefanVelichkov.getTeams().get(j).getClass()
						.getDeclaredConstructor(stefanVelichkov.getTeams().get(j).getClass())
						.newInstance(stefanVelichkov.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "StefanVelichkov [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear="
