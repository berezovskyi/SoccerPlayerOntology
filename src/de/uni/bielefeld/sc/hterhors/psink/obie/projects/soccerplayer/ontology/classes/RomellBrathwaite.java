...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IRomellBrathwaite;
...
public class RomellBrathwaite implements IRomellBrathwaite {
	...
	public RomellBrathwaite(RomellBrathwaite romellBrathwaite) throws InstantiationException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		this.annotationID = romellBrathwaite.getAnnotationID();
		for (int j = 0; j < romellBrathwaite.getBirthPlaces().size(); j++) {
			if (romellBrathwaite.getBirthPlaces().get(j) != null) {
				birthPlaces.add(romellBrathwaite.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(romellBrathwaite.getBirthPlaces().get(j).getClass())
						.newInstance(romellBrathwaite.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (romellBrathwaite.getBirthYear() != null)
			this.birthYear = romellBrathwaite.getBirthYear().getClass()
					.getDeclaredConstructor(romellBrathwaite.getBirthYear().getClass())
					.newInstance(romellBrathwaite.getBirthYear());
		this.characterOffset = romellBrathwaite.getCharacterOffset();
		this.characterOnset = romellBrathwaite.getCharacterOnset();
		if (romellBrathwaite.getPosition() != null)
			this.position = romellBrathwaite.getPosition().getClass()
					.getDeclaredConstructor(romellBrathwaite.getPosition().getClass())
					.newInstance(romellBrathwaite.getPosition());
		for (int j = 0; j < romellBrathwaite.getTeams().size(); j++) {
			if (romellBrathwaite.getTeams().get(j) != null) {
				teams.add(romellBrathwaite.getTeams().get(j).getClass()
						.getDeclaredConstructor(romellBrathwaite.getTeams().get(j).getClass())
						.newInstance(romellBrathwaite.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "RomellBrathwaite [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear="
