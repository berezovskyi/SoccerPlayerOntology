...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IByronLawrence;
...
public class ByronLawrence implements IByronLawrence {
	...
	public ByronLawrence(ByronLawrence byronLawrence) throws InstantiationException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		this.annotationID = byronLawrence.getAnnotationID();
		for (int j = 0; j < byronLawrence.getBirthPlaces().size(); j++) {
			if (byronLawrence.getBirthPlaces().get(j) != null) {
				birthPlaces.add(byronLawrence.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(byronLawrence.getBirthPlaces().get(j).getClass())
						.newInstance(byronLawrence.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (byronLawrence.getBirthYear() != null)
			this.birthYear = byronLawrence.getBirthYear().getClass()
					.getDeclaredConstructor(byronLawrence.getBirthYear().getClass())
					.newInstance(byronLawrence.getBirthYear());
		this.characterOffset = byronLawrence.getCharacterOffset();
		this.characterOnset = byronLawrence.getCharacterOnset();
		if (byronLawrence.getPosition() != null)
			this.position = byronLawrence.getPosition().getClass()
					.getDeclaredConstructor(byronLawrence.getPosition().getClass())
					.newInstance(byronLawrence.getPosition());
		for (int j = 0; j < byronLawrence.getTeams().size(); j++) {
			if (byronLawrence.getTeams().get(j) != null) {
				teams.add(byronLawrence.getTeams().get(j).getClass()
						.getDeclaredConstructor(byronLawrence.getTeams().get(j).getClass())
						.newInstance(byronLawrence.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "ByronLawrence [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear=" + birthYear
