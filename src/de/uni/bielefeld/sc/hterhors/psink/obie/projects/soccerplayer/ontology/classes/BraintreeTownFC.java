...
@NamedIndividual public class BraintreeTownFC implements IBraintreeTownFC{
...
this.textMention = null;
	...
	public BraintreeTownFC(BraintreeTownFC braintreeTownFC)throws InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException,NoSuchMethodException, SecurityException{
...
return "BraintreeTownFC [annotationID="+annotationID+",characterOffset="+characterOffset+",characterOnset="+characterOnset+",serialVersionUID="+serialVersionUID+",textMention="+textMention+"]";}
