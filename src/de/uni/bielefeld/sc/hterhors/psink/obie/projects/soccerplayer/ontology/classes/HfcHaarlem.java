...
@NamedIndividual public class HfcHaarlem implements IHfcHaarlem{
...
this.textMention = textMention;
	...
	public HfcHaarlem(HfcHaarlem hfcHaarlem)throws InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException,NoSuchMethodException, SecurityException{
...
return "HfcHaarlem [annotationID="+annotationID+",characterOffset="+characterOffset+",characterOnset="+characterOnset+",serialVersionUID="+serialVersionUID+",textMention="+textMention+"]";}
