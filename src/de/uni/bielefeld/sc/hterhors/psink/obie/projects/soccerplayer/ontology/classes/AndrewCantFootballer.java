...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IAndrewCantFootballer;
...
public class AndrewCantFootballer implements IAndrewCantFootballer {
	...
	public AndrewCantFootballer(AndrewCantFootballer andrewCantFootballer)
			throws InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException,
			NoSuchMethodException, SecurityException {
		this.annotationID = andrewCantFootballer.getAnnotationID();
		for (int j = 0; j < andrewCantFootballer.getBirthPlaces().size(); j++) {
			if (andrewCantFootballer.getBirthPlaces().get(j) != null) {
				birthPlaces.add(andrewCantFootballer.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(andrewCantFootballer.getBirthPlaces().get(j).getClass())
						.newInstance(andrewCantFootballer.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (andrewCantFootballer.getBirthYear() != null)
			this.birthYear = andrewCantFootballer.getBirthYear().getClass()
					.getDeclaredConstructor(andrewCantFootballer.getBirthYear().getClass())
					.newInstance(andrewCantFootballer.getBirthYear());
		this.characterOffset = andrewCantFootballer.getCharacterOffset();
		this.characterOnset = andrewCantFootballer.getCharacterOnset();
		if (andrewCantFootballer.getPosition() != null)
			this.position = andrewCantFootballer.getPosition().getClass()
					.getDeclaredConstructor(andrewCantFootballer.getPosition().getClass())
					.newInstance(andrewCantFootballer.getPosition());
		for (int j = 0; j < andrewCantFootballer.getTeams().size(); j++) {
			if (andrewCantFootballer.getTeams().get(j) != null) {
				teams.add(andrewCantFootballer.getTeams().get(j).getClass()
						.getDeclaredConstructor(andrewCantFootballer.getTeams().get(j).getClass())
						.newInstance(andrewCantFootballer.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "AndrewCantFootballer [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear="
