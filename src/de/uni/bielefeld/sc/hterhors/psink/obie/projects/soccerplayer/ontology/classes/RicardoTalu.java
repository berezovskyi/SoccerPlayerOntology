...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IRicardoTalu;
...
public class RicardoTalu implements IRicardoTalu {
	...
	public RicardoTalu(RicardoTalu ricardoTalu) throws InstantiationException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		this.annotationID = ricardoTalu.getAnnotationID();
		for (int j = 0; j < ricardoTalu.getBirthPlaces().size(); j++) {
			if (ricardoTalu.getBirthPlaces().get(j) != null) {
				birthPlaces.add(ricardoTalu.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(ricardoTalu.getBirthPlaces().get(j).getClass())
						.newInstance(ricardoTalu.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (ricardoTalu.getBirthYear() != null)
			this.birthYear = ricardoTalu.getBirthYear().getClass()
					.getDeclaredConstructor(ricardoTalu.getBirthYear().getClass())
					.newInstance(ricardoTalu.getBirthYear());
		this.characterOffset = ricardoTalu.getCharacterOffset();
		this.characterOnset = ricardoTalu.getCharacterOnset();
		if (ricardoTalu.getPosition() != null)
			this.position = ricardoTalu.getPosition().getClass()
					.getDeclaredConstructor(ricardoTalu.getPosition().getClass())
					.newInstance(ricardoTalu.getPosition());
		for (int j = 0; j < ricardoTalu.getTeams().size(); j++) {
			if (ricardoTalu.getTeams().get(j) != null) {
				teams.add(ricardoTalu.getTeams().get(j).getClass()
						.getDeclaredConstructor(ricardoTalu.getTeams().get(j).getClass())
						.newInstance(ricardoTalu.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "RicardoTalu [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear=" + birthYear
