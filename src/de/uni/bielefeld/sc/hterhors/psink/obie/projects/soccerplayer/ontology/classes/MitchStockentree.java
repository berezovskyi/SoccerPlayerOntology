...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IMitchStockentree;
...
public class MitchStockentree implements IMitchStockentree {
	...
	public MitchStockentree(MitchStockentree mitchStockentree) throws InstantiationException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		this.annotationID = mitchStockentree.getAnnotationID();
		for (int j = 0; j < mitchStockentree.getBirthPlaces().size(); j++) {
			if (mitchStockentree.getBirthPlaces().get(j) != null) {
				birthPlaces.add(mitchStockentree.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(mitchStockentree.getBirthPlaces().get(j).getClass())
						.newInstance(mitchStockentree.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (mitchStockentree.getBirthYear() != null)
			this.birthYear = mitchStockentree.getBirthYear().getClass()
					.getDeclaredConstructor(mitchStockentree.getBirthYear().getClass())
					.newInstance(mitchStockentree.getBirthYear());
		this.characterOffset = mitchStockentree.getCharacterOffset();
		this.characterOnset = mitchStockentree.getCharacterOnset();
		if (mitchStockentree.getPosition() != null)
			this.position = mitchStockentree.getPosition().getClass()
					.getDeclaredConstructor(mitchStockentree.getPosition().getClass())
					.newInstance(mitchStockentree.getPosition());
		for (int j = 0; j < mitchStockentree.getTeams().size(); j++) {
			if (mitchStockentree.getTeams().get(j) != null) {
				teams.add(mitchStockentree.getTeams().get(j).getClass()
						.getDeclaredConstructor(mitchStockentree.getTeams().get(j).getClass())
						.newInstance(mitchStockentree.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "MitchStockentree [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear="
