...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.ICiprianoSantos;
...
public class CiprianoSantos implements ICiprianoSantos {
	...
	public CiprianoSantos(CiprianoSantos ciprianoSantos) throws InstantiationException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		this.annotationID = ciprianoSantos.getAnnotationID();
		for (int j = 0; j < ciprianoSantos.getBirthPlaces().size(); j++) {
			if (ciprianoSantos.getBirthPlaces().get(j) != null) {
				birthPlaces.add(ciprianoSantos.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(ciprianoSantos.getBirthPlaces().get(j).getClass())
						.newInstance(ciprianoSantos.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (ciprianoSantos.getBirthYear() != null)
			this.birthYear = ciprianoSantos.getBirthYear().getClass()
					.getDeclaredConstructor(ciprianoSantos.getBirthYear().getClass())
					.newInstance(ciprianoSantos.getBirthYear());
		this.characterOffset = ciprianoSantos.getCharacterOffset();
		this.characterOnset = ciprianoSantos.getCharacterOnset();
		if (ciprianoSantos.getPosition() != null)
			this.position = ciprianoSantos.getPosition().getClass()
					.getDeclaredConstructor(ciprianoSantos.getPosition().getClass())
					.newInstance(ciprianoSantos.getPosition());
		for (int j = 0; j < ciprianoSantos.getTeams().size(); j++) {
			if (ciprianoSantos.getTeams().get(j) != null) {
				teams.add(ciprianoSantos.getTeams().get(j).getClass()
						.getDeclaredConstructor(ciprianoSantos.getTeams().get(j).getClass())
						.newInstance(ciprianoSantos.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "CiprianoSantos [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear="
