...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.ILalrinzualaKhiangte;
...
public class LalrinzualaKhiangte implements ILalrinzualaKhiangte {
	...
	public LalrinzualaKhiangte(LalrinzualaKhiangte lalrinzualaKhiangte)
			throws InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException,
			NoSuchMethodException, SecurityException {
		this.annotationID = lalrinzualaKhiangte.getAnnotationID();
		for (int j = 0; j < lalrinzualaKhiangte.getBirthPlaces().size(); j++) {
			if (lalrinzualaKhiangte.getBirthPlaces().get(j) != null) {
				birthPlaces.add(lalrinzualaKhiangte.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(lalrinzualaKhiangte.getBirthPlaces().get(j).getClass())
						.newInstance(lalrinzualaKhiangte.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (lalrinzualaKhiangte.getBirthYear() != null)
			this.birthYear = lalrinzualaKhiangte.getBirthYear().getClass()
					.getDeclaredConstructor(lalrinzualaKhiangte.getBirthYear().getClass())
					.newInstance(lalrinzualaKhiangte.getBirthYear());
		this.characterOffset = lalrinzualaKhiangte.getCharacterOffset();
		this.characterOnset = lalrinzualaKhiangte.getCharacterOnset();
		if (lalrinzualaKhiangte.getPosition() != null)
			this.position = lalrinzualaKhiangte.getPosition().getClass()
					.getDeclaredConstructor(lalrinzualaKhiangte.getPosition().getClass())
					.newInstance(lalrinzualaKhiangte.getPosition());
		for (int j = 0; j < lalrinzualaKhiangte.getTeams().size(); j++) {
			if (lalrinzualaKhiangte.getTeams().get(j) != null) {
				teams.add(lalrinzualaKhiangte.getTeams().get(j).getClass()
						.getDeclaredConstructor(lalrinzualaKhiangte.getTeams().get(j).getClass())
						.newInstance(lalrinzualaKhiangte.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "LalrinzualaKhiangte [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear="
