...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IBernardHallFootballer;
...
public class BernardHallFootballer implements IBernardHallFootballer {
	...
	public BernardHallFootballer(BernardHallFootballer bernardHallFootballer)
			throws InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException,
			NoSuchMethodException, SecurityException {
		this.annotationID = bernardHallFootballer.getAnnotationID();
		for (int j = 0; j < bernardHallFootballer.getBirthPlaces().size(); j++) {
			if (bernardHallFootballer.getBirthPlaces().get(j) != null) {
				birthPlaces.add(bernardHallFootballer.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(bernardHallFootballer.getBirthPlaces().get(j).getClass())
						.newInstance(bernardHallFootballer.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (bernardHallFootballer.getBirthYear() != null)
			this.birthYear = bernardHallFootballer.getBirthYear().getClass()
					.getDeclaredConstructor(bernardHallFootballer.getBirthYear().getClass())
					.newInstance(bernardHallFootballer.getBirthYear());
		this.characterOffset = bernardHallFootballer.getCharacterOffset();
		this.characterOnset = bernardHallFootballer.getCharacterOnset();
		if (bernardHallFootballer.getPosition() != null)
			this.position = bernardHallFootballer.getPosition().getClass()
					.getDeclaredConstructor(bernardHallFootballer.getPosition().getClass())
					.newInstance(bernardHallFootballer.getPosition());
		for (int j = 0; j < bernardHallFootballer.getTeams().size(); j++) {
			if (bernardHallFootballer.getTeams().get(j) != null) {
				teams.add(bernardHallFootballer.getTeams().get(j).getClass()
						.getDeclaredConstructor(bernardHallFootballer.getTeams().get(j).getClass())
						.newInstance(bernardHallFootballer.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "BernardHallFootballer [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear="
