...
@DirectInterface(get=IDefenderAssociationFootball.class)
...
@SuperRootClasses(get={Position.class, })
 public class DefenderAssociationFootball implements IDefenderAssociationFootball{

	final static public String ONTOLOGY_NAME = "http://psink.de/scio/DefenderAssociationFootball";
...
final private String textMention;
	...
	public DefenderAssociationFootball(String annotationID, String textMention){
this.annotationID = annotationID;
this.textMention = textMention;
}
	public DefenderAssociationFootball(){
this.annotationID = null;
this.textMention = null;
}
	public DefenderAssociationFootball(DefenderAssociationFootball defenderAssociationFootball)throws InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException,NoSuchMethodException, SecurityException{
this.annotationID = defenderAssociationFootball.getAnnotationID();
this.characterOffset = defenderAssociationFootball.getCharacterOffset();
this.characterOnset = defenderAssociationFootball.getCharacterOnset();
this.textMention = defenderAssociationFootball.getTextMention();
}
...
return false;
DefenderAssociationFootball other = (DefenderAssociationFootball) obj;
...
return "DefenderAssociationFootball [annotationID="+annotationID+",characterOffset="+characterOffset+",characterOnset="+characterOnset+",serialVersionUID="+serialVersionUID+",textMention="+textMention+"]";}
