...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IKurtSvensson;
...
public class KurtSvensson implements IKurtSvensson {
	...
	public KurtSvensson(KurtSvensson kurtSvensson) throws InstantiationException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		this.annotationID = kurtSvensson.getAnnotationID();
		for (int j = 0; j < kurtSvensson.getBirthPlaces().size(); j++) {
			if (kurtSvensson.getBirthPlaces().get(j) != null) {
				birthPlaces.add(kurtSvensson.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(kurtSvensson.getBirthPlaces().get(j).getClass())
						.newInstance(kurtSvensson.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (kurtSvensson.getBirthYear() != null)
			this.birthYear = kurtSvensson.getBirthYear().getClass()
					.getDeclaredConstructor(kurtSvensson.getBirthYear().getClass())
					.newInstance(kurtSvensson.getBirthYear());
		this.characterOffset = kurtSvensson.getCharacterOffset();
		this.characterOnset = kurtSvensson.getCharacterOnset();
		if (kurtSvensson.getPosition() != null)
			this.position = kurtSvensson.getPosition().getClass()
					.getDeclaredConstructor(kurtSvensson.getPosition().getClass())
					.newInstance(kurtSvensson.getPosition());
		for (int j = 0; j < kurtSvensson.getTeams().size(); j++) {
			if (kurtSvensson.getTeams().get(j) != null) {
				teams.add(kurtSvensson.getTeams().get(j).getClass()
						.getDeclaredConstructor(kurtSvensson.getTeams().get(j).getClass())
						.newInstance(kurtSvensson.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "KurtSvensson [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear=" + birthYear
