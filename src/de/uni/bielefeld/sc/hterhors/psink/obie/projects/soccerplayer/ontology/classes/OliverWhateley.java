...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IOliverWhateley;
...
public class OliverWhateley implements IOliverWhateley {
	...
	public OliverWhateley(OliverWhateley oliverWhateley) throws InstantiationException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		this.annotationID = oliverWhateley.getAnnotationID();
		for (int j = 0; j < oliverWhateley.getBirthPlaces().size(); j++) {
			if (oliverWhateley.getBirthPlaces().get(j) != null) {
				birthPlaces.add(oliverWhateley.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(oliverWhateley.getBirthPlaces().get(j).getClass())
						.newInstance(oliverWhateley.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (oliverWhateley.getBirthYear() != null)
			this.birthYear = oliverWhateley.getBirthYear().getClass()
					.getDeclaredConstructor(oliverWhateley.getBirthYear().getClass())
					.newInstance(oliverWhateley.getBirthYear());
		this.characterOffset = oliverWhateley.getCharacterOffset();
		this.characterOnset = oliverWhateley.getCharacterOnset();
		if (oliverWhateley.getPosition() != null)
			this.position = oliverWhateley.getPosition().getClass()
					.getDeclaredConstructor(oliverWhateley.getPosition().getClass())
					.newInstance(oliverWhateley.getPosition());
		for (int j = 0; j < oliverWhateley.getTeams().size(); j++) {
			if (oliverWhateley.getTeams().get(j) != null) {
				teams.add(oliverWhateley.getTeams().get(j).getClass()
						.getDeclaredConstructor(oliverWhateley.getTeams().get(j).getClass())
						.newInstance(oliverWhateley.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "OliverWhateley [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear="
