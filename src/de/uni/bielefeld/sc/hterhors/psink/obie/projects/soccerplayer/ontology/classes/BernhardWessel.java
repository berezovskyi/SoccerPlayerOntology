...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IBernhardWessel;
...
public class BernhardWessel implements IBernhardWessel {
	...
	public BernhardWessel(BernhardWessel bernhardWessel) throws InstantiationException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		this.annotationID = bernhardWessel.getAnnotationID();
		for (int j = 0; j < bernhardWessel.getBirthPlaces().size(); j++) {
			if (bernhardWessel.getBirthPlaces().get(j) != null) {
				birthPlaces.add(bernhardWessel.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(bernhardWessel.getBirthPlaces().get(j).getClass())
						.newInstance(bernhardWessel.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (bernhardWessel.getBirthYear() != null)
			this.birthYear = bernhardWessel.getBirthYear().getClass()
					.getDeclaredConstructor(bernhardWessel.getBirthYear().getClass())
					.newInstance(bernhardWessel.getBirthYear());
		this.characterOffset = bernhardWessel.getCharacterOffset();
		this.characterOnset = bernhardWessel.getCharacterOnset();
		if (bernhardWessel.getPosition() != null)
			this.position = bernhardWessel.getPosition().getClass()
					.getDeclaredConstructor(bernhardWessel.getPosition().getClass())
					.newInstance(bernhardWessel.getPosition());
		for (int j = 0; j < bernhardWessel.getTeams().size(); j++) {
			if (bernhardWessel.getTeams().get(j) != null) {
				teams.add(bernhardWessel.getTeams().get(j).getClass()
						.getDeclaredConstructor(bernhardWessel.getTeams().get(j).getClass())
						.newInstance(bernhardWessel.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "BernhardWessel [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear="
