...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IJustinChavez;
...
public class JustinChavez implements IJustinChavez {
	...
	public JustinChavez(JustinChavez justinChavez) throws InstantiationException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		this.annotationID = justinChavez.getAnnotationID();
		for (int j = 0; j < justinChavez.getBirthPlaces().size(); j++) {
			if (justinChavez.getBirthPlaces().get(j) != null) {
				birthPlaces.add(justinChavez.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(justinChavez.getBirthPlaces().get(j).getClass())
						.newInstance(justinChavez.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (justinChavez.getBirthYear() != null)
			this.birthYear = justinChavez.getBirthYear().getClass()
					.getDeclaredConstructor(justinChavez.getBirthYear().getClass())
					.newInstance(justinChavez.getBirthYear());
		this.characterOffset = justinChavez.getCharacterOffset();
		this.characterOnset = justinChavez.getCharacterOnset();
		if (justinChavez.getPosition() != null)
			this.position = justinChavez.getPosition().getClass()
					.getDeclaredConstructor(justinChavez.getPosition().getClass())
					.newInstance(justinChavez.getPosition());
		for (int j = 0; j < justinChavez.getTeams().size(); j++) {
			if (justinChavez.getTeams().get(j) != null) {
				teams.add(justinChavez.getTeams().get(j).getClass()
						.getDeclaredConstructor(justinChavez.getTeams().get(j).getClass())
						.newInstance(justinChavez.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "JustinChavez [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear=" + birthYear
