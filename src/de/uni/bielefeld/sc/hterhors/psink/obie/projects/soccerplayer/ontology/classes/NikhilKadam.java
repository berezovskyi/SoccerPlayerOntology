...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.INikhilKadam;
...
public class NikhilKadam implements INikhilKadam {
	...
	public NikhilKadam(NikhilKadam nikhilKadam) throws InstantiationException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		this.annotationID = nikhilKadam.getAnnotationID();
		for (int j = 0; j < nikhilKadam.getBirthPlaces().size(); j++) {
			if (nikhilKadam.getBirthPlaces().get(j) != null) {
				birthPlaces.add(nikhilKadam.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(nikhilKadam.getBirthPlaces().get(j).getClass())
						.newInstance(nikhilKadam.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (nikhilKadam.getBirthYear() != null)
			this.birthYear = nikhilKadam.getBirthYear().getClass()
					.getDeclaredConstructor(nikhilKadam.getBirthYear().getClass())
					.newInstance(nikhilKadam.getBirthYear());
		this.characterOffset = nikhilKadam.getCharacterOffset();
		this.characterOnset = nikhilKadam.getCharacterOnset();
		if (nikhilKadam.getPosition() != null)
			this.position = nikhilKadam.getPosition().getClass()
					.getDeclaredConstructor(nikhilKadam.getPosition().getClass())
					.newInstance(nikhilKadam.getPosition());
		for (int j = 0; j < nikhilKadam.getTeams().size(); j++) {
			if (nikhilKadam.getTeams().get(j) != null) {
				teams.add(nikhilKadam.getTeams().get(j).getClass()
						.getDeclaredConstructor(nikhilKadam.getTeams().get(j).getClass())
						.newInstance(nikhilKadam.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "NikhilKadam [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear=" + birthYear
