...
@DirectInterface(get=IGoalkeeperAssociationFootball.class)
...
@DirectSiblings(get={GoalkeeperAssociationFootball.class, FieldHockey.class, ForwardAssociationFootball.class, InsideForward.class, Midfielder.class, WingHalf.class, DefenderAssociationFootball.class, Midfield.class, })
 public class GoalkeeperAssociationFootball implements IGoalkeeperAssociationFootball{

	final static public String ONTOLOGY_NAME = "http://psink.de/scio/GoalkeeperAssociationFootball";
...
final private String textMention;
	...
	public GoalkeeperAssociationFootball(GoalkeeperAssociationFootball goalkeeperAssociationFootball)throws InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException,NoSuchMethodException, SecurityException{
this.annotationID = goalkeeperAssociationFootball.getAnnotationID();
this.characterOffset = goalkeeperAssociationFootball.getCharacterOffset();
this.characterOnset = goalkeeperAssociationFootball.getCharacterOnset();
this.textMention = goalkeeperAssociationFootball.getTextMention();
}
	public GoalkeeperAssociationFootball(String annotationID, String textMention){
this.annotationID = annotationID;
this.textMention = textMention;
}
	public GoalkeeperAssociationFootball(){
...
return false;
GoalkeeperAssociationFootball other = (GoalkeeperAssociationFootball) obj;
...
return "GoalkeeperAssociationFootball [annotationID="+annotationID+",characterOffset="+characterOffset+",characterOnset="+characterOnset+",serialVersionUID="+serialVersionUID+",textMention="+textMention+"]";}
