...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IJimmyThorpe;
...
public class JimmyThorpe implements IJimmyThorpe {
	...
	public JimmyThorpe(JimmyThorpe jimmyThorpe) throws InstantiationException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		this.annotationID = jimmyThorpe.getAnnotationID();
		for (int j = 0; j < jimmyThorpe.getBirthPlaces().size(); j++) {
			if (jimmyThorpe.getBirthPlaces().get(j) != null) {
				birthPlaces.add(jimmyThorpe.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(jimmyThorpe.getBirthPlaces().get(j).getClass())
						.newInstance(jimmyThorpe.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (jimmyThorpe.getBirthYear() != null)
			this.birthYear = jimmyThorpe.getBirthYear().getClass()
					.getDeclaredConstructor(jimmyThorpe.getBirthYear().getClass())
					.newInstance(jimmyThorpe.getBirthYear());
		this.characterOffset = jimmyThorpe.getCharacterOffset();
		this.characterOnset = jimmyThorpe.getCharacterOnset();
		if (jimmyThorpe.getPosition() != null)
			this.position = jimmyThorpe.getPosition().getClass()
					.getDeclaredConstructor(jimmyThorpe.getPosition().getClass())
					.newInstance(jimmyThorpe.getPosition());
		for (int j = 0; j < jimmyThorpe.getTeams().size(); j++) {
			if (jimmyThorpe.getTeams().get(j) != null) {
				teams.add(jimmyThorpe.getTeams().get(j).getClass()
						.getDeclaredConstructor(jimmyThorpe.getTeams().get(j).getClass())
						.newInstance(jimmyThorpe.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "JimmyThorpe [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear=" + birthYear
