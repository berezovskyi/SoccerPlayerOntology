...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IBobbyMillsFootballer;
...
public class BobbyMillsFootballer implements IBobbyMillsFootballer {
	...
	public BobbyMillsFootballer(BobbyMillsFootballer bobbyMillsFootballer)
			throws InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException,
			NoSuchMethodException, SecurityException {
		this.annotationID = bobbyMillsFootballer.getAnnotationID();
		for (int j = 0; j < bobbyMillsFootballer.getBirthPlaces().size(); j++) {
			if (bobbyMillsFootballer.getBirthPlaces().get(j) != null) {
				birthPlaces.add(bobbyMillsFootballer.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(bobbyMillsFootballer.getBirthPlaces().get(j).getClass())
						.newInstance(bobbyMillsFootballer.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (bobbyMillsFootballer.getBirthYear() != null)
			this.birthYear = bobbyMillsFootballer.getBirthYear().getClass()
					.getDeclaredConstructor(bobbyMillsFootballer.getBirthYear().getClass())
					.newInstance(bobbyMillsFootballer.getBirthYear());
		this.characterOffset = bobbyMillsFootballer.getCharacterOffset();
		this.characterOnset = bobbyMillsFootballer.getCharacterOnset();
		if (bobbyMillsFootballer.getPosition() != null)
			this.position = bobbyMillsFootballer.getPosition().getClass()
					.getDeclaredConstructor(bobbyMillsFootballer.getPosition().getClass())
					.newInstance(bobbyMillsFootballer.getPosition());
		for (int j = 0; j < bobbyMillsFootballer.getTeams().size(); j++) {
			if (bobbyMillsFootballer.getTeams().get(j) != null) {
				teams.add(bobbyMillsFootballer.getTeams().get(j).getClass()
						.getDeclaredConstructor(bobbyMillsFootballer.getTeams().get(j).getClass())
						.newInstance(bobbyMillsFootballer.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "BobbyMillsFootballer [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear="
