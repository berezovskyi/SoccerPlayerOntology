...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IJohnGrahamForward;
...
public class JohnGrahamForward implements IJohnGrahamForward {
	...
	public JohnGrahamForward(JohnGrahamForward johnGrahamForward) throws InstantiationException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		this.annotationID = johnGrahamForward.getAnnotationID();
		for (int j = 0; j < johnGrahamForward.getBirthPlaces().size(); j++) {
			if (johnGrahamForward.getBirthPlaces().get(j) != null) {
				birthPlaces.add(johnGrahamForward.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(johnGrahamForward.getBirthPlaces().get(j).getClass())
						.newInstance(johnGrahamForward.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (johnGrahamForward.getBirthYear() != null)
			this.birthYear = johnGrahamForward.getBirthYear().getClass()
					.getDeclaredConstructor(johnGrahamForward.getBirthYear().getClass())
					.newInstance(johnGrahamForward.getBirthYear());
		this.characterOffset = johnGrahamForward.getCharacterOffset();
		this.characterOnset = johnGrahamForward.getCharacterOnset();
		if (johnGrahamForward.getPosition() != null)
			this.position = johnGrahamForward.getPosition().getClass()
					.getDeclaredConstructor(johnGrahamForward.getPosition().getClass())
					.newInstance(johnGrahamForward.getPosition());
		for (int j = 0; j < johnGrahamForward.getTeams().size(); j++) {
			if (johnGrahamForward.getTeams().get(j) != null) {
				teams.add(johnGrahamForward.getTeams().get(j).getClass()
						.getDeclaredConstructor(johnGrahamForward.getTeams().get(j).getClass())
						.newInstance(johnGrahamForward.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "JohnGrahamForward [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear="
