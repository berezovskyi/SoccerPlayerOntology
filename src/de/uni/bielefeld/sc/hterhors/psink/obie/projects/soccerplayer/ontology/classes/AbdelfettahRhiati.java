...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IAbdelfettahRhiati;
...
public class AbdelfettahRhiati implements IAbdelfettahRhiati {
	...
	public AbdelfettahRhiati(AbdelfettahRhiati abdelfettahRhiati) throws InstantiationException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		this.annotationID = abdelfettahRhiati.getAnnotationID();
		for (int j = 0; j < abdelfettahRhiati.getBirthPlaces().size(); j++) {
			if (abdelfettahRhiati.getBirthPlaces().get(j) != null) {
				birthPlaces.add(abdelfettahRhiati.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(abdelfettahRhiati.getBirthPlaces().get(j).getClass())
						.newInstance(abdelfettahRhiati.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (abdelfettahRhiati.getBirthYear() != null)
			this.birthYear = abdelfettahRhiati.getBirthYear().getClass()
					.getDeclaredConstructor(abdelfettahRhiati.getBirthYear().getClass())
					.newInstance(abdelfettahRhiati.getBirthYear());
		this.characterOffset = abdelfettahRhiati.getCharacterOffset();
		this.characterOnset = abdelfettahRhiati.getCharacterOnset();
		if (abdelfettahRhiati.getPosition() != null)
			this.position = abdelfettahRhiati.getPosition().getClass()
					.getDeclaredConstructor(abdelfettahRhiati.getPosition().getClass())
					.newInstance(abdelfettahRhiati.getPosition());
		for (int j = 0; j < abdelfettahRhiati.getTeams().size(); j++) {
			if (abdelfettahRhiati.getTeams().get(j) != null) {
				teams.add(abdelfettahRhiati.getTeams().get(j).getClass()
						.getDeclaredConstructor(abdelfettahRhiati.getTeams().get(j).getClass())
						.newInstance(abdelfettahRhiati.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "AbdelfettahRhiati [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear="
