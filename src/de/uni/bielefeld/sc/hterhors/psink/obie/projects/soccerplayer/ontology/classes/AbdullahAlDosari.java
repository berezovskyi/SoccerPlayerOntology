...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IAbdullahAlDosari;
...
public class AbdullahAlDosari implements IAbdullahAlDosari {
	...
	public AbdullahAlDosari(AbdullahAlDosari abdullahAlDosari) throws InstantiationException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		this.annotationID = abdullahAlDosari.getAnnotationID();
		for (int j = 0; j < abdullahAlDosari.getBirthPlaces().size(); j++) {
			if (abdullahAlDosari.getBirthPlaces().get(j) != null) {
				birthPlaces.add(abdullahAlDosari.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(abdullahAlDosari.getBirthPlaces().get(j).getClass())
						.newInstance(abdullahAlDosari.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (abdullahAlDosari.getBirthYear() != null)
			this.birthYear = abdullahAlDosari.getBirthYear().getClass()
					.getDeclaredConstructor(abdullahAlDosari.getBirthYear().getClass())
					.newInstance(abdullahAlDosari.getBirthYear());
		this.characterOffset = abdullahAlDosari.getCharacterOffset();
		this.characterOnset = abdullahAlDosari.getCharacterOnset();
		if (abdullahAlDosari.getPosition() != null)
			this.position = abdullahAlDosari.getPosition().getClass()
					.getDeclaredConstructor(abdullahAlDosari.getPosition().getClass())
					.newInstance(abdullahAlDosari.getPosition());
		for (int j = 0; j < abdullahAlDosari.getTeams().size(); j++) {
			if (abdullahAlDosari.getTeams().get(j) != null) {
				teams.add(abdullahAlDosari.getTeams().get(j).getClass()
						.getDeclaredConstructor(abdullahAlDosari.getTeams().get(j).getClass())
						.newInstance(abdullahAlDosari.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "AbdullahAlDosari [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear="
