...
@NamedIndividual public class PfcBotevPlovdiv implements IPfcBotevPlovdiv{
...
this.textMention = null;
	...
	public PfcBotevPlovdiv(PfcBotevPlovdiv pfcBotevPlovdiv)throws InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException,NoSuchMethodException, SecurityException{
...
return "PfcBotevPlovdiv [annotationID="+annotationID+",characterOffset="+characterOffset+",characterOnset="+characterOnset+",serialVersionUID="+serialVersionUID+",textMention="+textMention+"]";}
