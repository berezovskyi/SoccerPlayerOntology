...
@NamedIndividual public class ArnettGardensFC implements IArnettGardensFC{
...
this.textMention = textMention;
	...
	public ArnettGardensFC(ArnettGardensFC arnettGardensFC)throws InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException,NoSuchMethodException, SecurityException{
...
return "ArnettGardensFC [annotationID="+annotationID+",characterOffset="+characterOffset+",characterOnset="+characterOnset+",serialVersionUID="+serialVersionUID+",textMention="+textMention+"]";}
