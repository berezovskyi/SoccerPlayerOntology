...
@NamedIndividual public class FleetwoodTownFC implements IFleetwoodTownFC{
...
this.textMention = textMention;
	...
	public FleetwoodTownFC(FleetwoodTownFC fleetwoodTownFC)throws InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException,NoSuchMethodException, SecurityException{
...
return "FleetwoodTownFC [annotationID="+annotationID+",characterOffset="+characterOffset+",characterOnset="+characterOnset+",serialVersionUID="+serialVersionUID+",textMention="+textMention+"]";}
