...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.ISouravChakraborty;
...
public class SouravChakraborty implements ISouravChakraborty {
	...
	public SouravChakraborty(SouravChakraborty souravChakraborty) throws InstantiationException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		this.annotationID = souravChakraborty.getAnnotationID();
		for (int j = 0; j < souravChakraborty.getBirthPlaces().size(); j++) {
			if (souravChakraborty.getBirthPlaces().get(j) != null) {
				birthPlaces.add(souravChakraborty.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(souravChakraborty.getBirthPlaces().get(j).getClass())
						.newInstance(souravChakraborty.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (souravChakraborty.getBirthYear() != null)
			this.birthYear = souravChakraborty.getBirthYear().getClass()
					.getDeclaredConstructor(souravChakraborty.getBirthYear().getClass())
					.newInstance(souravChakraborty.getBirthYear());
		this.characterOffset = souravChakraborty.getCharacterOffset();
		this.characterOnset = souravChakraborty.getCharacterOnset();
		if (souravChakraborty.getPosition() != null)
			this.position = souravChakraborty.getPosition().getClass()
					.getDeclaredConstructor(souravChakraborty.getPosition().getClass())
					.newInstance(souravChakraborty.getPosition());
		for (int j = 0; j < souravChakraborty.getTeams().size(); j++) {
			if (souravChakraborty.getTeams().get(j) != null) {
				teams.add(souravChakraborty.getTeams().get(j).getClass()
						.getDeclaredConstructor(souravChakraborty.getTeams().get(j).getClass())
						.newInstance(souravChakraborty.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "SouravChakraborty [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear="
