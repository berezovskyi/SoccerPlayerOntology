...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IKeithGriffithsFootballer;
...
public class KeithGriffithsFootballer implements IKeithGriffithsFootballer {
	...
	public KeithGriffithsFootballer(KeithGriffithsFootballer keithGriffithsFootballer)
			throws InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException,
			NoSuchMethodException, SecurityException {
		this.annotationID = keithGriffithsFootballer.getAnnotationID();
		for (int j = 0; j < keithGriffithsFootballer.getBirthPlaces().size(); j++) {
			if (keithGriffithsFootballer.getBirthPlaces().get(j) != null) {
				birthPlaces.add(keithGriffithsFootballer.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(keithGriffithsFootballer.getBirthPlaces().get(j).getClass())
						.newInstance(keithGriffithsFootballer.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (keithGriffithsFootballer.getBirthYear() != null)
			this.birthYear = keithGriffithsFootballer.getBirthYear().getClass()
					.getDeclaredConstructor(keithGriffithsFootballer.getBirthYear().getClass())
					.newInstance(keithGriffithsFootballer.getBirthYear());
		...
		if (keithGriffithsFootballer.getPosition() != null)
			this.position = keithGriffithsFootballer.getPosition().getClass()
					.getDeclaredConstructor(keithGriffithsFootballer.getPosition().getClass())
					.newInstance(keithGriffithsFootballer.getPosition());
		for (int j = 0; j < keithGriffithsFootballer.getTeams().size(); j++) {
			if (keithGriffithsFootballer.getTeams().get(j) != null) {
				teams.add(keithGriffithsFootballer.getTeams().get(j).getClass()
						.getDeclaredConstructor(keithGriffithsFootballer.getTeams().get(j).getClass())
						.newInstance(keithGriffithsFootballer.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "KeithGriffithsFootballer [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear="
