...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IBillWhare;
...
public class BillWhare implements IBillWhare {
	...
	public BillWhare(BillWhare billWhare) throws InstantiationException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		this.annotationID = billWhare.getAnnotationID();
		for (int j = 0; j < billWhare.getBirthPlaces().size(); j++) {
			if (billWhare.getBirthPlaces().get(j) != null) {
				birthPlaces.add(billWhare.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(billWhare.getBirthPlaces().get(j).getClass())
						.newInstance(billWhare.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (billWhare.getBirthYear() != null)
			this.birthYear = billWhare.getBirthYear().getClass()
					.getDeclaredConstructor(billWhare.getBirthYear().getClass()).newInstance(billWhare.getBirthYear());
		this.characterOffset = billWhare.getCharacterOffset();
		this.characterOnset = billWhare.getCharacterOnset();
		if (billWhare.getPosition() != null)
			this.position = billWhare.getPosition().getClass()
					.getDeclaredConstructor(billWhare.getPosition().getClass()).newInstance(billWhare.getPosition());
		for (int j = 0; j < billWhare.getTeams().size(); j++) {
			if (billWhare.getTeams().get(j) != null) {
				teams.add(billWhare.getTeams().get(j).getClass()
						.getDeclaredConstructor(billWhare.getTeams().get(j).getClass())
						.newInstance(billWhare.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "BillWhare [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear=" + birthYear
