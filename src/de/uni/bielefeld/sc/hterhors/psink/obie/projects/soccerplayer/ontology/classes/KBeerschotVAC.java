...
@NamedIndividual public class KBeerschotVAC implements IKBeerschotVAC{
...
this.textMention = null;
	...
	public KBeerschotVAC(KBeerschotVAC kBeerschotVAC)throws InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException,NoSuchMethodException, SecurityException{
...
return "KBeerschotVAC [annotationID="+annotationID+",characterOffset="+characterOffset+",characterOnset="+characterOnset+",serialVersionUID="+serialVersionUID+",textMention="+textMention+"]";}
