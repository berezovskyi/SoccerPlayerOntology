...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IWilliamCarrFootballer;
...
public class WilliamCarrFootballer implements IWilliamCarrFootballer {
	...
	public WilliamCarrFootballer(WilliamCarrFootballer williamCarrFootballer)
			throws InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException,
			NoSuchMethodException, SecurityException {
		this.annotationID = williamCarrFootballer.getAnnotationID();
		for (int j = 0; j < williamCarrFootballer.getBirthPlaces().size(); j++) {
			if (williamCarrFootballer.getBirthPlaces().get(j) != null) {
				birthPlaces.add(williamCarrFootballer.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(williamCarrFootballer.getBirthPlaces().get(j).getClass())
						.newInstance(williamCarrFootballer.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (williamCarrFootballer.getBirthYear() != null)
			this.birthYear = williamCarrFootballer.getBirthYear().getClass()
					.getDeclaredConstructor(williamCarrFootballer.getBirthYear().getClass())
					.newInstance(williamCarrFootballer.getBirthYear());
		this.characterOffset = williamCarrFootballer.getCharacterOffset();
		this.characterOnset = williamCarrFootballer.getCharacterOnset();
		if (williamCarrFootballer.getPosition() != null)
			this.position = williamCarrFootballer.getPosition().getClass()
					.getDeclaredConstructor(williamCarrFootballer.getPosition().getClass())
					.newInstance(williamCarrFootballer.getPosition());
		for (int j = 0; j < williamCarrFootballer.getTeams().size(); j++) {
			if (williamCarrFootballer.getTeams().get(j) != null) {
				teams.add(williamCarrFootballer.getTeams().get(j).getClass()
						.getDeclaredConstructor(williamCarrFootballer.getTeams().get(j).getClass())
						.newInstance(williamCarrFootballer.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "WilliamCarrFootballer [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear="
