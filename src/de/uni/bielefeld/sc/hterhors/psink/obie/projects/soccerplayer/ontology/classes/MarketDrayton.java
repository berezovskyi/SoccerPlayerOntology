...
@NamedIndividual public class MarketDrayton implements IMarketDrayton{
...
this.textMention = textMention;
	...
	public MarketDrayton(MarketDrayton marketDrayton)throws InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException,NoSuchMethodException, SecurityException{
...
return "MarketDrayton [annotationID="+annotationID+",characterOffset="+characterOffset+",characterOnset="+characterOnset+",serialVersionUID="+serialVersionUID+",textMention="+textMention+"]";}
