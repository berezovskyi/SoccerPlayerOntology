...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IImreKissFootballerBorn1957;
...
public class ImreKissFootballerBorn1957 implements IImreKissFootballerBorn1957 {
	...
	public ImreKissFootballerBorn1957(ImreKissFootballerBorn1957 imreKissFootballerBorn1957)
			throws InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException,
			NoSuchMethodException, SecurityException {
		this.annotationID = imreKissFootballerBorn1957.getAnnotationID();
		for (int j = 0; j < imreKissFootballerBorn1957.getBirthPlaces().size(); j++) {
			if (imreKissFootballerBorn1957.getBirthPlaces().get(j) != null) {
				birthPlaces.add(imreKissFootballerBorn1957.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(imreKissFootballerBorn1957.getBirthPlaces().get(j).getClass())
						.newInstance(imreKissFootballerBorn1957.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (imreKissFootballerBorn1957.getBirthYear() != null)
			this.birthYear = imreKissFootballerBorn1957.getBirthYear().getClass()
					.getDeclaredConstructor(imreKissFootballerBorn1957.getBirthYear().getClass())
					.newInstance(imreKissFootballerBorn1957.getBirthYear());
		...
		if (imreKissFootballerBorn1957.getPosition() != null)
			this.position = imreKissFootballerBorn1957.getPosition().getClass()
					.getDeclaredConstructor(imreKissFootballerBorn1957.getPosition().getClass())
					.newInstance(imreKissFootballerBorn1957.getPosition());
		for (int j = 0; j < imreKissFootballerBorn1957.getTeams().size(); j++) {
			if (imreKissFootballerBorn1957.getTeams().get(j) != null) {
				teams.add(imreKissFootballerBorn1957.getTeams().get(j).getClass()
						.getDeclaredConstructor(imreKissFootballerBorn1957.getTeams().get(j).getClass())
						.newInstance(imreKissFootballerBorn1957.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "ImreKissFootballerBorn1957 [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces
