...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.ILucVanHoyweghen;
...
public class LucVanHoyweghen implements ILucVanHoyweghen {
	...
	public LucVanHoyweghen(LucVanHoyweghen lucVanHoyweghen) throws InstantiationException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		this.annotationID = lucVanHoyweghen.getAnnotationID();
		for (int j = 0; j < lucVanHoyweghen.getBirthPlaces().size(); j++) {
			if (lucVanHoyweghen.getBirthPlaces().get(j) != null) {
				birthPlaces.add(lucVanHoyweghen.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(lucVanHoyweghen.getBirthPlaces().get(j).getClass())
						.newInstance(lucVanHoyweghen.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (lucVanHoyweghen.getBirthYear() != null)
			this.birthYear = lucVanHoyweghen.getBirthYear().getClass()
					.getDeclaredConstructor(lucVanHoyweghen.getBirthYear().getClass())
					.newInstance(lucVanHoyweghen.getBirthYear());
		this.characterOffset = lucVanHoyweghen.getCharacterOffset();
		this.characterOnset = lucVanHoyweghen.getCharacterOnset();
		if (lucVanHoyweghen.getPosition() != null)
			this.position = lucVanHoyweghen.getPosition().getClass()
					.getDeclaredConstructor(lucVanHoyweghen.getPosition().getClass())
					.newInstance(lucVanHoyweghen.getPosition());
		for (int j = 0; j < lucVanHoyweghen.getTeams().size(); j++) {
			if (lucVanHoyweghen.getTeams().get(j) != null) {
				teams.add(lucVanHoyweghen.getTeams().get(j).getClass()
						.getDeclaredConstructor(lucVanHoyweghen.getTeams().get(j).getClass())
						.newInstance(lucVanHoyweghen.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "LucVanHoyweghen [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear="
