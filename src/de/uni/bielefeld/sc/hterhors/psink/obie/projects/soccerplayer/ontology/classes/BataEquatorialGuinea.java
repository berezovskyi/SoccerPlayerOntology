...
@NamedIndividual public class BataEquatorialGuinea implements IBataEquatorialGuinea{
...
final private String textMention;
	...
	public BataEquatorialGuinea(BataEquatorialGuinea bataEquatorialGuinea)throws InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException,NoSuchMethodException, SecurityException{
...
return "BataEquatorialGuinea [annotationID="+annotationID+",characterOffset="+characterOffset+",characterOnset="+characterOnset+",serialVersionUID="+serialVersionUID+",textMention="+textMention+"]";}
