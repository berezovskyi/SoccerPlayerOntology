...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.ILewisMilne;
...
public class LewisMilne implements ILewisMilne {
	...
	public LewisMilne(LewisMilne lewisMilne) throws InstantiationException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		this.annotationID = lewisMilne.getAnnotationID();
		for (int j = 0; j < lewisMilne.getBirthPlaces().size(); j++) {
			if (lewisMilne.getBirthPlaces().get(j) != null) {
				birthPlaces.add(lewisMilne.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(lewisMilne.getBirthPlaces().get(j).getClass())
						.newInstance(lewisMilne.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (lewisMilne.getBirthYear() != null)
			this.birthYear = lewisMilne.getBirthYear().getClass()
					.getDeclaredConstructor(lewisMilne.getBirthYear().getClass())
					.newInstance(lewisMilne.getBirthYear());
		this.characterOffset = lewisMilne.getCharacterOffset();
		this.characterOnset = lewisMilne.getCharacterOnset();
		if (lewisMilne.getPosition() != null)
			this.position = lewisMilne.getPosition().getClass()
					.getDeclaredConstructor(lewisMilne.getPosition().getClass()).newInstance(lewisMilne.getPosition());
		for (int j = 0; j < lewisMilne.getTeams().size(); j++) {
			if (lewisMilne.getTeams().get(j) != null) {
				teams.add(lewisMilne.getTeams().get(j).getClass()
						.getDeclaredConstructor(lewisMilne.getTeams().get(j).getClass())
						.newInstance(lewisMilne.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "LewisMilne [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear=" + birthYear
