...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IJimmyPageFootballer;
...
public class JimmyPageFootballer implements IJimmyPageFootballer {
	...
	public JimmyPageFootballer(JimmyPageFootballer jimmyPageFootballer)
			throws InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException,
			NoSuchMethodException, SecurityException {
		this.annotationID = jimmyPageFootballer.getAnnotationID();
		for (int j = 0; j < jimmyPageFootballer.getBirthPlaces().size(); j++) {
			if (jimmyPageFootballer.getBirthPlaces().get(j) != null) {
				birthPlaces.add(jimmyPageFootballer.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(jimmyPageFootballer.getBirthPlaces().get(j).getClass())
						.newInstance(jimmyPageFootballer.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (jimmyPageFootballer.getBirthYear() != null)
			this.birthYear = jimmyPageFootballer.getBirthYear().getClass()
					.getDeclaredConstructor(jimmyPageFootballer.getBirthYear().getClass())
					.newInstance(jimmyPageFootballer.getBirthYear());
		this.characterOffset = jimmyPageFootballer.getCharacterOffset();
		this.characterOnset = jimmyPageFootballer.getCharacterOnset();
		if (jimmyPageFootballer.getPosition() != null)
			this.position = jimmyPageFootballer.getPosition().getClass()
					.getDeclaredConstructor(jimmyPageFootballer.getPosition().getClass())
					.newInstance(jimmyPageFootballer.getPosition());
		for (int j = 0; j < jimmyPageFootballer.getTeams().size(); j++) {
			if (jimmyPageFootballer.getTeams().get(j) != null) {
				teams.add(jimmyPageFootballer.getTeams().get(j).getClass()
						.getDeclaredConstructor(jimmyPageFootballer.getTeams().get(j).getClass())
						.newInstance(jimmyPageFootballer.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "JimmyPageFootballer [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear="
