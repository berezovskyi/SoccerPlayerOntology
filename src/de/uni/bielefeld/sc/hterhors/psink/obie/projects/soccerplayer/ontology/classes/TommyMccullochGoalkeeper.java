...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.ITommyMccullochGoalkeeper;
...
public class TommyMccullochGoalkeeper implements ITommyMccullochGoalkeeper {
	...
	public TommyMccullochGoalkeeper(TommyMccullochGoalkeeper tommyMccullochGoalkeeper)
			throws InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException,
			NoSuchMethodException, SecurityException {
		this.annotationID = tommyMccullochGoalkeeper.getAnnotationID();
		for (int j = 0; j < tommyMccullochGoalkeeper.getBirthPlaces().size(); j++) {
			if (tommyMccullochGoalkeeper.getBirthPlaces().get(j) != null) {
				birthPlaces.add(tommyMccullochGoalkeeper.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(tommyMccullochGoalkeeper.getBirthPlaces().get(j).getClass())
						.newInstance(tommyMccullochGoalkeeper.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (tommyMccullochGoalkeeper.getBirthYear() != null)
			this.birthYear = tommyMccullochGoalkeeper.getBirthYear().getClass()
					.getDeclaredConstructor(tommyMccullochGoalkeeper.getBirthYear().getClass())
					.newInstance(tommyMccullochGoalkeeper.getBirthYear());
		...
		if (tommyMccullochGoalkeeper.getPosition() != null)
			this.position = tommyMccullochGoalkeeper.getPosition().getClass()
					.getDeclaredConstructor(tommyMccullochGoalkeeper.getPosition().getClass())
					.newInstance(tommyMccullochGoalkeeper.getPosition());
		for (int j = 0; j < tommyMccullochGoalkeeper.getTeams().size(); j++) {
			if (tommyMccullochGoalkeeper.getTeams().get(j) != null) {
				teams.add(tommyMccullochGoalkeeper.getTeams().get(j).getClass()
						.getDeclaredConstructor(tommyMccullochGoalkeeper.getTeams().get(j).getClass())
						.newInstance(tommyMccullochGoalkeeper.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "TommyMccullochGoalkeeper [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear="
