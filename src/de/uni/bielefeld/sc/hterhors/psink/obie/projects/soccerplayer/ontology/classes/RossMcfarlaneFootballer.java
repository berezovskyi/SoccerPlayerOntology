...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.IRossMcfarlaneFootballer;
...
public class RossMcfarlaneFootballer implements IRossMcfarlaneFootballer {
	...
	public RossMcfarlaneFootballer(RossMcfarlaneFootballer rossMcfarlaneFootballer)
			throws InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException,
			NoSuchMethodException, SecurityException {
		this.annotationID = rossMcfarlaneFootballer.getAnnotationID();
		for (int j = 0; j < rossMcfarlaneFootballer.getBirthPlaces().size(); j++) {
			if (rossMcfarlaneFootballer.getBirthPlaces().get(j) != null) {
				birthPlaces.add(rossMcfarlaneFootballer.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(rossMcfarlaneFootballer.getBirthPlaces().get(j).getClass())
						.newInstance(rossMcfarlaneFootballer.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (rossMcfarlaneFootballer.getBirthYear() != null)
			this.birthYear = rossMcfarlaneFootballer.getBirthYear().getClass()
					.getDeclaredConstructor(rossMcfarlaneFootballer.getBirthYear().getClass())
					.newInstance(rossMcfarlaneFootballer.getBirthYear());
		...
		if (rossMcfarlaneFootballer.getPosition() != null)
			this.position = rossMcfarlaneFootballer.getPosition().getClass()
					.getDeclaredConstructor(rossMcfarlaneFootballer.getPosition().getClass())
					.newInstance(rossMcfarlaneFootballer.getPosition());
		for (int j = 0; j < rossMcfarlaneFootballer.getTeams().size(); j++) {
			if (rossMcfarlaneFootballer.getTeams().get(j) != null) {
				teams.add(rossMcfarlaneFootballer.getTeams().get(j).getClass()
						.getDeclaredConstructor(rossMcfarlaneFootballer.getTeams().get(j).getClass())
						.newInstance(rossMcfarlaneFootballer.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "RossMcfarlaneFootballer [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear="
