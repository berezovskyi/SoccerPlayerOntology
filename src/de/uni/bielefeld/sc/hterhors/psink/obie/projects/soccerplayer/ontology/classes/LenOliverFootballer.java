...
import de.uni.bielefeld.sc.hterhors.psink.obie.projects.soccerplayer.ontology.interfaces.ILenOliverFootballer;
...
public class LenOliverFootballer implements ILenOliverFootballer {
	...
	public LenOliverFootballer(LenOliverFootballer lenOliverFootballer)
			throws InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException,
			NoSuchMethodException, SecurityException {
		this.annotationID = lenOliverFootballer.getAnnotationID();
		for (int j = 0; j < lenOliverFootballer.getBirthPlaces().size(); j++) {
			if (lenOliverFootballer.getBirthPlaces().get(j) != null) {
				birthPlaces.add(lenOliverFootballer.getBirthPlaces().get(j).getClass()
						.getDeclaredConstructor(lenOliverFootballer.getBirthPlaces().get(j).getClass())
						.newInstance(lenOliverFootballer.getBirthPlaces().get(j)));
			} else {
				birthPlaces.add(null);
			}
		}
		if (lenOliverFootballer.getBirthYear() != null)
			this.birthYear = lenOliverFootballer.getBirthYear().getClass()
					.getDeclaredConstructor(lenOliverFootballer.getBirthYear().getClass())
					.newInstance(lenOliverFootballer.getBirthYear());
		this.characterOffset = lenOliverFootballer.getCharacterOffset();
		this.characterOnset = lenOliverFootballer.getCharacterOnset();
		if (lenOliverFootballer.getPosition() != null)
			this.position = lenOliverFootballer.getPosition().getClass()
					.getDeclaredConstructor(lenOliverFootballer.getPosition().getClass())
					.newInstance(lenOliverFootballer.getPosition());
		for (int j = 0; j < lenOliverFootballer.getTeams().size(); j++) {
			if (lenOliverFootballer.getTeams().get(j) != null) {
				teams.add(lenOliverFootballer.getTeams().get(j).getClass()
						.getDeclaredConstructor(lenOliverFootballer.getTeams().get(j).getClass())
						.newInstance(lenOliverFootballer.getTeams().get(j)));
			} else {
				teams.add(null);
			}
		}
	...
	public String toString() {
		return "LenOliverFootballer [annotationID=" + annotationID + ",birthPlaces=" + birthPlaces + ",birthYear="
